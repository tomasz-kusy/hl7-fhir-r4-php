...
class ProcedureType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $performedDateTime
     */
     ...
     * Estimated or actual date, date-time, period, or age when the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured. (choose any one of performed*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\PeriodType $performedPeriod
     */
     ...
     * Estimated or actual date, date-time, period, or age when the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured. (choose any one of performed*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\AgeType $performedAge
     */
     ...
     * Estimated or actual date, date-time, period, or age when the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured. (choose any one of performed*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\RangeType $performedRange
     */
     ...
     * Estimated or actual date, date-time, period, or age when the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured. (choose any one of performed*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $performedDateTime
     * @return self
     */
    public function setPerformedDateTime(\TKusy\Hl7FhirR4\DateTimeType $performedDateTime)
    {
     ...
     * Estimated or actual date, date-time, period, or age when the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured. (choose any one of performed*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\PeriodType $performedPeriod
     * @return self
     */
    public function setPerformedPeriod(\TKusy\Hl7FhirR4\PeriodType $performedPeriod)
    {
     ...
     * Estimated or actual date, date-time, period, or age when the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured. (choose any one of performed*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\AgeType $performedAge
     * @return self
     */
    public function setPerformedAge(\TKusy\Hl7FhirR4\AgeType $performedAge)
    {
     ...
     * Estimated or actual date, date-time, period, or age when the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured. (choose any one of performed*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\RangeType $performedRange
     * @return self
     */
    public function setPerformedRange(\TKusy\Hl7FhirR4\RangeType $performedRange)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ProcedurePerformerType $performer
     */
    public function addToPerformer(\TKusy\Hl7FhirR4\ProcedurePerformerType $performer)
    {
     ...
     * Limited to "real" people rather than equipment.
     *
     * @return \TKusy\Hl7FhirR4\ProcedurePerformerType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $report
     */
    public function addToReport(\TKusy\Hl7FhirR4\ReferenceType $report)
    {
        $this->report[] = $report;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $complication
     */
    public function addToComplication(\TKusy\Hl7FhirR4\CodeableConceptType $complication)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $complicationDetail
     */
    public function addToComplicationDetail(\TKusy\Hl7FhirR4\ReferenceType $complicationDetail)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $followUp
     */
    public function addToFollowUp(\TKusy\Hl7FhirR4\CodeableConceptType $followUp)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ProcedureFocalDeviceType $focalDevice
     */
    public function addToFocalDevice(\TKusy\Hl7FhirR4\ProcedureFocalDeviceType $focalDevice)
    {
     ...
     * A device that is implanted, removed or otherwise manipulated (calibration, battery replacement, fitting a prosthesis, attaching a wound-vac, etc.) as a focal portion of the Procedure.
     *
     * @return \TKusy\Hl7FhirR4\ProcedureFocalDeviceType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $usedReference
     */
    public function addToUsedReference(\TKusy\Hl7FhirR4\ReferenceType $usedReference)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $usedCode
     */
    public function addToUsedCode(\TKusy\Hl7FhirR4\CodeableConceptType $usedCode)
    {
