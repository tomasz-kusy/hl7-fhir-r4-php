...
class RiskEvidenceSynthesisType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\RiskEvidenceSynthesisSampleSizeType $sampleSize
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\RiskEvidenceSynthesisRiskEstimateType $riskEstimate
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\RiskEvidenceSynthesisCertaintyType[] $certainty
     */
    private $certainty = [
     ...
     * A description of the size of the sample involved in the synthesis.
     *
     * @return \TKusy\Hl7FhirR4\RiskEvidenceSynthesisSampleSizeType
     */
     ...
     * A description of the size of the sample involved in the synthesis.
     *
     * @param \TKusy\Hl7FhirR4\RiskEvidenceSynthesisSampleSizeType $sampleSize
     * @return self
     */
    public function setSampleSize(\TKusy\Hl7FhirR4\RiskEvidenceSynthesisSampleSizeType $sampleSize)
    {
     ...
     * The estimated risk of the outcome.
     *
     * @return \TKusy\Hl7FhirR4\RiskEvidenceSynthesisRiskEstimateType
     */
     ...
     * The estimated risk of the outcome.
     *
     * @param \TKusy\Hl7FhirR4\RiskEvidenceSynthesisRiskEstimateType $riskEstimate
     * @return self
     */
    public function setRiskEstimate(\TKusy\Hl7FhirR4\RiskEvidenceSynthesisRiskEstimateType $riskEstimate)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\RiskEvidenceSynthesisCertaintyType $certainty
     */
    public function addToCertainty(\TKusy\Hl7FhirR4\RiskEvidenceSynthesisCertaintyType $certainty)
    {
     ...
     * A description of the certainty of the risk estimate.
     *
     * @return \TKusy\Hl7FhirR4\RiskEvidenceSynthesisCertaintyType[]
     */
