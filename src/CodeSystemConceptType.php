...
class CodeSystemConceptType extends BackboneElementType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeSystemDesignationType $designation
     */
    public function addToDesignation(\TKusy\Hl7FhirR4\CodeSystemDesignationType $designation)
    {
     ...
     * Additional representations for the concept - other languages, aliases, specialized purposes, used for particular purposes, etc.
     *
     * @return \TKusy\Hl7FhirR4\CodeSystemDesignationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeSystemProperty1Type $property
     */
    public function addToProperty(\TKusy\Hl7FhirR4\CodeSystemProperty1Type $property)
    {
     ...
     * A property value for this concept.
     *
     * @return \TKusy\Hl7FhirR4\CodeSystemProperty1Type[]
     */
