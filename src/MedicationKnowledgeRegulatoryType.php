...
class MedicationKnowledgeRegulatoryType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $regulatoryAuthority
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\MedicationKnowledgeMaxDispenseType $maxDispense
     */
     ...
     * The authority that is specifying the regulations.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $regulatoryAuthority
     * @return self
     */
    public function setRegulatoryAuthority(\TKusy\Hl7FhirR4\ReferenceType $regulatoryAuthority)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MedicationKnowledgeSubstitutionType $substitution
     */
    public function addToSubstitution(\TKusy\Hl7FhirR4\MedicationKnowledgeSubstitutionType $substitution)
    {
     ...
     * Specifies if changes are allowed when dispensing a medication from a regulatory perspective.
     *
     * @return \TKusy\Hl7FhirR4\MedicationKnowledgeSubstitutionType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MedicationKnowledgeScheduleType $schedule
     */
    public function addToSchedule(\TKusy\Hl7FhirR4\MedicationKnowledgeScheduleType $schedule)
    {
     ...
     * Specifies the schedule of a medication in jurisdiction.
     *
     * @return \TKusy\Hl7FhirR4\MedicationKnowledgeScheduleType[]
     */
     ...
     * The maximum number of units of the medication that can be dispensed in a period.
     *
     * @return \TKusy\Hl7FhirR4\MedicationKnowledgeMaxDispenseType
     */
     ...
     * The maximum number of units of the medication that can be dispensed in a period.
     *
     * @param \TKusy\Hl7FhirR4\MedicationKnowledgeMaxDispenseType $maxDispense
     * @return self
     */
    public function setMaxDispense(\TKusy\Hl7FhirR4\MedicationKnowledgeMaxDispenseType $maxDispense)
    {
