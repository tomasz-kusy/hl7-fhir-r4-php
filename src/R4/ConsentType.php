...
class ConsentType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConsentStateType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AttachmentType $sourceAttachment
     */
     ...
     * The source on which this consent statement is based. The source might be a scanned original paper form, or a reference to a consent that links back to such a source, a reference to a document repository (e.g. XDS) that stores the original consent document. (choose any one of source*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $sourceReference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConsentPolicyType[] $policy
     */
    private $policy = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $policyRule
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConsentVerificationType[] $verification
     */
     ...
     * Indicates the current state of this consent.
     *
     * @return \TKusy\Hl7Fhir\R4\ConsentStateType
     */
     ...
     * Indicates the current state of this consent.
     *
     * @param \TKusy\Hl7Fhir\R4\ConsentStateType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ConsentStateType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     */
    public function addToOrganization(\TKusy\Hl7Fhir\R4\ReferenceType $organization)
    {
     ...
     * The source on which this consent statement is based. The source might be a scanned original paper form, or a reference to a consent that links back to such a source, a reference to a document repository (e.g. XDS) that stores the original consent document. (choose any one of source*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\AttachmentType $sourceAttachment
     * @return self
     */
    public function setSourceAttachment(\TKusy\Hl7Fhir\R4\AttachmentType $sourceAttachment)
    {
     ...
     * The source on which this consent statement is based. The source might be a scanned original paper form, or a reference to a consent that links back to such a source, a reference to a document repository (e.g. XDS) that stores the original consent document. (choose any one of source*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $sourceReference
     * @return self
     */
    public function setSourceReference(\TKusy\Hl7Fhir\R4\ReferenceType $sourceReference)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ConsentPolicyType $policy
     */
    public function addToPolicy(\TKusy\Hl7Fhir\R4\ConsentPolicyType $policy)
    {
        $this->policy[] = $policy;
        return $this;
    }
     ...
     * The references to the policies that are included in this consent scope. Policies may be organizational, but are often defined jurisdictionally, or in law.
     *
     * @return \TKusy\Hl7Fhir\R4\ConsentPolicyType[]
     */
     ...
     * A reference to the specific base computable regulation or policy.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $policyRule
     * @return self
     */
    public function setPolicyRule(\TKusy\Hl7Fhir\R4\CodeableConceptType $policyRule)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ConsentVerificationType $verification
     */
    public function addToVerification(\TKusy\Hl7Fhir\R4\ConsentVerificationType $verification)
    {
     ...
     * Whether a treatment instruction (e.g. artificial respiration yes or no) was verified with the patient, his/her family or another authorized person.
     *
     * @return \TKusy\Hl7Fhir\R4\ConsentVerificationType[]
     */
     ...
     * @return self
     */
    public function setProvision(\TKusy\Hl7Fhir\R4\ConsentProvisionType $provision)
    {
