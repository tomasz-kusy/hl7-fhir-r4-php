...
class CarePlanActivityType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $outcomeCodeableConcept
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AnnotationType[] $progress
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CarePlanDetailType $detail
     */
    private $detail = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $outcomeCodeableConcept
     */
    public function addToOutcomeCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $outcomeCodeableConcept)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\AnnotationType $progress
     */
    public function addToProgress(\TKusy\Hl7Fhir\R4\AnnotationType $progress)
    {
     ...
     * A simple summary of a planned activity suitable for a general care plan system (e.g. form driven) that doesn't know about specific resources such as procedure etc.
     *
     * @return \TKusy\Hl7Fhir\R4\CarePlanDetailType
     */
     ...
     * A simple summary of a planned activity suitable for a general care plan system (e.g. form driven) that doesn't know about specific resources such as procedure etc.
     *
     * @param \TKusy\Hl7Fhir\R4\CarePlanDetailType $detail
     * @return self
     */
    public function setDetail(\TKusy\Hl7Fhir\R4\CarePlanDetailType $detail)
    {
        $this->detail = $detail;
        return $this;
    }
