...
class EncounterDiagnosisType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $use
     */
    private $use = null;
     ...
     * Role that this diagnosis has within the encounter (e.g. admission, billing, discharge …).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $use
     * @return self
     */
    public function setUse(\TKusy\Hl7Fhir\R4\CodeableConceptType $use)
    {
        $this->use = $use;
        return $this;
    }
