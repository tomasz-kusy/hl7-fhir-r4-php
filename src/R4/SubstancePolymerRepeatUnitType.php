...
class SubstancePolymerRepeatUnitType extends BackboneElementType
{
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $orientationOfPolymerisation
     */
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $repeatUnit
     */
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\SubstancePolymerDegreeOfPolymerisationType[] $degreeOfPolymerisation
     */
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\SubstancePolymerStructuralRepresentationType[] $structuralRepresentation
     */
     ...
     * Todo.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $orientationOfPolymerisation
     * @return self
     */
    public function setOrientationOfPolymerisation(\TKusy\Hl7Fhir\R4\CodeableConceptType $orientationOfPolymerisation)
    {
     ...
     * Todo.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $repeatUnit
     * @return self
     */
    public function setRepeatUnit(\TKusy\Hl7Fhir\R4\StringType $repeatUnit)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstancePolymerDegreeOfPolymerisationType $degreeOfPolymerisation
     */
    public function addToDegreeOfPolymerisation(\TKusy\Hl7Fhir\R4\SubstancePolymerDegreeOfPolymerisationType $degreeOfPolymerisation)
    {
     ...
     * Todo.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstancePolymerDegreeOfPolymerisationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstancePolymerStructuralRepresentationType $structuralRepresentation
     */
    public function addToStructuralRepresentation(\TKusy\Hl7Fhir\R4\SubstancePolymerStructuralRepresentationType $structuralRepresentation)
    {
     ...
     * Todo.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstancePolymerStructuralRepresentationType[]
     */
