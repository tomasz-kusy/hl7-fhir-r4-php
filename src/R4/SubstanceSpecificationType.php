...
class SubstanceSpecificationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSpecificationMoietyType[] $moiety
     */
    private $moiety = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSpecificationPropertyType[] $property
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $referenceInformation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSpecificationStructureType $structure
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSpecificationCodeType[] $code
     */
    private $code = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSpecificationNameType[] $name
     */
    private $name = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSpecificationRelationshipType[] $relationship
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $nucleicAcid
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $polymer
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $protein
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $sourceMaterial
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceSpecificationMoietyType $moiety
     */
    public function addToMoiety(\TKusy\Hl7Fhir\R4\SubstanceSpecificationMoietyType $moiety)
    {
        $this->moiety[] = $moiety;
        return $this;
    }
     ...
     * Moiety, for structural modifications.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSpecificationMoietyType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceSpecificationPropertyType $property
     */
    public function addToProperty(\TKusy\Hl7Fhir\R4\SubstanceSpecificationPropertyType $property)
    {
     ...
     * General specifications for this substance, including how it is related to other substances.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSpecificationPropertyType[]
     */
     ...
     * General information detailing this substance.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $referenceInformation
     * @return self
     */
    public function setReferenceInformation(\TKusy\Hl7Fhir\R4\ReferenceType $referenceInformation)
    {
     ...
     * Structural information.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSpecificationStructureType
     */
     ...
     * Structural information.
     *
     * @param \TKusy\Hl7Fhir\R4\SubstanceSpecificationStructureType $structure
     * @return self
     */
    public function setStructure(\TKusy\Hl7Fhir\R4\SubstanceSpecificationStructureType $structure)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceSpecificationCodeType $code
     */
    public function addToCode(\TKusy\Hl7Fhir\R4\SubstanceSpecificationCodeType $code)
    {
        $this->code[] = $code;
        return $this;
    }
     ...
     * Codes associated with the substance.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSpecificationCodeType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceSpecificationNameType $name
     */
    public function addToName(\TKusy\Hl7Fhir\R4\SubstanceSpecificationNameType $name)
    {
        $this->name[] = $name;
        return $this;
    }
     ...
     * Names applicable to this substance.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSpecificationNameType[]
     */
     ...
     */
    public function addToMolecularWeight(\TKusy\Hl7Fhir\R4\SubstanceSpecificationMolecularWeightType $molecularWeight)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceSpecificationRelationshipType $relationship
     */
    public function addToRelationship(\TKusy\Hl7Fhir\R4\SubstanceSpecificationRelationshipType $relationship)
    {
     ...
     * A link between this substance and another, with details of the relationship.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSpecificationRelationshipType[]
     */
     ...
     * Data items specific to nucleic acids.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $nucleicAcid
     * @return self
     */
    public function setNucleicAcid(\TKusy\Hl7Fhir\R4\ReferenceType $nucleicAcid)
    {
     ...
     * Data items specific to polymers.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $polymer
     * @return self
     */
    public function setPolymer(\TKusy\Hl7Fhir\R4\ReferenceType $polymer)
    {
     ...
     * Data items specific to proteins.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $protein
     * @return self
     */
    public function setProtein(\TKusy\Hl7Fhir\R4\ReferenceType $protein)
    {
     ...
     * Material or taxonomic/anatomical source for the substance.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $sourceMaterial
     * @return self
     */
    public function setSourceMaterial(\TKusy\Hl7Fhir\R4\ReferenceType $sourceMaterial)
    {
