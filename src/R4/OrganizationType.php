...
class OrganizationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\OrganizationContactType[] $contact
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\OrganizationContactType $contact
     */
    public function addToContact(\TKusy\Hl7Fhir\R4\OrganizationContactType $contact)
    {
     ...
     * Contact for the organization for a certain purpose.
     *
     * @return \TKusy\Hl7Fhir\R4\OrganizationContactType[]
     */
