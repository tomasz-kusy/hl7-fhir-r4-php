...
class OrganizationAffiliationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $participatingOrganization
     */
     ...
     * The Participating Organization provides/performs the role(s) defined by the code to the Primary Organization (e.g. providing services or is a member of).
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $participatingOrganization
     * @return self
     */
    public function setParticipatingOrganization(\TKusy\Hl7Fhir\R4\ReferenceType $participatingOrganization)
    {
