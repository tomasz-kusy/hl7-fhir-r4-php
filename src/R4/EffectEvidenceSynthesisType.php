...
class EffectEvidenceSynthesisType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $exposureAlternative
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisSampleSizeType $sampleSize
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisResultsByExposureType[] $resultsByExposure
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisEffectEstimateType[] $effectEstimate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisCertaintyType[] $certainty
     */
     ...
     * A reference to a EvidenceVariable resource that defines the comparison exposure for the research.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $exposureAlternative
     * @return self
     */
    public function setExposureAlternative(\TKusy\Hl7Fhir\R4\ReferenceType $exposureAlternative)
    {
     ...
     * A description of the size of the sample involved in the synthesis.
     *
     * @return \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisSampleSizeType
     */
     ...
     * A description of the size of the sample involved in the synthesis.
     *
     * @param \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisSampleSizeType $sampleSize
     * @return self
     */
    public function setSampleSize(\TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisSampleSizeType $sampleSize)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisResultsByExposureType $resultsByExposure
     */
    public function addToResultsByExposure(\TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisResultsByExposureType $resultsByExposure)
    {
     ...
     * A description of the results for each exposure considered in the effect estimate.
     *
     * @return \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisResultsByExposureType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisEffectEstimateType $effectEstimate
     */
    public function addToEffectEstimate(\TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisEffectEstimateType $effectEstimate)
    {
     ...
     * The estimated effect of the exposure variant.
     *
     * @return \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisEffectEstimateType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisCertaintyType $certainty
     */
    public function addToCertainty(\TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisCertaintyType $certainty)
    {
     ...
     * A description of the certainty of the effect estimate.
     *
     * @return \TKusy\Hl7Fhir\R4\EffectEvidenceSynthesisCertaintyType[]
     */
