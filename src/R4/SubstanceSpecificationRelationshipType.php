...
class SubstanceSpecificationRelationshipType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $substanceReference
     */
     ...
     * A pointer to another substance, as a resource or just a representational code. (choose any one of substance*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $substanceCodeableConcept
     */
     ...
     * A numeric factor for the relationship, for instance to express that the salt of a substance has some percentage of the active substance in relation to some other. (choose any one of amount*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\RatioType $amountRatio
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RatioType $amountRatioLowLimit
     */
     ...
     * A pointer to another substance, as a resource or just a representational code. (choose any one of substance*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $substanceReference
     * @return self
     */
    public function setSubstanceReference(\TKusy\Hl7Fhir\R4\ReferenceType $substanceReference)
    {
     ...
     * A pointer to another substance, as a resource or just a representational code. (choose any one of substance*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $substanceCodeableConcept
     * @return self
     */
    public function setSubstanceCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $substanceCodeableConcept)
    {
     ...
     * A numeric factor for the relationship, for instance to express that the salt of a substance has some percentage of the active substance in relation to some other. (choose any one of amount*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RatioType $amountRatio
     * @return self
     */
    public function setAmountRatio(\TKusy\Hl7Fhir\R4\RatioType $amountRatio)
    {
     ...
     * For use when the numeric.
     *
     * @param \TKusy\Hl7Fhir\R4\RatioType $amountRatioLowLimit
     * @return self
     */
    public function setAmountRatioLowLimit(\TKusy\Hl7Fhir\R4\RatioType $amountRatioLowLimit)
    {
