...
class ImmunizationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ImmunizationStatusCodesType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $vaccineCode
     */
     ...
     * Date vaccine administered or was to be administered. (choose any one of occurrence*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $occurrenceString
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $recorded
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $primarySource
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $reportOrigin
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateType $expirationDate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $site
     */
    private $site = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $route
     */
    private $route = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $doseQuantity
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ImmunizationPerformerType[] $performer
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $isSubpotent
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $subpotentReason
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ImmunizationEducationType[] $education
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $programEligibility
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $fundingSource
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ImmunizationReactionType[] $reaction
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ImmunizationProtocolAppliedType[] $protocolApplied
     */
     ...
     * Indicates the current status of the immunization event.
     *
     * @return \TKusy\Hl7Fhir\R4\ImmunizationStatusCodesType
     */
     ...
     * Indicates the current status of the immunization event.
     *
     * @param \TKusy\Hl7Fhir\R4\ImmunizationStatusCodesType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ImmunizationStatusCodesType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * Vaccine that was administered or was to be administered.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $vaccineCode
     * @return self
     */
    public function setVaccineCode(\TKusy\Hl7Fhir\R4\CodeableConceptType $vaccineCode)
    {
     ...
     * Date vaccine administered or was to be administered. (choose any one of occurrence*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $occurrenceString
     * @return self
     */
    public function setOccurrenceString(\TKusy\Hl7Fhir\R4\StringType $occurrenceString)
    {
     ...
     * The date the occurrence of the immunization was first captured in the record - potentially significantly after the occurrence of the event.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $recorded
     * @return self
     */
    public function setRecorded(\TKusy\Hl7Fhir\R4\DateTimeType $recorded)
    {
     ...
     * An indication that the content of the record is based on information from the person who administered the vaccine. This reflects the context under which the data was originally recorded.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $primarySource
     * @return self
     */
    public function setPrimarySource(\TKusy\Hl7Fhir\R4\BooleanType $primarySource)
    {
     ...
     * The source of the data when the report of the immunization event is not based on information from the person who administered the vaccine.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $reportOrigin
     * @return self
     */
    public function setReportOrigin(\TKusy\Hl7Fhir\R4\CodeableConceptType $reportOrigin)
    {
     ...
     * Date vaccine batch expires.
     *
     * @param \TKusy\Hl7Fhir\R4\DateType $expirationDate
     * @return self
     */
    public function setExpirationDate(\TKusy\Hl7Fhir\R4\DateType $expirationDate)
    {
     ...
     * Body site where vaccine was administered.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $site
     * @return self
     */
    public function setSite(\TKusy\Hl7Fhir\R4\CodeableConceptType $site)
    {
        $this->site = $site;
        return $this;
    }
     ...
     * The path by which the vaccine product is taken into the body.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $route
     * @return self
     */
    public function setRoute(\TKusy\Hl7Fhir\R4\CodeableConceptType $route)
    {
        $this->route = $route;
        return $this;
    }
     ...
     * The quantity of vaccine product that was administered.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $doseQuantity
     * @return self
     */
    public function setDoseQuantity(\TKusy\Hl7Fhir\R4\QuantityType $doseQuantity)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ImmunizationPerformerType $performer
     */
    public function addToPerformer(\TKusy\Hl7Fhir\R4\ImmunizationPerformerType $performer)
    {
     ...
     * Indicates who performed the immunization event.
     *
     * @return \TKusy\Hl7Fhir\R4\ImmunizationPerformerType[]
     */
     ...
     * Indication if a dose is considered to be subpotent. By default, a dose should be considered to be potent.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $isSubpotent
     * @return self
     */
    public function setIsSubpotent(\TKusy\Hl7Fhir\R4\BooleanType $isSubpotent)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $subpotentReason
     */
    public function addToSubpotentReason(\TKusy\Hl7Fhir\R4\CodeableConceptType $subpotentReason)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ImmunizationEducationType $education
     */
    public function addToEducation(\TKusy\Hl7Fhir\R4\ImmunizationEducationType $education)
    {
     ...
     * Educational material presented to the patient (or guardian) at the time of vaccine administration.
     *
     * @return \TKusy\Hl7Fhir\R4\ImmunizationEducationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $programEligibility
     */
    public function addToProgramEligibility(\TKusy\Hl7Fhir\R4\CodeableConceptType $programEligibility)
    {
     ...
     * Indicates the source of the vaccine actually administered. This may be different than the patient eligibility (e.g. the patient may be eligible for a publically purchased vaccine but due to inventory issues, vaccine purchased with private funds was actually administered).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $fundingSource
     * @return self
     */
    public function setFundingSource(\TKusy\Hl7Fhir\R4\CodeableConceptType $fundingSource)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ImmunizationReactionType $reaction
     */
    public function addToReaction(\TKusy\Hl7Fhir\R4\ImmunizationReactionType $reaction)
    {
     ...
     * Categorical data indicating that an adverse event is associated in time to an immunization.
     *
     * @return \TKusy\Hl7Fhir\R4\ImmunizationReactionType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ImmunizationProtocolAppliedType $protocolApplied
     */
    public function addToProtocolApplied(\TKusy\Hl7Fhir\R4\ImmunizationProtocolAppliedType $protocolApplied)
    {
     ...
     * The protocol (set of recommendations) being followed by the provider who administered the dose.
     *
     * @return \TKusy\Hl7Fhir\R4\ImmunizationProtocolAppliedType[]
     */
