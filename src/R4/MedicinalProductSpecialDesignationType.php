...
class MedicinalProductSpecialDesignationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $intendedUse
     */
     ...
     * The intended use of the product, e.g. prevention, treatment.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $intendedUse
     * @return self
     */
    public function setIntendedUse(\TKusy\Hl7Fhir\R4\CodeableConceptType $intendedUse)
    {
