...
class MedicationKnowledgeKineticsType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType[] $areaUnderCurve
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType[] $lethalDose50
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $halfLifePeriod
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\QuantityType $areaUnderCurve
     */
    public function addToAreaUnderCurve(\TKusy\Hl7Fhir\R4\QuantityType $areaUnderCurve)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\QuantityType $lethalDose50
     */
    public function addToLethalDose50(\TKusy\Hl7Fhir\R4\QuantityType $lethalDose50)
    {
     ...
     * The time required for any specified property (e.g., the concentration of a substance in the body) to decrease by half.
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $halfLifePeriod
     * @return self
     */
    public function setHalfLifePeriod(\TKusy\Hl7Fhir\R4\DurationType $halfLifePeriod)
    {
