...
class SubstancePolymerDegreeOfPolymerisationType extends BackboneElementType
{
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $degree
     */
    private $degree = null;
     ...
     * Todo.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $degree
     * @return self
     */
    public function setDegree(\TKusy\Hl7Fhir\R4\CodeableConceptType $degree)
    {
        $this->degree = $degree;
        return $this;
    }
