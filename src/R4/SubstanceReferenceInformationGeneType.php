...
class SubstanceReferenceInformationGeneType extends BackboneElementType
{
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $geneSequenceOrigin
     */
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $gene
     */
    private $gene = null;
     ...
     * Todo.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $geneSequenceOrigin
     * @return self
     */
    public function setGeneSequenceOrigin(\TKusy\Hl7Fhir\R4\CodeableConceptType $geneSequenceOrigin)
    {
     ...
     * Todo.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $gene
     * @return self
     */
    public function setGene(\TKusy\Hl7Fhir\R4\CodeableConceptType $gene)
    {
        $this->gene = $gene;
        return $this;
    }
