...
class EncounterHospitalizationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $preAdmissionIdentifier
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $origin
     */
    private $origin = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $admitSource
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $reAdmission
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $dietPreference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $specialCourtesy
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $specialArrangement
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $dischargeDisposition
     */
     ...
     * Pre-admission identifier.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $preAdmissionIdentifier
     * @return self
     */
    public function setPreAdmissionIdentifier(\TKusy\Hl7Fhir\R4\IdentifierType $preAdmissionIdentifier)
    {
     ...
     * The location/organization from which the patient came before admission.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $origin
     * @return self
     */
    public function setOrigin(\TKusy\Hl7Fhir\R4\ReferenceType $origin)
    {
        $this->origin = $origin;
        return $this;
    }
     ...
     * From where patient was admitted (physician referral, transfer).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $admitSource
     * @return self
     */
    public function setAdmitSource(\TKusy\Hl7Fhir\R4\CodeableConceptType $admitSource)
    {
     ...
     * Whether this hospitalization is a readmission and why if known.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $reAdmission
     * @return self
     */
    public function setReAdmission(\TKusy\Hl7Fhir\R4\CodeableConceptType $reAdmission)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $dietPreference
     */
    public function addToDietPreference(\TKusy\Hl7Fhir\R4\CodeableConceptType $dietPreference)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $specialCourtesy
     */
    public function addToSpecialCourtesy(\TKusy\Hl7Fhir\R4\CodeableConceptType $specialCourtesy)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $specialArrangement
     */
    public function addToSpecialArrangement(\TKusy\Hl7Fhir\R4\CodeableConceptType $specialArrangement)
    {
     ...
     * Category or kind of location after discharge.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $dischargeDisposition
     * @return self
     */
    public function setDischargeDisposition(\TKusy\Hl7Fhir\R4\CodeableConceptType $dischargeDisposition)
    {
