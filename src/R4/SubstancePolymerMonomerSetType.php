...
class SubstancePolymerMonomerSetType extends BackboneElementType
{
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $ratioType
     */
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\SubstancePolymerStartingMaterialType[] $startingMaterial
     */
     ...
     * Todo.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $ratioType
     * @return self
     */
    public function setRatioType(\TKusy\Hl7Fhir\R4\CodeableConceptType $ratioType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstancePolymerStartingMaterialType $startingMaterial
     */
    public function addToStartingMaterial(\TKusy\Hl7Fhir\R4\SubstancePolymerStartingMaterialType $startingMaterial)
    {
     ...
     * Todo.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstancePolymerStartingMaterialType[]
     */
