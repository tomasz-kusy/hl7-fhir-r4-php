...
class SupplyDeliveryType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SupplyDeliveryStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SupplyDeliverySuppliedItemType $suppliedItem
     */
     ...
     * A code specifying the state of the dispense event.
     *
     * @return \TKusy\Hl7Fhir\R4\SupplyDeliveryStatusType
     */
     ...
     * A code specifying the state of the dispense event.
     *
     * @param \TKusy\Hl7Fhir\R4\SupplyDeliveryStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\SupplyDeliveryStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The item that is being delivered or has been supplied.
     *
     * @return \TKusy\Hl7Fhir\R4\SupplyDeliverySuppliedItemType
     */
     ...
     * The item that is being delivered or has been supplied.
     *
     * @param \TKusy\Hl7Fhir\R4\SupplyDeliverySuppliedItemType $suppliedItem
     * @return self
     */
    public function setSuppliedItem(\TKusy\Hl7Fhir\R4\SupplyDeliverySuppliedItemType $suppliedItem)
    {
     ...
     * @return self
     */
    public function setSupplier(\TKusy\Hl7Fhir\R4\ReferenceType $supplier)
    {
