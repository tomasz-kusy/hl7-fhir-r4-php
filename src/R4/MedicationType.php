...
class MedicationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationStatusCodesType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RatioType $amount
     */
    private $amount = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationIngredientType[] $ingredient
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationBatchType $batch
     */
    private $batch = null;
     ...
     * A code to indicate if the medication is in active use.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationStatusCodesType
     */
     ...
     * A code to indicate if the medication is in active use.
     *
     * @param \TKusy\Hl7Fhir\R4\MedicationStatusCodesType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\MedicationStatusCodesType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * Specific amount of the drug in the packaged product. For example, when specifying a product that has the same strength (For example, Insulin glargine 100 unit per mL solution for injection), this attribute provides additional clarification of the package amount (For example, 3 mL, 10mL, etc.).
     *
     * @param \TKusy\Hl7Fhir\R4\RatioType $amount
     * @return self
     */
    public function setAmount(\TKusy\Hl7Fhir\R4\RatioType $amount)
    {
        $this->amount = $amount;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationIngredientType $ingredient
     */
    public function addToIngredient(\TKusy\Hl7Fhir\R4\MedicationIngredientType $ingredient)
    {
     ...
     * Identifies a particular constituent of interest in the product.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationIngredientType[]
     */
     ...
     * Information that only applies to packages (not products).
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationBatchType
     */
     ...
     * Information that only applies to packages (not products).
     *
     * @param \TKusy\Hl7Fhir\R4\MedicationBatchType $batch
     * @return self
     */
    public function setBatch(\TKusy\Hl7Fhir\R4\MedicationBatchType $batch)
    {
        $this->batch = $batch;
        return $this;
    }
