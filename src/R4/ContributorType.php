...
class ContributorType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContributorTypeType $type
     */
    private $type = null;
     ...
     * The type of contributor.
     *
     * @return \TKusy\Hl7Fhir\R4\ContributorTypeType
     */
     ...
     * The type of contributor.
     *
     * @param \TKusy\Hl7Fhir\R4\ContributorTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\ContributorTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
