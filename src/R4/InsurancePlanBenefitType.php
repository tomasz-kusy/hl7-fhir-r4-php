...
class InsurancePlanBenefitType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InsurancePlanLimitType[] $limit
     */
    private $limit = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\InsurancePlanLimitType $limit
     */
    public function addToLimit(\TKusy\Hl7Fhir\R4\InsurancePlanLimitType $limit)
    {
        $this->limit[] = $limit;
        return $this;
    }
     ...
     * The specific limits on the benefit.
     *
     * @return \TKusy\Hl7Fhir\R4\InsurancePlanLimitType[]
     */
