...
class PatientType extends DomainResourceType
{
     ...
     * Indicates if the individual is deceased or not. (choose any one of deceased*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $deceasedDateTime
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $maritalStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $multipleBirthBoolean
     */
     ...
     * Indicates whether the patient is part of a multiple (boolean) or indicates the actual birth order (integer). (choose any one of multipleBirth*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\IntegerType $multipleBirthInteger
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PatientContactType[] $contact
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PatientCommunicationType[] $communication
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $generalPractitioner
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PatientLinkType[] $link
     */
    private $link = null;
     ...
     * Indicates if the individual is deceased or not. (choose any one of deceased*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $deceasedDateTime
     * @return self
     */
    public function setDeceasedDateTime(\TKusy\Hl7Fhir\R4\DateTimeType $deceasedDateTime)
    {
     ...
     * This field contains a patient's most recent marital (civil) status.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $maritalStatus
     * @return self
     */
    public function setMaritalStatus(\TKusy\Hl7Fhir\R4\CodeableConceptType $maritalStatus)
    {
     ...
     * Indicates whether the patient is part of a multiple (boolean) or indicates the actual birth order (integer). (choose any one of multipleBirth*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $multipleBirthBoolean
     * @return self
     */
    public function setMultipleBirthBoolean(\TKusy\Hl7Fhir\R4\BooleanType $multipleBirthBoolean)
    {
     ...
     * Indicates whether the patient is part of a multiple (boolean) or indicates the actual birth order (integer). (choose any one of multipleBirth*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\IntegerType $multipleBirthInteger
     * @return self
     */
    public function setMultipleBirthInteger(\TKusy\Hl7Fhir\R4\IntegerType $multipleBirthInteger)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PatientContactType $contact
     */
    public function addToContact(\TKusy\Hl7Fhir\R4\PatientContactType $contact)
    {
     ...
     * A contact party (e.g. guardian, partner, friend) for the patient.
     *
     * @return \TKusy\Hl7Fhir\R4\PatientContactType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PatientCommunicationType $communication
     */
    public function addToCommunication(\TKusy\Hl7Fhir\R4\PatientCommunicationType $communication)
    {
     ...
     * A language which may be used to communicate with the patient about his or her health.
     *
     * @return \TKusy\Hl7Fhir\R4\PatientCommunicationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $generalPractitioner
     */
    public function addToGeneralPractitioner(\TKusy\Hl7Fhir\R4\ReferenceType $generalPractitioner)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PatientLinkType $link
     */
    public function addToLink(\TKusy\Hl7Fhir\R4\PatientLinkType $link)
    {
        $this->link[] = $link;
        return $this;
    }
     ...
     * Link to another patient resource that concerns the same actual patient.
     *
     * @return \TKusy\Hl7Fhir\R4\PatientLinkType[]
     */
