...
class ClinicalImpressionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ClinicalImpressionStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $assessor
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $previous
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $problem
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ClinicalImpressionInvestigationType[] $investigation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType[] $protocol
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $summary
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ClinicalImpressionFindingType[] $finding
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $prognosisCodeableConcept
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $prognosisReference
     */
     ...
     * Identifies the workflow status of the assessment.
     *
     * @return \TKusy\Hl7Fhir\R4\ClinicalImpressionStatusType
     */
     ...
     * Identifies the workflow status of the assessment.
     *
     * @param \TKusy\Hl7Fhir\R4\ClinicalImpressionStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ClinicalImpressionStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The clinician performing the assessment.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $assessor
     * @return self
     */
    public function setAssessor(\TKusy\Hl7Fhir\R4\ReferenceType $assessor)
    {
     ...
     * A reference to the last assessment that was conducted on this patient. Assessments are often/usually ongoing in nature; a care provider (practitioner or team) will make new assessments on an ongoing basis as new data arises or the patient's conditions changes.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $previous
     * @return self
     */
    public function setPrevious(\TKusy\Hl7Fhir\R4\ReferenceType $previous)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $problem
     */
    public function addToProblem(\TKusy\Hl7Fhir\R4\ReferenceType $problem)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ClinicalImpressionInvestigationType $investigation
     */
    public function addToInvestigation(\TKusy\Hl7Fhir\R4\ClinicalImpressionInvestigationType $investigation)
    {
     ...
     * One or more sets of investigations (signs, symptoms, etc.). The actual grouping of investigations varies greatly depending on the type and context of the assessment. These investigations may include data generated during the assessment process, or data previously generated and recorded that is pertinent to the outcomes.
     *
     * @return \TKusy\Hl7Fhir\R4\ClinicalImpressionInvestigationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\UriType $protocol
     */
    public function addToProtocol(\TKusy\Hl7Fhir\R4\UriType $protocol)
    {
     ...
     * A text summary of the investigations and the diagnosis.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $summary
     * @return self
     */
    public function setSummary(\TKusy\Hl7Fhir\R4\StringType $summary)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ClinicalImpressionFindingType $finding
     */
    public function addToFinding(\TKusy\Hl7Fhir\R4\ClinicalImpressionFindingType $finding)
    {
     ...
     * Specific findings or diagnoses that were considered likely or relevant to ongoing treatment.
     *
     * @return \TKusy\Hl7Fhir\R4\ClinicalImpressionFindingType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $prognosisCodeableConcept
     */
    public function addToPrognosisCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $prognosisCodeableConcept)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $prognosisReference
     */
    public function addToPrognosisReference(\TKusy\Hl7Fhir\R4\ReferenceType $prognosisReference)
    {
