...
class SubstanceNucleicAcidType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $sequenceType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IntegerType $numberOfSubunits
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $areaOfHybridisation
     */
     ...
     * (TBC).
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $oligoNucleotideType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceNucleicAcidSubunitType[] $subunit
     */
     ...
     * The type of the sequence shall be specified based on a controlled vocabulary.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $sequenceType
     * @return self
     */
    public function setSequenceType(\TKusy\Hl7Fhir\R4\CodeableConceptType $sequenceType)
    {
     ...
     * The number of linear sequences of nucleotides linked through phosphodiester bonds shall be described. Subunits would be strands of nucleic acids that are tightly associated typically through Watson-Crick base pairing. NOTE: If not specified in the reference source, the assumption is that there is 1 subunit.
     *
     * @param \TKusy\Hl7Fhir\R4\IntegerType $numberOfSubunits
     * @return self
     */
    public function setNumberOfSubunits(\TKusy\Hl7Fhir\R4\IntegerType $numberOfSubunits)
    {
     ...
     * The area of hybridisation shall be described if applicable for double stranded RNA or DNA. The number associated with the subunit followed by the number associated to the residue shall be specified in increasing order. The underscore “” shall be used as separator as follows: “Subunitnumber Residue”.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $areaOfHybridisation
     * @return self
     */
    public function setAreaOfHybridisation(\TKusy\Hl7Fhir\R4\StringType $areaOfHybridisation)
    {
     ...
     * (TBC).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $oligoNucleotideType
     * @return self
     */
    public function setOligoNucleotideType(\TKusy\Hl7Fhir\R4\CodeableConceptType $oligoNucleotideType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceNucleicAcidSubunitType $subunit
     */
    public function addToSubunit(\TKusy\Hl7Fhir\R4\SubstanceNucleicAcidSubunitType $subunit)
    {
     ...
     * Subunits are listed in order of decreasing length; sequences of the same length will be ordered by molecular weight; subunits that have identical sequences will be repeated multiple times.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceNucleicAcidSubunitType[]
     */
