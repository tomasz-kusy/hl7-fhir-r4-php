...
class SpecimenContainerType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $specimenQuantity
     */
     ...
     * The quantity of specimen in the container; may be volume, dimensions, or other appropriate measurements, depending on the specimen type.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $specimenQuantity
     * @return self
     */
    public function setSpecimenQuantity(\TKusy\Hl7Fhir\R4\QuantityType $specimenQuantity)
    {
