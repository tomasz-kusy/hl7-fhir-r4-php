...
class PractitionerRoleType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $practitioner
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $organization
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $healthcareService
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PractitionerRoleAvailableTimeType[] $availableTime
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PractitionerRoleNotAvailableType[] $notAvailable
     */
     ...
     * Practitioner that is able to provide the defined services for the organization.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $practitioner
     * @return self
     */
    public function setPractitioner(\TKusy\Hl7Fhir\R4\ReferenceType $practitioner)
    {
     ...
     * The organization where the Practitioner performs the roles associated.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $organization
     * @return self
     */
    public function setOrganization(\TKusy\Hl7Fhir\R4\ReferenceType $organization)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $healthcareService
     */
    public function addToHealthcareService(\TKusy\Hl7Fhir\R4\ReferenceType $healthcareService)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PractitionerRoleAvailableTimeType $availableTime
     */
    public function addToAvailableTime(\TKusy\Hl7Fhir\R4\PractitionerRoleAvailableTimeType $availableTime)
    {
     ...
     * A collection of times the practitioner is available or performing this role at the location and/or healthcareservice.
     *
     * @return \TKusy\Hl7Fhir\R4\PractitionerRoleAvailableTimeType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PractitionerRoleNotAvailableType $notAvailable
     */
    public function addToNotAvailable(\TKusy\Hl7Fhir\R4\PractitionerRoleNotAvailableType $notAvailable)
    {
     ...
     * The practitioner is not available or performing this role during this period of time due to the provided reason.
     *
     * @return \TKusy\Hl7Fhir\R4\PractitionerRoleNotAvailableType[]
     */
