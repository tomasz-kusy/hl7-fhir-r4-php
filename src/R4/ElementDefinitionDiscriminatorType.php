...
class ElementDefinitionDiscriminatorType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DiscriminatorTypeType $type
     */
    private $type = null;
     ...
     * How the element value is interpreted when discrimination is evaluated.
     *
     * @return \TKusy\Hl7Fhir\R4\DiscriminatorTypeType
     */
     ...
     * How the element value is interpreted when discrimination is evaluated.
     *
     * @param \TKusy\Hl7Fhir\R4\DiscriminatorTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\DiscriminatorTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
