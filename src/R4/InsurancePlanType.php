...
class InsurancePlanType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $ownedBy
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $administeredBy
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InsurancePlanContactType[] $contact
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InsurancePlanCoverageType[] $coverage
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InsurancePlanPlanType[] $plan
     */
    private $plan = null;
     ...
     * The entity that is providing the health insurance product and underwriting the risk. This is typically an insurance carriers, other third-party payers, or health plan sponsors comonly referred to as 'payers'.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $ownedBy
     * @return self
     */
    public function setOwnedBy(\TKusy\Hl7Fhir\R4\ReferenceType $ownedBy)
    {
     ...
     * An organization which administer other services such as underwriting, customer service and/or claims processing on behalf of the health insurance product owner.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $administeredBy
     * @return self
     */
    public function setAdministeredBy(\TKusy\Hl7Fhir\R4\ReferenceType $administeredBy)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\InsurancePlanContactType $contact
     */
    public function addToContact(\TKusy\Hl7Fhir\R4\InsurancePlanContactType $contact)
    {
     ...
     * The contact for the health insurance product for a certain purpose.
     *
     * @return \TKusy\Hl7Fhir\R4\InsurancePlanContactType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\InsurancePlanCoverageType $coverage
     */
    public function addToCoverage(\TKusy\Hl7Fhir\R4\InsurancePlanCoverageType $coverage)
    {
     ...
     * Details about the coverage offered by the insurance product.
     *
     * @return \TKusy\Hl7Fhir\R4\InsurancePlanCoverageType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\InsurancePlanPlanType $plan
     */
    public function addToPlan(\TKusy\Hl7Fhir\R4\InsurancePlanPlanType $plan)
    {
        $this->plan[] = $plan;
        return $this;
    }
     ...
     * Details about an insurance plan.
     *
     * @return \TKusy\Hl7Fhir\R4\InsurancePlanPlanType[]
     */
