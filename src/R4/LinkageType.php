...
class LinkageType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\LinkageItemType[] $item
     */
    private $item = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\LinkageItemType $item
     */
    public function addToItem(\TKusy\Hl7Fhir\R4\LinkageItemType $item)
    {
        $this->item[] = $item;
        return $this;
    }
     ...
     * Identifies which record considered as the reference to the same real-world occurrence as well as how the items should be evaluated within the collection of linked items.
     *
     * @return \TKusy\Hl7Fhir\R4\LinkageItemType[]
     */
