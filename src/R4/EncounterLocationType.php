...
class EncounterLocationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EncounterLocationStatusType $status
     */
    private $status = null;
     ...
     * The status of the participants' presence at the specified location during the period specified. If the participant is no longer at the location, then the period will have an end date/time.
     *
     * @return \TKusy\Hl7Fhir\R4\EncounterLocationStatusType
     */
     ...
     * The status of the participants' presence at the specified location during the period specified. If the participant is no longer at the location, then the period will have an end date/time.
     *
     * @param \TKusy\Hl7Fhir\R4\EncounterLocationStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\EncounterLocationStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
