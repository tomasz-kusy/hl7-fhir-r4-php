...
/**
 * Class representing RiskEvidenceSynthesisCertaintySubcomponentType
 *
 * The RiskEvidenceSynthesis resource describes the likelihood of an outcome in a population plus exposure state where the risk estimate is derived from a combination of research studies.
 * XSD Type: RiskEvidenceSynthesis.CertaintySubcomponent
 */
class RiskEvidenceSynthesisCertaintySubcomponentType extends BackboneElementType
{
