...
class MedicinalProductContraindicationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $disease
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $therapeuticIndication
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductContraindicationOtherTherapyType[] $otherTherapy
     */
     ...
     * The disease, symptom or procedure for the contraindication.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $disease
     * @return self
     */
    public function setDisease(\TKusy\Hl7Fhir\R4\CodeableConceptType $disease)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $therapeuticIndication
     */
    public function addToTherapeuticIndication(\TKusy\Hl7Fhir\R4\ReferenceType $therapeuticIndication)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductContraindicationOtherTherapyType $otherTherapy
     */
    public function addToOtherTherapy(\TKusy\Hl7Fhir\R4\MedicinalProductContraindicationOtherTherapyType $otherTherapy)
    {
     ...
     * Information about the use of the medicinal product in relation to other therapies described as part of the indication.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductContraindicationOtherTherapyType[]
     */
