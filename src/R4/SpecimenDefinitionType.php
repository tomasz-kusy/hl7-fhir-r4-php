...
class SpecimenDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $typeCollected
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $patientPreparation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $timeAspect
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $collection
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SpecimenDefinitionTypeTestedType[] $typeTested
     */
     ...
     * The kind of material to be collected.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $typeCollected
     * @return self
     */
    public function setTypeCollected(\TKusy\Hl7Fhir\R4\CodeableConceptType $typeCollected)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $patientPreparation
     */
    public function addToPatientPreparation(\TKusy\Hl7Fhir\R4\CodeableConceptType $patientPreparation)
    {
     ...
     * Time aspect of specimen collection (duration or offset).
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $timeAspect
     * @return self
     */
    public function setTimeAspect(\TKusy\Hl7Fhir\R4\StringType $timeAspect)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $collection
     */
    public function addToCollection(\TKusy\Hl7Fhir\R4\CodeableConceptType $collection)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SpecimenDefinitionTypeTestedType $typeTested
     */
    public function addToTypeTested(\TKusy\Hl7Fhir\R4\SpecimenDefinitionTypeTestedType $typeTested)
    {
     ...
     * Specimen conditioned in a container as expected by the testing laboratory.
     *
     * @return \TKusy\Hl7Fhir\R4\SpecimenDefinitionTypeTestedType[]
     */
