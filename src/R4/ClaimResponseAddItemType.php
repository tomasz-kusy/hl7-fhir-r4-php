...
class ClaimResponseAddItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ClaimResponseDetail1Type[] $detail
     */
    private $detail = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ClaimResponseDetail1Type $detail
     */
    public function addToDetail(\TKusy\Hl7Fhir\R4\ClaimResponseDetail1Type $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
     ...
     * The second-tier service adjudications for payor added services.
     *
     * @return \TKusy\Hl7Fhir\R4\ClaimResponseDetail1Type[]
     */
