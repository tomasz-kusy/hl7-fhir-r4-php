...
class ExampleScenarioActorType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $actorId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExampleScenarioActorTypeType $type
     */
    private $type = null;
     ...
     * ID or acronym of actor.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $actorId
     * @return self
     */
    public function setActorId(\TKusy\Hl7Fhir\R4\StringType $actorId)
    {
     ...
     * The type of actor - person or system.
     *
     * @return \TKusy\Hl7Fhir\R4\ExampleScenarioActorTypeType
     */
     ...
     * The type of actor - person or system.
     *
     * @param \TKusy\Hl7Fhir\R4\ExampleScenarioActorTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\ExampleScenarioActorTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
