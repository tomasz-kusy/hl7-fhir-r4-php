...
class ParametersParameterType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ParametersParameterType[] $part
     */
    private $part = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ParametersParameterType $part
     */
    public function addToPart(\TKusy\Hl7Fhir\R4\ParametersParameterType $part)
    {
        $this->part[] = $part;
        return $this;
    }
     ...
     * A named part of a multi-part parameter.
     *
     * @return \TKusy\Hl7Fhir\R4\ParametersParameterType[]
     */
