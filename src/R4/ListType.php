...
class ListType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ListStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ListEntryType[] $entry
     */
    private $entry = null;
     ...
     * Indicates the current state of this list.
     *
     * @return \TKusy\Hl7Fhir\R4\ListStatusType
     */
     ...
     * Indicates the current state of this list.
     *
     * @param \TKusy\Hl7Fhir\R4\ListStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ListStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ListEntryType $entry
     */
    public function addToEntry(\TKusy\Hl7Fhir\R4\ListEntryType $entry)
    {
        $this->entry[] = $entry;
        return $this;
    }
     ...
     * Entries in this list.
     *
     * @return \TKusy\Hl7Fhir\R4\ListEntryType[]
     */
