...
class CatalogEntryType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $orderable
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $referencedItem
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType[] $additionalIdentifier
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $validTo
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $lastUpdated
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $additionalCharacteristic
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $additionalClassification
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CatalogEntryRelatedEntryType[] $relatedEntry
     */
     ...
     * Whether the entry represents an orderable item.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $orderable
     * @return self
     */
    public function setOrderable(\TKusy\Hl7Fhir\R4\BooleanType $orderable)
    {
     ...
     * The item in a catalog or definition.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $referencedItem
     * @return self
     */
    public function setReferencedItem(\TKusy\Hl7Fhir\R4\ReferenceType $referencedItem)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $additionalIdentifier
     */
    public function addToAdditionalIdentifier(\TKusy\Hl7Fhir\R4\IdentifierType $additionalIdentifier)
    {
     ...
     */
    public function addToClassification(\TKusy\Hl7Fhir\R4\CodeableConceptType $classification)
    {
     ...
     * The date until which this catalog entry is expected to be active.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $validTo
     * @return self
     */
    public function setValidTo(\TKusy\Hl7Fhir\R4\DateTimeType $validTo)
    {
     ...
     * Typically date of issue is different from the beginning of the validity. This can be used to see when an item was last updated.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $lastUpdated
     * @return self
     */
    public function setLastUpdated(\TKusy\Hl7Fhir\R4\DateTimeType $lastUpdated)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $additionalCharacteristic
     */
    public function addToAdditionalCharacteristic(\TKusy\Hl7Fhir\R4\CodeableConceptType $additionalCharacteristic)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $additionalClassification
     */
    public function addToAdditionalClassification(\TKusy\Hl7Fhir\R4\CodeableConceptType $additionalClassification)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CatalogEntryRelatedEntryType $relatedEntry
     */
    public function addToRelatedEntry(\TKusy\Hl7Fhir\R4\CatalogEntryRelatedEntryType $relatedEntry)
    {
     ...
     * Used for example, to point to a substance, or to a device used to administer a medication.
     *
     * @return \TKusy\Hl7Fhir\R4\CatalogEntryRelatedEntryType[]
     */
