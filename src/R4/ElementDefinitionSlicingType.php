...
class ElementDefinitionSlicingType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ElementDefinitionDiscriminatorType[] $discriminator
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $ordered
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SlicingRulesType $rules
     */
    private $rules = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ElementDefinitionDiscriminatorType $discriminator
     */
    public function addToDiscriminator(\TKusy\Hl7Fhir\R4\ElementDefinitionDiscriminatorType $discriminator)
    {
     ...
     * Designates which child elements are used to discriminate between the slices when processing an instance. If one or more discriminators are provided, the value of the child elements in the instance data SHALL completely distinguish which slice the element in the resource matches based on the allowed values for those elements in each of the slices.
     *
     * @return \TKusy\Hl7Fhir\R4\ElementDefinitionDiscriminatorType[]
     */
     ...
     * If the matching elements have to occur in the same order as defined in the profile.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $ordered
     * @return self
     */
    public function setOrdered(\TKusy\Hl7Fhir\R4\BooleanType $ordered)
    {
     ...
     * Whether additional slices are allowed or not. When the slices are ordered, profile authors can also say that additional slices are only allowed at the end.
     *
     * @return \TKusy\Hl7Fhir\R4\SlicingRulesType
     */
     ...
     * Whether additional slices are allowed or not. When the slices are ordered, profile authors can also say that additional slices are only allowed at the end.
     *
     * @param \TKusy\Hl7Fhir\R4\SlicingRulesType $rules
     * @return self
     */
    public function setRules(\TKusy\Hl7Fhir\R4\SlicingRulesType $rules)
    {
        $this->rules = $rules;
        return $this;
    }
