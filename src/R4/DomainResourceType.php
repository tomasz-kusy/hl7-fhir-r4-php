...
class DomainResourceType extends ResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ResourceContainerType[] $contained
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExtensionType[] $extension
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExtensionType[] $modifierExtension
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ResourceContainerType $contained
     */
    public function addToContained(\TKusy\Hl7Fhir\R4\ResourceContainerType $contained)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExtensionType $extension
     */
    public function addToExtension(\TKusy\Hl7Fhir\R4\ExtensionType $extension)
    {
     ...
     * May be used to represent additional information that is not part of the basic definition of the resource. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
     *
     * @return \TKusy\Hl7Fhir\R4\ExtensionType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExtensionType $modifierExtension
     */
    public function addToModifierExtension(\TKusy\Hl7Fhir\R4\ExtensionType $modifierExtension)
    {
