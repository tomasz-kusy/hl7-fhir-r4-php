...
class ExplanationOfBenefitProcedureType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $procedureCodeableConcept
     */
     ...
     * The code or reference to a Procedure resource which identifies the clinical intervention performed. (choose any one of procedure*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $procedureCodeableConcept
     * @return self
     */
    public function setProcedureCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $procedureCodeableConcept)
    {
