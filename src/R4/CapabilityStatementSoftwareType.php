...
class CapabilityStatementSoftwareType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $releaseDate
     */
     ...
     * Date this version of the software was released.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $releaseDate
     * @return self
     */
    public function setReleaseDate(\TKusy\Hl7Fhir\R4\DateTimeType $releaseDate)
    {
