...
class QuestionnaireResponseItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuestionnaireResponseAnswerType[] $answer
     */
    private $answer = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\QuestionnaireResponseAnswerType $answer
     */
    public function addToAnswer(\TKusy\Hl7Fhir\R4\QuestionnaireResponseAnswerType $answer)
    {
        $this->answer[] = $answer;
        return $this;
    }
     ...
     * The respondent's answer(s) to the question.
     *
     * @return \TKusy\Hl7Fhir\R4\QuestionnaireResponseAnswerType[]
     */
