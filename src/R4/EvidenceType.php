...
class EvidenceType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $exposureBackground
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $exposureVariant
     */
    private $exposureVariant = null;
     ...
     * A reference to a EvidenceVariable resource that defines the population for the research.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $exposureBackground
     * @return self
     */
    public function setExposureBackground(\TKusy\Hl7Fhir\R4\ReferenceType $exposureBackground)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $exposureVariant
     */
    public function addToExposureVariant(\TKusy\Hl7Fhir\R4\ReferenceType $exposureVariant)
    {
     ...
     */
    public function addToOutcome(\TKusy\Hl7Fhir\R4\ReferenceType $outcome)
    {
