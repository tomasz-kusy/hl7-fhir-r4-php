...
class ServiceRequestType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $requisition
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $orderDetail
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $quantityQuantity
     */
     ...
     * An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction). (choose any one of quantity*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\RatioType $quantityRatio
     */
     ...
     * An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction). (choose any one of quantity*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\RangeType $quantityRange
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $asNeededBoolean
     */
     ...
     * If a CodeableConcept is present, it indicates the pre-condition for performing the service. For example "pain", "on flare-up", etc. (choose any one of asNeeded*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $asNeededCodeableConcept
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $locationCode
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $patientInstruction
     */
     ...
     * A shared identifier common to all service requests that were authorized more or less simultaneously by a single author, representing the composite or group identifier.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $requisition
     * @return self
     */
    public function setRequisition(\TKusy\Hl7Fhir\R4\IdentifierType $requisition)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $orderDetail
     */
    public function addToOrderDetail(\TKusy\Hl7Fhir\R4\CodeableConceptType $orderDetail)
    {
     ...
     * An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction). (choose any one of quantity*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $quantityQuantity
     * @return self
     */
    public function setQuantityQuantity(\TKusy\Hl7Fhir\R4\QuantityType $quantityQuantity)
    {
     ...
     * An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction). (choose any one of quantity*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RatioType $quantityRatio
     * @return self
     */
    public function setQuantityRatio(\TKusy\Hl7Fhir\R4\RatioType $quantityRatio)
    {
     ...
     * An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction). (choose any one of quantity*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RangeType $quantityRange
     * @return self
     */
    public function setQuantityRange(\TKusy\Hl7Fhir\R4\RangeType $quantityRange)
    {
     ...
     * If a CodeableConcept is present, it indicates the pre-condition for performing the service. For example "pain", "on flare-up", etc. (choose any one of asNeeded*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $asNeededBoolean
     * @return self
     */
    public function setAsNeededBoolean(\TKusy\Hl7Fhir\R4\BooleanType $asNeededBoolean)
    {
     ...
     * If a CodeableConcept is present, it indicates the pre-condition for performing the service. For example "pain", "on flare-up", etc. (choose any one of asNeeded*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $asNeededCodeableConcept
     * @return self
     */
    public function setAsNeededCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $asNeededCodeableConcept)
    {
     ...
     */
    public function addToPerformer(\TKusy\Hl7Fhir\R4\ReferenceType $performer)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $locationCode
     */
    public function addToLocationCode(\TKusy\Hl7Fhir\R4\CodeableConceptType $locationCode)
    {
     ...
     */
    public function addToLocationReference(\TKusy\Hl7Fhir\R4\ReferenceType $locationReference)
    {
     ...
     */
    public function addToSpecimen(\TKusy\Hl7Fhir\R4\ReferenceType $specimen)
    {
     ...
     * Instructions in terms that are understood by the patient or consumer.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $patientInstruction
     * @return self
     */
    public function setPatientInstruction(\TKusy\Hl7Fhir\R4\StringType $patientInstruction)
    {
