...
class CoverageEligibilityResponseInsuranceType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $inforce
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseItemType[] $item
     */
    private $item = null;
     ...
     * Flag indicating if the coverage provided is inforce currently if no service date(s) specified or for the whole duration of the service dates.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $inforce
     * @return self
     */
    public function setInforce(\TKusy\Hl7Fhir\R4\BooleanType $inforce)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseItemType $item
     */
    public function addToItem(\TKusy\Hl7Fhir\R4\CoverageEligibilityResponseItemType $item)
    {
        $this->item[] = $item;
        return $this;
    }
     ...
     * Benefits and optionally current balances, and authorization details by category or service.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseItemType[]
     */
