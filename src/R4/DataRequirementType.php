...
class DataRequirementType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $mustSupport
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DataRequirementCodeFilterType[] $codeFilter
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DataRequirementDateFilterType[] $dateFilter
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $limit
     */
    private $limit = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DataRequirementSortType[] $sort
     */
    private $sort = null;
     ...
     */
    public function addToProfile(\TKusy\Hl7Fhir\R4\CanonicalType $profile)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $mustSupport
     */
    public function addToMustSupport(\TKusy\Hl7Fhir\R4\StringType $mustSupport)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DataRequirementCodeFilterType $codeFilter
     */
    public function addToCodeFilter(\TKusy\Hl7Fhir\R4\DataRequirementCodeFilterType $codeFilter)
    {
     ...
     * Code filters specify additional constraints on the data, specifying the value set of interest for a particular element of the data. Each code filter defines an additional constraint on the data, i.e. code filters are AND'ed, not OR'ed.
     *
     * @return \TKusy\Hl7Fhir\R4\DataRequirementCodeFilterType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DataRequirementDateFilterType $dateFilter
     */
    public function addToDateFilter(\TKusy\Hl7Fhir\R4\DataRequirementDateFilterType $dateFilter)
    {
     ...
     * Date filters specify additional constraints on the data in terms of the applicable date range for specific elements. Each date filter specifies an additional constraint on the data, i.e. date filters are AND'ed, not OR'ed.
     *
     * @return \TKusy\Hl7Fhir\R4\DataRequirementDateFilterType[]
     */
     ...
     * Specifies a maximum number of results that are required (uses the _count search parameter).
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $limit
     * @return self
     */
    public function setLimit(\TKusy\Hl7Fhir\R4\PositiveIntType $limit)
    {
        $this->limit = $limit;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DataRequirementSortType $sort
     */
    public function addToSort(\TKusy\Hl7Fhir\R4\DataRequirementSortType $sort)
    {
        $this->sort[] = $sort;
        return $this;
    }
     ...
     * Specifies the order of the results to be returned.
     *
     * @return \TKusy\Hl7Fhir\R4\DataRequirementSortType[]
     */
