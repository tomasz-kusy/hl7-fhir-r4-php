...
class OperationDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\OperationKindType $kind
     */
    private $kind = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $affectsState
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $base
     */
    private $base = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $system
     */
    private $system = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $instance
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $inputProfile
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $outputProfile
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\OperationDefinitionParameterType[] $parameter
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\OperationDefinitionOverloadType[] $overload
     */
     ...
     * Whether this is an operation or a named query.
     *
     * @return \TKusy\Hl7Fhir\R4\OperationKindType
     */
     ...
     * Whether this is an operation or a named query.
     *
     * @param \TKusy\Hl7Fhir\R4\OperationKindType $kind
     * @return self
     */
    public function setKind(\TKusy\Hl7Fhir\R4\OperationKindType $kind)
    {
        $this->kind = $kind;
        return $this;
    }
     ...
     * Whether the operation affects state. Side effects such as producing audit trail entries do not count as 'affecting state'.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $affectsState
     * @return self
     */
    public function setAffectsState(\TKusy\Hl7Fhir\R4\BooleanType $affectsState)
    {
     ...
     * Indicates that this operation definition is a constraining profile on the base.
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $base
     * @return self
     */
    public function setBase(\TKusy\Hl7Fhir\R4\CanonicalType $base)
    {
        $this->base = $base;
        return $this;
    }
     ...
     */
    public function addToResource(\TKusy\Hl7Fhir\R4\CodeType $resource)
    {
     ...
     * Indicates whether this operation or named query can be invoked at the system level (e.g. without needing to choose a resource type for the context).
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $system
     * @return self
     */
    public function setSystem(\TKusy\Hl7Fhir\R4\BooleanType $system)
    {
        $this->system = $system;
        return $this;
    }
     ...
     * Indicates whether this operation or named query can be invoked at the resource type level for any given resource type level (e.g. without needing to choose a specific resource id for the context).
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\BooleanType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     * Indicates whether this operation can be invoked on a particular instance of one of the given types.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $instance
     * @return self
     */
    public function setInstance(\TKusy\Hl7Fhir\R4\BooleanType $instance)
    {
     ...
     * Additional validation information for the in parameters - a single profile that covers all the parameters. The profile is a constraint on the parameters resource as a whole.
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $inputProfile
     * @return self
     */
    public function setInputProfile(\TKusy\Hl7Fhir\R4\CanonicalType $inputProfile)
    {
     ...
     * Additional validation information for the out parameters - a single profile that covers all the parameters. The profile is a constraint on the parameters resource.
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $outputProfile
     * @return self
     */
    public function setOutputProfile(\TKusy\Hl7Fhir\R4\CanonicalType $outputProfile)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\OperationDefinitionParameterType $parameter
     */
    public function addToParameter(\TKusy\Hl7Fhir\R4\OperationDefinitionParameterType $parameter)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\OperationDefinitionOverloadType $overload
     */
    public function addToOverload(\TKusy\Hl7Fhir\R4\OperationDefinitionOverloadType $overload)
    {
     ...
     * Defines an appropriate combination of parameters to use when invoking this operation, to help code generators when generating overloaded parameter sets for this operation.
     *
     * @return \TKusy\Hl7Fhir\R4\OperationDefinitionOverloadType[]
     */
