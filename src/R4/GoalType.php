...
class GoalType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\GoalLifecycleStatusType $lifecycleStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $achievementStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $description
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateType $startDate
     */
     ...
     * The date or event after which the goal should begin being pursued. (choose any one of start*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $startCodeableConcept
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\GoalTargetType[] $target
     */
    private $target = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateType $statusDate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $statusReason
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $expressedBy
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $outcomeCode
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $outcomeReference
     */
     ...
     * The state of the goal throughout its lifecycle.
     *
     * @return \TKusy\Hl7Fhir\R4\GoalLifecycleStatusType
     */
     ...
     * The state of the goal throughout its lifecycle.
     *
     * @param \TKusy\Hl7Fhir\R4\GoalLifecycleStatusType $lifecycleStatus
     * @return self
     */
    public function setLifecycleStatus(\TKusy\Hl7Fhir\R4\GoalLifecycleStatusType $lifecycleStatus)
    {
     ...
     * Describes the progression, or lack thereof, towards the goal against the target.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $achievementStatus
     * @return self
     */
    public function setAchievementStatus(\TKusy\Hl7Fhir\R4\CodeableConceptType $achievementStatus)
    {
     ...
     * Human-readable and/or coded description of a specific desired objective of care, such as "control blood pressure" or "negotiate an obstacle course" or "dance with child at wedding".
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $description
     * @return self
     */
    public function setDescription(\TKusy\Hl7Fhir\R4\CodeableConceptType $description)
    {
     ...
     * The date or event after which the goal should begin being pursued. (choose any one of start*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DateType $startDate
     * @return self
     */
    public function setStartDate(\TKusy\Hl7Fhir\R4\DateType $startDate)
    {
     ...
     * The date or event after which the goal should begin being pursued. (choose any one of start*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $startCodeableConcept
     * @return self
     */
    public function setStartCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $startCodeableConcept)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\GoalTargetType $target
     */
    public function addToTarget(\TKusy\Hl7Fhir\R4\GoalTargetType $target)
    {
        $this->target[] = $target;
        return $this;
    }
     ...
     * Indicates what should be done by when.
     *
     * @return \TKusy\Hl7Fhir\R4\GoalTargetType[]
     */
     ...
     * Identifies when the current status. I.e. When initially created, when achieved, when cancelled, etc.
     *
     * @param \TKusy\Hl7Fhir\R4\DateType $statusDate
     * @return self
     */
    public function setStatusDate(\TKusy\Hl7Fhir\R4\DateType $statusDate)
    {
     ...
     * Captures the reason for the current status.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $statusReason
     * @return self
     */
    public function setStatusReason(\TKusy\Hl7Fhir\R4\StringType $statusReason)
    {
     ...
     * Indicates whose goal this is - patient goal, practitioner goal, etc.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $expressedBy
     * @return self
     */
    public function setExpressedBy(\TKusy\Hl7Fhir\R4\ReferenceType $expressedBy)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $outcomeCode
     */
    public function addToOutcomeCode(\TKusy\Hl7Fhir\R4\CodeableConceptType $outcomeCode)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $outcomeReference
     */
    public function addToOutcomeReference(\TKusy\Hl7Fhir\R4\ReferenceType $outcomeReference)
    {
