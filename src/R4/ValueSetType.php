...
class ValueSetType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $immutable
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ValueSetComposeType $compose
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ValueSetExpansionType $expansion
     */
     ...
     * If this is set to 'true', then no new versions of the content logical definition can be created. Note: Other metadata might still change.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $immutable
     * @return self
     */
    public function setImmutable(\TKusy\Hl7Fhir\R4\BooleanType $immutable)
    {
     ...
     * A set of criteria that define the contents of the value set by including or excluding codes selected from the specified code system(s) that the value set draws from. This is also known as the Content Logical Definition (CLD).
     *
     * @return \TKusy\Hl7Fhir\R4\ValueSetComposeType
     */
     ...
     * A set of criteria that define the contents of the value set by including or excluding codes selected from the specified code system(s) that the value set draws from. This is also known as the Content Logical Definition (CLD).
     *
     * @param \TKusy\Hl7Fhir\R4\ValueSetComposeType $compose
     * @return self
     */
    public function setCompose(\TKusy\Hl7Fhir\R4\ValueSetComposeType $compose)
    {
     ...
     * A value set can also be "expanded", where the value set is turned into a simple collection of enumerated codes. This element holds the expansion, if it has been performed.
     *
     * @return \TKusy\Hl7Fhir\R4\ValueSetExpansionType
     */
     ...
     * A value set can also be "expanded", where the value set is turned into a simple collection of enumerated codes. This element holds the expansion, if it has been performed.
     *
     * @param \TKusy\Hl7Fhir\R4\ValueSetExpansionType $expansion
     * @return self
     */
    public function setExpansion(\TKusy\Hl7Fhir\R4\ValueSetExpansionType $expansion)
    {
