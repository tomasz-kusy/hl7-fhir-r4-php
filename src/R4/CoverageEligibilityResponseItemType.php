...
class CoverageEligibilityResponseItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $excluded
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $network
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $unit
     */
    private $unit = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $term
     */
    private $term = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseBenefitType[] $benefit
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $authorizationRequired
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $authorizationSupporting
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType $authorizationUrl
     */
     ...
     * True if the indicated class of service is excluded from the plan, missing or False indicates the product or service is included in the coverage.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $excluded
     * @return self
     */
    public function setExcluded(\TKusy\Hl7Fhir\R4\BooleanType $excluded)
    {
     ...
     * Is a flag to indicate whether the benefits refer to in-network providers or out-of-network providers.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $network
     * @return self
     */
    public function setNetwork(\TKusy\Hl7Fhir\R4\CodeableConceptType $network)
    {
     ...
     * Indicates if the benefits apply to an individual or to the family.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $unit
     * @return self
     */
    public function setUnit(\TKusy\Hl7Fhir\R4\CodeableConceptType $unit)
    {
        $this->unit = $unit;
        return $this;
    }
     ...
     * The term or period of the values such as 'maximum lifetime benefit' or 'maximum annual visits'.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $term
     * @return self
     */
    public function setTerm(\TKusy\Hl7Fhir\R4\CodeableConceptType $term)
    {
        $this->term = $term;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseBenefitType $benefit
     */
    public function addToBenefit(\TKusy\Hl7Fhir\R4\CoverageEligibilityResponseBenefitType $benefit)
    {
     ...
     * Benefits used to date.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseBenefitType[]
     */
     ...
     * A boolean flag indicating whether a preauthorization is required prior to actual service delivery.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $authorizationRequired
     * @return self
     */
    public function setAuthorizationRequired(\TKusy\Hl7Fhir\R4\BooleanType $authorizationRequired)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $authorizationSupporting
     */
    public function addToAuthorizationSupporting(\TKusy\Hl7Fhir\R4\CodeableConceptType $authorizationSupporting)
    {
     ...
     * A web location for obtaining requirements or descriptive information regarding the preauthorization.
     *
     * @param \TKusy\Hl7Fhir\R4\UriType $authorizationUrl
     * @return self
     */
    public function setAuthorizationUrl(\TKusy\Hl7Fhir\R4\UriType $authorizationUrl)
    {
