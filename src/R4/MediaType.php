...
class MediaType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $modality
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $view
     */
    private $view = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $createdDateTime
     */
     ...
     * The date and time(s) at which the media was collected. (choose any one of created*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType $createdPeriod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $operator
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $deviceName
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $height
     */
    private $height = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $width
     */
    private $width = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $frames
     */
    private $frames = null;
     ...
     * Details of the type of the media - usually, how it was acquired (what type of device). If images sourced from a DICOM system, are wrapped in a Media resource, then this is the modality.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $modality
     * @return self
     */
    public function setModality(\TKusy\Hl7Fhir\R4\CodeableConceptType $modality)
    {
     ...
     * The name of the imaging view e.g. Lateral or Antero-posterior (AP).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $view
     * @return self
     */
    public function setView(\TKusy\Hl7Fhir\R4\CodeableConceptType $view)
    {
        $this->view = $view;
        return $this;
    }
     ...
     * The date and time(s) at which the media was collected. (choose any one of created*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $createdDateTime
     * @return self
     */
    public function setCreatedDateTime(\TKusy\Hl7Fhir\R4\DateTimeType $createdDateTime)
    {
     ...
     * The date and time(s) at which the media was collected. (choose any one of created*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\PeriodType $createdPeriod
     * @return self
     */
    public function setCreatedPeriod(\TKusy\Hl7Fhir\R4\PeriodType $createdPeriod)
    {
     ...
     * The person who administered the collection of the image.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $operator
     * @return self
     */
    public function setOperator(\TKusy\Hl7Fhir\R4\ReferenceType $operator)
    {
     ...
     * The name of the device / manufacturer of the device that was used to make the recording.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $deviceName
     * @return self
     */
    public function setDeviceName(\TKusy\Hl7Fhir\R4\StringType $deviceName)
    {
     ...
     * Height of the image in pixels (photo/video).
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $height
     * @return self
     */
    public function setHeight(\TKusy\Hl7Fhir\R4\PositiveIntType $height)
    {
        $this->height = $height;
        return $this;
    }
     ...
     * Width of the image in pixels (photo/video).
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $width
     * @return self
     */
    public function setWidth(\TKusy\Hl7Fhir\R4\PositiveIntType $width)
    {
        $this->width = $width;
        return $this;
    }
     ...
     * The number of frames in a photo. This is used with a multi-page fax, or an imaging acquisition context that takes multiple slices in a single image, or an animated gif. If there is more than one frame, this SHALL have a value in order to alert interface software that a multi-frame capable rendering widget is required.
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $frames
     * @return self
     */
    public function setFrames(\TKusy\Hl7Fhir\R4\PositiveIntType $frames)
    {
        $this->frames = $frames;
        return $this;
    }
     ...
     * @return self
     */
    public function setContent(\TKusy\Hl7Fhir\R4\AttachmentType $content)
    {
