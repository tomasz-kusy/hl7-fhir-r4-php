...
class MedicinalProductPharmaceuticalRouteOfAdministrationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $firstDose
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $maxSingleDose
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $maxDosePerDay
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RatioType $maxDosePerTreatmentPeriod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $maxTreatmentPeriod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalTargetSpeciesType[] $targetSpecies
     */
     ...
     * The first dose (dose quantity) administered in humans can be specified, for a product under investigation, using a numerical value and its unit of measurement.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $firstDose
     * @return self
     */
    public function setFirstDose(\TKusy\Hl7Fhir\R4\QuantityType $firstDose)
    {
     ...
     * The maximum single dose that can be administered as per the protocol of a clinical trial can be specified using a numerical value and its unit of measurement.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $maxSingleDose
     * @return self
     */
    public function setMaxSingleDose(\TKusy\Hl7Fhir\R4\QuantityType $maxSingleDose)
    {
     ...
     * The maximum dose per day (maximum dose quantity to be administered in any one 24-h period) that can be administered as per the protocol referenced in the clinical trial authorisation.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $maxDosePerDay
     * @return self
     */
    public function setMaxDosePerDay(\TKusy\Hl7Fhir\R4\QuantityType $maxDosePerDay)
    {
     ...
     * The maximum dose per treatment period that can be administered as per the protocol referenced in the clinical trial authorisation.
     *
     * @param \TKusy\Hl7Fhir\R4\RatioType $maxDosePerTreatmentPeriod
     * @return self
     */
    public function setMaxDosePerTreatmentPeriod(\TKusy\Hl7Fhir\R4\RatioType $maxDosePerTreatmentPeriod)
    {
     ...
     * The maximum treatment period during which an Investigational Medicinal Product can be administered as per the protocol referenced in the clinical trial authorisation.
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $maxTreatmentPeriod
     * @return self
     */
    public function setMaxTreatmentPeriod(\TKusy\Hl7Fhir\R4\DurationType $maxTreatmentPeriod)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalTargetSpeciesType $targetSpecies
     */
    public function addToTargetSpecies(\TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalTargetSpeciesType $targetSpecies)
    {
     ...
     * A species for which this route applies.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalTargetSpeciesType[]
     */
