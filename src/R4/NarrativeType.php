...
class NarrativeType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\NarrativeStatusType $status
     */
    private $status = null;
     ...
     * The status of the narrative - whether it's entirely generated (from just the defined data or the extensions too), or whether a human authored it and it may contain additional data.
     *
     * @return \TKusy\Hl7Fhir\R4\NarrativeStatusType
     */
     ...
     * The status of the narrative - whether it's entirely generated (from just the defined data or the extensions too), or whether a human authored it and it may contain additional data.
     *
     * @param \TKusy\Hl7Fhir\R4\NarrativeStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\NarrativeStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
