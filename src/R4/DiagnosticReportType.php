...
class DiagnosticReportType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DiagnosticReportStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $resultsInterpreter
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $result
     */
    private $result = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $imagingStudy
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DiagnosticReportMediaType[] $media
     */
    private $media = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $conclusion
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $conclusionCode
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AttachmentType[] $presentedForm
     */
     ...
     * The status of the diagnostic report.
     *
     * @return \TKusy\Hl7Fhir\R4\DiagnosticReportStatusType
     */
     ...
     * The status of the diagnostic report.
     *
     * @param \TKusy\Hl7Fhir\R4\DiagnosticReportStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\DiagnosticReportStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $resultsInterpreter
     */
    public function addToResultsInterpreter(\TKusy\Hl7Fhir\R4\ReferenceType $resultsInterpreter)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $result
     */
    public function addToResult(\TKusy\Hl7Fhir\R4\ReferenceType $result)
    {
        $this->result[] = $result;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $imagingStudy
     */
    public function addToImagingStudy(\TKusy\Hl7Fhir\R4\ReferenceType $imagingStudy)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DiagnosticReportMediaType $media
     */
    public function addToMedia(\TKusy\Hl7Fhir\R4\DiagnosticReportMediaType $media)
    {
        $this->media[] = $media;
        return $this;
    }
     ...
     * A list of key images associated with this report. The images are generally created during the diagnostic process, and may be directly of the patient, or of treated specimens (i.e. slides of interest).
     *
     * @return \TKusy\Hl7Fhir\R4\DiagnosticReportMediaType[]
     */
     ...
     * Concise and clinically contextualized summary conclusion (interpretation/impression) of the diagnostic report.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $conclusion
     * @return self
     */
    public function setConclusion(\TKusy\Hl7Fhir\R4\StringType $conclusion)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $conclusionCode
     */
    public function addToConclusionCode(\TKusy\Hl7Fhir\R4\CodeableConceptType $conclusionCode)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\AttachmentType $presentedForm
     */
    public function addToPresentedForm(\TKusy\Hl7Fhir\R4\AttachmentType $presentedForm)
    {
