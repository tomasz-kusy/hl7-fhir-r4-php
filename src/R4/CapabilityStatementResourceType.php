...
class CapabilityStatementResourceType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType[] $supportedProfile
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CapabilityStatementInteractionType[] $interaction
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ResourceVersionPolicyType $versioning
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $readHistory
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $updateCreate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $conditionalCreate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConditionalReadStatusType $conditionalRead
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $conditionalUpdate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConditionalDeleteStatusType $conditionalDelete
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceHandlingPolicyType[] $referencePolicy
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $searchInclude
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $searchRevInclude
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CapabilityStatementSearchParamType[] $searchParam
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CapabilityStatementOperationType[] $operation
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $supportedProfile
     */
    public function addToSupportedProfile(\TKusy\Hl7Fhir\R4\CanonicalType $supportedProfile)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CapabilityStatementInteractionType $interaction
     */
    public function addToInteraction(\TKusy\Hl7Fhir\R4\CapabilityStatementInteractionType $interaction)
    {
     ...
     * Identifies a restful operation supported by the solution.
     *
     * @return \TKusy\Hl7Fhir\R4\CapabilityStatementInteractionType[]
     */
     ...
     * This field is set to no-version to specify that the system does not support (server) or use (client) versioning for this resource type. If this has some other value, the server must at least correctly track and populate the versionId meta-property on resources. If the value is 'versioned-update', then the server supports all the versioning features, including using e-tags for version integrity in the API.
     *
     * @return \TKusy\Hl7Fhir\R4\ResourceVersionPolicyType
     */
     ...
     * This field is set to no-version to specify that the system does not support (server) or use (client) versioning for this resource type. If this has some other value, the server must at least correctly track and populate the versionId meta-property on resources. If the value is 'versioned-update', then the server supports all the versioning features, including using e-tags for version integrity in the API.
     *
     * @param \TKusy\Hl7Fhir\R4\ResourceVersionPolicyType $versioning
     * @return self
     */
    public function setVersioning(\TKusy\Hl7Fhir\R4\ResourceVersionPolicyType $versioning)
    {
     ...
     * A flag for whether the server is able to return past versions as part of the vRead operation.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $readHistory
     * @return self
     */
    public function setReadHistory(\TKusy\Hl7Fhir\R4\BooleanType $readHistory)
    {
     ...
     * A flag to indicate that the server allows or needs to allow the client to create new identities on the server (that is, the client PUTs to a location where there is no existing resource). Allowing this operation means that the server allows the client to create new identities on the server.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $updateCreate
     * @return self
     */
    public function setUpdateCreate(\TKusy\Hl7Fhir\R4\BooleanType $updateCreate)
    {
     ...
     * A flag that indicates that the server supports conditional create.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $conditionalCreate
     * @return self
     */
    public function setConditionalCreate(\TKusy\Hl7Fhir\R4\BooleanType $conditionalCreate)
    {
     ...
     * A code that indicates how the server supports conditional read.
     *
     * @return \TKusy\Hl7Fhir\R4\ConditionalReadStatusType
     */
     ...
     * A code that indicates how the server supports conditional read.
     *
     * @param \TKusy\Hl7Fhir\R4\ConditionalReadStatusType $conditionalRead
     * @return self
     */
    public function setConditionalRead(\TKusy\Hl7Fhir\R4\ConditionalReadStatusType $conditionalRead)
    {
     ...
     * A flag that indicates that the server supports conditional update.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $conditionalUpdate
     * @return self
     */
    public function setConditionalUpdate(\TKusy\Hl7Fhir\R4\BooleanType $conditionalUpdate)
    {
     ...
     * A code that indicates how the server supports conditional delete.
     *
     * @return \TKusy\Hl7Fhir\R4\ConditionalDeleteStatusType
     */
     ...
     * A code that indicates how the server supports conditional delete.
     *
     * @param \TKusy\Hl7Fhir\R4\ConditionalDeleteStatusType $conditionalDelete
     * @return self
     */
    public function setConditionalDelete(\TKusy\Hl7Fhir\R4\ConditionalDeleteStatusType $conditionalDelete)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceHandlingPolicyType $referencePolicy
     */
    public function addToReferencePolicy(\TKusy\Hl7Fhir\R4\ReferenceHandlingPolicyType $referencePolicy)
    {
     ...
     * A set of flags that defines how references are supported.
     *
     * @return \TKusy\Hl7Fhir\R4\ReferenceHandlingPolicyType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $searchInclude
     */
    public function addToSearchInclude(\TKusy\Hl7Fhir\R4\StringType $searchInclude)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $searchRevInclude
     */
    public function addToSearchRevInclude(\TKusy\Hl7Fhir\R4\StringType $searchRevInclude)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CapabilityStatementSearchParamType $searchParam
     */
    public function addToSearchParam(\TKusy\Hl7Fhir\R4\CapabilityStatementSearchParamType $searchParam)
    {
     ...
     * Search parameters for implementations to support and/or make use of - either references to ones defined in the specification, or additional ones defined for/by the implementation.
     *
     * @return \TKusy\Hl7Fhir\R4\CapabilityStatementSearchParamType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CapabilityStatementOperationType $operation
     */
    public function addToOperation(\TKusy\Hl7Fhir\R4\CapabilityStatementOperationType $operation)
    {
     ...
     * Definition of an operation or a named query together with its parameters and their meaning and type. Consult the definition of the operation for details about how to invoke the operation, and the parameters.
     *
     * @return \TKusy\Hl7Fhir\R4\CapabilityStatementOperationType[]
     */
