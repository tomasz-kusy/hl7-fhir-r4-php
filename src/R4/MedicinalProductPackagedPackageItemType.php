...
class MedicinalProductPackagedPackageItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $alternateMaterial
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $manufacturedItem
     */
     ...
     */
    public function addToMaterial(\TKusy\Hl7Fhir\R4\CodeableConceptType $material)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $alternateMaterial
     */
    public function addToAlternateMaterial(\TKusy\Hl7Fhir\R4\CodeableConceptType $alternateMaterial)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $manufacturedItem
     */
    public function addToManufacturedItem(\TKusy\Hl7Fhir\R4\ReferenceType $manufacturedItem)
    {
