...
class RiskAssessmentType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $basis
     */
    private $basis = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RiskAssessmentPredictionType[] $prediction
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $mitigation
     */
     ...
     * @return self
     */
    public function setBasedOn(\TKusy\Hl7Fhir\R4\ReferenceType $basedOn)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $basis
     */
    public function addToBasis(\TKusy\Hl7Fhir\R4\ReferenceType $basis)
    {
        $this->basis[] = $basis;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\RiskAssessmentPredictionType $prediction
     */
    public function addToPrediction(\TKusy\Hl7Fhir\R4\RiskAssessmentPredictionType $prediction)
    {
     ...
     * Describes the expected outcome for the subject.
     *
     * @return \TKusy\Hl7Fhir\R4\RiskAssessmentPredictionType[]
     */
     ...
     * A description of the steps that might be taken to reduce the identified risk(s).
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $mitigation
     * @return self
     */
    public function setMitigation(\TKusy\Hl7Fhir\R4\StringType $mitigation)
    {
