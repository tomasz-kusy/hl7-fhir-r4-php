...
class MeasureStratifierType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureComponentType[] $component
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasureComponentType $component
     */
    public function addToComponent(\TKusy\Hl7Fhir\R4\MeasureComponentType $component)
    {
     ...
     * A component of the stratifier criteria for the measure report, specified as either the name of a valid CQL expression defined within a referenced library or a valid FHIR Resource Path.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureComponentType[]
     */
