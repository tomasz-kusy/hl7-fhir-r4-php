...
class DeviceUdiCarrierType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\Base64BinaryType $carrierAIDC
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $carrierHRF
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UDIEntryTypeType $entryType
     */
     ...
     * The full UDI carrier of the Automatic Identification and Data Capture (AIDC) technology representation of the barcode string as printed on the packaging of the device - e.g., a barcode or RFID. Because of limitations on character sets in XML and the need to round-trip JSON data through XML, AIDC Formats *SHALL* be base64 encoded.
     *
     * @param \TKusy\Hl7Fhir\R4\Base64BinaryType $carrierAIDC
     * @return self
     */
    public function setCarrierAIDC(\TKusy\Hl7Fhir\R4\Base64BinaryType $carrierAIDC)
    {
     ...
     * The full UDI carrier as the human readable form (HRF) representation of the barcode string as printed on the packaging of the device.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $carrierHRF
     * @return self
     */
    public function setCarrierHRF(\TKusy\Hl7Fhir\R4\StringType $carrierHRF)
    {
     ...
     * A coded entry to indicate how the data was entered.
     *
     * @return \TKusy\Hl7Fhir\R4\UDIEntryTypeType
     */
     ...
     * A coded entry to indicate how the data was entered.
     *
     * @param \TKusy\Hl7Fhir\R4\UDIEntryTypeType $entryType
     * @return self
     */
    public function setEntryType(\TKusy\Hl7Fhir\R4\UDIEntryTypeType $entryType)
    {
