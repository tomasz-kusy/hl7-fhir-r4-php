...
class TriggerDefinitionType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TriggerTypeType $type
     */
    private $type = null;
     ...
     * The timing of the event (if this is a periodic trigger). (choose any one of timing*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $timingReference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DataRequirementType[] $data
     */
    private $data = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExpressionType $condition
     */
     ...
     * The type of triggering event.
     *
     * @return \TKusy\Hl7Fhir\R4\TriggerTypeType
     */
     ...
     * The type of triggering event.
     *
     * @param \TKusy\Hl7Fhir\R4\TriggerTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\TriggerTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     * The timing of the event (if this is a periodic trigger). (choose any one of timing*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $timingReference
     * @return self
     */
    public function setTimingReference(\TKusy\Hl7Fhir\R4\ReferenceType $timingReference)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DataRequirementType $data
     */
    public function addToData(\TKusy\Hl7Fhir\R4\DataRequirementType $data)
    {
        $this->data[] = $data;
        return $this;
    }
     ...
     * A boolean-valued expression that is evaluated in the context of the container of the trigger definition and returns whether or not the trigger fires.
     *
     * @param \TKusy\Hl7Fhir\R4\ExpressionType $condition
     * @return self
     */
    public function setCondition(\TKusy\Hl7Fhir\R4\ExpressionType $condition)
    {
