...
class SubstanceSpecificationPropertyType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $parameters
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $definingSubstanceReference
     */
     ...
     * A substance upon which a defining property depends (e.g. for solubility: in water, in alcohol). (choose any one of definingSubstance*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $definingSubstanceCodeableConcept
     */
     ...
     * Parameters that were used in the measurement of a property (e.g. for viscosity: measured at 20C with a pH of 7.1).
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $parameters
     * @return self
     */
    public function setParameters(\TKusy\Hl7Fhir\R4\StringType $parameters)
    {
     ...
     * A substance upon which a defining property depends (e.g. for solubility: in water, in alcohol). (choose any one of definingSubstance*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $definingSubstanceReference
     * @return self
     */
    public function setDefiningSubstanceReference(\TKusy\Hl7Fhir\R4\ReferenceType $definingSubstanceReference)
    {
     ...
     * A substance upon which a defining property depends (e.g. for solubility: in water, in alcohol). (choose any one of definingSubstance*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $definingSubstanceCodeableConcept
     * @return self
     */
    public function setDefiningSubstanceCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $definingSubstanceCodeableConcept)
    {
