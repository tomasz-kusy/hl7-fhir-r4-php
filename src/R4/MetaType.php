...
class MetaType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdType $versionId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InstantType $lastUpdated
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType[] $security
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType[] $tag
     */
    private $tag = null;
     ...
     * The version specific identifier, as it appears in the version portion of the URL. This value changes when the resource is created, updated, or deleted.
     *
     * @param \TKusy\Hl7Fhir\R4\IdType $versionId
     * @return self
     */
    public function setVersionId(\TKusy\Hl7Fhir\R4\IdType $versionId)
    {
     ...
     * When the resource last changed - e.g. when the version changed.
     *
     * @param \TKusy\Hl7Fhir\R4\InstantType $lastUpdated
     * @return self
     */
    public function setLastUpdated(\TKusy\Hl7Fhir\R4\InstantType $lastUpdated)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodingType $security
     */
    public function addToSecurity(\TKusy\Hl7Fhir\R4\CodingType $security)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodingType $tag
     */
    public function addToTag(\TKusy\Hl7Fhir\R4\CodingType $tag)
    {
        $this->tag[] = $tag;
        return $this;
    }
