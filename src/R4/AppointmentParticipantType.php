...
class AppointmentParticipantType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ParticipantRequiredType $required
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ParticipationStatusType $status
     */
    private $status = null;
     ...
     * Whether this participant is required to be present at the meeting. This covers a use-case where two doctors need to meet to discuss the results for a specific patient, and the patient is not required to be present.
     *
     * @return \TKusy\Hl7Fhir\R4\ParticipantRequiredType
     */
     ...
     * Whether this participant is required to be present at the meeting. This covers a use-case where two doctors need to meet to discuss the results for a specific patient, and the patient is not required to be present.
     *
     * @param \TKusy\Hl7Fhir\R4\ParticipantRequiredType $required
     * @return self
     */
    public function setRequired(\TKusy\Hl7Fhir\R4\ParticipantRequiredType $required)
    {
     ...
     * Participation status of the actor.
     *
     * @param \TKusy\Hl7Fhir\R4\ParticipationStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ParticipationStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
