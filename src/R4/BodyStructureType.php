...
class BodyStructureType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $morphology
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $locationQualifier
     */
     ...
     * The kind of structure being represented by the body structure at `BodyStructure.location`. This can define both normal and abnormal morphologies.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $morphology
     * @return self
     */
    public function setMorphology(\TKusy\Hl7Fhir\R4\CodeableConceptType $morphology)
    {
     ...
     * @return self
     */
    public function setLocation(\TKusy\Hl7Fhir\R4\CodeableConceptType $location)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $locationQualifier
     */
    public function addToLocationQualifier(\TKusy\Hl7Fhir\R4\CodeableConceptType $locationQualifier)
    {
