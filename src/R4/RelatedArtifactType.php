...
class RelatedArtifactType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RelatedArtifactTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarkdownType $citation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AttachmentType $document
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $resource
     */
     ...
     * The type of relationship to the related artifact.
     *
     * @return \TKusy\Hl7Fhir\R4\RelatedArtifactTypeType
     */
     ...
     * The type of relationship to the related artifact.
     *
     * @param \TKusy\Hl7Fhir\R4\RelatedArtifactTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\RelatedArtifactTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     * A bibliographic citation for the related artifact. This text SHOULD be formatted according to an accepted citation format.
     *
     * @param \TKusy\Hl7Fhir\R4\MarkdownType $citation
     * @return self
     */
    public function setCitation(\TKusy\Hl7Fhir\R4\MarkdownType $citation)
    {
     ...
     * The document being referenced, represented as an attachment. This is exclusive with the resource element.
     *
     * @param \TKusy\Hl7Fhir\R4\AttachmentType $document
     * @return self
     */
    public function setDocument(\TKusy\Hl7Fhir\R4\AttachmentType $document)
    {
     ...
     * The related resource, such as a library, value set, profile, or other knowledge resource.
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $resource
     * @return self
     */
    public function setResource(\TKusy\Hl7Fhir\R4\CanonicalType $resource)
    {
