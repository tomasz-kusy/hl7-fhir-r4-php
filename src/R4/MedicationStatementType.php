...
class MedicationStatementType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $dateAsserted
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $informationSource
     */
     ...
     * The date when the medication statement was asserted by the information source.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $dateAsserted
     * @return self
     */
    public function setDateAsserted(\TKusy\Hl7Fhir\R4\DateTimeType $dateAsserted)
    {
     ...
     * The person or organization that provided the information about the taking of this medication. Note: Use derivedFrom when a MedicationStatement is derived from other resources, e.g. Claim or MedicationRequest.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $informationSource
     * @return self
     */
    public function setInformationSource(\TKusy\Hl7Fhir\R4\ReferenceType $informationSource)
    {
