...
class ElementDefinitionMappingType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdType $identity
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $map
     */
    private $map = null;
     ...
     * An internal reference to the definition of a mapping.
     *
     * @param \TKusy\Hl7Fhir\R4\IdType $identity
     * @return self
     */
    public function setIdentity(\TKusy\Hl7Fhir\R4\IdType $identity)
    {
     ...
     * Expresses what part of the target specification corresponds to this element.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $map
     * @return self
     */
    public function setMap(\TKusy\Hl7Fhir\R4\StringType $map)
    {
        $this->map = $map;
        return $this;
    }
