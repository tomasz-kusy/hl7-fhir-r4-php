...
class SubstanceReferenceInformationType extends DomainResourceType
{
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationGeneType[] $gene
     */
    private $gene = null;
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationGeneElementType[] $geneElement
     */
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationClassificationType[] $classification
     */
     ...
     * Todo.
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationTargetType[] $target
     */
    private $target = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationGeneType $gene
     */
    public function addToGene(\TKusy\Hl7Fhir\R4\SubstanceReferenceInformationGeneType $gene)
    {
        $this->gene[] = $gene;
        return $this;
    }
     ...
     * Todo.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationGeneType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationGeneElementType $geneElement
     */
    public function addToGeneElement(\TKusy\Hl7Fhir\R4\SubstanceReferenceInformationGeneElementType $geneElement)
    {
     ...
     * Todo.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationGeneElementType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationClassificationType $classification
     */
    public function addToClassification(\TKusy\Hl7Fhir\R4\SubstanceReferenceInformationClassificationType $classification)
    {
     ...
     * Todo.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationClassificationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationTargetType $target
     */
    public function addToTarget(\TKusy\Hl7Fhir\R4\SubstanceReferenceInformationTargetType $target)
    {
        $this->target[] = $target;
        return $this;
    }
     ...
     * Todo.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceReferenceInformationTargetType[]
     */
