...
class MedicationRequestType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationrequestStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationRequestIntentType $intent
     */
    private $intent = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $doNotPerform
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $reportedBoolean
     */
     ...
     * Indicates if this record was captured as a secondary 'reported' record rather than as an original primary source-of-truth record. It may also indicate the source of the report. (choose any one of reported*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $reportedReference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $performerType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $groupIdentifier
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $courseOfTherapyType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $insurance
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DosageType[] $dosageInstruction
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationRequestDispenseRequestType $dispenseRequest
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationRequestSubstitutionType $substitution
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $priorPrescription
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $detectedIssue
     */
     ...
     * A code specifying the current state of the order. Generally, this will be active or completed state.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationrequestStatusType
     */
     ...
     * A code specifying the current state of the order. Generally, this will be active or completed state.
     *
     * @param \TKusy\Hl7Fhir\R4\MedicationrequestStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\MedicationrequestStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * Whether the request is a proposal, plan, or an original order.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationRequestIntentType
     */
     ...
     * Whether the request is a proposal, plan, or an original order.
     *
     * @param \TKusy\Hl7Fhir\R4\MedicationRequestIntentType $intent
     * @return self
     */
    public function setIntent(\TKusy\Hl7Fhir\R4\MedicationRequestIntentType $intent)
    {
        $this->intent = $intent;
        return $this;
    }
     ...
     * If true indicates that the provider is asking for the medication request not to occur.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $doNotPerform
     * @return self
     */
    public function setDoNotPerform(\TKusy\Hl7Fhir\R4\BooleanType $doNotPerform)
    {
     ...
     * Indicates if this record was captured as a secondary 'reported' record rather than as an original primary source-of-truth record. It may also indicate the source of the report. (choose any one of reported*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $reportedBoolean
     * @return self
     */
    public function setReportedBoolean(\TKusy\Hl7Fhir\R4\BooleanType $reportedBoolean)
    {
     ...
     * Indicates if this record was captured as a secondary 'reported' record rather than as an original primary source-of-truth record. It may also indicate the source of the report. (choose any one of reported*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $reportedReference
     * @return self
     */
    public function setReportedReference(\TKusy\Hl7Fhir\R4\ReferenceType $reportedReference)
    {
     ...
     * Indicates the type of performer of the administration of the medication.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $performerType
     * @return self
     */
    public function setPerformerType(\TKusy\Hl7Fhir\R4\CodeableConceptType $performerType)
    {
     ...
     * A shared identifier common to all requests that were authorized more or less simultaneously by a single author, representing the identifier of the requisition or prescription.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $groupIdentifier
     * @return self
     */
    public function setGroupIdentifier(\TKusy\Hl7Fhir\R4\IdentifierType $groupIdentifier)
    {
     ...
     * The description of the overall patte3rn of the administration of the medication to the patient.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $courseOfTherapyType
     * @return self
     */
    public function setCourseOfTherapyType(\TKusy\Hl7Fhir\R4\CodeableConceptType $courseOfTherapyType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $insurance
     */
    public function addToInsurance(\TKusy\Hl7Fhir\R4\ReferenceType $insurance)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DosageType $dosageInstruction
     */
    public function addToDosageInstruction(\TKusy\Hl7Fhir\R4\DosageType $dosageInstruction)
    {
     ...
     * Indicates the specific details for the dispense or medication supply part of a medication request (also known as a Medication Prescription or Medication Order). Note that this information is not always sent with the order. There may be in some settings (e.g. hospitals) institutional or system support for completing the dispense details in the pharmacy department.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationRequestDispenseRequestType
     */
     ...
     * Indicates the specific details for the dispense or medication supply part of a medication request (also known as a Medication Prescription or Medication Order). Note that this information is not always sent with the order. There may be in some settings (e.g. hospitals) institutional or system support for completing the dispense details in the pharmacy department.
     *
     * @param \TKusy\Hl7Fhir\R4\MedicationRequestDispenseRequestType $dispenseRequest
     * @return self
     */
    public function setDispenseRequest(\TKusy\Hl7Fhir\R4\MedicationRequestDispenseRequestType $dispenseRequest)
    {
     ...
     * Indicates whether or not substitution can or should be part of the dispense. In some cases, substitution must happen, in other cases substitution must not happen. This block explains the prescriber's intent. If nothing is specified substitution may be done.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationRequestSubstitutionType
     */
     ...
     * Indicates whether or not substitution can or should be part of the dispense. In some cases, substitution must happen, in other cases substitution must not happen. This block explains the prescriber's intent. If nothing is specified substitution may be done.
     *
     * @param \TKusy\Hl7Fhir\R4\MedicationRequestSubstitutionType $substitution
     * @return self
     */
    public function setSubstitution(\TKusy\Hl7Fhir\R4\MedicationRequestSubstitutionType $substitution)
    {
     ...
     * A link to a resource representing an earlier order related order or prescription.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $priorPrescription
     * @return self
     */
    public function setPriorPrescription(\TKusy\Hl7Fhir\R4\ReferenceType $priorPrescription)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $detectedIssue
     */
    public function addToDetectedIssue(\TKusy\Hl7Fhir\R4\ReferenceType $detectedIssue)
    {
