...
class CompositionAttesterType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CompositionAttestationModeType $mode
     */
    private $mode = null;
     ...
     * The type of attestation the authenticator offers.
     *
     * @return \TKusy\Hl7Fhir\R4\CompositionAttestationModeType
     */
     ...
     * The type of attestation the authenticator offers.
     *
     * @param \TKusy\Hl7Fhir\R4\CompositionAttestationModeType $mode
     * @return self
     */
    public function setMode(\TKusy\Hl7Fhir\R4\CompositionAttestationModeType $mode)
    {
        $this->mode = $mode;
        return $this;
    }
