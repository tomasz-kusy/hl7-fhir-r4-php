...
class AdverseEventCausalityType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $assessment
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $productRelatedness
     */
     ...
     * Assessment of if the entity caused the event.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $assessment
     * @return self
     */
    public function setAssessment(\TKusy\Hl7Fhir\R4\CodeableConceptType $assessment)
    {
     ...
     * AdverseEvent.suspectEntity.causalityProductRelatedness.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $productRelatedness
     * @return self
     */
    public function setProductRelatedness(\TKusy\Hl7Fhir\R4\StringType $productRelatedness)
    {
