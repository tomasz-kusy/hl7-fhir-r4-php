...
class EvidenceVariableType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EvidenceVariableTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EvidenceVariableCharacteristicType[] $characteristic
     */
     ...
     * The type of evidence element, a population, an exposure, or an outcome.
     *
     * @return \TKusy\Hl7Fhir\R4\EvidenceVariableTypeType
     */
     ...
     * The type of evidence element, a population, an exposure, or an outcome.
     *
     * @param \TKusy\Hl7Fhir\R4\EvidenceVariableTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\EvidenceVariableTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\EvidenceVariableCharacteristicType $characteristic
     */
    public function addToCharacteristic(\TKusy\Hl7Fhir\R4\EvidenceVariableCharacteristicType $characteristic)
    {
     ...
     * A characteristic that defines the members of the evidence element. Multiple characteristics are applied with "and" semantics.
     *
     * @return \TKusy\Hl7Fhir\R4\EvidenceVariableCharacteristicType[]
     */
