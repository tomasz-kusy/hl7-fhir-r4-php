...
class SpecimenType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $accessionIdentifier
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SpecimenStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $receivedTime
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SpecimenCollectionType $collection
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SpecimenProcessingType[] $processing
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SpecimenContainerType[] $container
     */
     ...
     * The identifier assigned by the lab when accessioning specimen(s). This is not necessarily the same as the specimen identifier, depending on local lab procedures.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $accessionIdentifier
     * @return self
     */
    public function setAccessionIdentifier(\TKusy\Hl7Fhir\R4\IdentifierType $accessionIdentifier)
    {
     ...
     * The availability of the specimen.
     *
     * @return \TKusy\Hl7Fhir\R4\SpecimenStatusType
     */
     ...
     * The availability of the specimen.
     *
     * @param \TKusy\Hl7Fhir\R4\SpecimenStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\SpecimenStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * Time when specimen was received for processing or testing.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $receivedTime
     * @return self
     */
    public function setReceivedTime(\TKusy\Hl7Fhir\R4\DateTimeType $receivedTime)
    {
     ...
     * Details concerning the specimen collection.
     *
     * @return \TKusy\Hl7Fhir\R4\SpecimenCollectionType
     */
     ...
     * Details concerning the specimen collection.
     *
     * @param \TKusy\Hl7Fhir\R4\SpecimenCollectionType $collection
     * @return self
     */
    public function setCollection(\TKusy\Hl7Fhir\R4\SpecimenCollectionType $collection)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SpecimenProcessingType $processing
     */
    public function addToProcessing(\TKusy\Hl7Fhir\R4\SpecimenProcessingType $processing)
    {
     ...
     * Details concerning processing and processing steps for the specimen.
     *
     * @return \TKusy\Hl7Fhir\R4\SpecimenProcessingType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SpecimenContainerType $container
     */
    public function addToContainer(\TKusy\Hl7Fhir\R4\SpecimenContainerType $container)
    {
     ...
     * The container holding the specimen. The recursive nature of containers; i.e. blood in tube in tray in rack is not addressed here.
     *
     * @return \TKusy\Hl7Fhir\R4\SpecimenContainerType[]
     */
