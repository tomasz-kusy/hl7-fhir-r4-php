...
class MeasureSupplementalDataType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $usage
     */
    private $usage = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $usage
     */
    public function addToUsage(\TKusy\Hl7Fhir\R4\CodeableConceptType $usage)
    {
        $this->usage[] = $usage;
        return $this;
    }
