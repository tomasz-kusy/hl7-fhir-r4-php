...
class TaskType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TaskStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $businessStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TaskIntentType $intent
     */
    private $intent = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $for
     */
    private $for = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType $executionPeriod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $lastModified
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TaskRestrictionType $restriction
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TaskInputType[] $input
     */
    private $input = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TaskOutputType[] $output
     */
    private $output = null;
     ...
     * @return self
     */
    public function setInstantiatesCanonical(\TKusy\Hl7Fhir\R4\CanonicalType $instantiatesCanonical)
    {
     ...
     * The current status of the task.
     *
     * @return \TKusy\Hl7Fhir\R4\TaskStatusType
     */
     ...
     * The current status of the task.
     *
     * @param \TKusy\Hl7Fhir\R4\TaskStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\TaskStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * Contains business-specific nuances of the business state.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $businessStatus
     * @return self
     */
    public function setBusinessStatus(\TKusy\Hl7Fhir\R4\CodeableConceptType $businessStatus)
    {
     ...
     * Indicates the "level" of actionability associated with the Task, i.e. i+R[9]Cs this a proposed task, a planned task, an actionable task, etc.
     *
     * @return \TKusy\Hl7Fhir\R4\TaskIntentType
     */
     ...
     * Indicates the "level" of actionability associated with the Task, i.e. i+R[9]Cs this a proposed task, a planned task, an actionable task, etc.
     *
     * @param \TKusy\Hl7Fhir\R4\TaskIntentType $intent
     * @return self
     */
    public function setIntent(\TKusy\Hl7Fhir\R4\TaskIntentType $intent)
    {
        $this->intent = $intent;
        return $this;
    }
     ...
     * The entity who benefits from the performance of the service specified in the task (e.g., the patient).
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $for
     * @return self
     */
    public function setFor(\TKusy\Hl7Fhir\R4\ReferenceType $for)
    {
        $this->for = $for;
        return $this;
    }
     ...
     * Identifies the time action was first taken against the task (start) and/or the time final action was taken against the task prior to marking it as completed (end).
     *
     * @param \TKusy\Hl7Fhir\R4\PeriodType $executionPeriod
     * @return self
     */
    public function setExecutionPeriod(\TKusy\Hl7Fhir\R4\PeriodType $executionPeriod)
    {
     ...
     * The date and time of last modification to this task.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $lastModified
     * @return self
     */
    public function setLastModified(\TKusy\Hl7Fhir\R4\DateTimeType $lastModified)
    {
     ...
     */
    public function addToPerformerType(\TKusy\Hl7Fhir\R4\CodeableConceptType $performerType)
    {
     ...
     * @return self
     */
    public function setReasonCode(\TKusy\Hl7Fhir\R4\CodeableConceptType $reasonCode)
    {
     ...
     * @return self
     */
    public function setReasonReference(\TKusy\Hl7Fhir\R4\ReferenceType $reasonReference)
    {
     ...
     * If the Task.focus is a request resource and the task is seeking fulfillment (i.e. is asking for the request to be actioned), this element identifies any limitations on what parts of the referenced request should be actioned.
     *
     * @return \TKusy\Hl7Fhir\R4\TaskRestrictionType
     */
     ...
     * If the Task.focus is a request resource and the task is seeking fulfillment (i.e. is asking for the request to be actioned), this element identifies any limitations on what parts of the referenced request should be actioned.
     *
     * @param \TKusy\Hl7Fhir\R4\TaskRestrictionType $restriction
     * @return self
     */
    public function setRestriction(\TKusy\Hl7Fhir\R4\TaskRestrictionType $restriction)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\TaskInputType $input
     */
    public function addToInput(\TKusy\Hl7Fhir\R4\TaskInputType $input)
    {
        $this->input[] = $input;
        return $this;
    }
     ...
     * Additional information that may be needed in the execution of the task.
     *
     * @return \TKusy\Hl7Fhir\R4\TaskInputType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\TaskOutputType $output
     */
    public function addToOutput(\TKusy\Hl7Fhir\R4\TaskOutputType $output)
    {
        $this->output[] = $output;
        return $this;
    }
     ...
     * Outputs produced by the Task.
     *
     * @return \TKusy\Hl7Fhir\R4\TaskOutputType[]
     */
