...
class MedicationDispenseSubstitutionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $wasSubstituted
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $responsibleParty
     */
     ...
     * True if the dispenser dispensed a different drug or product from what was prescribed.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $wasSubstituted
     * @return self
     */
    public function setWasSubstituted(\TKusy\Hl7Fhir\R4\BooleanType $wasSubstituted)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $responsibleParty
     */
    public function addToResponsibleParty(\TKusy\Hl7Fhir\R4\ReferenceType $responsibleParty)
    {
