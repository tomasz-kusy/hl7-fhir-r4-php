...
class ObservationDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ObservationDataTypeType[] $permittedDataType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $multipleResultsAllowed
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $preferredReportName
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ObservationDefinitionQuantitativeDetailsType $quantitativeDetails
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ObservationDefinitionQualifiedIntervalType[] $qualifiedInterval
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $validCodedValueSet
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $normalCodedValueSet
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $abnormalCodedValueSet
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $criticalCodedValueSet
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ObservationDataTypeType $permittedDataType
     */
    public function addToPermittedDataType(\TKusy\Hl7Fhir\R4\ObservationDataTypeType $permittedDataType)
    {
     ...
     * The data types allowed for the value element of the instance observations conforming to this ObservationDefinition.
     *
     * @return \TKusy\Hl7Fhir\R4\ObservationDataTypeType[]
     */
     ...
     * Multiple results allowed for observations conforming to this ObservationDefinition.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $multipleResultsAllowed
     * @return self
     */
    public function setMultipleResultsAllowed(\TKusy\Hl7Fhir\R4\BooleanType $multipleResultsAllowed)
    {
     ...
     * The preferred name to be used when reporting the results of observations conforming to this ObservationDefinition.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $preferredReportName
     * @return self
     */
    public function setPreferredReportName(\TKusy\Hl7Fhir\R4\StringType $preferredReportName)
    {
     ...
     * Characteristics for quantitative results of this observation.
     *
     * @return \TKusy\Hl7Fhir\R4\ObservationDefinitionQuantitativeDetailsType
     */
     ...
     * Characteristics for quantitative results of this observation.
     *
     * @param \TKusy\Hl7Fhir\R4\ObservationDefinitionQuantitativeDetailsType $quantitativeDetails
     * @return self
     */
    public function setQuantitativeDetails(\TKusy\Hl7Fhir\R4\ObservationDefinitionQuantitativeDetailsType $quantitativeDetails)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ObservationDefinitionQualifiedIntervalType $qualifiedInterval
     */
    public function addToQualifiedInterval(\TKusy\Hl7Fhir\R4\ObservationDefinitionQualifiedIntervalType $qualifiedInterval)
    {
     ...
     * Multiple ranges of results qualified by different contexts for ordinal or continuous observations conforming to this ObservationDefinition.
     *
     * @return \TKusy\Hl7Fhir\R4\ObservationDefinitionQualifiedIntervalType[]
     */
     ...
     * The set of valid coded results for the observations conforming to this ObservationDefinition.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $validCodedValueSet
     * @return self
     */
    public function setValidCodedValueSet(\TKusy\Hl7Fhir\R4\ReferenceType $validCodedValueSet)
    {
     ...
     * The set of normal coded results for the observations conforming to this ObservationDefinition.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $normalCodedValueSet
     * @return self
     */
    public function setNormalCodedValueSet(\TKusy\Hl7Fhir\R4\ReferenceType $normalCodedValueSet)
    {
     ...
     * The set of abnormal coded results for the observation conforming to this ObservationDefinition.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $abnormalCodedValueSet
     * @return self
     */
    public function setAbnormalCodedValueSet(\TKusy\Hl7Fhir\R4\ReferenceType $abnormalCodedValueSet)
    {
     ...
     * The set of critical coded results for the observation conforming to this ObservationDefinition.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $criticalCodedValueSet
     * @return self
     */
    public function setCriticalCodedValueSet(\TKusy\Hl7Fhir\R4\ReferenceType $criticalCodedValueSet)
    {
