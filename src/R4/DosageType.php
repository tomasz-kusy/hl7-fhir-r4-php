...
class DosageType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IntegerType $sequence
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $additionalInstruction
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TimingType $timing
     */
    private $timing = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DosageDoseAndRateType[] $doseAndRate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RatioType $maxDosePerPeriod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $maxDosePerAdministration
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $maxDosePerLifetime
     */
     ...
     * Indicates the order in which the dosage instructions should be applied or interpreted.
     *
     * @param \TKusy\Hl7Fhir\R4\IntegerType $sequence
     * @return self
     */
    public function setSequence(\TKusy\Hl7Fhir\R4\IntegerType $sequence)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $additionalInstruction
     */
    public function addToAdditionalInstruction(\TKusy\Hl7Fhir\R4\CodeableConceptType $additionalInstruction)
    {
     ...
     * When medication should be administered.
     *
     * @param \TKusy\Hl7Fhir\R4\TimingType $timing
     * @return self
     */
    public function setTiming(\TKusy\Hl7Fhir\R4\TimingType $timing)
    {
        $this->timing = $timing;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DosageDoseAndRateType $doseAndRate
     */
    public function addToDoseAndRate(\TKusy\Hl7Fhir\R4\DosageDoseAndRateType $doseAndRate)
    {
     ...
     * The amount of medication administered.
     *
     * @return \TKusy\Hl7Fhir\R4\DosageDoseAndRateType[]
     */
     ...
     * Upper limit on medication per unit of time.
     *
     * @param \TKusy\Hl7Fhir\R4\RatioType $maxDosePerPeriod
     * @return self
     */
    public function setMaxDosePerPeriod(\TKusy\Hl7Fhir\R4\RatioType $maxDosePerPeriod)
    {
     ...
     * Upper limit on medication per administration.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $maxDosePerAdministration
     * @return self
     */
    public function setMaxDosePerAdministration(\TKusy\Hl7Fhir\R4\QuantityType $maxDosePerAdministration)
    {
     ...
     * Upper limit on medication per lifetime of the patient.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $maxDosePerLifetime
     * @return self
     */
    public function setMaxDosePerLifetime(\TKusy\Hl7Fhir\R4\QuantityType $maxDosePerLifetime)
    {
