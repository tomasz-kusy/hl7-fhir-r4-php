...
class DeviceRequestType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $priorRequest
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $codeReference
     */
     ...
     * The details of the device to be used. (choose any one of code*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $codeCodeableConcept
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DeviceRequestParameterType[] $parameter
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $priorRequest
     */
    public function addToPriorRequest(\TKusy\Hl7Fhir\R4\ReferenceType $priorRequest)
    {
     ...
     * The details of the device to be used. (choose any one of code*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $codeReference
     * @return self
     */
    public function setCodeReference(\TKusy\Hl7Fhir\R4\ReferenceType $codeReference)
    {
     ...
     * The details of the device to be used. (choose any one of code*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $codeCodeableConcept
     * @return self
     */
    public function setCodeCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $codeCodeableConcept)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DeviceRequestParameterType $parameter
     */
    public function addToParameter(\TKusy\Hl7Fhir\R4\DeviceRequestParameterType $parameter)
    {
     ...
     * Specific parameters for the ordered item. For example, the prism value for lenses.
     *
     * @return \TKusy\Hl7Fhir\R4\DeviceRequestParameterType[]
     */
