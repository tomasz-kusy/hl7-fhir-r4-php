...
class ConceptMapTargetType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConceptMapEquivalenceType $equivalence
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConceptMapDependsOnType[] $dependsOn
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConceptMapDependsOnType[] $product
     */
     ...
     * The equivalence between the source and target concepts (counting for the dependencies and products). The equivalence is read from target to source (e.g. the target is 'wider' than the source).
     *
     * @return \TKusy\Hl7Fhir\R4\ConceptMapEquivalenceType
     */
     ...
     * The equivalence between the source and target concepts (counting for the dependencies and products). The equivalence is read from target to source (e.g. the target is 'wider' than the source).
     *
     * @param \TKusy\Hl7Fhir\R4\ConceptMapEquivalenceType $equivalence
     * @return self
     */
    public function setEquivalence(\TKusy\Hl7Fhir\R4\ConceptMapEquivalenceType $equivalence)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ConceptMapDependsOnType $dependsOn
     */
    public function addToDependsOn(\TKusy\Hl7Fhir\R4\ConceptMapDependsOnType $dependsOn)
    {
     ...
     * A set of additional dependencies for this mapping to hold. This mapping is only applicable if the specified element can be resolved, and it has the specified value.
     *
     * @return \TKusy\Hl7Fhir\R4\ConceptMapDependsOnType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ConceptMapDependsOnType $product
     */
    public function addToProduct(\TKusy\Hl7Fhir\R4\ConceptMapDependsOnType $product)
    {
