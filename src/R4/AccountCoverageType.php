...
class AccountCoverageType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $priority
     */
     ...
     * The priority of the coverage in the context of this account.
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $priority
     * @return self
     */
    public function setPriority(\TKusy\Hl7Fhir\R4\PositiveIntType $priority)
    {
