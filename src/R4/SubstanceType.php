...
class SubstanceType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\FHIRSubstanceStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceInstanceType[] $instance
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceIngredientType[] $ingredient
     */
     ...
     * A code to indicate if the substance is actively used.
     *
     * @return \TKusy\Hl7Fhir\R4\FHIRSubstanceStatusType
     */
     ...
     * A code to indicate if the substance is actively used.
     *
     * @param \TKusy\Hl7Fhir\R4\FHIRSubstanceStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\FHIRSubstanceStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceInstanceType $instance
     */
    public function addToInstance(\TKusy\Hl7Fhir\R4\SubstanceInstanceType $instance)
    {
     ...
     * Substance may be used to describe a kind of substance, or a specific package/container of the substance: an instance.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceInstanceType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceIngredientType $ingredient
     */
    public function addToIngredient(\TKusy\Hl7Fhir\R4\SubstanceIngredientType $ingredient)
    {
     ...
     * A substance can be composed of other substances.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceIngredientType[]
     */
