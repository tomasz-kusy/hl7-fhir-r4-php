...
class ConceptMapElementType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConceptMapTargetType[] $target
     */
    private $target = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ConceptMapTargetType $target
     */
    public function addToTarget(\TKusy\Hl7Fhir\R4\ConceptMapTargetType $target)
    {
        $this->target[] = $target;
        return $this;
    }
     ...
     * A concept from the target value set that this concept maps to.
     *
     * @return \TKusy\Hl7Fhir\R4\ConceptMapTargetType[]
     */
