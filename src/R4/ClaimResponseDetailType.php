...
class ClaimResponseDetailType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ClaimResponseSubDetailType[] $subDetail
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ClaimResponseSubDetailType $subDetail
     */
    public function addToSubDetail(\TKusy\Hl7Fhir\R4\ClaimResponseSubDetailType $subDetail)
    {
     ...
     * A sub-detail adjudication of a simple product or service.
     *
     * @return \TKusy\Hl7Fhir\R4\ClaimResponseSubDetailType[]
     */
