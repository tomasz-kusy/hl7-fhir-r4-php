...
class MeasureReportStratifierType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureReportStratumType[] $stratum
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasureReportStratumType $stratum
     */
    public function addToStratum(\TKusy\Hl7Fhir\R4\MeasureReportStratumType $stratum)
    {
     ...
     * This element contains the results for a single stratum within the stratifier. For example, when stratifying on administrative gender, there will be four strata, one for each possible gender value.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureReportStratumType[]
     */
