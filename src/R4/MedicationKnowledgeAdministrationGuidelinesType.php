...
class MedicationKnowledgeAdministrationGuidelinesType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeDosageType[] $dosage
     */
    private $dosage = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $indicationCodeableConcept
     */
     ...
     * Indication for use that apply to the specific administration guidelines. (choose any one of indication*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $indicationReference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgePatientCharacteristicsType[] $patientCharacteristics
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeDosageType $dosage
     */
    public function addToDosage(\TKusy\Hl7Fhir\R4\MedicationKnowledgeDosageType $dosage)
    {
        $this->dosage[] = $dosage;
        return $this;
    }
     ...
     * Dosage for the medication for the specific guidelines.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeDosageType[]
     */
     ...
     * Indication for use that apply to the specific administration guidelines. (choose any one of indication*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $indicationCodeableConcept
     * @return self
     */
    public function setIndicationCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $indicationCodeableConcept)
    {
     ...
     * Indication for use that apply to the specific administration guidelines. (choose any one of indication*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $indicationReference
     * @return self
     */
    public function setIndicationReference(\TKusy\Hl7Fhir\R4\ReferenceType $indicationReference)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgePatientCharacteristicsType $patientCharacteristics
     */
    public function addToPatientCharacteristics(\TKusy\Hl7Fhir\R4\MedicationKnowledgePatientCharacteristicsType $patientCharacteristics)
    {
     ...
     * Characteristics of the patient that are relevant to the administration guidelines (for example, height, weight, gender, etc.).
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgePatientCharacteristicsType[]
     */
