...
class ImplementationGuideResourceType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $exampleBoolean
     */
     ...
     * If true or a reference, indicates the resource is an example instance. If a reference is present, indicates that the example is an example of the specified profile. (choose any one of example*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $exampleCanonical
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdType $groupingId
     */
     ...
     * If true or a reference, indicates the resource is an example instance. If a reference is present, indicates that the example is an example of the specified profile. (choose any one of example*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $exampleBoolean
     * @return self
     */
    public function setExampleBoolean(\TKusy\Hl7Fhir\R4\BooleanType $exampleBoolean)
    {
     ...
     * If true or a reference, indicates the resource is an example instance. If a reference is present, indicates that the example is an example of the specified profile. (choose any one of example*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $exampleCanonical
     * @return self
     */
    public function setExampleCanonical(\TKusy\Hl7Fhir\R4\CanonicalType $exampleCanonical)
    {
     ...
     * Reference to the id of the grouping this resource appears in.
     *
     * @param \TKusy\Hl7Fhir\R4\IdType $groupingId
     * @return self
     */
    public function setGroupingId(\TKusy\Hl7Fhir\R4\IdType $groupingId)
    {
