...
class CodingType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $userSelected
     */
     ...
     * Indicates that this coding was chosen by a user directly - e.g. off a pick list of available items (codes or displays).
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $userSelected
     * @return self
     */
    public function setUserSelected(\TKusy\Hl7Fhir\R4\BooleanType $userSelected)
    {
