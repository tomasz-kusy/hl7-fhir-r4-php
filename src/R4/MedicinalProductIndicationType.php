...
class MedicinalProductIndicationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $diseaseSymptomProcedure
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $diseaseStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $comorbidity
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $intendedEffect
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductIndicationOtherTherapyType[] $otherTherapy
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $undesirableEffect
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PopulationType[] $population
     */
     ...
     * The disease, symptom or procedure that is the indication for treatment.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $diseaseSymptomProcedure
     * @return self
     */
    public function setDiseaseSymptomProcedure(\TKusy\Hl7Fhir\R4\CodeableConceptType $diseaseSymptomProcedure)
    {
     ...
     * The status of the disease or symptom for which the indication applies.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $diseaseStatus
     * @return self
     */
    public function setDiseaseStatus(\TKusy\Hl7Fhir\R4\CodeableConceptType $diseaseStatus)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $comorbidity
     */
    public function addToComorbidity(\TKusy\Hl7Fhir\R4\CodeableConceptType $comorbidity)
    {
     ...
     * The intended effect, aim or strategy to be achieved by the indication.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $intendedEffect
     * @return self
     */
    public function setIntendedEffect(\TKusy\Hl7Fhir\R4\CodeableConceptType $intendedEffect)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductIndicationOtherTherapyType $otherTherapy
     */
    public function addToOtherTherapy(\TKusy\Hl7Fhir\R4\MedicinalProductIndicationOtherTherapyType $otherTherapy)
    {
     ...
     * Information about the use of the medicinal product in relation to other therapies described as part of the indication.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductIndicationOtherTherapyType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $undesirableEffect
     */
    public function addToUndesirableEffect(\TKusy\Hl7Fhir\R4\ReferenceType $undesirableEffect)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PopulationType $population
     */
    public function addToPopulation(\TKusy\Hl7Fhir\R4\PopulationType $population)
    {
     ...
     * The population group to which this applies.
     *
     * @return \TKusy\Hl7Fhir\R4\PopulationType[]
     */
