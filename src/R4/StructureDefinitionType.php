...
class StructureDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType[] $keyword
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\FHIRVersionType $fhirVersion
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StructureDefinitionMappingType[] $mapping
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StructureDefinitionKindType $kind
     */
    private $kind = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $abstract
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StructureDefinitionContextType[] $context
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $contextInvariant
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $baseDefinition
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TypeDerivationRuleType $derivation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StructureDefinitionSnapshotType $snapshot
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StructureDefinitionDifferentialType $differential
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodingType $keyword
     */
    public function addToKeyword(\TKusy\Hl7Fhir\R4\CodingType $keyword)
    {
     ...
     * The version of the FHIR specification on which this StructureDefinition is based - this is the formal version of the specification, without the revision number, e.g. [publication].[major].[minor], which is 4.0.1. for this version.
     *
     * @return \TKusy\Hl7Fhir\R4\FHIRVersionType
     */
     ...
     * The version of the FHIR specification on which this StructureDefinition is based - this is the formal version of the specification, without the revision number, e.g. [publication].[major].[minor], which is 4.0.1. for this version.
     *
     * @param \TKusy\Hl7Fhir\R4\FHIRVersionType $fhirVersion
     * @return self
     */
    public function setFhirVersion(\TKusy\Hl7Fhir\R4\FHIRVersionType $fhirVersion)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StructureDefinitionMappingType $mapping
     */
    public function addToMapping(\TKusy\Hl7Fhir\R4\StructureDefinitionMappingType $mapping)
    {
     ...
     * An external specification that the content is mapped to.
     *
     * @return \TKusy\Hl7Fhir\R4\StructureDefinitionMappingType[]
     */
     ...
     * Defines the kind of structure that this definition is describing.
     *
     * @return \TKusy\Hl7Fhir\R4\StructureDefinitionKindType
     */
     ...
     * Defines the kind of structure that this definition is describing.
     *
     * @param \TKusy\Hl7Fhir\R4\StructureDefinitionKindType $kind
     * @return self
     */
    public function setKind(\TKusy\Hl7Fhir\R4\StructureDefinitionKindType $kind)
    {
        $this->kind = $kind;
        return $this;
    }
     ...
     * Whether structure this definition describes is abstract or not - that is, whether the structure is not intended to be instantiated. For Resources and Data types, abstract types will never be exchanged between systems.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $abstract
     * @return self
     */
    public function setAbstract(\TKusy\Hl7Fhir\R4\BooleanType $abstract)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StructureDefinitionContextType $context
     */
    public function addToContext(\TKusy\Hl7Fhir\R4\StructureDefinitionContextType $context)
    {
     ...
     * Identifies the types of resource or data type elements to which the extension can be applied.
     *
     * @return \TKusy\Hl7Fhir\R4\StructureDefinitionContextType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $contextInvariant
     */
    public function addToContextInvariant(\TKusy\Hl7Fhir\R4\StringType $contextInvariant)
    {
     ...
     * The type this structure describes. If the derivation kind is 'specialization' then this is the master definition for a type, and there is always one of these (a data type, an extension, a resource, including abstract ones). Otherwise the structure definition is a constraint on the stated type (and in this case, the type cannot be an abstract type). References are URLs that are relative to http://hl7.org/fhir/StructureDefinition e.g. "string" is a reference to http://hl7.org/fhir/StructureDefinition/string. Absolute URLs are only allowed in logical models.
     *
     * @param \TKusy\Hl7Fhir\R4\UriType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\UriType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     * An absolute URI that is the base structure from which this type is derived, either by specialization or constraint.
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $baseDefinition
     * @return self
     */
    public function setBaseDefinition(\TKusy\Hl7Fhir\R4\CanonicalType $baseDefinition)
    {
     ...
     * How the type relates to the baseDefinition.
     *
     * @return \TKusy\Hl7Fhir\R4\TypeDerivationRuleType
     */
     ...
     * How the type relates to the baseDefinition.
     *
     * @param \TKusy\Hl7Fhir\R4\TypeDerivationRuleType $derivation
     * @return self
     */
    public function setDerivation(\TKusy\Hl7Fhir\R4\TypeDerivationRuleType $derivation)
    {
     ...
     * A snapshot view is expressed in a standalone form that can be used and interpreted without considering the base StructureDefinition.
     *
     * @return \TKusy\Hl7Fhir\R4\StructureDefinitionSnapshotType
     */
     ...
     * A snapshot view is expressed in a standalone form that can be used and interpreted without considering the base StructureDefinition.
     *
     * @param \TKusy\Hl7Fhir\R4\StructureDefinitionSnapshotType $snapshot
     * @return self
     */
    public function setSnapshot(\TKusy\Hl7Fhir\R4\StructureDefinitionSnapshotType $snapshot)
    {
     ...
     * A differential view is expressed relative to the base StructureDefinition - a statement of differences that it applies.
     *
     * @return \TKusy\Hl7Fhir\R4\StructureDefinitionDifferentialType
     */
     ...
     * A differential view is expressed relative to the base StructureDefinition - a statement of differences that it applies.
     *
     * @param \TKusy\Hl7Fhir\R4\StructureDefinitionDifferentialType $differential
     * @return self
     */
    public function setDifferential(\TKusy\Hl7Fhir\R4\StructureDefinitionDifferentialType $differential)
    {
