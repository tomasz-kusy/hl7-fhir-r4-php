...
class SpecimenCollectionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $duration
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $fastingStatusCodeableConcept
     */
     ...
     * Abstinence or reduction from some or all food, drink, or both, for a period of time prior to sample collection. (choose any one of fastingStatus*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $fastingStatusDuration
     */
     ...
     * The span of time over which the collection of a specimen occurred.
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $duration
     * @return self
     */
    public function setDuration(\TKusy\Hl7Fhir\R4\DurationType $duration)
    {
     ...
     * Abstinence or reduction from some or all food, drink, or both, for a period of time prior to sample collection. (choose any one of fastingStatus*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $fastingStatusCodeableConcept
     * @return self
     */
    public function setFastingStatusCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $fastingStatusCodeableConcept)
    {
     ...
     * Abstinence or reduction from some or all food, drink, or both, for a period of time prior to sample collection. (choose any one of fastingStatus*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $fastingStatusDuration
     * @return self
     */
    public function setFastingStatusDuration(\TKusy\Hl7Fhir\R4\DurationType $fastingStatusDuration)
    {
