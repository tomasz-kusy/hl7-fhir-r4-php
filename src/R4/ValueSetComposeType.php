...
class ValueSetComposeType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateType $lockedDate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ValueSetIncludeType[] $include
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ValueSetIncludeType[] $exclude
     */
     ...
     * The Locked Date is the effective date that is used to determine the version of all referenced Code Systems and Value Set Definitions included in the compose that are not already tied to a specific version.
     *
     * @param \TKusy\Hl7Fhir\R4\DateType $lockedDate
     * @return self
     */
    public function setLockedDate(\TKusy\Hl7Fhir\R4\DateType $lockedDate)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ValueSetIncludeType $include
     */
    public function addToInclude(\TKusy\Hl7Fhir\R4\ValueSetIncludeType $include)
    {
     ...
     * Include one or more codes from a code system or other value set(s).
     *
     * @return \TKusy\Hl7Fhir\R4\ValueSetIncludeType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ValueSetIncludeType $exclude
     */
    public function addToExclude(\TKusy\Hl7Fhir\R4\ValueSetIncludeType $exclude)
    {
