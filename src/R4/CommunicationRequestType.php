...
class CommunicationRequestType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CommunicationRequestPayloadType[] $payload
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CommunicationRequestPayloadType $payload
     */
    public function addToPayload(\TKusy\Hl7Fhir\R4\CommunicationRequestPayloadType $payload)
    {
     ...
     * Text, attachment(s), or resource(s) to be communicated to the recipient.
     *
     * @return \TKusy\Hl7Fhir\R4\CommunicationRequestPayloadType[]
     */
