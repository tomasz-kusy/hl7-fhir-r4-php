...
class MeasureReportType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureReportStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureReportTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $measure
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $reporter
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureReportGroupType[] $group
     */
    private $group = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $evaluatedResource
     */
     ...
     * The MeasureReport status. No data will be available until the MeasureReport status is complete.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureReportStatusType
     */
     ...
     * The MeasureReport status. No data will be available until the MeasureReport status is complete.
     *
     * @param \TKusy\Hl7Fhir\R4\MeasureReportStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\MeasureReportStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The type of measure report. This may be an individual report, which provides the score for the measure for an individual member of the population; a subject-listing, which returns the list of members that meet the various criteria in the measure; a summary report, which returns a population count for each of the criteria in the measure; or a data-collection, which enables the MeasureReport to be used to exchange the data-of-interest for a quality measure.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureReportTypeType
     */
     ...
     * The type of measure report. This may be an individual report, which provides the score for the measure for an individual member of the population; a subject-listing, which returns the list of members that meet the various criteria in the measure; a summary report, which returns a population count for each of the criteria in the measure; or a data-collection, which enables the MeasureReport to be used to exchange the data-of-interest for a quality measure.
     *
     * @param \TKusy\Hl7Fhir\R4\MeasureReportTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\MeasureReportTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     * A reference to the Measure that was calculated to produce this report.
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $measure
     * @return self
     */
    public function setMeasure(\TKusy\Hl7Fhir\R4\CanonicalType $measure)
    {
     ...
     * The individual, location, or organization that is reporting the data.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $reporter
     * @return self
     */
    public function setReporter(\TKusy\Hl7Fhir\R4\ReferenceType $reporter)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasureReportGroupType $group
     */
    public function addToGroup(\TKusy\Hl7Fhir\R4\MeasureReportGroupType $group)
    {
        $this->group[] = $group;
        return $this;
    }
     ...
     * The results of the calculation, one for each population group in the measure.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureReportGroupType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $evaluatedResource
     */
    public function addToEvaluatedResource(\TKusy\Hl7Fhir\R4\ReferenceType $evaluatedResource)
    {
