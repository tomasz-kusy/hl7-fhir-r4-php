...
class AllergyIntoleranceType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AllergyIntoleranceTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AllergyIntoleranceCategoryType[] $category
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AllergyIntoleranceCriticalityType $criticality
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $lastOccurrence
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AllergyIntoleranceReactionType[] $reaction
     */
     ...
     * Identification of the underlying physiological mechanism for the reaction risk.
     *
     * @return \TKusy\Hl7Fhir\R4\AllergyIntoleranceTypeType
     */
     ...
     * Identification of the underlying physiological mechanism for the reaction risk.
     *
     * @param \TKusy\Hl7Fhir\R4\AllergyIntoleranceTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\AllergyIntoleranceTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\AllergyIntoleranceCategoryType $category
     */
    public function addToCategory(\TKusy\Hl7Fhir\R4\AllergyIntoleranceCategoryType $category)
    {
     ...
     * Category of the identified substance.
     *
     * @return \TKusy\Hl7Fhir\R4\AllergyIntoleranceCategoryType[]
     */
     ...
     * Estimate of the potential clinical harm, or seriousness, of the reaction to the identified substance.
     *
     * @return \TKusy\Hl7Fhir\R4\AllergyIntoleranceCriticalityType
     */
     ...
     * Estimate of the potential clinical harm, or seriousness, of the reaction to the identified substance.
     *
     * @param \TKusy\Hl7Fhir\R4\AllergyIntoleranceCriticalityType $criticality
     * @return self
     */
    public function setCriticality(\TKusy\Hl7Fhir\R4\AllergyIntoleranceCriticalityType $criticality)
    {
     ...
     * Represents the date and/or time of the last known occurrence of a reaction event.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $lastOccurrence
     * @return self
     */
    public function setLastOccurrence(\TKusy\Hl7Fhir\R4\DateTimeType $lastOccurrence)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\AllergyIntoleranceReactionType $reaction
     */
    public function addToReaction(\TKusy\Hl7Fhir\R4\AllergyIntoleranceReactionType $reaction)
    {
     ...
     * Details about each adverse reaction event linked to exposure to the identified substance.
     *
     * @return \TKusy\Hl7Fhir\R4\AllergyIntoleranceReactionType[]
     */
