...
class RelatedPersonType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RelatedPersonCommunicationType[] $communication
     */
     ...
     */
    public function addToRelationship(\TKusy\Hl7Fhir\R4\CodeableConceptType $relationship)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\RelatedPersonCommunicationType $communication
     */
    public function addToCommunication(\TKusy\Hl7Fhir\R4\RelatedPersonCommunicationType $communication)
    {
     ...
     * A language which may be used to communicate with about the patient's health.
     *
     * @return \TKusy\Hl7Fhir\R4\RelatedPersonCommunicationType[]
     */
