...
class ValueSetIncludeType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ValueSetConceptType[] $concept
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ValueSetFilterType[] $filter
     */
    private $filter = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ValueSetConceptType $concept
     */
    public function addToConcept(\TKusy\Hl7Fhir\R4\ValueSetConceptType $concept)
    {
     ...
     * Specifies a concept to be included or excluded.
     *
     * @return \TKusy\Hl7Fhir\R4\ValueSetConceptType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ValueSetFilterType $filter
     */
    public function addToFilter(\TKusy\Hl7Fhir\R4\ValueSetFilterType $filter)
    {
        $this->filter[] = $filter;
        return $this;
    }
     ...
     * Select concepts by specify a matching criterion based on the properties (including relationships) defined by the system, or on filters defined by the system. If multiple filters are specified, they SHALL all be true.
     *
     * @return \TKusy\Hl7Fhir\R4\ValueSetFilterType[]
     */
     ...
     */
    public function addToValueSet(\TKusy\Hl7Fhir\R4\CanonicalType $valueSet)
    {
