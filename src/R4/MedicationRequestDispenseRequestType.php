...
class MedicationRequestDispenseRequestType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationRequestInitialFillType $initialFill
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $dispenseInterval
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UnsignedIntType $numberOfRepeatsAllowed
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $expectedSupplyDuration
     */
     ...
     * Indicates the quantity or duration for the first dispense of the medication.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationRequestInitialFillType
     */
     ...
     * Indicates the quantity or duration for the first dispense of the medication.
     *
     * @param \TKusy\Hl7Fhir\R4\MedicationRequestInitialFillType $initialFill
     * @return self
     */
    public function setInitialFill(\TKusy\Hl7Fhir\R4\MedicationRequestInitialFillType $initialFill)
    {
     ...
     * The minimum period of time that must occur between dispenses of the medication.
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $dispenseInterval
     * @return self
     */
    public function setDispenseInterval(\TKusy\Hl7Fhir\R4\DurationType $dispenseInterval)
    {
     ...
     * An integer indicating the number of times, in addition to the original dispense, (aka refills or repeats) that the patient can receive the prescribed medication. Usage Notes: This integer does not include the original order dispense. This means that if an order indicates dispense 30 tablets plus "3 repeats", then the order can be dispensed a total of 4 times and the patient can receive a total of 120 tablets. A prescriber may explicitly say that zero refills are permitted after the initial dispense.
     *
     * @param \TKusy\Hl7Fhir\R4\UnsignedIntType $numberOfRepeatsAllowed
     * @return self
     */
    public function setNumberOfRepeatsAllowed(\TKusy\Hl7Fhir\R4\UnsignedIntType $numberOfRepeatsAllowed)
    {
     ...
     * Identifies the period time over which the supplied product is expected to be used, or the length of time the dispense is expected to last.
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $expectedSupplyDuration
     * @return self
     */
    public function setExpectedSupplyDuration(\TKusy\Hl7Fhir\R4\DurationType $expectedSupplyDuration)
    {
