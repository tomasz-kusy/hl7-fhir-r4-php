...
class LocationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\LocationStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType $operationalStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\LocationModeType $mode
     */
    private $mode = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $physicalType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\LocationPositionType $position
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\LocationHoursOfOperationType[] $hoursOfOperation
     */
     ...
     * The status property covers the general availability of the resource, not the current value which may be covered by the operationStatus, or by a schedule/slots if they are configured for the location.
     *
     * @return \TKusy\Hl7Fhir\R4\LocationStatusType
     */
     ...
     * The status property covers the general availability of the resource, not the current value which may be covered by the operationStatus, or by a schedule/slots if they are configured for the location.
     *
     * @param \TKusy\Hl7Fhir\R4\LocationStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\LocationStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The operational status covers operation values most relevant to beds (but can also apply to rooms/units/chairs/etc. such as an isolation unit/dialysis chair). This typically covers concepts such as contamination, housekeeping, and other activities like maintenance.
     *
     * @param \TKusy\Hl7Fhir\R4\CodingType $operationalStatus
     * @return self
     */
    public function setOperationalStatus(\TKusy\Hl7Fhir\R4\CodingType $operationalStatus)
    {
     ...
     * Indicates whether a resource instance represents a specific location or a class of locations.
     *
     * @return \TKusy\Hl7Fhir\R4\LocationModeType
     */
     ...
     * Indicates whether a resource instance represents a specific location or a class of locations.
     *
     * @param \TKusy\Hl7Fhir\R4\LocationModeType $mode
     * @return self
     */
    public function setMode(\TKusy\Hl7Fhir\R4\LocationModeType $mode)
    {
        $this->mode = $mode;
        return $this;
    }
     ...
     * Physical form of the location, e.g. building, room, vehicle, road.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $physicalType
     * @return self
     */
    public function setPhysicalType(\TKusy\Hl7Fhir\R4\CodeableConceptType $physicalType)
    {
     ...
     * The absolute geographic location of the Location, expressed using the WGS84 datum (This is the same co-ordinate system used in KML).
     *
     * @return \TKusy\Hl7Fhir\R4\LocationPositionType
     */
     ...
     * The absolute geographic location of the Location, expressed using the WGS84 datum (This is the same co-ordinate system used in KML).
     *
     * @param \TKusy\Hl7Fhir\R4\LocationPositionType $position
     * @return self
     */
    public function setPosition(\TKusy\Hl7Fhir\R4\LocationPositionType $position)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\LocationHoursOfOperationType $hoursOfOperation
     */
    public function addToHoursOfOperation(\TKusy\Hl7Fhir\R4\LocationHoursOfOperationType $hoursOfOperation)
    {
     ...
     * What days/times during a week is this location usually open.
     *
     * @return \TKusy\Hl7Fhir\R4\LocationHoursOfOperationType[]
     */
