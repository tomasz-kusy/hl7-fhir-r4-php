...
class ImmunizationRecommendationRecommendationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $targetDisease
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $contraindicatedVaccineCode
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $forecastStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $forecastReason
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ImmunizationRecommendationDateCriterionType[] $dateCriterion
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $series
     */
    private $series = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $doseNumberPositiveInt
     */
     ...
     * Nominal position of the recommended dose in a series (e.g. dose 2 is the next recommended dose). (choose any one of doseNumber*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $doseNumberString
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $seriesDosesPositiveInt
     */
     ...
     * The recommended number of doses to achieve immunity. (choose any one of seriesDoses*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $seriesDosesString
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $supportingImmunization
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $supportingPatientInformation
     */
     ...
     */
    public function addToVaccineCode(\TKusy\Hl7Fhir\R4\CodeableConceptType $vaccineCode)
    {
     ...
     * The targeted disease for the recommendation.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $targetDisease
     * @return self
     */
    public function setTargetDisease(\TKusy\Hl7Fhir\R4\CodeableConceptType $targetDisease)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $contraindicatedVaccineCode
     */
    public function addToContraindicatedVaccineCode(\TKusy\Hl7Fhir\R4\CodeableConceptType $contraindicatedVaccineCode)
    {
     ...
     * Indicates the patient status with respect to the path to immunity for the target disease.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $forecastStatus
     * @return self
     */
    public function setForecastStatus(\TKusy\Hl7Fhir\R4\CodeableConceptType $forecastStatus)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $forecastReason
     */
    public function addToForecastReason(\TKusy\Hl7Fhir\R4\CodeableConceptType $forecastReason)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ImmunizationRecommendationDateCriterionType $dateCriterion
     */
    public function addToDateCriterion(\TKusy\Hl7Fhir\R4\ImmunizationRecommendationDateCriterionType $dateCriterion)
    {
     ...
     * Vaccine date recommendations. For example, earliest date to administer, latest date to administer, etc.
     *
     * @return \TKusy\Hl7Fhir\R4\ImmunizationRecommendationDateCriterionType[]
     */
     ...
     * One possible path to achieve presumed immunity against a disease - within the context of an authority.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $series
     * @return self
     */
    public function setSeries(\TKusy\Hl7Fhir\R4\StringType $series)
    {
        $this->series = $series;
        return $this;
    }
     ...
     * Nominal position of the recommended dose in a series (e.g. dose 2 is the next recommended dose). (choose any one of doseNumber*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $doseNumberPositiveInt
     * @return self
     */
    public function setDoseNumberPositiveInt(\TKusy\Hl7Fhir\R4\PositiveIntType $doseNumberPositiveInt)
    {
     ...
     * Nominal position of the recommended dose in a series (e.g. dose 2 is the next recommended dose). (choose any one of doseNumber*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $doseNumberString
     * @return self
     */
    public function setDoseNumberString(\TKusy\Hl7Fhir\R4\StringType $doseNumberString)
    {
     ...
     * The recommended number of doses to achieve immunity. (choose any one of seriesDoses*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $seriesDosesPositiveInt
     * @return self
     */
    public function setSeriesDosesPositiveInt(\TKusy\Hl7Fhir\R4\PositiveIntType $seriesDosesPositiveInt)
    {
     ...
     * The recommended number of doses to achieve immunity. (choose any one of seriesDoses*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $seriesDosesString
     * @return self
     */
    public function setSeriesDosesString(\TKusy\Hl7Fhir\R4\StringType $seriesDosesString)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $supportingImmunization
     */
    public function addToSupportingImmunization(\TKusy\Hl7Fhir\R4\ReferenceType $supportingImmunization)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $supportingPatientInformation
     */
    public function addToSupportingPatientInformation(\TKusy\Hl7Fhir\R4\ReferenceType $supportingPatientInformation)
    {
