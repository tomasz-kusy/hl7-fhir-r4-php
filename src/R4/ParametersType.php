...
class ParametersType extends ResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ParametersParameterType[] $parameter
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ParametersParameterType $parameter
     */
    public function addToParameter(\TKusy\Hl7Fhir\R4\ParametersParameterType $parameter)
    {
