...
/**
 * Class representing ResearchElementDefinitionType
 *
 ...
 * XSD Type: ResearchElementDefinition
 */
class ResearchElementDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $shortTitle
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ResearchElementTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\VariableTypeType $variableType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ResearchElementDefinitionCharacteristicType[] $characteristic
     */
     ...
     * The short title provides an alternate title for use in informal descriptive contexts where the full, formal title is not necessary.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $shortTitle
     * @return self
     */
    public function setShortTitle(\TKusy\Hl7Fhir\R4\StringType $shortTitle)
    {
     ...
     */
    public function addToComment(\TKusy\Hl7Fhir\R4\StringType $comment)
    {
     ...
     * The type of research element, a population, an exposure, or an outcome.
     *
     * @return \TKusy\Hl7Fhir\R4\ResearchElementTypeType
     */
     ...
     * The type of research element, a population, an exposure, or an outcome.
     *
     * @param \TKusy\Hl7Fhir\R4\ResearchElementTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\ResearchElementTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
    ...
    /**
     * Gets as variableType
     *
     * The type of the outcome (e.g. Dichotomous, Continuous, or Descriptive).
     *
     * @return \TKusy\Hl7Fhir\R4\VariableTypeType
     */
    ...
    /**
     * Sets a new variableType
     *
     * The type of the outcome (e.g. Dichotomous, Continuous, or Descriptive).
     *
     * @param \TKusy\Hl7Fhir\R4\VariableTypeType $variableType
     * @return self
     */
    public function setVariableType(\TKusy\Hl7Fhir\R4\VariableTypeType $variableType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ResearchElementDefinitionCharacteristicType $characteristic
     */
    public function addToCharacteristic(\TKusy\Hl7Fhir\R4\ResearchElementDefinitionCharacteristicType $characteristic)
    {
     ...
     * A characteristic that defines the members of the research element. Multiple characteristics are applied with "and" semantics.
     *
     * @return \TKusy\Hl7Fhir\R4\ResearchElementDefinitionCharacteristicType[]
     */
