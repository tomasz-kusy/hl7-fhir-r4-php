...
class DocumentReferenceType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $masterIdentifier
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DocumentReferenceStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CompositionStatusType $docStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InstantType $date
     */
    private $date = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $authenticator
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DocumentReferenceRelatesToType[] $relatesTo
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $securityLabel
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DocumentReferenceContentType[] $content
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DocumentReferenceContextType $context
     */
     ...
     * Document identifier as assigned by the source of the document. This identifier is specific to this version of the document. This unique identifier may be used elsewhere to identify this version of the document.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $masterIdentifier
     * @return self
     */
    public function setMasterIdentifier(\TKusy\Hl7Fhir\R4\IdentifierType $masterIdentifier)
    {
     ...
     * The status of this document reference.
     *
     * @return \TKusy\Hl7Fhir\R4\DocumentReferenceStatusType
     */
     ...
     * The status of this document reference.
     *
     * @param \TKusy\Hl7Fhir\R4\DocumentReferenceStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\DocumentReferenceStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The status of the underlying document.
     *
     * @return \TKusy\Hl7Fhir\R4\CompositionStatusType
     */
     ...
     * The status of the underlying document.
     *
     * @param \TKusy\Hl7Fhir\R4\CompositionStatusType $docStatus
     * @return self
     */
    public function setDocStatus(\TKusy\Hl7Fhir\R4\CompositionStatusType $docStatus)
    {
     ...
     * When the document reference was created.
     *
     * @param \TKusy\Hl7Fhir\R4\InstantType $date
     * @return self
     */
    public function setDate(\TKusy\Hl7Fhir\R4\InstantType $date)
    {
        $this->date = $date;
        return $this;
    }
     ...
     * Which person or organization authenticates that this document is valid.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $authenticator
     * @return self
     */
    public function setAuthenticator(\TKusy\Hl7Fhir\R4\ReferenceType $authenticator)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DocumentReferenceRelatesToType $relatesTo
     */
    public function addToRelatesTo(\TKusy\Hl7Fhir\R4\DocumentReferenceRelatesToType $relatesTo)
    {
     ...
     * Relationships that this document has with other document references that already exist.
     *
     * @return \TKusy\Hl7Fhir\R4\DocumentReferenceRelatesToType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $securityLabel
     */
    public function addToSecurityLabel(\TKusy\Hl7Fhir\R4\CodeableConceptType $securityLabel)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DocumentReferenceContentType $content
     */
    public function addToContent(\TKusy\Hl7Fhir\R4\DocumentReferenceContentType $content)
    {
     ...
     * The document and format referenced. There may be multiple content element repetitions, each with a different format.
     *
     * @return \TKusy\Hl7Fhir\R4\DocumentReferenceContentType[]
     */
     ...
     * The clinical context in which the document was prepared.
     *
     * @return \TKusy\Hl7Fhir\R4\DocumentReferenceContextType
     */
     ...
     * The clinical context in which the document was prepared.
     *
     * @param \TKusy\Hl7Fhir\R4\DocumentReferenceContextType $context
     * @return self
     */
    public function setContext(\TKusy\Hl7Fhir\R4\DocumentReferenceContextType $context)
    {
