...
class EnrollmentRequestType extends DomainResourceType
{
     ...
     * Patient Resource.
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $candidate
     */
     ...
     * Patient Resource.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $candidate
     * @return self
     */
    public function setCandidate(\TKusy\Hl7Fhir\R4\ReferenceType $candidate)
    {
