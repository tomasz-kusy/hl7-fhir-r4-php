...
class DocumentManifestType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $content
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DocumentManifestRelatedType[] $related
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $content
     */
    public function addToContent(\TKusy\Hl7Fhir\R4\ReferenceType $content)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DocumentManifestRelatedType $related
     */
    public function addToRelated(\TKusy\Hl7Fhir\R4\DocumentManifestRelatedType $related)
    {
     ...
     * Related identifiers or resources associated with the DocumentManifest.
     *
     * @return \TKusy\Hl7Fhir\R4\DocumentManifestRelatedType[]
     */
