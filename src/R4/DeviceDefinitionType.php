...
class DeviceDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DeviceDefinitionUdiDeviceIdentifierType[] $udiDeviceIdentifier
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $manufacturerString
     */
     ...
     * A name of the manufacturer. (choose any one of manufacturer*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $manufacturerReference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DeviceDefinitionDeviceNameType[] $deviceName
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $modelNumber
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DeviceDefinitionSpecializationType[] $specialization
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $safety
     */
    private $safety = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ProductShelfLifeType[] $shelfLifeStorage
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $languageCode
     */
     ...
     * Device capabilities.
     *
     * @var \TKusy\Hl7Fhir\R4\DeviceDefinitionCapabilityType[] $capability
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DeviceDefinitionPropertyType[] $property
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType $onlineInformation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $parentDevice
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DeviceDefinitionMaterialType[] $material
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DeviceDefinitionUdiDeviceIdentifierType $udiDeviceIdentifier
     */
    public function addToUdiDeviceIdentifier(\TKusy\Hl7Fhir\R4\DeviceDefinitionUdiDeviceIdentifierType $udiDeviceIdentifier)
    {
     ...
     * Unique device identifier (UDI) assigned to device label or package. Note that the Device may include multiple udiCarriers as it either may include just the udiCarrier for the jurisdiction it is sold, or for multiple jurisdictions it could have been sold.
     *
     * @return \TKusy\Hl7Fhir\R4\DeviceDefinitionUdiDeviceIdentifierType[]
     */
     ...
     * A name of the manufacturer. (choose any one of manufacturer*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $manufacturerString
     * @return self
     */
    public function setManufacturerString(\TKusy\Hl7Fhir\R4\StringType $manufacturerString)
    {
     ...
     * A name of the manufacturer. (choose any one of manufacturer*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $manufacturerReference
     * @return self
     */
    public function setManufacturerReference(\TKusy\Hl7Fhir\R4\ReferenceType $manufacturerReference)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DeviceDefinitionDeviceNameType $deviceName
     */
    public function addToDeviceName(\TKusy\Hl7Fhir\R4\DeviceDefinitionDeviceNameType $deviceName)
    {
     ...
     * A name given to the device to identify it.
     *
     * @return \TKusy\Hl7Fhir\R4\DeviceDefinitionDeviceNameType[]
     */
     ...
     * The model number for the device.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $modelNumber
     * @return self
     */
    public function setModelNumber(\TKusy\Hl7Fhir\R4\StringType $modelNumber)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DeviceDefinitionSpecializationType $specialization
     */
    public function addToSpecialization(\TKusy\Hl7Fhir\R4\DeviceDefinitionSpecializationType $specialization)
    {
     ...
     * The capabilities supported on a device, the standards to which the device conforms for a particular purpose, and used for the communication.
     *
     * @return \TKusy\Hl7Fhir\R4\DeviceDefinitionSpecializationType[]
     */
     ...
     */
    public function addToVersion(\TKusy\Hl7Fhir\R4\StringType $version)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $safety
     */
    public function addToSafety(\TKusy\Hl7Fhir\R4\CodeableConceptType $safety)
    {
        $this->safety[] = $safety;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ProductShelfLifeType $shelfLifeStorage
     */
    public function addToShelfLifeStorage(\TKusy\Hl7Fhir\R4\ProductShelfLifeType $shelfLifeStorage)
    {
     ...
     * Shelf Life and storage information.
     *
     * @return \TKusy\Hl7Fhir\R4\ProductShelfLifeType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $languageCode
     */
    public function addToLanguageCode(\TKusy\Hl7Fhir\R4\CodeableConceptType $languageCode)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DeviceDefinitionCapabilityType $capability
     */
    public function addToCapability(\TKusy\Hl7Fhir\R4\DeviceDefinitionCapabilityType $capability)
    {
     ...
     * Device capabilities.
     *
     * @return \TKusy\Hl7Fhir\R4\DeviceDefinitionCapabilityType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DeviceDefinitionPropertyType $property
     */
    public function addToProperty(\TKusy\Hl7Fhir\R4\DeviceDefinitionPropertyType $property)
    {
     ...
     * The actual configuration settings of a device as it actually operates, e.g., regulation status, time properties.
     *
     * @return \TKusy\Hl7Fhir\R4\DeviceDefinitionPropertyType[]
     */
     ...
     */
    public function addToContact(\TKusy\Hl7Fhir\R4\ContactPointType $contact)
    {
     ...
     * Access to on-line information about the device.
     *
     * @param \TKusy\Hl7Fhir\R4\UriType $onlineInformation
     * @return self
     */
    public function setOnlineInformation(\TKusy\Hl7Fhir\R4\UriType $onlineInformation)
    {
     ...
     * The parent device it can be part of.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $parentDevice
     * @return self
     */
    public function setParentDevice(\TKusy\Hl7Fhir\R4\ReferenceType $parentDevice)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DeviceDefinitionMaterialType $material
     */
    public function addToMaterial(\TKusy\Hl7Fhir\R4\DeviceDefinitionMaterialType $material)
    {
     ...
     * A substance used to create the material(s) of which the device is made.
     *
     * @return \TKusy\Hl7Fhir\R4\DeviceDefinitionMaterialType[]
     */
