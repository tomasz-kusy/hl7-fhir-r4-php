...
class ObservationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ObservationStatusType $status
     */
    private $status = null;
     ...
     * The time or time-period the observed value is asserted as being true. For biological subjects - e.g. human patients - this is usually called the "physiologically relevant time". This is usually either the time of the procedure or of specimen collection, but very often the source of the date/time is not known, only the date/time itself. (choose any one of effective*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\TimingType $effectiveTiming
     */
     ...
     * The time or time-period the observed value is asserted as being true. For biological subjects - e.g. human patients - this is usually called the "physiologically relevant time". This is usually either the time of the procedure or of specimen collection, but very often the source of the date/time is not known, only the date/time itself. (choose any one of effective*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\InstantType $effectiveInstant
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InstantType $issued
     */
    private $issued = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $interpretation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ObservationReferenceRangeType[] $referenceRange
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $hasMember
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ObservationComponentType[] $component
     */
     ...
     * The status of the result value.
     *
     * @return \TKusy\Hl7Fhir\R4\ObservationStatusType
     */
     ...
     * The status of the result value.
     *
     * @param \TKusy\Hl7Fhir\R4\ObservationStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ObservationStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The time or time-period the observed value is asserted as being true. For biological subjects - e.g. human patients - this is usually called the "physiologically relevant time". This is usually either the time of the procedure or of specimen collection, but very often the source of the date/time is not known, only the date/time itself. (choose any one of effective*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\TimingType $effectiveTiming
     * @return self
     */
    public function setEffectiveTiming(\TKusy\Hl7Fhir\R4\TimingType $effectiveTiming)
    {
     ...
     * The time or time-period the observed value is asserted as being true. For biological subjects - e.g. human patients - this is usually called the "physiologically relevant time". This is usually either the time of the procedure or of specimen collection, but very often the source of the date/time is not known, only the date/time itself. (choose any one of effective*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\InstantType $effectiveInstant
     * @return self
     */
    public function setEffectiveInstant(\TKusy\Hl7Fhir\R4\InstantType $effectiveInstant)
    {
     ...
     * The date and time this version of the observation was made available to providers, typically after the results have been reviewed and verified.
     *
     * @param \TKusy\Hl7Fhir\R4\InstantType $issued
     * @return self
     */
    public function setIssued(\TKusy\Hl7Fhir\R4\InstantType $issued)
    {
        $this->issued = $issued;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $interpretation
     */
    public function addToInterpretation(\TKusy\Hl7Fhir\R4\CodeableConceptType $interpretation)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ObservationReferenceRangeType $referenceRange
     */
    public function addToReferenceRange(\TKusy\Hl7Fhir\R4\ObservationReferenceRangeType $referenceRange)
    {
     ...
     * Guidance on how to interpret the value by comparison to a normal or recommended range. Multiple reference ranges are interpreted as an "OR". In other words, to represent two distinct target populations, two `referenceRange` elements would be used.
     *
     * @return \TKusy\Hl7Fhir\R4\ObservationReferenceRangeType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $hasMember
     */
    public function addToHasMember(\TKusy\Hl7Fhir\R4\ReferenceType $hasMember)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ObservationComponentType $component
     */
    public function addToComponent(\TKusy\Hl7Fhir\R4\ObservationComponentType $component)
    {
     ...
     * Some observations have multiple component observations. These component observations are expressed as separate code value pairs that share the same attributes. Examples include systolic and diastolic component observations for blood pressure measurement and multiple component observations for genetics observations.
     *
     * @return \TKusy\Hl7Fhir\R4\ObservationComponentType[]
     */
