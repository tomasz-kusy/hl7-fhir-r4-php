...
class MedicationKnowledgeType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $doseForm
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $synonym
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeRelatedMedicationKnowledgeType[] $relatedMedicationKnowledge
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $associatedMedication
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $productType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeMonographType[] $monograph
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeIngredientType[] $ingredient
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarkdownType $preparationInstruction
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $intendedRoute
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeCostType[] $cost
     */
    private $cost = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeMonitoringProgramType[] $monitoringProgram
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeAdministrationGuidelinesType[] $administrationGuidelines
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeMedicineClassificationType[] $medicineClassification
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgePackagingType $packaging
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeDrugCharacteristicType[] $drugCharacteristic
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $contraindication
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeRegulatoryType[] $regulatory
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicationKnowledgeKineticsType[] $kinetics
     */
     ...
     * @return self
     */
    public function setManufacturer(\TKusy\Hl7Fhir\R4\ReferenceType $manufacturer)
    {
     ...
     * Describes the form of the item. Powder; tablets; capsule.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $doseForm
     * @return self
     */
    public function setDoseForm(\TKusy\Hl7Fhir\R4\CodeableConceptType $doseForm)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $synonym
     */
    public function addToSynonym(\TKusy\Hl7Fhir\R4\StringType $synonym)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeRelatedMedicationKnowledgeType $relatedMedicationKnowledge
     */
    public function addToRelatedMedicationKnowledge(\TKusy\Hl7Fhir\R4\MedicationKnowledgeRelatedMedicationKnowledgeType $relatedMedicationKnowledge)
    {
     ...
     * Associated or related knowledge about a medication.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeRelatedMedicationKnowledgeType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $associatedMedication
     */
    public function addToAssociatedMedication(\TKusy\Hl7Fhir\R4\ReferenceType $associatedMedication)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $productType
     */
    public function addToProductType(\TKusy\Hl7Fhir\R4\CodeableConceptType $productType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeMonographType $monograph
     */
    public function addToMonograph(\TKusy\Hl7Fhir\R4\MedicationKnowledgeMonographType $monograph)
    {
     ...
     * Associated documentation about the medication.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeMonographType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeIngredientType $ingredient
     */
    public function addToIngredient(\TKusy\Hl7Fhir\R4\MedicationKnowledgeIngredientType $ingredient)
    {
     ...
     * Identifies a particular constituent of interest in the product.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeIngredientType[]
     */
     ...
     * The instructions for preparing the medication.
     *
     * @param \TKusy\Hl7Fhir\R4\MarkdownType $preparationInstruction
     * @return self
     */
    public function setPreparationInstruction(\TKusy\Hl7Fhir\R4\MarkdownType $preparationInstruction)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $intendedRoute
     */
    public function addToIntendedRoute(\TKusy\Hl7Fhir\R4\CodeableConceptType $intendedRoute)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeCostType $cost
     */
    public function addToCost(\TKusy\Hl7Fhir\R4\MedicationKnowledgeCostType $cost)
    {
        $this->cost[] = $cost;
        return $this;
    }
     ...
     * The price of the medication.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeCostType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeMonitoringProgramType $monitoringProgram
     */
    public function addToMonitoringProgram(\TKusy\Hl7Fhir\R4\MedicationKnowledgeMonitoringProgramType $monitoringProgram)
    {
     ...
     * The program under which the medication is reviewed.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeMonitoringProgramType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeAdministrationGuidelinesType $administrationGuidelines
     */
    public function addToAdministrationGuidelines(\TKusy\Hl7Fhir\R4\MedicationKnowledgeAdministrationGuidelinesType $administrationGuidelines)
    {
     ...
     * Guidelines for the administration of the medication.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeAdministrationGuidelinesType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeMedicineClassificationType $medicineClassification
     */
    public function addToMedicineClassification(\TKusy\Hl7Fhir\R4\MedicationKnowledgeMedicineClassificationType $medicineClassification)
    {
     ...
     * Categorization of the medication within a formulary or classification system.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeMedicineClassificationType[]
     */
     ...
     * Information that only applies to packages (not products).
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgePackagingType
     */
     ...
     * Information that only applies to packages (not products).
     *
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgePackagingType $packaging
     * @return self
     */
    public function setPackaging(\TKusy\Hl7Fhir\R4\MedicationKnowledgePackagingType $packaging)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeDrugCharacteristicType $drugCharacteristic
     */
    public function addToDrugCharacteristic(\TKusy\Hl7Fhir\R4\MedicationKnowledgeDrugCharacteristicType $drugCharacteristic)
    {
     ...
     * Specifies descriptive properties of the medicine, such as color, shape, imprints, etc.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeDrugCharacteristicType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $contraindication
     */
    public function addToContraindication(\TKusy\Hl7Fhir\R4\ReferenceType $contraindication)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeRegulatoryType $regulatory
     */
    public function addToRegulatory(\TKusy\Hl7Fhir\R4\MedicationKnowledgeRegulatoryType $regulatory)
    {
     ...
     * Regulatory information about a medication.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeRegulatoryType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicationKnowledgeKineticsType $kinetics
     */
    public function addToKinetics(\TKusy\Hl7Fhir\R4\MedicationKnowledgeKineticsType $kinetics)
    {
     ...
     * The time course of drug absorption, distribution, metabolism and excretion of a medication from the body.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicationKnowledgeKineticsType[]
     */
