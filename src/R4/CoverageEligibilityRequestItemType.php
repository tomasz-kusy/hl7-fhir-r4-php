...
class CoverageEligibilityRequestItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType[] $supportingInfoSequence
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestDiagnosisType[] $diagnosis
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $supportingInfoSequence
     */
    public function addToSupportingInfoSequence(\TKusy\Hl7Fhir\R4\PositiveIntType $supportingInfoSequence)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestDiagnosisType $diagnosis
     */
    public function addToDiagnosis(\TKusy\Hl7Fhir\R4\CoverageEligibilityRequestDiagnosisType $diagnosis)
    {
     ...
     * Patient diagnosis for which care is sought.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestDiagnosisType[]
     */
     ...
     */
    public function addToDetail(\TKusy\Hl7Fhir\R4\ReferenceType $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
