...
class ExplanationOfBenefitAddItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitDetail1Type[] $detail
     */
    private $detail = null;
     ...
     */
    public function addToItemSequence(\TKusy\Hl7Fhir\R4\PositiveIntType $itemSequence)
    {
     ...
     */
    public function addToDetailSequence(\TKusy\Hl7Fhir\R4\PositiveIntType $detailSequence)
    {
     ...
     */
    public function addToSubDetailSequence(\TKusy\Hl7Fhir\R4\PositiveIntType $subDetailSequence)
    {
     ...
     */
    public function addToProvider(\TKusy\Hl7Fhir\R4\ReferenceType $provider)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitDetail1Type $detail
     */
    public function addToDetail(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitDetail1Type $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
     ...
     * The second-tier service adjudications for payor added services.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitDetail1Type[]
     */
