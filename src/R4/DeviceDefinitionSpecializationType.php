...
class DeviceDefinitionSpecializationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $systemType
     */
     ...
     * The standard that is used to operate and communicate.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $systemType
     * @return self
     */
    public function setSystemType(\TKusy\Hl7Fhir\R4\StringType $systemType)
    {
