...
class CoverageEligibilityRequestType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EligibilityRequestPurposeType[] $purpose
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestSupportingInfoType[] $supportingInfo
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestInsuranceType[] $insurance
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestItemType[] $item
     */
    private $item = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\EligibilityRequestPurposeType $purpose
     */
    public function addToPurpose(\TKusy\Hl7Fhir\R4\EligibilityRequestPurposeType $purpose)
    {
     ...
     * Code to specify whether requesting: prior authorization requirements for some service categories or billing codes; benefits for coverages specified or discovered; discovery and return of coverages for the patient; and/or validation that the specified coverage is in-force at the date/period specified or 'now' if not specified.
     *
     * @return \TKusy\Hl7Fhir\R4\EligibilityRequestPurposeType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestSupportingInfoType $supportingInfo
     */
    public function addToSupportingInfo(\TKusy\Hl7Fhir\R4\CoverageEligibilityRequestSupportingInfoType $supportingInfo)
    {
     ...
     * Additional information codes regarding exceptions, special considerations, the condition, situation, prior or concurrent issues.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestSupportingInfoType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestInsuranceType $insurance
     */
    public function addToInsurance(\TKusy\Hl7Fhir\R4\CoverageEligibilityRequestInsuranceType $insurance)
    {
     ...
     * Financial instruments for reimbursement for the health care products and services.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestInsuranceType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestItemType $item
     */
    public function addToItem(\TKusy\Hl7Fhir\R4\CoverageEligibilityRequestItemType $item)
    {
        $this->item[] = $item;
        return $this;
    }
     ...
     * Service categories or billable services for which benefit details and/or an authorization prior to service delivery may be required by the payor.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageEligibilityRequestItemType[]
     */
