...
class ResearchElementDefinitionCharacteristicType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $studyEffectiveDescription
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $studyEffectiveDateTime
     */
     ...
     * Indicates what effective period the study covers. (choose any one of studyEffective*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType $studyEffectivePeriod
     */
     ...
     * Indicates what effective period the study covers. (choose any one of studyEffective*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $studyEffectiveDuration
     */
     ...
     * Indicates what effective period the study covers. (choose any one of studyEffective*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\TimingType $studyEffectiveTiming
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $studyEffectiveTimeFromStart
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\GroupMeasureType $studyEffectiveGroupMeasure
     */
     ...
     * A narrative description of the time period the study covers.
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $participantEffectiveDescription
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $participantEffectiveTimeFromStart
     */
     ...
     * Indicates how elements are aggregated within the study effective period.
     *
     * @var \TKusy\Hl7Fhir\R4\GroupMeasureType $participantEffectiveGroupMeasure
     */
     ...
     * A narrative description of the time period the study covers.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $studyEffectiveDescription
     * @return self
     */
    public function setStudyEffectiveDescription(\TKusy\Hl7Fhir\R4\StringType $studyEffectiveDescription)
    {
     ...
     * Indicates what effective period the study covers. (choose any one of studyEffective*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $studyEffectiveDateTime
     * @return self
     */
    public function setStudyEffectiveDateTime(\TKusy\Hl7Fhir\R4\DateTimeType $studyEffectiveDateTime)
    {
     ...
     * Indicates what effective period the study covers. (choose any one of studyEffective*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\PeriodType $studyEffectivePeriod
     * @return self
     */
    public function setStudyEffectivePeriod(\TKusy\Hl7Fhir\R4\PeriodType $studyEffectivePeriod)
    {
     ...
     * Indicates what effective period the study covers. (choose any one of studyEffective*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $studyEffectiveDuration
     * @return self
     */
    public function setStudyEffectiveDuration(\TKusy\Hl7Fhir\R4\DurationType $studyEffectiveDuration)
    {
     ...
     * Indicates what effective period the study covers. (choose any one of studyEffective*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\TimingType $studyEffectiveTiming
     * @return self
     */
    public function setStudyEffectiveTiming(\TKusy\Hl7Fhir\R4\TimingType $studyEffectiveTiming)
    {
     ...
     * Indicates duration from the study initiation.
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $studyEffectiveTimeFromStart
     * @return self
     */
    public function setStudyEffectiveTimeFromStart(\TKusy\Hl7Fhir\R4\DurationType $studyEffectiveTimeFromStart)
    {
     ...
     * Indicates how elements are aggregated within the study effective period.
     *
     * @param \TKusy\Hl7Fhir\R4\GroupMeasureType $studyEffectiveGroupMeasure
     * @return self
     */
    public function setStudyEffectiveGroupMeasure(\TKusy\Hl7Fhir\R4\GroupMeasureType $studyEffectiveGroupMeasure)
    {
     ...
     * A narrative description of the time period the study covers.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $participantEffectiveDescription
     * @return self
     */
    public function setParticipantEffectiveDescription(\TKusy\Hl7Fhir\R4\StringType $participantEffectiveDescription)
    {
     ...
     * Indicates duration from the participant's study entry.
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $participantEffectiveTimeFromStart
     * @return self
     */
    public function setParticipantEffectiveTimeFromStart(\TKusy\Hl7Fhir\R4\DurationType $participantEffectiveTimeFromStart)
    {
     ...
     * Indicates how elements are aggregated within the study effective period.
     *
     * @param \TKusy\Hl7Fhir\R4\GroupMeasureType $participantEffectiveGroupMeasure
     * @return self
     */
    public function setParticipantEffectiveGroupMeasure(\TKusy\Hl7Fhir\R4\GroupMeasureType $participantEffectiveGroupMeasure)
    {
