...
class ElementDefinitionTypeType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType $code
     */
    private $code = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AggregationModeType[] $aggregation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceVersionRulesType $versioning
     */
     ...
     * URL of Data type or Resource that is a(or the) type used for this element. References are URLs that are relative to http://hl7.org/fhir/StructureDefinition e.g. "string" is a reference to http://hl7.org/fhir/StructureDefinition/string. Absolute URLs are only allowed in logical models.
     *
     * @param \TKusy\Hl7Fhir\R4\UriType $code
     * @return self
     */
    public function setCode(\TKusy\Hl7Fhir\R4\UriType $code)
    {
        $this->code = $code;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\AggregationModeType $aggregation
     */
    public function addToAggregation(\TKusy\Hl7Fhir\R4\AggregationModeType $aggregation)
    {
     ...
     * If the type is a reference to another resource, how the resource is or can be aggregated - is it a contained resource, or a reference, and if the context is a bundle, is it included in the bundle.
     *
     * @return \TKusy\Hl7Fhir\R4\AggregationModeType[]
     */
     ...
     * Whether this reference needs to be version specific or version independent, or whether either can be used.
     *
     * @return \TKusy\Hl7Fhir\R4\ReferenceVersionRulesType
     */
     ...
     * Whether this reference needs to be version specific or version independent, or whether either can be used.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceVersionRulesType $versioning
     * @return self
     */
    public function setVersioning(\TKusy\Hl7Fhir\R4\ReferenceVersionRulesType $versioning)
    {
