...
class MessageDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType[] $replaces
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType[] $parent
     */
    private $parent = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MessageSignificanceCategoryType $category
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MessageDefinitionFocusType[] $focus
     */
    private $focus = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MessageheaderResponseRequestType $responseRequired
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MessageDefinitionAllowedResponseType[] $allowedResponse
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType[] $graph
     */
    private $graph = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $replaces
     */
    public function addToReplaces(\TKusy\Hl7Fhir\R4\CanonicalType $replaces)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $parent
     */
    public function addToParent(\TKusy\Hl7Fhir\R4\CanonicalType $parent)
    {
        $this->parent[] = $parent;
        return $this;
    }
     ...
     * The impact of the content of the message.
     *
     * @return \TKusy\Hl7Fhir\R4\MessageSignificanceCategoryType
     */
     ...
     * The impact of the content of the message.
     *
     * @param \TKusy\Hl7Fhir\R4\MessageSignificanceCategoryType $category
     * @return self
     */
    public function setCategory(\TKusy\Hl7Fhir\R4\MessageSignificanceCategoryType $category)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MessageDefinitionFocusType $focus
     */
    public function addToFocus(\TKusy\Hl7Fhir\R4\MessageDefinitionFocusType $focus)
    {
        $this->focus[] = $focus;
        return $this;
    }
     ...
     * Identifies the resource (or resources) that are being addressed by the event. For example, the Encounter for an admit message or two Account records for a merge.
     *
     * @return \TKusy\Hl7Fhir\R4\MessageDefinitionFocusType[]
     */
     ...
     * Declare at a message definition level whether a response is required or only upon error or success, or never.
     *
     * @return \TKusy\Hl7Fhir\R4\MessageheaderResponseRequestType
     */
     ...
     * Declare at a message definition level whether a response is required or only upon error or success, or never.
     *
     * @param \TKusy\Hl7Fhir\R4\MessageheaderResponseRequestType $responseRequired
     * @return self
     */
    public function setResponseRequired(\TKusy\Hl7Fhir\R4\MessageheaderResponseRequestType $responseRequired)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MessageDefinitionAllowedResponseType $allowedResponse
     */
    public function addToAllowedResponse(\TKusy\Hl7Fhir\R4\MessageDefinitionAllowedResponseType $allowedResponse)
    {
     ...
     * Indicates what types of messages may be sent as an application-level response to this message.
     *
     * @return \TKusy\Hl7Fhir\R4\MessageDefinitionAllowedResponseType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $graph
     */
    public function addToGraph(\TKusy\Hl7Fhir\R4\CanonicalType $graph)
    {
        $this->graph[] = $graph;
        return $this;
    }
