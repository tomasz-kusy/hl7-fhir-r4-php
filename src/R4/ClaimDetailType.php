...
class ClaimDetailType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ClaimSubDetailType[] $subDetail
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ClaimSubDetailType $subDetail
     */
    public function addToSubDetail(\TKusy\Hl7Fhir\R4\ClaimSubDetailType $subDetail)
    {
     ...
     * A claim detail line. Either a simple (a product or service) or a 'group' of sub-details which are simple items.
     *
     * @return \TKusy\Hl7Fhir\R4\ClaimSubDetailType[]
     */
