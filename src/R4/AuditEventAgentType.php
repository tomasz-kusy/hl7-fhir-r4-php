...
class AuditEventAgentType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $altId
     */
    private $altId = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $requestor
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType $media
     */
    private $media = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AuditEventNetworkType $network
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $purposeOfUse
     */
     ...
     */
    public function addToRole(\TKusy\Hl7Fhir\R4\CodeableConceptType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * Alternative agent Identifier. For a human, this should be a user identifier text string from authentication system. This identifier would be one known to a common authentication system (e.g. single sign-on), if available.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $altId
     * @return self
     */
    public function setAltId(\TKusy\Hl7Fhir\R4\StringType $altId)
    {
        $this->altId = $altId;
        return $this;
    }
     ...
     * Indicator that the user is or is not the requestor, or initiator, for the event being audited.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $requestor
     * @return self
     */
    public function setRequestor(\TKusy\Hl7Fhir\R4\BooleanType $requestor)
    {
     ...
     * Type of media involved. Used when the event is about exporting/importing onto media.
     *
     * @param \TKusy\Hl7Fhir\R4\CodingType $media
     * @return self
     */
    public function setMedia(\TKusy\Hl7Fhir\R4\CodingType $media)
    {
        $this->media = $media;
        return $this;
    }
     ...
     * Logical network location for application activity, if the activity has a network location.
     *
     * @return \TKusy\Hl7Fhir\R4\AuditEventNetworkType
     */
     ...
     * Logical network location for application activity, if the activity has a network location.
     *
     * @param \TKusy\Hl7Fhir\R4\AuditEventNetworkType $network
     * @return self
     */
    public function setNetwork(\TKusy\Hl7Fhir\R4\AuditEventNetworkType $network)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $purposeOfUse
     */
    public function addToPurposeOfUse(\TKusy\Hl7Fhir\R4\CodeableConceptType $purposeOfUse)
    {
