...
class PlanDefinitionGoalType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $start
     */
    private $start = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $addresses
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PlanDefinitionTargetType[] $target
     */
    private $target = null;
     ...
     * The event after which the goal should begin being pursued.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $start
     * @return self
     */
    public function setStart(\TKusy\Hl7Fhir\R4\CodeableConceptType $start)
    {
        $this->start = $start;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $addresses
     */
    public function addToAddresses(\TKusy\Hl7Fhir\R4\CodeableConceptType $addresses)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PlanDefinitionTargetType $target
     */
    public function addToTarget(\TKusy\Hl7Fhir\R4\PlanDefinitionTargetType $target)
    {
        $this->target[] = $target;
        return $this;
    }
     ...
     * Indicates what should be done and within what timeframe.
     *
     * @return \TKusy\Hl7Fhir\R4\PlanDefinitionTargetType[]
     */
