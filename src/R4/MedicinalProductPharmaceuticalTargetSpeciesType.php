...
class MedicinalProductPharmaceuticalTargetSpeciesType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalWithdrawalPeriodType[] $withdrawalPeriod
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalWithdrawalPeriodType $withdrawalPeriod
     */
    public function addToWithdrawalPeriod(\TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalWithdrawalPeriodType $withdrawalPeriod)
    {
     ...
     * A species specific time during which consumption of animal product is not appropriate.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalWithdrawalPeriodType[]
     */
