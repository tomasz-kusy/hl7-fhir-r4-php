...
class MeasureGroupType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasurePopulationType[] $population
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureStratifierType[] $stratifier
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasurePopulationType $population
     */
    public function addToPopulation(\TKusy\Hl7Fhir\R4\MeasurePopulationType $population)
    {
     ...
     * A population criteria for the measure.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasurePopulationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasureStratifierType $stratifier
     */
    public function addToStratifier(\TKusy\Hl7Fhir\R4\MeasureStratifierType $stratifier)
    {
     ...
     * The stratifier criteria for the measure report, specified as either the name of a valid CQL expression defined within a referenced library or a valid FHIR Resource Path.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureStratifierType[]
     */
