...
class SubstanceSpecificationOfficialType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $authority
     */
     ...
     * Which authority uses this official name.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $authority
     * @return self
     */
    public function setAuthority(\TKusy\Hl7Fhir\R4\CodeableConceptType $authority)
    {
