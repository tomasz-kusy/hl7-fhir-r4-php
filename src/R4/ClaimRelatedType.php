...
class ClaimRelatedType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $reference
     */
     ...
     * An alternate organizational reference to the case or file to which this particular claim pertains.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $reference
     * @return self
     */
    public function setReference(\TKusy\Hl7Fhir\R4\IdentifierType $reference)
    {
