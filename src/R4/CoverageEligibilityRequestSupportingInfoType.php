...
class CoverageEligibilityRequestSupportingInfoType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $information
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $appliesToAll
     */
     ...
     * Additional data or information such as resources, documents, images etc. including references to the data or the actual inclusion of the data.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $information
     * @return self
     */
    public function setInformation(\TKusy\Hl7Fhir\R4\ReferenceType $information)
    {
     ...
     * The supporting materials are applicable for all detail items, product/servce categories and specific billing codes.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $appliesToAll
     * @return self
     */
    public function setAppliesToAll(\TKusy\Hl7Fhir\R4\BooleanType $appliesToAll)
    {
