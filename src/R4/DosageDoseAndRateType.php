...
class DosageDoseAndRateType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RangeType $doseRange
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RatioType $rateRatio
     */
     ...
     * Amount of medication per unit of time. (choose any one of rate*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\RangeType $rateRange
     */
     ...
     * Amount of medication per unit of time. (choose any one of rate*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $rateQuantity
     */
     ...
     * Amount of medication per dose. (choose any one of dose*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RangeType $doseRange
     * @return self
     */
    public function setDoseRange(\TKusy\Hl7Fhir\R4\RangeType $doseRange)
    {
     ...
     * Amount of medication per unit of time. (choose any one of rate*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RatioType $rateRatio
     * @return self
     */
    public function setRateRatio(\TKusy\Hl7Fhir\R4\RatioType $rateRatio)
    {
     ...
     * Amount of medication per unit of time. (choose any one of rate*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RangeType $rateRange
     * @return self
     */
    public function setRateRange(\TKusy\Hl7Fhir\R4\RangeType $rateRange)
    {
     ...
     * Amount of medication per unit of time. (choose any one of rate*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $rateQuantity
     * @return self
     */
    public function setRateQuantity(\TKusy\Hl7Fhir\R4\QuantityType $rateQuantity)
    {
