...
class ExpressionType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExpressionLanguageType $language
     */
     ...
     * The media type of the language for the expression.
     *
     * @return \TKusy\Hl7Fhir\R4\ExpressionLanguageType
     */
     ...
     * The media type of the language for the expression.
     *
     * @param \TKusy\Hl7Fhir\R4\ExpressionLanguageType $language
     * @return self
     */
    public function setLanguage(\TKusy\Hl7Fhir\R4\ExpressionLanguageType $language)
    {
