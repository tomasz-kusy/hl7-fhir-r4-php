...
class DeviceSpecializationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $systemType
     */
     ...
     * The standard that is used to operate and communicate.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $systemType
     * @return self
     */
    public function setSystemType(\TKusy\Hl7Fhir\R4\CodeableConceptType $systemType)
    {
