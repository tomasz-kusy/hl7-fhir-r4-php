...
class AuditEventEntityType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $what
     */
    private $what = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType $role
     */
    private $role = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType $lifecycle
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\Base64BinaryType $query
     */
    private $query = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AuditEventDetailType[] $detail
     */
    private $detail = null;
     ...
     * Identifies a specific instance of the entity. The reference should be version specific.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $what
     * @return self
     */
    public function setWhat(\TKusy\Hl7Fhir\R4\ReferenceType $what)
    {
        $this->what = $what;
        return $this;
    }
     ...
     * Code representing the role the entity played in the event being audited.
     *
     * @param \TKusy\Hl7Fhir\R4\CodingType $role
     * @return self
     */
    public function setRole(\TKusy\Hl7Fhir\R4\CodingType $role)
    {
        $this->role = $role;
        return $this;
    }
     ...
     * Identifier for the data life-cycle stage for the entity.
     *
     * @param \TKusy\Hl7Fhir\R4\CodingType $lifecycle
     * @return self
     */
    public function setLifecycle(\TKusy\Hl7Fhir\R4\CodingType $lifecycle)
    {
     ...
     * The query parameters for a query-type entities.
     *
     * @param \TKusy\Hl7Fhir\R4\Base64BinaryType $query
     * @return self
     */
    public function setQuery(\TKusy\Hl7Fhir\R4\Base64BinaryType $query)
    {
        $this->query = $query;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\AuditEventDetailType $detail
     */
    public function addToDetail(\TKusy\Hl7Fhir\R4\AuditEventDetailType $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
     ...
     * Tagged value pairs for conveying additional information about the entity.
     *
     * @return \TKusy\Hl7Fhir\R4\AuditEventDetailType[]
     */
