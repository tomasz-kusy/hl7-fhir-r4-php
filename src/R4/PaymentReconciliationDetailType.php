...
class PaymentReconciliationDetailType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $predecessor
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $submitter
     */
     ...
     * Unique identifier for the prior payment item for the referenced payable.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $predecessor
     * @return self
     */
    public function setPredecessor(\TKusy\Hl7Fhir\R4\IdentifierType $predecessor)
    {
     ...
     * The party which submitted the claim or financial transaction.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $submitter
     * @return self
     */
    public function setSubmitter(\TKusy\Hl7Fhir\R4\ReferenceType $submitter)
    {
