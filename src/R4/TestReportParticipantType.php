...
class TestReportParticipantType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TestReportParticipantTypeType $type
     */
    private $type = null;
     ...
     * The type of participant.
     *
     * @return \TKusy\Hl7Fhir\R4\TestReportParticipantTypeType
     */
     ...
     * The type of participant.
     *
     * @param \TKusy\Hl7Fhir\R4\TestReportParticipantTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\TestReportParticipantTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
