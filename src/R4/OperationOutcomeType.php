...
class OperationOutcomeType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\OperationOutcomeIssueType[] $issue
     */
    private $issue = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\OperationOutcomeIssueType $issue
     */
    public function addToIssue(\TKusy\Hl7Fhir\R4\OperationOutcomeIssueType $issue)
    {
        $this->issue[] = $issue;
        return $this;
    }
     ...
     * An error, warning, or information message that results from a system action.
     *
     * @return \TKusy\Hl7Fhir\R4\OperationOutcomeIssueType[]
     */
