...
class CodeSystemFilterType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\FilterOperatorType[] $operator
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\FilterOperatorType $operator
     */
    public function addToOperator(\TKusy\Hl7Fhir\R4\FilterOperatorType $operator)
    {
