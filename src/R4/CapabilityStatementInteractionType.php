...
class CapabilityStatementInteractionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TypeRestfulInteractionType $code
     */
    private $code = null;
     ...
     * Coded identifier of the operation, supported by the system resource.
     *
     * @return \TKusy\Hl7Fhir\R4\TypeRestfulInteractionType
     */
     ...
     * Coded identifier of the operation, supported by the system resource.
     *
     * @param \TKusy\Hl7Fhir\R4\TypeRestfulInteractionType $code
     * @return self
     */
    public function setCode(\TKusy\Hl7Fhir\R4\TypeRestfulInteractionType $code)
    {
        $this->code = $code;
        return $this;
    }
