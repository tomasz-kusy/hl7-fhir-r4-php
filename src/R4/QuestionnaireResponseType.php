...
class QuestionnaireResponseType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $questionnaire
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuestionnaireResponseStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $authored
     */
     ...
     * The Questionnaire that defines and organizes the questions for which answers are being provided.
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $questionnaire
     * @return self
     */
    public function setQuestionnaire(\TKusy\Hl7Fhir\R4\CanonicalType $questionnaire)
    {
     ...
     * The position of the questionnaire response within its overall lifecycle.
     *
     * @return \TKusy\Hl7Fhir\R4\QuestionnaireResponseStatusType
     */
     ...
     * The position of the questionnaire response within its overall lifecycle.
     *
     * @param \TKusy\Hl7Fhir\R4\QuestionnaireResponseStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\QuestionnaireResponseStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The date and/or time that this set of answers were last changed.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $authored
     * @return self
     */
    public function setAuthored(\TKusy\Hl7Fhir\R4\DateTimeType $authored)
    {
