...
class GraphDefinitionTargetType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\GraphDefinitionCompartmentType[] $compartment
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\GraphDefinitionLinkType[] $link
     */
    private $link = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\GraphDefinitionCompartmentType $compartment
     */
    public function addToCompartment(\TKusy\Hl7Fhir\R4\GraphDefinitionCompartmentType $compartment)
    {
     ...
     * Compartment Consistency Rules.
     *
     * @return \TKusy\Hl7Fhir\R4\GraphDefinitionCompartmentType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\GraphDefinitionLinkType $link
     */
    public function addToLink(\TKusy\Hl7Fhir\R4\GraphDefinitionLinkType $link)
    {
        $this->link[] = $link;
        return $this;
    }
     ...
     * Additional links from target resource.
     *
     * @return \TKusy\Hl7Fhir\R4\GraphDefinitionLinkType[]
     */
