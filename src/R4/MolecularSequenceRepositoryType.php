...
class MolecularSequenceRepositoryType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RepositoryTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $datasetId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $variantsetId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $readsetId
     */
     ...
     * Click and see / RESTful API / Need login to see / RESTful API with authentication / Other ways to see resource.
     *
     * @return \TKusy\Hl7Fhir\R4\RepositoryTypeType
     */
     ...
     * Click and see / RESTful API / Need login to see / RESTful API with authentication / Other ways to see resource.
     *
     * @param \TKusy\Hl7Fhir\R4\RepositoryTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\RepositoryTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     * Id of the variant in this external repository. The server will understand how to use this id to call for more info about datasets in external repository.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $datasetId
     * @return self
     */
    public function setDatasetId(\TKusy\Hl7Fhir\R4\StringType $datasetId)
    {
     ...
     * Id of the variantset in this external repository. The server will understand how to use this id to call for more info about variantsets in external repository.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $variantsetId
     * @return self
     */
    public function setVariantsetId(\TKusy\Hl7Fhir\R4\StringType $variantsetId)
    {
     ...
     * Id of the read in this external repository.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $readsetId
     * @return self
     */
    public function setReadsetId(\TKusy\Hl7Fhir\R4\StringType $readsetId)
    {
