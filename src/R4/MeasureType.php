...
class MeasureType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType[] $library
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarkdownType $disclaimer
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $scoring
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $compositeScoring
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $riskAdjustment
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $rateAggregation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarkdownType $rationale
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarkdownType $clinicalRecommendationStatement
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $improvementNotation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarkdownType[] $definition
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarkdownType $guidance
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureGroupType[] $group
     */
    private $group = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureSupplementalDataType[] $supplementalData
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $library
     */
    public function addToLibrary(\TKusy\Hl7Fhir\R4\CanonicalType $library)
    {
     ...
     * Notices and disclaimers regarding the use of the measure or related to intellectual property (such as code systems) referenced by the measure.
     *
     * @param \TKusy\Hl7Fhir\R4\MarkdownType $disclaimer
     * @return self
     */
    public function setDisclaimer(\TKusy\Hl7Fhir\R4\MarkdownType $disclaimer)
    {
     ...
     * Indicates how the calculation is performed for the measure, including proportion, ratio, continuous-variable, and cohort. The value set is extensible, allowing additional measure scoring types to be represented.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $scoring
     * @return self
     */
    public function setScoring(\TKusy\Hl7Fhir\R4\CodeableConceptType $scoring)
    {
     ...
     * If this is a composite measure, the scoring method used to combine the component measures to determine the composite score.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $compositeScoring
     * @return self
     */
    public function setCompositeScoring(\TKusy\Hl7Fhir\R4\CodeableConceptType $compositeScoring)
    {
     ...
     * A description of the risk adjustment factors that may impact the resulting score for the measure and how they may be accounted for when computing and reporting measure results.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $riskAdjustment
     * @return self
     */
    public function setRiskAdjustment(\TKusy\Hl7Fhir\R4\StringType $riskAdjustment)
    {
     ...
     * Describes how to combine the information calculated, based on logic in each of several populations, into one summarized result.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $rateAggregation
     * @return self
     */
    public function setRateAggregation(\TKusy\Hl7Fhir\R4\StringType $rateAggregation)
    {
     ...
     * Provides a succinct statement of the need for the measure. Usually includes statements pertaining to importance criterion: impact, gap in care, and evidence.
     *
     * @param \TKusy\Hl7Fhir\R4\MarkdownType $rationale
     * @return self
     */
    public function setRationale(\TKusy\Hl7Fhir\R4\MarkdownType $rationale)
    {
     ...
     * Provides a summary of relevant clinical guidelines or other clinical recommendations supporting the measure.
     *
     * @param \TKusy\Hl7Fhir\R4\MarkdownType $clinicalRecommendationStatement
     * @return self
     */
    public function setClinicalRecommendationStatement(\TKusy\Hl7Fhir\R4\MarkdownType $clinicalRecommendationStatement)
    {
     ...
     * Information on whether an increase or decrease in score is the preferred result (e.g., a higher score indicates better quality OR a lower score indicates better quality OR quality is within a range).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $improvementNotation
     * @return self
     */
    public function setImprovementNotation(\TKusy\Hl7Fhir\R4\CodeableConceptType $improvementNotation)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MarkdownType $definition
     */
    public function addToDefinition(\TKusy\Hl7Fhir\R4\MarkdownType $definition)
    {
     ...
     * Additional guidance for the measure including how it can be used in a clinical context, and the intent of the measure.
     *
     * @param \TKusy\Hl7Fhir\R4\MarkdownType $guidance
     * @return self
     */
    public function setGuidance(\TKusy\Hl7Fhir\R4\MarkdownType $guidance)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasureGroupType $group
     */
    public function addToGroup(\TKusy\Hl7Fhir\R4\MeasureGroupType $group)
    {
        $this->group[] = $group;
        return $this;
    }
     ...
     * A group of population criteria for the measure.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureGroupType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasureSupplementalDataType $supplementalData
     */
    public function addToSupplementalData(\TKusy\Hl7Fhir\R4\MeasureSupplementalDataType $supplementalData)
    {
     ...
     * The supplemental data criteria for the measure report, specified as either the name of a valid CQL expression within a referenced library, or a valid FHIR Resource Path.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureSupplementalDataType[]
     */
