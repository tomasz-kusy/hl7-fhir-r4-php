...
class InvoiceType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InvoiceStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $cancelledReason
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InvoiceParticipantType[] $participant
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $issuer
     */
    private $issuer = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InvoiceLineItemType[] $lineItem
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InvoicePriceComponentType[] $totalPriceComponent
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MoneyType $totalNet
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MoneyType $totalGross
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarkdownType $paymentTerms
     */
     ...
     * The current state of the Invoice.
     *
     * @return \TKusy\Hl7Fhir\R4\InvoiceStatusType
     */
     ...
     * The current state of the Invoice.
     *
     * @param \TKusy\Hl7Fhir\R4\InvoiceStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\InvoiceStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * In case of Invoice cancellation a reason must be given (entered in error, superseded by corrected invoice etc.).
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $cancelledReason
     * @return self
     */
    public function setCancelledReason(\TKusy\Hl7Fhir\R4\StringType $cancelledReason)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\InvoiceParticipantType $participant
     */
    public function addToParticipant(\TKusy\Hl7Fhir\R4\InvoiceParticipantType $participant)
    {
     ...
     * Indicates who or what performed or participated in the charged service.
     *
     * @return \TKusy\Hl7Fhir\R4\InvoiceParticipantType[]
     */
     ...
     * The organizationissuing the Invoice.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $issuer
     * @return self
     */
    public function setIssuer(\TKusy\Hl7Fhir\R4\ReferenceType $issuer)
    {
        $this->issuer = $issuer;
        return $this;
    }
     ...
     * @return self
     */
    public function setAccount(\TKusy\Hl7Fhir\R4\ReferenceType $account)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\InvoiceLineItemType $lineItem
     */
    public function addToLineItem(\TKusy\Hl7Fhir\R4\InvoiceLineItemType $lineItem)
    {
     ...
     * Each line item represents one charge for goods and services rendered. Details such as date, code and amount are found in the referenced ChargeItem resource.
     *
     * @return \TKusy\Hl7Fhir\R4\InvoiceLineItemType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\InvoicePriceComponentType $totalPriceComponent
     */
    public function addToTotalPriceComponent(\TKusy\Hl7Fhir\R4\InvoicePriceComponentType $totalPriceComponent)
    {
     ...
     * The total amount for the Invoice may be calculated as the sum of the line items with surcharges/deductions that apply in certain conditions. The priceComponent element can be used to offer transparency to the recipient of the Invoice of how the total price was calculated.
     *
     * @return \TKusy\Hl7Fhir\R4\InvoicePriceComponentType[]
     */
     ...
     * Invoice total , taxes excluded.
     *
     * @param \TKusy\Hl7Fhir\R4\MoneyType $totalNet
     * @return self
     */
    public function setTotalNet(\TKusy\Hl7Fhir\R4\MoneyType $totalNet)
    {
     ...
     * Invoice total, tax included.
     *
     * @param \TKusy\Hl7Fhir\R4\MoneyType $totalGross
     * @return self
     */
    public function setTotalGross(\TKusy\Hl7Fhir\R4\MoneyType $totalGross)
    {
     ...
     * Payment details such as banking details, period of payment, deductibles, methods of payment.
     *
     * @param \TKusy\Hl7Fhir\R4\MarkdownType $paymentTerms
     * @return self
     */
    public function setPaymentTerms(\TKusy\Hl7Fhir\R4\MarkdownType $paymentTerms)
    {
