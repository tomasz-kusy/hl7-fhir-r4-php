...
class CoverageCostToBeneficiaryType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageExceptionType[] $exception
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageExceptionType $exception
     */
    public function addToException(\TKusy\Hl7Fhir\R4\CoverageExceptionType $exception)
    {
     ...
     * A suite of codes indicating exceptions or reductions to patient costs and their effective periods.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageExceptionType[]
     */
