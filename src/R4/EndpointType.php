...
class EndpointType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EndpointStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType $connectionType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $payloadType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeType[] $payloadMimeType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $header
     */
    private $header = null;
     ...
     * active | suspended | error | off | test.
     *
     * @return \TKusy\Hl7Fhir\R4\EndpointStatusType
     */
     ...
     * active | suspended | error | off | test.
     *
     * @param \TKusy\Hl7Fhir\R4\EndpointStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\EndpointStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * A coded value that represents the technical details of the usage of this endpoint, such as what WSDLs should be used in what way. (e.g. XDS.b/DICOM/cds-hook).
     *
     * @param \TKusy\Hl7Fhir\R4\CodingType $connectionType
     * @return self
     */
    public function setConnectionType(\TKusy\Hl7Fhir\R4\CodingType $connectionType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $payloadType
     */
    public function addToPayloadType(\TKusy\Hl7Fhir\R4\CodeableConceptType $payloadType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeType $payloadMimeType
     */
    public function addToPayloadMimeType(\TKusy\Hl7Fhir\R4\CodeType $payloadMimeType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $header
     */
    public function addToHeader(\TKusy\Hl7Fhir\R4\StringType $header)
    {
        $this->header[] = $header;
        return $this;
    }
