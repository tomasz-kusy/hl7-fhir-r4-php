...
class ConceptMapType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType $sourceUri
     */
     ...
     * Identifier for the source value set that contains the concepts that are being mapped and provides context for the mappings. (choose any one of source*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $sourceCanonical
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType $targetUri
     */
     ...
     * The target value set provides context for the mappings. Note that the mapping is made between concepts, not between value sets, but the value set provides important context about how the concept mapping choices are made. (choose any one of target*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $targetCanonical
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ConceptMapGroupType[] $group
     */
    private $group = null;
     ...
     * Identifier for the source value set that contains the concepts that are being mapped and provides context for the mappings. (choose any one of source*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\UriType $sourceUri
     * @return self
     */
    public function setSourceUri(\TKusy\Hl7Fhir\R4\UriType $sourceUri)
    {
     ...
     * Identifier for the source value set that contains the concepts that are being mapped and provides context for the mappings. (choose any one of source*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $sourceCanonical
     * @return self
     */
    public function setSourceCanonical(\TKusy\Hl7Fhir\R4\CanonicalType $sourceCanonical)
    {
     ...
     * The target value set provides context for the mappings. Note that the mapping is made between concepts, not between value sets, but the value set provides important context about how the concept mapping choices are made. (choose any one of target*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\UriType $targetUri
     * @return self
     */
    public function setTargetUri(\TKusy\Hl7Fhir\R4\UriType $targetUri)
    {
     ...
     * The target value set provides context for the mappings. Note that the mapping is made between concepts, not between value sets, but the value set provides important context about how the concept mapping choices are made. (choose any one of target*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $targetCanonical
     * @return self
     */
    public function setTargetCanonical(\TKusy\Hl7Fhir\R4\CanonicalType $targetCanonical)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ConceptMapGroupType $group
     */
    public function addToGroup(\TKusy\Hl7Fhir\R4\ConceptMapGroupType $group)
    {
        $this->group[] = $group;
        return $this;
    }
     ...
     * A group of mappings that all have the same source and target system.
     *
     * @return \TKusy\Hl7Fhir\R4\ConceptMapGroupType[]
     */
