...
class SampledDataType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $origin
     */
    private $origin = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DecimalType $lowerLimit
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DecimalType $upperLimit
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $dimensions
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SampledDataDataTypeType $data
     */
    private $data = null;
     ...
     * The base quantity that a measured value of zero represents. In addition, this provides the units of the entire measurement series.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $origin
     * @return self
     */
    public function setOrigin(\TKusy\Hl7Fhir\R4\QuantityType $origin)
    {
        $this->origin = $origin;
        return $this;
    }
     ...
     * The lower limit of detection of the measured points. This is needed if any of the data points have the value "L" (lower than detection limit).
     *
     * @param \TKusy\Hl7Fhir\R4\DecimalType $lowerLimit
     * @return self
     */
    public function setLowerLimit(\TKusy\Hl7Fhir\R4\DecimalType $lowerLimit)
    {
     ...
     * The upper limit of detection of the measured points. This is needed if any of the data points have the value "U" (higher than detection limit).
     *
     * @param \TKusy\Hl7Fhir\R4\DecimalType $upperLimit
     * @return self
     */
    public function setUpperLimit(\TKusy\Hl7Fhir\R4\DecimalType $upperLimit)
    {
     ...
     * The number of sample points at each time point. If this value is greater than one, then the dimensions will be interlaced - all the sample points for a point in time will be recorded at once.
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $dimensions
     * @return self
     */
    public function setDimensions(\TKusy\Hl7Fhir\R4\PositiveIntType $dimensions)
    {
     ...
     * A series of data points which are decimal values separated by a single space (character u20). The special values "E" (error), "L" (below detection limit) and "U" (above detection limit) can also be used in place of a decimal value.
     *
     * @return \TKusy\Hl7Fhir\R4\SampledDataDataTypeType
     */
     ...
     * A series of data points which are decimal values separated by a single space (character u20). The special values "E" (error), "L" (below detection limit) and "U" (above detection limit) can also be used in place of a decimal value.
     *
     * @param \TKusy\Hl7Fhir\R4\SampledDataDataTypeType $data
     * @return self
     */
    public function setData(\TKusy\Hl7Fhir\R4\SampledDataDataTypeType $data)
    {
        $this->data = $data;
        return $this;
    }
