...
class ScheduleType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType $planningHorizon
     */
     ...
     */
    public function addToActor(\TKusy\Hl7Fhir\R4\ReferenceType $actor)
    {
        $this->actor[] = $actor;
        return $this;
    }
     ...
     * The period of time that the slots that reference this Schedule resource cover (even if none exist). These cover the amount of time that an organization's planning horizon; the interval for which they are currently accepting appointments. This does not define a "template" for planning outside these dates.
     *
     * @param \TKusy\Hl7Fhir\R4\PeriodType $planningHorizon
     * @return self
     */
    public function setPlanningHorizon(\TKusy\Hl7Fhir\R4\PeriodType $planningHorizon)
    {
