...
class SlotType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $schedule
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SlotStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $overbooked
     */
     ...
     * The schedule resource that this slot defines an interval of status information.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $schedule
     * @return self
     */
    public function setSchedule(\TKusy\Hl7Fhir\R4\ReferenceType $schedule)
    {
     ...
     * busy | free | busy-unavailable | busy-tentative | entered-in-error.
     *
     * @return \TKusy\Hl7Fhir\R4\SlotStatusType
     */
     ...
     * busy | free | busy-unavailable | busy-tentative | entered-in-error.
     *
     * @param \TKusy\Hl7Fhir\R4\SlotStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\SlotStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * This slot has already been overbooked, appointments are unlikely to be accepted for this time.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $overbooked
     * @return self
     */
    public function setOverbooked(\TKusy\Hl7Fhir\R4\BooleanType $overbooked)
    {
