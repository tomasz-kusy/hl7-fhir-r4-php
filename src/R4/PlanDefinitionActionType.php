...
class PlanDefinitionActionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $prefix
     */
    private $prefix = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $textEquivalent
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RelatedArtifactType[] $documentation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdType[] $goalId
     */
    private $goalId = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TriggerDefinitionType[] $trigger
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PlanDefinitionConditionType[] $condition
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DataRequirementType[] $input
     */
    private $input = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DataRequirementType[] $output
     */
    private $output = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PlanDefinitionRelatedActionType[] $relatedAction
     */
     ...
     * An optional value describing when the action should be performed. (choose any one of timing*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\AgeType $timingAge
     */
     ...
     * An optional value describing when the action should be performed. (choose any one of timing*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\DurationType $timingDuration
     */
     ...
     * An optional value describing when the action should be performed. (choose any one of timing*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\RangeType $timingRange
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PlanDefinitionParticipantType[] $participant
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ActionGroupingBehaviorType $groupingBehavior
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ActionSelectionBehaviorType $selectionBehavior
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ActionRequiredBehaviorType $requiredBehavior
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ActionPrecheckBehaviorType $precheckBehavior
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ActionCardinalityBehaviorType $cardinalityBehavior
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $transform
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PlanDefinitionDynamicValueType[] $dynamicValue
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PlanDefinitionActionType[] $action
     */
    private $action = null;
     ...
     * A user-visible prefix for the action.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $prefix
     * @return self
     */
    public function setPrefix(\TKusy\Hl7Fhir\R4\StringType $prefix)
    {
        $this->prefix = $prefix;
        return $this;
    }
     ...
     * A text equivalent of the action to be performed. This provides a human-interpretable description of the action when the definition is consumed by a system that might not be capable of interpreting it dynamically.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $textEquivalent
     * @return self
     */
    public function setTextEquivalent(\TKusy\Hl7Fhir\R4\StringType $textEquivalent)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\RelatedArtifactType $documentation
     */
    public function addToDocumentation(\TKusy\Hl7Fhir\R4\RelatedArtifactType $documentation)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\IdType $goalId
     */
    public function addToGoalId(\TKusy\Hl7Fhir\R4\IdType $goalId)
    {
        $this->goalId[] = $goalId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\TriggerDefinitionType $trigger
     */
    public function addToTrigger(\TKusy\Hl7Fhir\R4\TriggerDefinitionType $trigger)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PlanDefinitionConditionType $condition
     */
    public function addToCondition(\TKusy\Hl7Fhir\R4\PlanDefinitionConditionType $condition)
    {
     ...
     * An expression that describes applicability criteria or start/stop conditions for the action.
     *
     * @return \TKusy\Hl7Fhir\R4\PlanDefinitionConditionType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DataRequirementType $input
     */
    public function addToInput(\TKusy\Hl7Fhir\R4\DataRequirementType $input)
    {
        $this->input[] = $input;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DataRequirementType $output
     */
    public function addToOutput(\TKusy\Hl7Fhir\R4\DataRequirementType $output)
    {
        $this->output[] = $output;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PlanDefinitionRelatedActionType $relatedAction
     */
    public function addToRelatedAction(\TKusy\Hl7Fhir\R4\PlanDefinitionRelatedActionType $relatedAction)
    {
     ...
     * A relationship to another action such as "before" or "30-60 minutes after start of".
     *
     * @return \TKusy\Hl7Fhir\R4\PlanDefinitionRelatedActionType[]
     */
     ...
     * An optional value describing when the action should be performed. (choose any one of timing*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\AgeType $timingAge
     * @return self
     */
    public function setTimingAge(\TKusy\Hl7Fhir\R4\AgeType $timingAge)
    {
     ...
     * An optional value describing when the action should be performed. (choose any one of timing*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DurationType $timingDuration
     * @return self
     */
    public function setTimingDuration(\TKusy\Hl7Fhir\R4\DurationType $timingDuration)
    {
     ...
     * An optional value describing when the action should be performed. (choose any one of timing*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RangeType $timingRange
     * @return self
     */
    public function setTimingRange(\TKusy\Hl7Fhir\R4\RangeType $timingRange)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PlanDefinitionParticipantType $participant
     */
    public function addToParticipant(\TKusy\Hl7Fhir\R4\PlanDefinitionParticipantType $participant)
    {
     ...
     * Indicates who should participate in performing the action described.
     *
     * @return \TKusy\Hl7Fhir\R4\PlanDefinitionParticipantType[]
     */
     ...
     * Defines the grouping behavior for the action and its children.
     *
     * @return \TKusy\Hl7Fhir\R4\ActionGroupingBehaviorType
     */
     ...
     * Defines the grouping behavior for the action and its children.
     *
     * @param \TKusy\Hl7Fhir\R4\ActionGroupingBehaviorType $groupingBehavior
     * @return self
     */
    public function setGroupingBehavior(\TKusy\Hl7Fhir\R4\ActionGroupingBehaviorType $groupingBehavior)
    {
     ...
     * Defines the selection behavior for the action and its children.
     *
     * @return \TKusy\Hl7Fhir\R4\ActionSelectionBehaviorType
     */
     ...
     * Defines the selection behavior for the action and its children.
     *
     * @param \TKusy\Hl7Fhir\R4\ActionSelectionBehaviorType $selectionBehavior
     * @return self
     */
    public function setSelectionBehavior(\TKusy\Hl7Fhir\R4\ActionSelectionBehaviorType $selectionBehavior)
    {
     ...
     * Defines the required behavior for the action.
     *
     * @return \TKusy\Hl7Fhir\R4\ActionRequiredBehaviorType
     */
     ...
     * Defines the required behavior for the action.
     *
     * @param \TKusy\Hl7Fhir\R4\ActionRequiredBehaviorType $requiredBehavior
     * @return self
     */
    public function setRequiredBehavior(\TKusy\Hl7Fhir\R4\ActionRequiredBehaviorType $requiredBehavior)
    {
     ...
     * Defines whether the action should usually be preselected.
     *
     * @return \TKusy\Hl7Fhir\R4\ActionPrecheckBehaviorType
     */
     ...
     * Defines whether the action should usually be preselected.
     *
     * @param \TKusy\Hl7Fhir\R4\ActionPrecheckBehaviorType $precheckBehavior
     * @return self
     */
    public function setPrecheckBehavior(\TKusy\Hl7Fhir\R4\ActionPrecheckBehaviorType $precheckBehavior)
    {
     ...
     * Defines whether the action can be selected multiple times.
     *
     * @return \TKusy\Hl7Fhir\R4\ActionCardinalityBehaviorType
     */
     ...
     * Defines whether the action can be selected multiple times.
     *
     * @param \TKusy\Hl7Fhir\R4\ActionCardinalityBehaviorType $cardinalityBehavior
     * @return self
     */
    public function setCardinalityBehavior(\TKusy\Hl7Fhir\R4\ActionCardinalityBehaviorType $cardinalityBehavior)
    {
     ...
     * @return self
     */
    public function setDefinitionUri(\TKusy\Hl7Fhir\R4\UriType $definitionUri)
    {
     ...
     * A reference to a StructureMap resource that defines a transform that can be executed to produce the intent resource using the ActivityDefinition instance as the input.
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $transform
     * @return self
     */
    public function setTransform(\TKusy\Hl7Fhir\R4\CanonicalType $transform)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PlanDefinitionDynamicValueType $dynamicValue
     */
    public function addToDynamicValue(\TKusy\Hl7Fhir\R4\PlanDefinitionDynamicValueType $dynamicValue)
    {
     ...
     * Customizations that should be applied to the statically defined resource. For example, if the dosage of a medication must be computed based on the patient's weight, a customization would be used to specify an expression that calculated the weight, and the path on the resource that would contain the result.
     *
     * @return \TKusy\Hl7Fhir\R4\PlanDefinitionDynamicValueType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PlanDefinitionActionType $action
     */
    public function addToAction(\TKusy\Hl7Fhir\R4\PlanDefinitionActionType $action)
    {
        $this->action[] = $action;
        return $this;
    }
     ...
     * Sub actions that are contained within the action. The behavior of this action determines the functionality of the sub-actions. For example, a selection behavior of at-most-one indicates that of the sub-actions, at most one may be chosen as part of realizing the action definition.
     *
     * @return \TKusy\Hl7Fhir\R4\PlanDefinitionActionType[]
     */
