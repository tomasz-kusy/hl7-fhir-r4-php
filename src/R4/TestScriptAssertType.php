...
class TestScriptAssertType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AssertionDirectionTypeType $direction
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $compareToSourceId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $compareToSourceExpression
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $compareToSourcePath
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $minimumId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $navigationLinks
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AssertionOperatorTypeType $operator
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TestScriptRequestMethodCodeType $requestMethod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $requestURL
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AssertionResponseTypesType $response
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $responseCode
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdType $validateProfileId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $warningOnly
     */
     ...
     * The direction to use for the assertion.
     *
     * @return \TKusy\Hl7Fhir\R4\AssertionDirectionTypeType
     */
     ...
     * The direction to use for the assertion.
     *
     * @param \TKusy\Hl7Fhir\R4\AssertionDirectionTypeType $direction
     * @return self
     */
    public function setDirection(\TKusy\Hl7Fhir\R4\AssertionDirectionTypeType $direction)
    {
     ...
     * Id of the source fixture used as the contents to be evaluated by either the "source/expression" or "sourceId/path" definition.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $compareToSourceId
     * @return self
     */
    public function setCompareToSourceId(\TKusy\Hl7Fhir\R4\StringType $compareToSourceId)
    {
     ...
     * The FHIRPath expression to evaluate against the source fixture. When compareToSourceId is defined, either compareToSourceExpression or compareToSourcePath must be defined, but not both.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $compareToSourceExpression
     * @return self
     */
    public function setCompareToSourceExpression(\TKusy\Hl7Fhir\R4\StringType $compareToSourceExpression)
    {
     ...
     * XPath or JSONPath expression to evaluate against the source fixture. When compareToSourceId is defined, either compareToSourceExpression or compareToSourcePath must be defined, but not both.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $compareToSourcePath
     * @return self
     */
    public function setCompareToSourcePath(\TKusy\Hl7Fhir\R4\StringType $compareToSourcePath)
    {
     ...
     * The ID of a fixture. Asserts that the response contains at a minimum the fixture specified by minimumId.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $minimumId
     * @return self
     */
    public function setMinimumId(\TKusy\Hl7Fhir\R4\StringType $minimumId)
    {
     ...
     * Whether or not the test execution performs validation on the bundle navigation links.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $navigationLinks
     * @return self
     */
    public function setNavigationLinks(\TKusy\Hl7Fhir\R4\BooleanType $navigationLinks)
    {
     ...
     * The operator type defines the conditional behavior of the assert. If not defined, the default is equals.
     *
     * @return \TKusy\Hl7Fhir\R4\AssertionOperatorTypeType
     */
     ...
     * The operator type defines the conditional behavior of the assert. If not defined, the default is equals.
     *
     * @param \TKusy\Hl7Fhir\R4\AssertionOperatorTypeType $operator
     * @return self
     */
    public function setOperator(\TKusy\Hl7Fhir\R4\AssertionOperatorTypeType $operator)
    {
     ...
     * The request method or HTTP operation code to compare against that used by the client system under test.
     *
     * @param \TKusy\Hl7Fhir\R4\TestScriptRequestMethodCodeType $requestMethod
     * @return self
     */
    public function setRequestMethod(\TKusy\Hl7Fhir\R4\TestScriptRequestMethodCodeType $requestMethod)
    {
     ...
     * The value to use in a comparison against the request URL path string.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $requestURL
     * @return self
     */
    public function setRequestURL(\TKusy\Hl7Fhir\R4\StringType $requestURL)
    {
     ...
     * okay | created | noContent | notModified | bad | forbidden | notFound | methodNotAllowed | conflict | gone | preconditionFailed | unprocessable.
     *
     * @return \TKusy\Hl7Fhir\R4\AssertionResponseTypesType
     */
     ...
     * okay | created | noContent | notModified | bad | forbidden | notFound | methodNotAllowed | conflict | gone | preconditionFailed | unprocessable.
     *
     * @param \TKusy\Hl7Fhir\R4\AssertionResponseTypesType $response
     * @return self
     */
    public function setResponse(\TKusy\Hl7Fhir\R4\AssertionResponseTypesType $response)
    {
     ...
     * The value of the HTTP response code to be tested.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $responseCode
     * @return self
     */
    public function setResponseCode(\TKusy\Hl7Fhir\R4\StringType $responseCode)
    {
     ...
     * The ID of the Profile to validate against.
     *
     * @param \TKusy\Hl7Fhir\R4\IdType $validateProfileId
     * @return self
     */
    public function setValidateProfileId(\TKusy\Hl7Fhir\R4\IdType $validateProfileId)
    {
     ...
     * Whether or not the test execution will produce a warning only on error for this assert.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $warningOnly
     * @return self
     */
    public function setWarningOnly(\TKusy\Hl7Fhir\R4\BooleanType $warningOnly)
    {
