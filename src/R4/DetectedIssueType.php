...
class DetectedIssueType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DetectedIssueSeverityType $severity
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $identifiedDateTime
     */
     ...
     * The date or period when the detected issue was initially identified. (choose any one of identified*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType $identifiedPeriod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $implicated
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DetectedIssueEvidenceType[] $evidence
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $detail
     */
    private $detail = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DetectedIssueMitigationType[] $mitigation
     */
     ...
     * Indicates the degree of importance associated with the identified issue based on the potential impact on the patient.
     *
     * @return \TKusy\Hl7Fhir\R4\DetectedIssueSeverityType
     */
     ...
     * Indicates the degree of importance associated with the identified issue based on the potential impact on the patient.
     *
     * @param \TKusy\Hl7Fhir\R4\DetectedIssueSeverityType $severity
     * @return self
     */
    public function setSeverity(\TKusy\Hl7Fhir\R4\DetectedIssueSeverityType $severity)
    {
     ...
     * The date or period when the detected issue was initially identified. (choose any one of identified*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $identifiedDateTime
     * @return self
     */
    public function setIdentifiedDateTime(\TKusy\Hl7Fhir\R4\DateTimeType $identifiedDateTime)
    {
     ...
     * The date or period when the detected issue was initially identified. (choose any one of identified*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\PeriodType $identifiedPeriod
     * @return self
     */
    public function setIdentifiedPeriod(\TKusy\Hl7Fhir\R4\PeriodType $identifiedPeriod)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $implicated
     */
    public function addToImplicated(\TKusy\Hl7Fhir\R4\ReferenceType $implicated)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DetectedIssueEvidenceType $evidence
     */
    public function addToEvidence(\TKusy\Hl7Fhir\R4\DetectedIssueEvidenceType $evidence)
    {
     ...
     * Supporting evidence or manifestations that provide the basis for identifying the detected issue such as a GuidanceResponse or MeasureReport.
     *
     * @return \TKusy\Hl7Fhir\R4\DetectedIssueEvidenceType[]
     */
     ...
     * A textual explanation of the detected issue.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $detail
     * @return self
     */
    public function setDetail(\TKusy\Hl7Fhir\R4\StringType $detail)
    {
        $this->detail = $detail;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DetectedIssueMitigationType $mitigation
     */
    public function addToMitigation(\TKusy\Hl7Fhir\R4\DetectedIssueMitigationType $mitigation)
    {
     ...
     * Indicates an action that has been taken or is committed to reduce or eliminate the likelihood of the risk identified by the detected issue from manifesting. Can also reflect an observation of known mitigating factors that may reduce/eliminate the need for any action.
     *
     * @return \TKusy\Hl7Fhir\R4\DetectedIssueMitigationType[]
     */
