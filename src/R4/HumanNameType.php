...
class HumanNameType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\NameUseType $use
     */
    private $use = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $family
     */
    private $family = null;
     ...
     * Given name.
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $given
     */
    private $given = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $suffix
     */
    private $suffix = null;
     ...
     * Identifies the purpose for this name.
     *
     * @return \TKusy\Hl7Fhir\R4\NameUseType
     */
     ...
     * Identifies the purpose for this name.
     *
     * @param \TKusy\Hl7Fhir\R4\NameUseType $use
     * @return self
     */
    public function setUse(\TKusy\Hl7Fhir\R4\NameUseType $use)
    {
        $this->use = $use;
        return $this;
    }
     ...
     * The part of a name that links to the genealogy. In some cultures (e.g. Eritrea) the family name of a son is the first name of his father.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $family
     * @return self
     */
    public function setFamily(\TKusy\Hl7Fhir\R4\StringType $family)
    {
        $this->family = $family;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $given
     */
    public function addToGiven(\TKusy\Hl7Fhir\R4\StringType $given)
    {
        $this->given[] = $given;
        return $this;
    }
     ...
     */
    public function addToPrefix(\TKusy\Hl7Fhir\R4\StringType $prefix)
    {
        $this->prefix[] = $prefix;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $suffix
     */
    public function addToSuffix(\TKusy\Hl7Fhir\R4\StringType $suffix)
    {
        $this->suffix[] = $suffix;
        return $this;
    }
