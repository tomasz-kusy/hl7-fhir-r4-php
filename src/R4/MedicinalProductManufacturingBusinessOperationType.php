...
class MedicinalProductManufacturingBusinessOperationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $operationType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $authorisationReferenceNumber
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $effectiveDate
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $confidentialityIndicator
     */
     ...
     * The type of manufacturing operation.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $operationType
     * @return self
     */
    public function setOperationType(\TKusy\Hl7Fhir\R4\CodeableConceptType $operationType)
    {
     ...
     * Regulatory authorization reference number.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $authorisationReferenceNumber
     * @return self
     */
    public function setAuthorisationReferenceNumber(\TKusy\Hl7Fhir\R4\IdentifierType $authorisationReferenceNumber)
    {
     ...
     * Regulatory authorization date.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $effectiveDate
     * @return self
     */
    public function setEffectiveDate(\TKusy\Hl7Fhir\R4\DateTimeType $effectiveDate)
    {
     ...
     * To indicate if this proces is commercially confidential.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $confidentialityIndicator
     * @return self
     */
    public function setConfidentialityIndicator(\TKusy\Hl7Fhir\R4\CodeableConceptType $confidentialityIndicator)
    {
