...
class ListEntryType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $flag
     */
    private $flag = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $deleted
     */
     ...
     * The flag allows the system constructing the list to indicate the role and significance of the item in the list.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $flag
     * @return self
     */
    public function setFlag(\TKusy\Hl7Fhir\R4\CodeableConceptType $flag)
    {
        $this->flag = $flag;
        return $this;
    }
     ...
     * True if this item is marked as deleted in the list.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $deleted
     * @return self
     */
    public function setDeleted(\TKusy\Hl7Fhir\R4\BooleanType $deleted)
    {
