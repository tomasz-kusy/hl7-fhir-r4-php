...
class MedicinalProductInteractionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductInteractionInteractantType[] $interactant
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $effect
     */
    private $effect = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $incidence
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $management
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductInteractionInteractantType $interactant
     */
    public function addToInteractant(\TKusy\Hl7Fhir\R4\MedicinalProductInteractionInteractantType $interactant)
    {
     ...
     * The specific medication, food or laboratory test that interacts.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductInteractionInteractantType[]
     */
     ...
     * The effect of the interaction, for example "reduced gastric absorption of primary medication".
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $effect
     * @return self
     */
    public function setEffect(\TKusy\Hl7Fhir\R4\CodeableConceptType $effect)
    {
        $this->effect = $effect;
        return $this;
    }
     ...
     * The incidence of the interaction, e.g. theoretical, observed.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $incidence
     * @return self
     */
    public function setIncidence(\TKusy\Hl7Fhir\R4\CodeableConceptType $incidence)
    {
     ...
     * Actions for managing the interaction.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $management
     * @return self
     */
    public function setManagement(\TKusy\Hl7Fhir\R4\CodeableConceptType $management)
    {
