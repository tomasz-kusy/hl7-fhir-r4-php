...
class EffectEvidenceSynthesisResultsByExposureType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExposureStateType $exposureState
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $riskEvidenceSynthesis
     */
     ...
     * Whether these results are for the exposure state or alternative exposure state.
     *
     * @return \TKusy\Hl7Fhir\R4\ExposureStateType
     */
     ...
     * Whether these results are for the exposure state or alternative exposure state.
     *
     * @param \TKusy\Hl7Fhir\R4\ExposureStateType $exposureState
     * @return self
     */
    public function setExposureState(\TKusy\Hl7Fhir\R4\ExposureStateType $exposureState)
    {
     ...
     * Reference to a RiskEvidenceSynthesis resource.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $riskEvidenceSynthesis
     * @return self
     */
    public function setRiskEvidenceSynthesis(\TKusy\Hl7Fhir\R4\ReferenceType $riskEvidenceSynthesis)
    {
