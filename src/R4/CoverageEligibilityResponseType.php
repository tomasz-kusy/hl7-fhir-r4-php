...
class CoverageEligibilityResponseType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\EligibilityResponsePurposeType[] $purpose
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\RemittanceOutcomeType $outcome
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseInsuranceType[] $insurance
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $form
     */
    private $form = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseErrorType[] $error
     */
    private $error = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\EligibilityResponsePurposeType $purpose
     */
    public function addToPurpose(\TKusy\Hl7Fhir\R4\EligibilityResponsePurposeType $purpose)
    {
     ...
     * Code to specify whether requesting: prior authorization requirements for some service categories or billing codes; benefits for coverages specified or discovered; discovery and return of coverages for the patient; and/or validation that the specified coverage is in-force at the date/period specified or 'now' if not specified.
     *
     * @return \TKusy\Hl7Fhir\R4\EligibilityResponsePurposeType[]
     */
     ...
     * The outcome of the request processing.
     *
     * @return \TKusy\Hl7Fhir\R4\RemittanceOutcomeType
     */
     ...
     * The outcome of the request processing.
     *
     * @param \TKusy\Hl7Fhir\R4\RemittanceOutcomeType $outcome
     * @return self
     */
    public function setOutcome(\TKusy\Hl7Fhir\R4\RemittanceOutcomeType $outcome)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseInsuranceType $insurance
     */
    public function addToInsurance(\TKusy\Hl7Fhir\R4\CoverageEligibilityResponseInsuranceType $insurance)
    {
     ...
     * Financial instruments for reimbursement for the health care products and services.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseInsuranceType[]
     */
     ...
     * A code for the form to be used for printing the content.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $form
     * @return self
     */
    public function setForm(\TKusy\Hl7Fhir\R4\CodeableConceptType $form)
    {
        $this->form = $form;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseErrorType $error
     */
    public function addToError(\TKusy\Hl7Fhir\R4\CoverageEligibilityResponseErrorType $error)
    {
        $this->error[] = $error;
        return $this;
    }
     ...
     * Errors encountered during the processing of the request.
     *
     * @return \TKusy\Hl7Fhir\R4\CoverageEligibilityResponseErrorType[]
     */
