...
class StructureDefinitionContextType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExtensionContextTypeType $type
     */
    private $type = null;
     ...
     * Defines how to interpret the expression that defines what the context of the extension is.
     *
     * @return \TKusy\Hl7Fhir\R4\ExtensionContextTypeType
     */
     ...
     * Defines how to interpret the expression that defines what the context of the extension is.
     *
     * @param \TKusy\Hl7Fhir\R4\ExtensionContextTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\ExtensionContextTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
