...
class GuidanceResponseType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $requestIdentifier
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType $moduleUri
     */
     ...
     * An identifier, CodeableConcept or canonical reference to the guidance that was requested. (choose any one of module*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType $moduleCanonical
     */
     ...
     * An identifier, CodeableConcept or canonical reference to the guidance that was requested. (choose any one of module*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $moduleCodeableConcept
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\GuidanceResponseStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $evaluationMessage
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $outputParameters
     */
     ...
     * The identifier of the request associated with this response. If an identifier was given as part of the request, it will be reproduced here to enable the requester to more easily identify the response in a multi-request scenario.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $requestIdentifier
     * @return self
     */
    public function setRequestIdentifier(\TKusy\Hl7Fhir\R4\IdentifierType $requestIdentifier)
    {
     ...
     * An identifier, CodeableConcept or canonical reference to the guidance that was requested. (choose any one of module*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\UriType $moduleUri
     * @return self
     */
    public function setModuleUri(\TKusy\Hl7Fhir\R4\UriType $moduleUri)
    {
     ...
     * An identifier, CodeableConcept or canonical reference to the guidance that was requested. (choose any one of module*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $moduleCanonical
     * @return self
     */
    public function setModuleCanonical(\TKusy\Hl7Fhir\R4\CanonicalType $moduleCanonical)
    {
     ...
     * An identifier, CodeableConcept or canonical reference to the guidance that was requested. (choose any one of module*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $moduleCodeableConcept
     * @return self
     */
    public function setModuleCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $moduleCodeableConcept)
    {
     ...
     * The status of the response. If the evaluation is completed successfully, the status will indicate success. However, in order to complete the evaluation, the engine may require more information. In this case, the status will be data-required, and the response will contain a description of the additional required information. If the evaluation completed successfully, but the engine determines that a potentially more accurate response could be provided if more data was available, the status will be data-requested, and the response will contain a description of the additional requested information.
     *
     * @return \TKusy\Hl7Fhir\R4\GuidanceResponseStatusType
     */
     ...
     * The status of the response. If the evaluation is completed successfully, the status will indicate success. However, in order to complete the evaluation, the engine may require more information. In this case, the status will be data-required, and the response will contain a description of the additional required information. If the evaluation completed successfully, but the engine determines that a potentially more accurate response could be provided if more data was available, the status will be data-requested, and the response will contain a description of the additional requested information.
     *
     * @param \TKusy\Hl7Fhir\R4\GuidanceResponseStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\GuidanceResponseStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $evaluationMessage
     */
    public function addToEvaluationMessage(\TKusy\Hl7Fhir\R4\ReferenceType $evaluationMessage)
    {
     ...
     * The output parameters of the evaluation, if any. Many modules will result in the return of specific resources such as procedure or communication requests that are returned as part of the operation result. However, modules may define specific outputs that would be returned as the result of the evaluation, and these would be returned in this element.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $outputParameters
     * @return self
     */
    public function setOutputParameters(\TKusy\Hl7Fhir\R4\ReferenceType $outputParameters)
    {
     ...
     * @return self
     */
    public function setResult(\TKusy\Hl7Fhir\R4\ReferenceType $result)
    {
        $this->result = $result;
        return $this;
    }
