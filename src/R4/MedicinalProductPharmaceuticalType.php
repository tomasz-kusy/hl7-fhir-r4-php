...
class MedicinalProductPharmaceuticalType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $administrableDoseForm
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalCharacteristicsType[] $characteristics
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalRouteOfAdministrationType[] $routeOfAdministration
     */
     ...
     * The administrable dose form, after necessary reconstitution.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $administrableDoseForm
     * @return self
     */
    public function setAdministrableDoseForm(\TKusy\Hl7Fhir\R4\CodeableConceptType $administrableDoseForm)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalCharacteristicsType $characteristics
     */
    public function addToCharacteristics(\TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalCharacteristicsType $characteristics)
    {
     ...
     * Characteristics e.g. a products onset of action.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalCharacteristicsType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalRouteOfAdministrationType $routeOfAdministration
     */
    public function addToRouteOfAdministration(\TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalRouteOfAdministrationType $routeOfAdministration)
    {
     ...
     * The path by which the pharmaceutical product is taken into or makes contact with the body.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductPharmaceuticalRouteOfAdministrationType[]
     */
