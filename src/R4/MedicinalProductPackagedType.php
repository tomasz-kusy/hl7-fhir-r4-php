...
class MedicinalProductPackagedType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $marketingAuthorization
     */
     ...
     * Batch numbering.
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductPackagedBatchIdentifierType[] $batchIdentifier
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductPackagedPackageItemType[] $packageItem
     */
     ...
     * Manufacturer of this Package Item.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $marketingAuthorization
     * @return self
     */
    public function setMarketingAuthorization(\TKusy\Hl7Fhir\R4\ReferenceType $marketingAuthorization)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductPackagedBatchIdentifierType $batchIdentifier
     */
    public function addToBatchIdentifier(\TKusy\Hl7Fhir\R4\MedicinalProductPackagedBatchIdentifierType $batchIdentifier)
    {
     ...
     * Batch numbering.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductPackagedBatchIdentifierType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductPackagedPackageItemType $packageItem
     */
    public function addToPackageItem(\TKusy\Hl7Fhir\R4\MedicinalProductPackagedPackageItemType $packageItem)
    {
     ...
     * A packaging item, as a contained for medicine, possibly with other packaging items within.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductPackagedPackageItemType[]
     */
