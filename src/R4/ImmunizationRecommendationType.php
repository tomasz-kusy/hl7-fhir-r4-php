...
class ImmunizationRecommendationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ImmunizationRecommendationRecommendationType[] $recommendation
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ImmunizationRecommendationRecommendationType $recommendation
     */
    public function addToRecommendation(\TKusy\Hl7Fhir\R4\ImmunizationRecommendationRecommendationType $recommendation)
    {
     ...
     * Vaccine administration recommendations.
     *
     * @return \TKusy\Hl7Fhir\R4\ImmunizationRecommendationRecommendationType[]
     */
