...
class ImplementationGuideResource1Type extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UrlType $relativePath
     */
     ...
     * The relative path for primary page for this resource within the IG.
     *
     * @param \TKusy\Hl7Fhir\R4\UrlType $relativePath
     * @return self
     */
    public function setRelativePath(\TKusy\Hl7Fhir\R4\UrlType $relativePath)
    {
