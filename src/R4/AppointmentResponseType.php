...
class AppointmentResponseType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $participantType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ParticipationStatusType $participantStatus
     */
     ...
     * @return self
     */
    public function setAppointment(\TKusy\Hl7Fhir\R4\ReferenceType $appointment)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $participantType
     */
    public function addToParticipantType(\TKusy\Hl7Fhir\R4\CodeableConceptType $participantType)
    {
     ...
     * Participation status of the participant. When the status is declined or tentative if the start/end times are different to the appointment, then these times should be interpreted as a requested time change. When the status is accepted, the times can either be the time of the appointment (as a confirmation of the time) or can be empty.
     *
     * @return \TKusy\Hl7Fhir\R4\ParticipationStatusType
     */
     ...
     * Participation status of the participant. When the status is declined or tentative if the start/end times are different to the appointment, then these times should be interpreted as a requested time change. When the status is accepted, the times can either be the time of the appointment (as a confirmation of the time) or can be empty.
     *
     * @param \TKusy\Hl7Fhir\R4\ParticipationStatusType $participantStatus
     * @return self
     */
    public function setParticipantStatus(\TKusy\Hl7Fhir\R4\ParticipationStatusType $participantStatus)
    {
