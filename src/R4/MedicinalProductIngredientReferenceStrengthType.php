...
class MedicinalProductIngredientReferenceStrengthType extends BackboneElementType
{
     ...
     * Strength expressed in terms of a reference substance.
     *
     * @var \TKusy\Hl7Fhir\R4\RatioType $strengthLowLimit
     */
     ...
     * Strength expressed in terms of a reference substance.
     *
     * @param \TKusy\Hl7Fhir\R4\RatioType $strengthLowLimit
     * @return self
     */
    public function setStrengthLowLimit(\TKusy\Hl7Fhir\R4\RatioType $strengthLowLimit)
    {
