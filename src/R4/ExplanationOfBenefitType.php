...
class ExplanationOfBenefitType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $fundsReserveRequested
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitRelatedType[] $related
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitPayeeType $payee
     */
    private $payee = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $claim
     */
    private $claim = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType[] $preAuthRefPeriod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitCareTeamType[] $careTeam
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitSupportingInfoType[] $supportingInfo
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitDiagnosisType[] $diagnosis
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitProcedureType[] $procedure
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $precedence
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitInsuranceType[] $insurance
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAccidentType $accident
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitItemType[] $item
     */
    private $item = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAddItemType[] $addItem
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAdjudicationType[] $adjudication
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitTotalType[] $total
     */
    private $total = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitPaymentType $payment
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitProcessNoteType[] $processNote
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType $benefitPeriod
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitBenefitBalanceType[] $benefitBalance
     */
     ...
     * The status of the resource instance.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitStatusType
     */
     ...
     * The status of the resource instance.
     *
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * A code to indicate whether and for whom funds are to be reserved for future claims.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $fundsReserveRequested
     * @return self
     */
    public function setFundsReserveRequested(\TKusy\Hl7Fhir\R4\CodeableConceptType $fundsReserveRequested)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitRelatedType $related
     */
    public function addToRelated(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitRelatedType $related)
    {
     ...
     * Other claims which are related to this claim such as prior submissions or claims for related services or for the same event.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitRelatedType[]
     */
     ...
     * The party to be reimbursed for cost of the products and services according to the terms of the policy.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitPayeeType
     */
     ...
     * The party to be reimbursed for cost of the products and services according to the terms of the policy.
     *
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitPayeeType $payee
     * @return self
     */
    public function setPayee(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitPayeeType $payee)
    {
        $this->payee = $payee;
        return $this;
    }
     ...
     * The business identifier for the instance of the adjudication request: claim predetermination or preauthorization.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $claim
     * @return self
     */
    public function setClaim(\TKusy\Hl7Fhir\R4\ReferenceType $claim)
    {
        $this->claim = $claim;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PeriodType $preAuthRefPeriod
     */
    public function addToPreAuthRefPeriod(\TKusy\Hl7Fhir\R4\PeriodType $preAuthRefPeriod)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitCareTeamType $careTeam
     */
    public function addToCareTeam(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitCareTeamType $careTeam)
    {
     ...
     * The members of the team who provided the products and services.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitCareTeamType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitSupportingInfoType $supportingInfo
     */
    public function addToSupportingInfo(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitSupportingInfoType $supportingInfo)
    {
     ...
     * Additional information codes regarding exceptions, special considerations, the condition, situation, prior or concurrent issues.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitSupportingInfoType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitDiagnosisType $diagnosis
     */
    public function addToDiagnosis(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitDiagnosisType $diagnosis)
    {
     ...
     * Information about diagnoses relevant to the claim items.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitDiagnosisType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitProcedureType $procedure
     */
    public function addToProcedure(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitProcedureType $procedure)
    {
     ...
     * Procedures performed on the patient relevant to the billing items with the claim.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitProcedureType[]
     */
     ...
     * This indicates the relative order of a series of EOBs related to different coverages for the same suite of services.
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $precedence
     * @return self
     */
    public function setPrecedence(\TKusy\Hl7Fhir\R4\PositiveIntType $precedence)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitInsuranceType $insurance
     */
    public function addToInsurance(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitInsuranceType $insurance)
    {
     ...
     * Financial instruments for reimbursement for the health care products and services specified on the claim.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitInsuranceType[]
     */
     ...
     * Details of a accident which resulted in injuries which required the products and services listed in the claim.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAccidentType
     */
     ...
     * Details of a accident which resulted in injuries which required the products and services listed in the claim.
     *
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAccidentType $accident
     * @return self
     */
    public function setAccident(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitAccidentType $accident)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitItemType $item
     */
    public function addToItem(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitItemType $item)
    {
        $this->item[] = $item;
        return $this;
    }
     ...
     * A claim line. Either a simple (a product or service) or a 'group' of details which can also be a simple items or groups of sub-details.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitItemType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAddItemType $addItem
     */
    public function addToAddItem(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitAddItemType $addItem)
    {
     ...
     * The first-tier service adjudications for payor added product or service lines.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAddItemType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAdjudicationType $adjudication
     */
    public function addToAdjudication(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitAdjudicationType $adjudication)
    {
     ...
     * The adjudication results which are presented at the header level rather than at the line-item or add-item levels.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitAdjudicationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitTotalType $total
     */
    public function addToTotal(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitTotalType $total)
    {
        $this->total[] = $total;
        return $this;
    }
     ...
     * Categorized monetary totals for the adjudication.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitTotalType[]
     */
     ...
     * Payment details for the adjudication of the claim.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitPaymentType
     */
     ...
     * Payment details for the adjudication of the claim.
     *
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitPaymentType $payment
     * @return self
     */
    public function setPayment(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitPaymentType $payment)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitProcessNoteType $processNote
     */
    public function addToProcessNote(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitProcessNoteType $processNote)
    {
     ...
     * A note that describes or explains adjudication results in a human readable form.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitProcessNoteType[]
     */
     ...
     * The term of the benefits documented in this response.
     *
     * @param \TKusy\Hl7Fhir\R4\PeriodType $benefitPeriod
     * @return self
     */
    public function setBenefitPeriod(\TKusy\Hl7Fhir\R4\PeriodType $benefitPeriod)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitBenefitBalanceType $benefitBalance
     */
    public function addToBenefitBalance(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitBenefitBalanceType $benefitBalance)
    {
     ...
     * Balance by Benefit Category.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitBenefitBalanceType[]
     */
