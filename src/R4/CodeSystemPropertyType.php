...
class CodeSystemPropertyType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PropertyTypeType $type
     */
    private $type = null;
     ...
     * The type of the property value. Properties of type "code" contain a code defined by the code system (e.g. a reference to another defined concept).
     *
     * @return \TKusy\Hl7Fhir\R4\PropertyTypeType
     */
     ...
     * The type of the property value. Properties of type "code" contain a code defined by the code system (e.g. a reference to another defined concept).
     *
     * @param \TKusy\Hl7Fhir\R4\PropertyTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\PropertyTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
