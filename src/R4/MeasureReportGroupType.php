...
class MeasureReportGroupType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureReportPopulationType[] $population
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MeasureReportStratifierType[] $stratifier
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasureReportPopulationType $population
     */
    public function addToPopulation(\TKusy\Hl7Fhir\R4\MeasureReportPopulationType $population)
    {
     ...
     * The populations that make up the population group, one for each type of population appropriate for the measure.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureReportPopulationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MeasureReportStratifierType $stratifier
     */
    public function addToStratifier(\TKusy\Hl7Fhir\R4\MeasureReportStratifierType $stratifier)
    {
     ...
     * When a measure includes multiple stratifiers, there will be a stratifier group for each stratifier defined by the measure.
     *
     * @return \TKusy\Hl7Fhir\R4\MeasureReportStratifierType[]
     */
