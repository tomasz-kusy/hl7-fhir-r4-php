...
class TimingType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType[] $event
     */
    private $event = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TimingRepeatType $repeat
     */
    private $repeat = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $event
     */
    public function addToEvent(\TKusy\Hl7Fhir\R4\DateTimeType $event)
    {
        $this->event[] = $event;
        return $this;
    }
     ...
     * A set of rules that describe when the event is scheduled.
     *
     * @return \TKusy\Hl7Fhir\R4\TimingRepeatType
     */
     ...
     * A set of rules that describe when the event is scheduled.
     *
     * @param \TKusy\Hl7Fhir\R4\TimingRepeatType $repeat
     * @return self
     */
    public function setRepeat(\TKusy\Hl7Fhir\R4\TimingRepeatType $repeat)
    {
        $this->repeat = $repeat;
        return $this;
    }
