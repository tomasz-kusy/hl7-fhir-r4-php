...
class InvoiceLineItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $chargeItemReference
     */
     ...
     * The ChargeItem contains information such as the billing code, date, amount etc. If no further details are required for the lineItem, inline billing codes can be added using the CodeableConcept data type instead of the Reference. (choose any one of chargeItem*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $chargeItemCodeableConcept
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InvoicePriceComponentType[] $priceComponent
     */
     ...
     * The ChargeItem contains information such as the billing code, date, amount etc. If no further details are required for the lineItem, inline billing codes can be added using the CodeableConcept data type instead of the Reference. (choose any one of chargeItem*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $chargeItemReference
     * @return self
     */
    public function setChargeItemReference(\TKusy\Hl7Fhir\R4\ReferenceType $chargeItemReference)
    {
     ...
     * The ChargeItem contains information such as the billing code, date, amount etc. If no further details are required for the lineItem, inline billing codes can be added using the CodeableConcept data type instead of the Reference. (choose any one of chargeItem*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $chargeItemCodeableConcept
     * @return self
     */
    public function setChargeItemCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $chargeItemCodeableConcept)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\InvoicePriceComponentType $priceComponent
     */
    public function addToPriceComponent(\TKusy\Hl7Fhir\R4\InvoicePriceComponentType $priceComponent)
    {
