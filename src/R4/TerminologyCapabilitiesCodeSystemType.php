...
class TerminologyCapabilitiesCodeSystemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TerminologyCapabilitiesVersionType[] $version
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $subsumption
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\TerminologyCapabilitiesVersionType $version
     */
    public function addToVersion(\TKusy\Hl7Fhir\R4\TerminologyCapabilitiesVersionType $version)
    {
     ...
     * For the code system, a list of versions that are supported by the server.
     *
     * @return \TKusy\Hl7Fhir\R4\TerminologyCapabilitiesVersionType[]
     */
     ...
     * True if subsumption is supported for this version of the code system.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $subsumption
     * @return self
     */
    public function setSubsumption(\TKusy\Hl7Fhir\R4\BooleanType $subsumption)
    {
