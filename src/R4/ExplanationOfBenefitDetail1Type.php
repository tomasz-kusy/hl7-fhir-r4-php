...
class ExplanationOfBenefitDetail1Type extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ExplanationOfBenefitSubDetail1Type[] $subDetail
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ExplanationOfBenefitSubDetail1Type $subDetail
     */
    public function addToSubDetail(\TKusy\Hl7Fhir\R4\ExplanationOfBenefitSubDetail1Type $subDetail)
    {
     ...
     * The third-tier service adjudications for payor added services.
     *
     * @return \TKusy\Hl7Fhir\R4\ExplanationOfBenefitSubDetail1Type[]
     */
