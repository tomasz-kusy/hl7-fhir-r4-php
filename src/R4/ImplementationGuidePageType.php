...
class ImplementationGuidePageType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UrlType $nameUrl
     */
     ...
     * The source address for the page. (choose any one of name*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $nameReference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\GuidePageGenerationType $generation
     */
     ...
     * The source address for the page. (choose any one of name*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\UrlType $nameUrl
     * @return self
     */
    public function setNameUrl(\TKusy\Hl7Fhir\R4\UrlType $nameUrl)
    {
     ...
     * The source address for the page. (choose any one of name*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $nameReference
     * @return self
     */
    public function setNameReference(\TKusy\Hl7Fhir\R4\ReferenceType $nameReference)
    {
     ...
     * A code that indicates how the page is generated.
     *
     * @return \TKusy\Hl7Fhir\R4\GuidePageGenerationType
     */
     ...
     * A code that indicates how the page is generated.
     *
     * @param \TKusy\Hl7Fhir\R4\GuidePageGenerationType $generation
     * @return self
     */
    public function setGeneration(\TKusy\Hl7Fhir\R4\GuidePageGenerationType $generation)
    {
     ...
     */
    public function addToPage(\TKusy\Hl7Fhir\R4\ImplementationGuidePageType $page)
    {
        $this->page[] = $page;
        return $this;
    }
