...
class ClaimItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ClaimDetailType[] $detail
     */
    private $detail = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ClaimDetailType $detail
     */
    public function addToDetail(\TKusy\Hl7Fhir\R4\ClaimDetailType $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
     ...
     * A claim detail line. Either a simple (a product or service) or a 'group' of sub-details which are simple items.
     *
     * @return \TKusy\Hl7Fhir\R4\ClaimDetailType[]
     */
