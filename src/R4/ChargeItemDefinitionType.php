...
class ChargeItemDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UriType[] $derivedFromUri
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CanonicalType[] $partOf
     */
    private $partOf = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $instance
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ChargeItemDefinitionApplicabilityType[] $applicability
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ChargeItemDefinitionPropertyGroupType[] $propertyGroup
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\UriType $derivedFromUri
     */
    public function addToDerivedFromUri(\TKusy\Hl7Fhir\R4\UriType $derivedFromUri)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CanonicalType $partOf
     */
    public function addToPartOf(\TKusy\Hl7Fhir\R4\CanonicalType $partOf)
    {
        $this->partOf[] = $partOf;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $instance
     */
    public function addToInstance(\TKusy\Hl7Fhir\R4\ReferenceType $instance)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ChargeItemDefinitionApplicabilityType $applicability
     */
    public function addToApplicability(\TKusy\Hl7Fhir\R4\ChargeItemDefinitionApplicabilityType $applicability)
    {
     ...
     * Expressions that describe applicability criteria for the billing code.
     *
     * @return \TKusy\Hl7Fhir\R4\ChargeItemDefinitionApplicabilityType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ChargeItemDefinitionPropertyGroupType $propertyGroup
     */
    public function addToPropertyGroup(\TKusy\Hl7Fhir\R4\ChargeItemDefinitionPropertyGroupType $propertyGroup)
    {
     ...
     * Group of properties which are applicable under the same conditions. If no applicability rules are established for the group, then all properties always apply.
     *
     * @return \TKusy\Hl7Fhir\R4\ChargeItemDefinitionPropertyGroupType[]
     */
