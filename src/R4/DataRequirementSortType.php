...
class DataRequirementSortType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SortDirectionType $direction
     */
     ...
     * The direction of the sort, ascending or descending.
     *
     * @return \TKusy\Hl7Fhir\R4\SortDirectionType
     */
     ...
     * The direction of the sort, ascending or descending.
     *
     * @param \TKusy\Hl7Fhir\R4\SortDirectionType $direction
     * @return self
     */
    public function setDirection(\TKusy\Hl7Fhir\R4\SortDirectionType $direction)
    {
