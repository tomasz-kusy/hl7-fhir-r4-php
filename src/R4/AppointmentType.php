...
class AppointmentType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AppointmentStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $cancelationReason
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $serviceCategory
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $appointmentType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\UnsignedIntType $priority
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InstantType $start
     */
    private $start = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InstantType $end
     */
    private $end = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $minutesDuration
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $slot
     */
    private $slot = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AppointmentParticipantType[] $participant
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType[] $requestedPeriod
     */
     ...
     * The overall status of the Appointment. Each of the participants has their own participation status which indicates their involvement in the process, however this status indicates the shared status.
     *
     * @return \TKusy\Hl7Fhir\R4\AppointmentStatusType
     */
     ...
     * The overall status of the Appointment. Each of the participants has their own participation status which indicates their involvement in the process, however this status indicates the shared status.
     *
     * @param \TKusy\Hl7Fhir\R4\AppointmentStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\AppointmentStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The coded reason for the appointment being cancelled. This is often used in reporting/billing/futher processing to determine if further actions are required, or specific fees apply.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $cancelationReason
     * @return self
     */
    public function setCancelationReason(\TKusy\Hl7Fhir\R4\CodeableConceptType $cancelationReason)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $serviceCategory
     */
    public function addToServiceCategory(\TKusy\Hl7Fhir\R4\CodeableConceptType $serviceCategory)
    {
     ...
     */
    public function addToServiceType(\TKusy\Hl7Fhir\R4\CodeableConceptType $serviceType)
    {
     ...
     * The style of appointment or patient that has been booked in the slot (not service type).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $appointmentType
     * @return self
     */
    public function setAppointmentType(\TKusy\Hl7Fhir\R4\CodeableConceptType $appointmentType)
    {
     ...
     * The priority of the appointment. Can be used to make informed decisions if needing to re-prioritize appointments. (The iCal Standard specifies 0 as undefined, 1 as highest, 9 as lowest priority).
     *
     * @param \TKusy\Hl7Fhir\R4\UnsignedIntType $priority
     * @return self
     */
    public function setPriority(\TKusy\Hl7Fhir\R4\UnsignedIntType $priority)
    {
     ...
     * Date/Time that the appointment is to take place.
     *
     * @param \TKusy\Hl7Fhir\R4\InstantType $start
     * @return self
     */
    public function setStart(\TKusy\Hl7Fhir\R4\InstantType $start)
    {
        $this->start = $start;
        return $this;
    }
     ...
     * Date/Time that the appointment is to conclude.
     *
     * @param \TKusy\Hl7Fhir\R4\InstantType $end
     * @return self
     */
    public function setEnd(\TKusy\Hl7Fhir\R4\InstantType $end)
    {
        $this->end = $end;
        return $this;
    }
     ...
     * Number of minutes that the appointment is to take. This can be less than the duration between the start and end times. For example, where the actual time of appointment is only an estimate or if a 30 minute appointment is being requested, but any time would work. Also, if there is, for example, a planned 15 minute break in the middle of a long appointment, the duration may be 15 minutes less than the difference between the start and end.
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $minutesDuration
     * @return self
     */
    public function setMinutesDuration(\TKusy\Hl7Fhir\R4\PositiveIntType $minutesDuration)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $slot
     */
    public function addToSlot(\TKusy\Hl7Fhir\R4\ReferenceType $slot)
    {
        $this->slot[] = $slot;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\AppointmentParticipantType $participant
     */
    public function addToParticipant(\TKusy\Hl7Fhir\R4\AppointmentParticipantType $participant)
    {
     ...
     * List of participants involved in the appointment.
     *
     * @return \TKusy\Hl7Fhir\R4\AppointmentParticipantType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\PeriodType $requestedPeriod
     */
    public function addToRequestedPeriod(\TKusy\Hl7Fhir\R4\PeriodType $requestedPeriod)
    {
