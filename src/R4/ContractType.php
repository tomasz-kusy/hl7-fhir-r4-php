...
class ContractType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContractResourceStatusCodesType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $legalState
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $instantiatesCanonical
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $contentDerivative
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $expirationType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $authority
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $domain
     */
    private $domain = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $site
     */
    private $site = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $scope
     */
    private $scope = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContractContentDefinitionType $contentDefinition
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContractTermType[] $term
     */
    private $term = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $relevantHistory
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContractSignerType[] $signer
     */
    private $signer = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContractFriendlyType[] $friendly
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContractLegalType[] $legal
     */
    private $legal = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContractRuleType[] $rule
     */
    private $rule = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AttachmentType $legallyBindingAttachment
     */
     ...
     * Legally binding Contract: This is the signed and legally recognized representation of the Contract, which is considered the "source of truth" and which would be the basis for legal action related to enforcement of this Contract. (choose any one of legallyBinding*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $legallyBindingReference
     */
     ...
     * The status of the resource instance.
     *
     * @return \TKusy\Hl7Fhir\R4\ContractResourceStatusCodesType
     */
     ...
     * The status of the resource instance.
     *
     * @param \TKusy\Hl7Fhir\R4\ContractResourceStatusCodesType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ContractResourceStatusCodesType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * Legal states of the formation of a legal instrument, which is a formally executed written document that can be formally attributed to its author, records and formally expresses a legally enforceable act, process, or contractual duty, obligation, or right, and therefore evidences that act, process, or agreement.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $legalState
     * @return self
     */
    public function setLegalState(\TKusy\Hl7Fhir\R4\CodeableConceptType $legalState)
    {
     ...
     * The URL pointing to a FHIR-defined Contract Definition that is adhered to in whole or part by this Contract.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $instantiatesCanonical
     * @return self
     */
    public function setInstantiatesCanonical(\TKusy\Hl7Fhir\R4\ReferenceType $instantiatesCanonical)
    {
     ...
     * @return self
     */
    public function setInstantiatesUri(\TKusy\Hl7Fhir\R4\UriType $instantiatesUri)
    {
     ...
     * The minimal content derived from the basal information source at a specific stage in its lifecycle.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $contentDerivative
     * @return self
     */
    public function setContentDerivative(\TKusy\Hl7Fhir\R4\CodeableConceptType $contentDerivative)
    {
     ...
     * Event resulting in discontinuation or termination of this Contract instance by one or more parties to the contract.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $expirationType
     * @return self
     */
    public function setExpirationType(\TKusy\Hl7Fhir\R4\CodeableConceptType $expirationType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $authority
     */
    public function addToAuthority(\TKusy\Hl7Fhir\R4\ReferenceType $authority)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $domain
     */
    public function addToDomain(\TKusy\Hl7Fhir\R4\ReferenceType $domain)
    {
        $this->domain[] = $domain;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $site
     */
    public function addToSite(\TKusy\Hl7Fhir\R4\ReferenceType $site)
    {
        $this->site[] = $site;
        return $this;
    }
     ...
     */
    public function addToAlias(\TKusy\Hl7Fhir\R4\StringType $alias)
    {
        $this->alias[] = $alias;
        return $this;
    }
     ...
     * A selector of legal concerns for this Contract definition, derivative, or instance in any legal state.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $scope
     * @return self
     */
    public function setScope(\TKusy\Hl7Fhir\R4\CodeableConceptType $scope)
    {
        $this->scope = $scope;
        return $this;
    }
     ...
     * Precusory content developed with a focus and intent of supporting the formation a Contract instance, which may be associated with and transformable into a Contract.
     *
     * @return \TKusy\Hl7Fhir\R4\ContractContentDefinitionType
     */
     ...
     * Precusory content developed with a focus and intent of supporting the formation a Contract instance, which may be associated with and transformable into a Contract.
     *
     * @param \TKusy\Hl7Fhir\R4\ContractContentDefinitionType $contentDefinition
     * @return self
     */
    public function setContentDefinition(\TKusy\Hl7Fhir\R4\ContractContentDefinitionType $contentDefinition)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ContractTermType $term
     */
    public function addToTerm(\TKusy\Hl7Fhir\R4\ContractTermType $term)
    {
        $this->term[] = $term;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $relevantHistory
     */
    public function addToRelevantHistory(\TKusy\Hl7Fhir\R4\ReferenceType $relevantHistory)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ContractSignerType $signer
     */
    public function addToSigner(\TKusy\Hl7Fhir\R4\ContractSignerType $signer)
    {
        $this->signer[] = $signer;
        return $this;
    }
     ...
     * Parties with legal standing in the Contract, including the principal parties, the grantor(s) and grantee(s), which are any person or organization bound by the contract, and any ancillary parties, which facilitate the execution of the contract such as a notary or witness.
     *
     * @return \TKusy\Hl7Fhir\R4\ContractSignerType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ContractFriendlyType $friendly
     */
    public function addToFriendly(\TKusy\Hl7Fhir\R4\ContractFriendlyType $friendly)
    {
     ...
     * The "patient friendly language" versionof the Contract in whole or in parts. "Patient friendly language" means the representation of the Contract and Contract Provisions in a manner that is readily accessible and understandable by a layperson in accordance with best practices for communication styles that ensure that those agreeing to or signing the Contract understand the roles, actions, obligations, responsibilities, and implication of the agreement.
     *
     * @return \TKusy\Hl7Fhir\R4\ContractFriendlyType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ContractLegalType $legal
     */
    public function addToLegal(\TKusy\Hl7Fhir\R4\ContractLegalType $legal)
    {
        $this->legal[] = $legal;
        return $this;
    }
     ...
     * List of Legal expressions or representations of this Contract.
     *
     * @return \TKusy\Hl7Fhir\R4\ContractLegalType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ContractRuleType $rule
     */
    public function addToRule(\TKusy\Hl7Fhir\R4\ContractRuleType $rule)
    {
        $this->rule[] = $rule;
        return $this;
    }
     ...
     * List of Computable Policy Rule Language Representations of this Contract.
     *
     * @return \TKusy\Hl7Fhir\R4\ContractRuleType[]
     */
     ...
     * Legally binding Contract: This is the signed and legally recognized representation of the Contract, which is considered the "source of truth" and which would be the basis for legal action related to enforcement of this Contract. (choose any one of legallyBinding*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\AttachmentType $legallyBindingAttachment
     * @return self
     */
    public function setLegallyBindingAttachment(\TKusy\Hl7Fhir\R4\AttachmentType $legallyBindingAttachment)
    {
     ...
     * Legally binding Contract: This is the signed and legally recognized representation of the Contract, which is considered the "source of truth" and which would be the basis for legal action related to enforcement of this Contract. (choose any one of legallyBinding*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $legallyBindingReference
     * @return self
     */
    public function setLegallyBindingReference(\TKusy\Hl7Fhir\R4\ReferenceType $legallyBindingReference)
    {
