...
class ExplanationOfBenefitCareTeamType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $responsible
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $qualification
     */
     ...
     * The party who is billing and/or responsible for the claimed products or services.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $responsible
     * @return self
     */
    public function setResponsible(\TKusy\Hl7Fhir\R4\BooleanType $responsible)
    {
     ...
     * The qualification of the practitioner which is applicable for this service.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $qualification
     * @return self
     */
    public function setQualification(\TKusy\Hl7Fhir\R4\CodeableConceptType $qualification)
    {
