...
class ImmunizationEvaluationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ImmunizationEvaluationStatusCodesType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $immunizationEvent
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $doseStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $doseStatusReason
     */
     ...
     * Indicates the current status of the evaluation of the vaccination administration event.
     *
     * @return \TKusy\Hl7Fhir\R4\ImmunizationEvaluationStatusCodesType
     */
     ...
     * Indicates the current status of the evaluation of the vaccination administration event.
     *
     * @param \TKusy\Hl7Fhir\R4\ImmunizationEvaluationStatusCodesType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\ImmunizationEvaluationStatusCodesType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * @return self
     */
    public function setAuthority(\TKusy\Hl7Fhir\R4\ReferenceType $authority)
    {
     ...
     * The vaccine administration event being evaluated.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $immunizationEvent
     * @return self
     */
    public function setImmunizationEvent(\TKusy\Hl7Fhir\R4\ReferenceType $immunizationEvent)
    {
     ...
     * Indicates if the dose is valid or not valid with respect to the published recommendations.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $doseStatus
     * @return self
     */
    public function setDoseStatus(\TKusy\Hl7Fhir\R4\CodeableConceptType $doseStatus)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $doseStatusReason
     */
    public function addToDoseStatusReason(\TKusy\Hl7Fhir\R4\CodeableConceptType $doseStatusReason)
    {
