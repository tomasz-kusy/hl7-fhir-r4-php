...
class ProcedureFocalDeviceType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $manipulated
     */
     ...
     * @return self
     */
    public function setAction(\TKusy\Hl7Fhir\R4\CodeableConceptType $action)
    {
        $this->action = $action;
        return $this;
    }
     ...
     * The device that was manipulated (changed) during the procedure.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $manipulated
     * @return self
     */
    public function setManipulated(\TKusy\Hl7Fhir\R4\ReferenceType $manipulated)
    {
