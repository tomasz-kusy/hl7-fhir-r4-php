...
class AllergyIntoleranceReactionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $manifestation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $onset
     */
    private $onset = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AllergyIntoleranceSeverityType $severity
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $exposureRoute
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $manifestation
     */
    public function addToManifestation(\TKusy\Hl7Fhir\R4\CodeableConceptType $manifestation)
    {
     ...
     * Record of the date and/or time of the onset of the Reaction.
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $onset
     * @return self
     */
    public function setOnset(\TKusy\Hl7Fhir\R4\DateTimeType $onset)
    {
        $this->onset = $onset;
        return $this;
    }
     ...
     * Clinical assessment of the severity of the reaction event as a whole, potentially considering multiple different manifestations.
     *
     * @return \TKusy\Hl7Fhir\R4\AllergyIntoleranceSeverityType
     */
     ...
     * Clinical assessment of the severity of the reaction event as a whole, potentially considering multiple different manifestations.
     *
     * @param \TKusy\Hl7Fhir\R4\AllergyIntoleranceSeverityType $severity
     * @return self
     */
    public function setSeverity(\TKusy\Hl7Fhir\R4\AllergyIntoleranceSeverityType $severity)
    {
     ...
     * Identification of the route by which the subject was exposed to the substance.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $exposureRoute
     * @return self
     */
    public function setExposureRoute(\TKusy\Hl7Fhir\R4\CodeableConceptType $exposureRoute)
    {
