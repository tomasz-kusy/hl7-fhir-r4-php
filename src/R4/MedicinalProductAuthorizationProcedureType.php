...
class MedicinalProductAuthorizationProcedureType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType $datePeriod
     */
     ...
     * Date of procedure. (choose any one of date*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\DateTimeType $dateDateTime
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductAuthorizationProcedureType[] $application
     */
     ...
     * Date of procedure. (choose any one of date*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\PeriodType $datePeriod
     * @return self
     */
    public function setDatePeriod(\TKusy\Hl7Fhir\R4\PeriodType $datePeriod)
    {
     ...
     * Date of procedure. (choose any one of date*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DateTimeType $dateDateTime
     * @return self
     */
    public function setDateDateTime(\TKusy\Hl7Fhir\R4\DateTimeType $dateDateTime)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductAuthorizationProcedureType $application
     */
    public function addToApplication(\TKusy\Hl7Fhir\R4\MedicinalProductAuthorizationProcedureType $application)
    {
