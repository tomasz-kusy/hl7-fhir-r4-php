...
class TestReportTeardownType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TestReportAction2Type[] $action
     */
    private $action = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\TestReportAction2Type $action
     */
    public function addToAction(\TKusy\Hl7Fhir\R4\TestReportAction2Type $action)
    {
        $this->action[] = $action;
        return $this;
    }
     ...
     * The teardown action will only contain an operation.
     *
     * @return \TKusy\Hl7Fhir\R4\TestReportAction2Type[]
     */
