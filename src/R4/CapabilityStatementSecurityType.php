...
class CapabilityStatementSecurityType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $cors
     */
    private $cors = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $service
     */
     ...
     * Server adds CORS headers when responding to requests - this enables Javascript applications to use the server.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $cors
     * @return self
     */
    public function setCors(\TKusy\Hl7Fhir\R4\BooleanType $cors)
    {
        $this->cors = $cors;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $service
     */
    public function addToService(\TKusy\Hl7Fhir\R4\CodeableConceptType $service)
    {
