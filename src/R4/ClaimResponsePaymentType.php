...
class ClaimResponsePaymentType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MoneyType $adjustment
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $adjustmentReason
     */
     ...
     * Total amount of all adjustments to this payment included in this transaction which are not related to this claim's adjudication.
     *
     * @param \TKusy\Hl7Fhir\R4\MoneyType $adjustment
     * @return self
     */
    public function setAdjustment(\TKusy\Hl7Fhir\R4\MoneyType $adjustment)
    {
     ...
     * Reason for the payment adjustment.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $adjustmentReason
     * @return self
     */
    public function setAdjustmentReason(\TKusy\Hl7Fhir\R4\CodeableConceptType $adjustmentReason)
    {
