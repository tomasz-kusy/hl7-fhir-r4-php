...
class SubscriptionChannelType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubscriptionChannelTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeType $payload
     */
     ...
     * The type of channel to send notifications on.
     *
     * @return \TKusy\Hl7Fhir\R4\SubscriptionChannelTypeType
     */
     ...
     * The type of channel to send notifications on.
     *
     * @param \TKusy\Hl7Fhir\R4\SubscriptionChannelTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\SubscriptionChannelTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     * The mime type to send the payload in - either application/fhir+xml, or application/fhir+json. If the payload is not present, then there is no payload in the notification, just a notification. The mime type "text/plain" may also be used for Email and SMS subscriptions.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeType $payload
     * @return self
     */
    public function setPayload(\TKusy\Hl7Fhir\R4\CodeType $payload)
    {
