...
class InvoicePriceComponentType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\InvoicePriceComponentTypeType $type
     */
    private $type = null;
     ...
     * This code identifies the type of the component.
     *
     * @return \TKusy\Hl7Fhir\R4\InvoicePriceComponentTypeType
     */
     ...
     * This code identifies the type of the component.
     *
     * @param \TKusy\Hl7Fhir\R4\InvoicePriceComponentTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7Fhir\R4\InvoicePriceComponentTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
