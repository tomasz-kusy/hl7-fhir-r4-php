...
class StructureDefinitionDifferentialType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ElementDefinitionType[] $element
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ElementDefinitionType $element
     */
    public function addToElement(\TKusy\Hl7Fhir\R4\ElementDefinitionType $element)
    {
     ...
     * Captures constraints on each element within the resource.
     *
     * @return \TKusy\Hl7Fhir\R4\ElementDefinitionType[]
     */
