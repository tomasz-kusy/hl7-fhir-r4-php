...
class NutritionOrderOralDietType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TimingType[] $schedule
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\NutritionOrderNutrientType[] $nutrient
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\NutritionOrderTextureType[] $texture
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $fluidConsistencyType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $instruction
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\TimingType $schedule
     */
    public function addToSchedule(\TKusy\Hl7Fhir\R4\TimingType $schedule)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\NutritionOrderNutrientType $nutrient
     */
    public function addToNutrient(\TKusy\Hl7Fhir\R4\NutritionOrderNutrientType $nutrient)
    {
     ...
     * Class that defines the quantity and type of nutrient modifications (for example carbohydrate, fiber or sodium) required for the oral diet.
     *
     * @return \TKusy\Hl7Fhir\R4\NutritionOrderNutrientType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\NutritionOrderTextureType $texture
     */
    public function addToTexture(\TKusy\Hl7Fhir\R4\NutritionOrderTextureType $texture)
    {
     ...
     * Class that describes any texture modifications required for the patient to safely consume various types of solid foods.
     *
     * @return \TKusy\Hl7Fhir\R4\NutritionOrderTextureType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $fluidConsistencyType
     */
    public function addToFluidConsistencyType(\TKusy\Hl7Fhir\R4\CodeableConceptType $fluidConsistencyType)
    {
     ...
     * Free text or additional instructions or information pertaining to the oral diet.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $instruction
     * @return self
     */
    public function setInstruction(\TKusy\Hl7Fhir\R4\StringType $instruction)
    {
