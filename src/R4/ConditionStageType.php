...
class ConditionStageType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $summary
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $assessment
     */
     ...
     * A simple summary of the stage such as "Stage 3". The determination of the stage is disease-specific.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $summary
     * @return self
     */
    public function setSummary(\TKusy\Hl7Fhir\R4\CodeableConceptType $summary)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $assessment
     */
    public function addToAssessment(\TKusy\Hl7Fhir\R4\ReferenceType $assessment)
    {
