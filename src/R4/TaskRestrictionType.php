...
class TaskRestrictionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PositiveIntType $repetitions
     */
     ...
     * Indicates the number of times the requested action should occur.
     *
     * @param \TKusy\Hl7Fhir\R4\PositiveIntType $repetitions
     * @return self
     */
    public function setRepetitions(\TKusy\Hl7Fhir\R4\PositiveIntType $repetitions)
    {
