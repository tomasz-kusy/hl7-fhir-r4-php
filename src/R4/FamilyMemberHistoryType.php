...
class FamilyMemberHistoryType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\FamilyHistoryStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $dataAbsentReason
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $sex
     */
    private $sex = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\PeriodType $bornPeriod
     */
     ...
     * The actual or approximate date of birth of the relative. (choose any one of born*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\DateType $bornDate
     */
     ...
     * The actual or approximate date of birth of the relative. (choose any one of born*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $bornString
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\AgeType $ageAge
     */
    private $ageAge = null;
     ...
     * The age of the relative at the time the family member history is recorded. (choose any one of age*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\RangeType $ageRange
     */
     ...
     * The age of the relative at the time the family member history is recorded. (choose any one of age*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $ageString
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $estimatedAge
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $deceasedBoolean
     */
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\AgeType $deceasedAge
     */
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\RangeType $deceasedRange
     */
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\DateType $deceasedDate
     */
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $deceasedString
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\FamilyMemberHistoryConditionType[] $condition
     */
     ...
     * A code specifying the status of the record of the family history of a specific family member.
     *
     * @return \TKusy\Hl7Fhir\R4\FamilyHistoryStatusType
     */
     ...
     * A code specifying the status of the record of the family history of a specific family member.
     *
     * @param \TKusy\Hl7Fhir\R4\FamilyHistoryStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R4\FamilyHistoryStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * Describes why the family member's history is not available.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $dataAbsentReason
     * @return self
     */
    public function setDataAbsentReason(\TKusy\Hl7Fhir\R4\CodeableConceptType $dataAbsentReason)
    {
     ...
     * The birth sex of the family member.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $sex
     * @return self
     */
    public function setSex(\TKusy\Hl7Fhir\R4\CodeableConceptType $sex)
    {
        $this->sex = $sex;
        return $this;
    }
     ...
     * The actual or approximate date of birth of the relative. (choose any one of born*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\PeriodType $bornPeriod
     * @return self
     */
    public function setBornPeriod(\TKusy\Hl7Fhir\R4\PeriodType $bornPeriod)
    {
     ...
     * The actual or approximate date of birth of the relative. (choose any one of born*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DateType $bornDate
     * @return self
     */
    public function setBornDate(\TKusy\Hl7Fhir\R4\DateType $bornDate)
    {
     ...
     * The actual or approximate date of birth of the relative. (choose any one of born*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $bornString
     * @return self
     */
    public function setBornString(\TKusy\Hl7Fhir\R4\StringType $bornString)
    {
     ...
     * The age of the relative at the time the family member history is recorded. (choose any one of age*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\AgeType $ageAge
     * @return self
     */
    public function setAgeAge(\TKusy\Hl7Fhir\R4\AgeType $ageAge)
    {
        $this->ageAge = $ageAge;
        return $this;
    }
     ...
     * The age of the relative at the time the family member history is recorded. (choose any one of age*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RangeType $ageRange
     * @return self
     */
    public function setAgeRange(\TKusy\Hl7Fhir\R4\RangeType $ageRange)
    {
     ...
     * The age of the relative at the time the family member history is recorded. (choose any one of age*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $ageString
     * @return self
     */
    public function setAgeString(\TKusy\Hl7Fhir\R4\StringType $ageString)
    {
     ...
     * If true, indicates that the age value specified is an estimated value.
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $estimatedAge
     * @return self
     */
    public function setEstimatedAge(\TKusy\Hl7Fhir\R4\BooleanType $estimatedAge)
    {
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $deceasedBoolean
     * @return self
     */
    public function setDeceasedBoolean(\TKusy\Hl7Fhir\R4\BooleanType $deceasedBoolean)
    {
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\AgeType $deceasedAge
     * @return self
     */
    public function setDeceasedAge(\TKusy\Hl7Fhir\R4\AgeType $deceasedAge)
    {
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\RangeType $deceasedRange
     * @return self
     */
    public function setDeceasedRange(\TKusy\Hl7Fhir\R4\RangeType $deceasedRange)
    {
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\DateType $deceasedDate
     * @return self
     */
    public function setDeceasedDate(\TKusy\Hl7Fhir\R4\DateType $deceasedDate)
    {
     ...
     * Deceased flag or the actual or approximate age of the relative at the time of death for the family member history record. (choose any one of deceased*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $deceasedString
     * @return self
     */
    public function setDeceasedString(\TKusy\Hl7Fhir\R4\StringType $deceasedString)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\FamilyMemberHistoryConditionType $condition
     */
    public function addToCondition(\TKusy\Hl7Fhir\R4\FamilyMemberHistoryConditionType $condition)
    {
     ...
     * The significant Conditions (or condition) that the family member had. This is a repeating section to allow a system to represent more than one condition per resource, though there is nothing stopping multiple resources - one per condition.
     *
     * @return \TKusy\Hl7Fhir\R4\FamilyMemberHistoryConditionType[]
     */
