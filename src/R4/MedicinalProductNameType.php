...
class MedicinalProductNameType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $productName
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductNamePartType[] $namePart
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductCountryLanguageType[] $countryLanguage
     */
     ...
     * The full product name.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $productName
     * @return self
     */
    public function setProductName(\TKusy\Hl7Fhir\R4\StringType $productName)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductNamePartType $namePart
     */
    public function addToNamePart(\TKusy\Hl7Fhir\R4\MedicinalProductNamePartType $namePart)
    {
     ...
     * Coding words or phrases of the name.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductNamePartType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductCountryLanguageType $countryLanguage
     */
    public function addToCountryLanguage(\TKusy\Hl7Fhir\R4\MedicinalProductCountryLanguageType $countryLanguage)
    {
     ...
     * Country where the name applies.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductCountryLanguageType[]
     */
