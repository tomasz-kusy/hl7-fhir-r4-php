...
class SpecimenDefinitionContainerType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $cap
     */
    private $cap = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $capacity
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\QuantityType $minimumVolumeQuantity
     */
     ...
     * The minimum volume to be conditioned in the container. (choose any one of minimumVolume*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $minimumVolumeString
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SpecimenDefinitionAdditiveType[] $additive
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $preparation
     */
     ...
     * Color of container cap.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $cap
     * @return self
     */
    public function setCap(\TKusy\Hl7Fhir\R4\CodeableConceptType $cap)
    {
        $this->cap = $cap;
        return $this;
    }
     ...
     * The capacity (volume or other measure) of this kind of container.
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $capacity
     * @return self
     */
    public function setCapacity(\TKusy\Hl7Fhir\R4\QuantityType $capacity)
    {
     ...
     * The minimum volume to be conditioned in the container. (choose any one of minimumVolume*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\QuantityType $minimumVolumeQuantity
     * @return self
     */
    public function setMinimumVolumeQuantity(\TKusy\Hl7Fhir\R4\QuantityType $minimumVolumeQuantity)
    {
     ...
     * The minimum volume to be conditioned in the container. (choose any one of minimumVolume*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $minimumVolumeString
     * @return self
     */
    public function setMinimumVolumeString(\TKusy\Hl7Fhir\R4\StringType $minimumVolumeString)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SpecimenDefinitionAdditiveType $additive
     */
    public function addToAdditive(\TKusy\Hl7Fhir\R4\SpecimenDefinitionAdditiveType $additive)
    {
     ...
     * Substance introduced in the kind of container to preserve, maintain or enhance the specimen. Examples: Formalin, Citrate, EDTA.
     *
     * @return \TKusy\Hl7Fhir\R4\SpecimenDefinitionAdditiveType[]
     */
     ...
     * Special processing that should be applied to the container for this kind of specimen.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $preparation
     * @return self
     */
    public function setPreparation(\TKusy\Hl7Fhir\R4\StringType $preparation)
    {
