...
class AuditEventSourceType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $site
     */
    private $site = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $observer
     */
     ...
     * Logical source location within the healthcare enterprise network. For example, a hospital or other provider location within a multi-entity provider group.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $site
     * @return self
     */
    public function setSite(\TKusy\Hl7Fhir\R4\StringType $site)
    {
        $this->site = $site;
        return $this;
    }
     ...
     * Identifier of the source where the event was detected.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $observer
     * @return self
     */
    public function setObserver(\TKusy\Hl7Fhir\R4\ReferenceType $observer)
    {
