...
class MedicinalProductUndesirableEffectType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $symptomConditionEffect
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $frequencyOfOccurrence
     */
     ...
     * The symptom, condition or undesirable effect.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $symptomConditionEffect
     * @return self
     */
    public function setSymptomConditionEffect(\TKusy\Hl7Fhir\R4\CodeableConceptType $symptomConditionEffect)
    {
     ...
     * The frequency of occurrence of the effect.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $frequencyOfOccurrence
     * @return self
     */
    public function setFrequencyOfOccurrence(\TKusy\Hl7Fhir\R4\CodeableConceptType $frequencyOfOccurrence)
    {
