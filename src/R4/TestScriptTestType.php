...
class TestScriptTestType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\TestScriptAction1Type[] $action
     */
    private $action = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\TestScriptAction1Type $action
     */
    public function addToAction(\TKusy\Hl7Fhir\R4\TestScriptAction1Type $action)
    {
        $this->action[] = $action;
        return $this;
    }
     ...
     * Action would contain either an operation or an assertion.
     *
     * @return \TKusy\Hl7Fhir\R4\TestScriptAction1Type[]
     */
