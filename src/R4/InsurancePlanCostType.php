...
class InsurancePlanCostType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $applicability
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $qualifiers
     */
     ...
     * Whether the cost applies to in-network or out-of-network providers (in-network; out-of-network; other).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $applicability
     * @return self
     */
    public function setApplicability(\TKusy\Hl7Fhir\R4\CodeableConceptType $applicability)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $qualifiers
     */
    public function addToQualifiers(\TKusy\Hl7Fhir\R4\CodeableConceptType $qualifiers)
    {
