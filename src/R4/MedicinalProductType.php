...
class MedicinalProductType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodingType $domain
     */
    private $domain = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $combinedPharmaceuticalDoseForm
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $additionalMonitoringIndicator
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $specialMeasures
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $paediatricUseIndicator
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $productClassification
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MarketingStatusType[] $marketingStatus
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $pharmaceuticalProduct
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $packagedMedicinalProduct
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $attachedDocument
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $masterFile
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $contact
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType[] $clinicalTrial
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductNameType[] $name
     */
    private $name = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType[] $crossReference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductManufacturingBusinessOperationType[] $manufacturingBusinessOperation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\MedicinalProductSpecialDesignationType[] $specialDesignation
     */
     ...
     * If this medicine applies to human or veterinary uses.
     *
     * @param \TKusy\Hl7Fhir\R4\CodingType $domain
     * @return self
     */
    public function setDomain(\TKusy\Hl7Fhir\R4\CodingType $domain)
    {
        $this->domain = $domain;
        return $this;
    }
     ...
     * The dose form for a single part product, or combined form of a multiple part product.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $combinedPharmaceuticalDoseForm
     * @return self
     */
    public function setCombinedPharmaceuticalDoseForm(\TKusy\Hl7Fhir\R4\CodeableConceptType $combinedPharmaceuticalDoseForm)
    {
     ...
     * Whether the Medicinal Product is subject to additional monitoring for regulatory reasons.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $additionalMonitoringIndicator
     * @return self
     */
    public function setAdditionalMonitoringIndicator(\TKusy\Hl7Fhir\R4\CodeableConceptType $additionalMonitoringIndicator)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $specialMeasures
     */
    public function addToSpecialMeasures(\TKusy\Hl7Fhir\R4\StringType $specialMeasures)
    {
     ...
     * If authorised for use in children.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $paediatricUseIndicator
     * @return self
     */
    public function setPaediatricUseIndicator(\TKusy\Hl7Fhir\R4\CodeableConceptType $paediatricUseIndicator)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $productClassification
     */
    public function addToProductClassification(\TKusy\Hl7Fhir\R4\CodeableConceptType $productClassification)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MarketingStatusType $marketingStatus
     */
    public function addToMarketingStatus(\TKusy\Hl7Fhir\R4\MarketingStatusType $marketingStatus)
    {
     ...
     * Marketing status of the medicinal product, in contrast to marketing authorizaton.
     *
     * @return \TKusy\Hl7Fhir\R4\MarketingStatusType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $pharmaceuticalProduct
     */
    public function addToPharmaceuticalProduct(\TKusy\Hl7Fhir\R4\ReferenceType $pharmaceuticalProduct)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $packagedMedicinalProduct
     */
    public function addToPackagedMedicinalProduct(\TKusy\Hl7Fhir\R4\ReferenceType $packagedMedicinalProduct)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $attachedDocument
     */
    public function addToAttachedDocument(\TKusy\Hl7Fhir\R4\ReferenceType $attachedDocument)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $masterFile
     */
    public function addToMasterFile(\TKusy\Hl7Fhir\R4\ReferenceType $masterFile)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $contact
     */
    public function addToContact(\TKusy\Hl7Fhir\R4\ReferenceType $contact)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $clinicalTrial
     */
    public function addToClinicalTrial(\TKusy\Hl7Fhir\R4\ReferenceType $clinicalTrial)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductNameType $name
     */
    public function addToName(\TKusy\Hl7Fhir\R4\MedicinalProductNameType $name)
    {
        $this->name[] = $name;
        return $this;
    }
     ...
     * The product's name, including full name and possibly coded parts.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductNameType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $crossReference
     */
    public function addToCrossReference(\TKusy\Hl7Fhir\R4\IdentifierType $crossReference)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductManufacturingBusinessOperationType $manufacturingBusinessOperation
     */
    public function addToManufacturingBusinessOperation(\TKusy\Hl7Fhir\R4\MedicinalProductManufacturingBusinessOperationType $manufacturingBusinessOperation)
    {
     ...
     * An operation applied to the product, for manufacturing or adminsitrative purpose.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductManufacturingBusinessOperationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\MedicinalProductSpecialDesignationType $specialDesignation
     */
    public function addToSpecialDesignation(\TKusy\Hl7Fhir\R4\MedicinalProductSpecialDesignationType $specialDesignation)
    {
     ...
     * Indicates if the medicinal product has an orphan designation for the treatment of a rare disease.
     *
     * @return \TKusy\Hl7Fhir\R4\MedicinalProductSpecialDesignationType[]
     */
