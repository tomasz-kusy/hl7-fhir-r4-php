...
class EnrollmentResponseType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ReferenceType $requestProvider
     */
     ...
     * The practitioner who is responsible for the services rendered to the patient.
     *
     * @param \TKusy\Hl7Fhir\R4\ReferenceType $requestProvider
     * @return self
     */
    public function setRequestProvider(\TKusy\Hl7Fhir\R4\ReferenceType $requestProvider)
    {
