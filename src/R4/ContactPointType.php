...
class ContactPointType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContactPointSystemType $system
     */
    private $system = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\ContactPointUseType $use
     */
    private $use = null;
     ...
     * Telecommunications form for contact point - what communications system is required to make use of the contact.
     *
     * @return \TKusy\Hl7Fhir\R4\ContactPointSystemType
     */
     ...
     * Telecommunications form for contact point - what communications system is required to make use of the contact.
     *
     * @param \TKusy\Hl7Fhir\R4\ContactPointSystemType $system
     * @return self
     */
    public function setSystem(\TKusy\Hl7Fhir\R4\ContactPointSystemType $system)
    {
        $this->system = $system;
        return $this;
    }
     ...
     * Identifies the purpose for the contact point.
     *
     * @return \TKusy\Hl7Fhir\R4\ContactPointUseType
     */
     ...
     * Identifies the purpose for the contact point.
     *
     * @param \TKusy\Hl7Fhir\R4\ContactPointUseType $use
     * @return self
     */
    public function setUse(\TKusy\Hl7Fhir\R4\ContactPointUseType $use)
    {
        $this->use = $use;
        return $this;
    }
