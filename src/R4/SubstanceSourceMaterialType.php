...
class SubstanceSourceMaterialType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialClass
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialType
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialState
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType $organismId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType $organismName
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\IdentifierType[] $parentSubstanceId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $parentSubstanceName
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType[] $countryOfOrigin
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\StringType[] $geographicalLocation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $developmentStage
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialFractionDescriptionType[] $fractionDescription
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialOrganismType $organism
     */
     ...
     * To do.
     *
     * @var \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialPartDescriptionType[] $partDescription
     */
     ...
     * General high level classification of the source material specific to the origin of the material.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialClass
     * @return self
     */
    public function setSourceMaterialClass(\TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialClass)
    {
     ...
     * The type of the source material shall be specified based on a controlled vocabulary. For vaccines, this subclause refers to the class of infectious agent.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialType
     * @return self
     */
    public function setSourceMaterialType(\TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialType)
    {
     ...
     * The state of the source material when extracted.
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialState
     * @return self
     */
    public function setSourceMaterialState(\TKusy\Hl7Fhir\R4\CodeableConceptType $sourceMaterialState)
    {
     ...
     * The unique identifier associated with the source material parent organism shall be specified.
     *
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $organismId
     * @return self
     */
    public function setOrganismId(\TKusy\Hl7Fhir\R4\IdentifierType $organismId)
    {
     ...
     * The organism accepted Scientific name shall be provided based on the organism taxonomy.
     *
     * @param \TKusy\Hl7Fhir\R4\StringType $organismName
     * @return self
     */
    public function setOrganismName(\TKusy\Hl7Fhir\R4\StringType $organismName)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\IdentifierType $parentSubstanceId
     */
    public function addToParentSubstanceId(\TKusy\Hl7Fhir\R4\IdentifierType $parentSubstanceId)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $parentSubstanceName
     */
    public function addToParentSubstanceName(\TKusy\Hl7Fhir\R4\StringType $parentSubstanceName)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $countryOfOrigin
     */
    public function addToCountryOfOrigin(\TKusy\Hl7Fhir\R4\CodeableConceptType $countryOfOrigin)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\StringType $geographicalLocation
     */
    public function addToGeographicalLocation(\TKusy\Hl7Fhir\R4\StringType $geographicalLocation)
    {
     ...
     * Stage of life for animals, plants, insects and microorganisms. This information shall be provided only when the substance is significantly different in these stages (e.g. foetal bovine serum).
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $developmentStage
     * @return self
     */
    public function setDevelopmentStage(\TKusy\Hl7Fhir\R4\CodeableConceptType $developmentStage)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialFractionDescriptionType $fractionDescription
     */
    public function addToFractionDescription(\TKusy\Hl7Fhir\R4\SubstanceSourceMaterialFractionDescriptionType $fractionDescription)
    {
     ...
     * Many complex materials are fractions of parts of plants, animals, or minerals. Fraction elements are often necessary to define both Substances and Specified Group 1 Substances. For substances derived from Plants, fraction information will be captured at the Substance information level ( . Oils, Juices and Exudates). Additional information for Extracts, such as extraction solvent composition, will be captured at the Specified Substance Group 1 information level. For plasma-derived products fraction information will be captured at the Substance and the Specified Substance Group 1 levels.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialFractionDescriptionType[]
     */
     ...
     * This subclause describes the organism which the substance is derived from. For vaccines, the parent organism shall be specified based on these subclause elements. As an example, full taxonomy will be described for the Substance Name: ., Leaf.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialOrganismType
     */
     ...
     * This subclause describes the organism which the substance is derived from. For vaccines, the parent organism shall be specified based on these subclause elements. As an example, full taxonomy will be described for the Substance Name: ., Leaf.
     *
     * @param \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialOrganismType $organism
     * @return self
     */
    public function setOrganism(\TKusy\Hl7Fhir\R4\SubstanceSourceMaterialOrganismType $organism)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialPartDescriptionType $partDescription
     */
    public function addToPartDescription(\TKusy\Hl7Fhir\R4\SubstanceSourceMaterialPartDescriptionType $partDescription)
    {
     ...
     * To do.
     *
     * @return \TKusy\Hl7Fhir\R4\SubstanceSourceMaterialPartDescriptionType[]
     */
