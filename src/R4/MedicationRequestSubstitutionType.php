...
class MedicationRequestSubstitutionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R4\BooleanType $allowedBoolean
     */
     ...
     * True if the prescriber allows a different drug to be dispensed from what was prescribed. (choose any one of allowed*, but only one)
     *
     * @var \TKusy\Hl7Fhir\R4\CodeableConceptType $allowedCodeableConcept
     */
     ...
     * True if the prescriber allows a different drug to be dispensed from what was prescribed. (choose any one of allowed*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\BooleanType $allowedBoolean
     * @return self
     */
    public function setAllowedBoolean(\TKusy\Hl7Fhir\R4\BooleanType $allowedBoolean)
    {
     ...
     * True if the prescriber allows a different drug to be dispensed from what was prescribed. (choose any one of allowed*, but only one)
     *
     * @param \TKusy\Hl7Fhir\R4\CodeableConceptType $allowedCodeableConcept
     * @return self
     */
    public function setAllowedCodeableConcept(\TKusy\Hl7Fhir\R4\CodeableConceptType $allowedCodeableConcept)
    {
