...
class CarePlanType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CarePlanIntentType $intent
     */
    private $intent = null;
     ...
     * Indicates the level of authority/intentionality associated with the care plan and where the care plan fits into the workflow chain.
     *
     * @return \TKusy\Hl7FhirR4\CarePlanIntentType
     */
     ...
     * Indicates the level of authority/intentionality associated with the care plan and where the care plan fits into the workflow chain.
     *
     * @param \TKusy\Hl7FhirR4\CarePlanIntentType $intent
     * @return self
     */
    public function setIntent(\TKusy\Hl7FhirR4\CarePlanIntentType $intent)
    {
        $this->intent = $intent;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $careTeam
     */
    public function addToCareTeam(\TKusy\Hl7FhirR4\ReferenceType $careTeam)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CarePlanActivityType $activity
     */
    public function addToActivity(\TKusy\Hl7FhirR4\CarePlanActivityType $activity)
    {
     ...
     * Identifies a planned action to occur as part of the plan. For example, a medication to be used, lab tests to perform, self-monitoring, education, etc.
     *
     * @return \TKusy\Hl7FhirR4\CarePlanActivityType[]
     */
