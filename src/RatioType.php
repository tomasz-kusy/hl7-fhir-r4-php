...
class RatioType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\QuantityType $numerator
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\QuantityType $denominator
     */
     ...
     * The value of the numerator.
     *
     * @param \TKusy\Hl7FhirR4\QuantityType $numerator
     * @return self
     */
    public function setNumerator(\TKusy\Hl7FhirR4\QuantityType $numerator)
    {
     ...
     * The value of the denominator.
     *
     * @param \TKusy\Hl7FhirR4\QuantityType $denominator
     * @return self
     */
    public function setDenominator(\TKusy\Hl7FhirR4\QuantityType $denominator)
    {
