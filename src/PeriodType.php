...
class PeriodType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $start
     */
    private $start = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $end
     */
    private $end = null;
     ...
     * The start of the period. The boundary is inclusive.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $start
     * @return self
     */
    public function setStart(\TKusy\Hl7FhirR4\DateTimeType $start)
    {
        $this->start = $start;
        return $this;
    }
     ...
     * The end of the period. If the end of the period is missing, it means no end was known or planned at the time the instance was created. The start may be in the past, and the end date in the future, which means that period is expected/planned to end at that time.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $end
     * @return self
     */
    public function setEnd(\TKusy\Hl7FhirR4\DateTimeType $end)
    {
        $this->end = $end;
        return $this;
    }
