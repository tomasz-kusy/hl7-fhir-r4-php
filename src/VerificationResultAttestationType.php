...
class VerificationResultAttestationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\SignatureType $proxySignature
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\SignatureType $sourceSignature
     */
     ...
     * @return self
     */
    public function setCommunicationMethod(\TKusy\Hl7FhirR4\CodeableConceptType $communicationMethod)
    {
     ...
     * Signed assertion by the proxy entity indicating that they have the right to submit attested information on behalf of the attestation source.
     *
     * @param \TKusy\Hl7FhirR4\SignatureType $proxySignature
     * @return self
     */
    public function setProxySignature(\TKusy\Hl7FhirR4\SignatureType $proxySignature)
    {
     ...
     * Signed assertion by the attestation source that they have attested to the information.
     *
     * @param \TKusy\Hl7FhirR4\SignatureType $sourceSignature
     * @return self
     */
    public function setSourceSignature(\TKusy\Hl7FhirR4\SignatureType $sourceSignature)
    {
