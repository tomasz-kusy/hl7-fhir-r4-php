...
class EffectEvidenceSynthesisEffectEstimateType extends BackboneElementType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EffectEvidenceSynthesisPrecisionEstimateType $precisionEstimate
     */
    public function addToPrecisionEstimate(\TKusy\Hl7FhirR4\EffectEvidenceSynthesisPrecisionEstimateType $precisionEstimate)
    {
     ...
     * A description of the precision of the estimate for the effect.
     *
     * @return \TKusy\Hl7FhirR4\EffectEvidenceSynthesisPrecisionEstimateType[]
     */
