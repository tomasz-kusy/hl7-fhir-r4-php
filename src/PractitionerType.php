...
class PractitionerType extends DomainResourceType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\PractitionerQualificationType $qualification
     */
    public function addToQualification(\TKusy\Hl7FhirR4\PractitionerQualificationType $qualification)
    {
     ...
     * The official certifications, training, and licenses that authorize or otherwise pertain to the provision of care by the practitioner. For example, a medical license issued by a medical board authorizing the practitioner to practice medicine within a certian locality.
     *
     * @return \TKusy\Hl7FhirR4\PractitionerQualificationType[]
     */
