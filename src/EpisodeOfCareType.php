...
class EpisodeOfCareType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $careManager
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EpisodeOfCareStatusHistoryType $statusHistory
     */
    public function addToStatusHistory(\TKusy\Hl7FhirR4\EpisodeOfCareStatusHistoryType $statusHistory)
    {
     ...
     * The history of statuses that the EpisodeOfCare has been through (without requiring processing the history of the resource).
     *
     * @return \TKusy\Hl7FhirR4\EpisodeOfCareStatusHistoryType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EpisodeOfCareDiagnosisType $diagnosis
     */
    public function addToDiagnosis(\TKusy\Hl7FhirR4\EpisodeOfCareDiagnosisType $diagnosis)
    {
     ...
     * The list of diagnosis relevant to this episode of care.
     *
     * @return \TKusy\Hl7FhirR4\EpisodeOfCareDiagnosisType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $referralRequest
     */
    public function addToReferralRequest(\TKusy\Hl7FhirR4\ReferenceType $referralRequest)
    {
     ...
     * The practitioner that is the care manager/care coordinator for this patient.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $careManager
     * @return self
     */
    public function setCareManager(\TKusy\Hl7FhirR4\ReferenceType $careManager)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $team
     */
    public function addToTeam(\TKusy\Hl7FhirR4\ReferenceType $team)
    {
        $this->team[] = $team;
        return $this;
    }
