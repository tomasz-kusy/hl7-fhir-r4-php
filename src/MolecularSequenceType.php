...
class MolecularSequenceType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\MolecularSequenceReferenceSeqType $referenceSeq
     */
     ...
     * A sequence that is used as a reference to describe variants that are present in a sequence analyzed.
     *
     * @return \TKusy\Hl7FhirR4\MolecularSequenceReferenceSeqType
     */
     ...
     * A sequence that is used as a reference to describe variants that are present in a sequence analyzed.
     *
     * @param \TKusy\Hl7FhirR4\MolecularSequenceReferenceSeqType $referenceSeq
     * @return self
     */
    public function setReferenceSeq(\TKusy\Hl7FhirR4\MolecularSequenceReferenceSeqType $referenceSeq)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MolecularSequenceVariantType $variant
     */
    public function addToVariant(\TKusy\Hl7FhirR4\MolecularSequenceVariantType $variant)
    {
     ...
     * The definition of variant here originates from Sequence ontology ([variant_of](http://www.sequenceontology.org/browser/current_svn/term/variant_of)). This element can represent amino acid or nucleic sequence change(including insertion,deletion,SNP,etc.) It can represent some complex mutation or segment variation with the assist of CIGAR string.
     *
     * @return \TKusy\Hl7FhirR4\MolecularSequenceVariantType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MolecularSequenceQualityType $quality
     */
    public function addToQuality(\TKusy\Hl7FhirR4\MolecularSequenceQualityType $quality)
    {
     ...
     * An experimental feature attribute that defines the quality of the feature in a quantitative way, such as a phred quality score ([SO:0001686](http://www.sequenceontology.org/browser/current_svn/term/SO:0001686)).
     *
     * @return \TKusy\Hl7FhirR4\MolecularSequenceQualityType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MolecularSequenceRepositoryType $repository
     */
    public function addToRepository(\TKusy\Hl7FhirR4\MolecularSequenceRepositoryType $repository)
    {
     ...
     * Configurations of the external repository. The repository shall store target's observedSeq or records related with target's observedSeq.
     *
     * @return \TKusy\Hl7FhirR4\MolecularSequenceRepositoryType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $pointer
     */
    public function addToPointer(\TKusy\Hl7FhirR4\ReferenceType $pointer)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MolecularSequenceStructureVariantType $structureVariant
     */
    public function addToStructureVariant(\TKusy\Hl7FhirR4\MolecularSequenceStructureVariantType $structureVariant)
    {
     ...
     * Information about chromosome structure variation.
     *
     * @return \TKusy\Hl7FhirR4\MolecularSequenceStructureVariantType[]
     */
