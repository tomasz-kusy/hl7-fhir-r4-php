...
class BundleType extends ResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\BundleTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\InstantType $timestamp
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\UnsignedIntType $total
     */
    private $total = null;
     ...
     * Indicates the purpose of this bundle - how it is intended to be used.
     *
     * @return \TKusy\Hl7FhirR4\BundleTypeType
     */
     ...
     * Indicates the purpose of this bundle - how it is intended to be used.
     *
     * @param \TKusy\Hl7FhirR4\BundleTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7FhirR4\BundleTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     * The date/time that the bundle was assembled - i.e. when the resources were placed in the bundle.
     *
     * @param \TKusy\Hl7FhirR4\InstantType $timestamp
     * @return self
     */
    public function setTimestamp(\TKusy\Hl7FhirR4\InstantType $timestamp)
    {
     ...
     * If a set of search matches, this is the total number of entries of type 'match' across all pages in the search. It does not include search.mode = 'include' or 'outcome' entries and it does not provide a count of the number of entries in the Bundle.
     *
     * @param \TKusy\Hl7FhirR4\UnsignedIntType $total
     * @return self
     */
    public function setTotal(\TKusy\Hl7FhirR4\UnsignedIntType $total)
    {
        $this->total = $total;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\BundleEntryType $entry
     */
    public function addToEntry(\TKusy\Hl7FhirR4\BundleEntryType $entry)
    {
        $this->entry[] = $entry;
        return $this;
    }
     ...
     * An entry in a bundle resource - will either contain a resource or information about a resource (transactions and history only).
     *
     * @return \TKusy\Hl7FhirR4\BundleEntryType[]
     */
     ...
     * @return self
     */
    public function setSignature(\TKusy\Hl7FhirR4\SignatureType $signature)
    {
