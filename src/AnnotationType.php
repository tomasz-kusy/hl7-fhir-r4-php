...
class AnnotationType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $authorReference
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\MarkdownType $text
     */
    private $text = null;
     ...
     * The individual responsible for making the annotation. (choose any one of author*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $authorReference
     * @return self
     */
    public function setAuthorReference(\TKusy\Hl7FhirR4\ReferenceType $authorReference)
    {
     ...
     * The text of the annotation in markdown format.
     *
     * @param \TKusy\Hl7FhirR4\MarkdownType $text
     * @return self
     */
    public function setText(\TKusy\Hl7FhirR4\MarkdownType $text)
    {
        $this->text = $text;
        return $this;
    }
