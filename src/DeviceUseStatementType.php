...
class DeviceUseStatementType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\DeviceUseStatementStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $recordedOn
     */
     ...
     * A code representing the patient or other source's judgment about the state of the device used that this statement is about. Generally this will be active or completed.
     *
     * @return \TKusy\Hl7FhirR4\DeviceUseStatementStatusType
     */
     ...
     * A code representing the patient or other source's judgment about the state of the device used that this statement is about. Generally this will be active or completed.
     *
     * @param \TKusy\Hl7FhirR4\DeviceUseStatementStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7FhirR4\DeviceUseStatementStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The time at which the statement was made/recorded.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $recordedOn
     * @return self
     */
    public function setRecordedOn(\TKusy\Hl7FhirR4\DateTimeType $recordedOn)
    {
