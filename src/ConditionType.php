...
class ConditionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $abatementDateTime
     */
     ...
     * The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution" - Conditions are never really resolved, but they can abate. (choose any one of abatement*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\AgeType $abatementAge
     */
     ...
     * The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution" - Conditions are never really resolved, but they can abate. (choose any one of abatement*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\PeriodType $abatementPeriod
     */
     ...
     * The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution" - Conditions are never really resolved, but they can abate. (choose any one of abatement*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\RangeType $abatementRange
     */
     ...
     * The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution" - Conditions are never really resolved, but they can abate. (choose any one of abatement*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $abatementDateTime
     * @return self
     */
    public function setAbatementDateTime(\TKusy\Hl7FhirR4\DateTimeType $abatementDateTime)
    {
     ...
     * The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution" - Conditions are never really resolved, but they can abate. (choose any one of abatement*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\AgeType $abatementAge
     * @return self
     */
    public function setAbatementAge(\TKusy\Hl7FhirR4\AgeType $abatementAge)
    {
     ...
     * The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution" - Conditions are never really resolved, but they can abate. (choose any one of abatement*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\PeriodType $abatementPeriod
     * @return self
     */
    public function setAbatementPeriod(\TKusy\Hl7FhirR4\PeriodType $abatementPeriod)
    {
     ...
     * The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution" - Conditions are never really resolved, but they can abate. (choose any one of abatement*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\RangeType $abatementRange
     * @return self
     */
    public function setAbatementRange(\TKusy\Hl7FhirR4\RangeType $abatementRange)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ConditionStageType $stage
     */
    public function addToStage(\TKusy\Hl7FhirR4\ConditionStageType $stage)
    {
        $this->stage[] = $stage;
        return $this;
    }
     ...
     * Clinical stage or grade of a condition. May include formal severity assessments.
     *
     * @return \TKusy\Hl7FhirR4\ConditionStageType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ConditionEvidenceType $evidence
     */
    public function addToEvidence(\TKusy\Hl7FhirR4\ConditionEvidenceType $evidence)
    {
     ...
     * Supporting evidence / manifestations that are the basis of the Condition's verification status, such as evidence that confirmed or refuted the condition.
     *
     * @return \TKusy\Hl7FhirR4\ConditionEvidenceType[]
     */
