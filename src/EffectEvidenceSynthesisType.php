...
class EffectEvidenceSynthesisType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $synthesisType
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $studyType
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\EffectEvidenceSynthesisSampleSizeType $sampleSize
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\EffectEvidenceSynthesisResultsByExposureType[] $resultsByExposure
     */
    private $resultsByExposure = null;

    /**
     * The estimated effect of the exposure variant.
     *
     * @var \TKusy\Hl7FhirR4\EffectEvidenceSynthesisEffectEstimateType[] $effectEstimate
     */
    private $effectEstimate = null;

    /**
     * A description of the certainty of the effect estimate.
     *
     * @var \TKusy\Hl7FhirR4\EffectEvidenceSynthesisCertaintyType[] $certainty
     */
     ...
     * Type of synthesis eg meta-analysis.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $synthesisType
     * @return self
     */
    public function setSynthesisType(\TKusy\Hl7FhirR4\CodeableConceptType $synthesisType)
    {
     ...
     * Type of study eg randomized trial.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $studyType
     * @return self
     */
    public function setStudyType(\TKusy\Hl7FhirR4\CodeableConceptType $studyType)
    {
     ...
     * A description of the size of the sample involved in the synthesis.
     *
     * @return \TKusy\Hl7FhirR4\EffectEvidenceSynthesisSampleSizeType
     */
     ...
     * A description of the size of the sample involved in the synthesis.
     *
     * @param \TKusy\Hl7FhirR4\EffectEvidenceSynthesisSampleSizeType $sampleSize
     * @return self
     */
    public function setSampleSize(\TKusy\Hl7FhirR4\EffectEvidenceSynthesisSampleSizeType $sampleSize)
    {
    ...
    /**
     * Adds as resultsByExposure
     *
     * A description of the results for each exposure considered in the effect estimate.
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EffectEvidenceSynthesisResultsByExposureType $resultsByExposure
     */
    public function addToResultsByExposure(\TKusy\Hl7FhirR4\EffectEvidenceSynthesisResultsByExposureType $resultsByExposure)
    {
     ...
     * @return bool
     */
    public function issetResultsByExposure($index)
    {
        return isset($this->resultsByExposure[$index]);
    }

    /**
     * unset resultsByExposure
     *
     * A description of the results for each exposure considered in the effect estimate.
     *
     * @param int|string $index
     * @return void
     */
    public function unsetResultsByExposure($index)
    {
        unset($this->resultsByExposure[$index]);
    }

    /**
     * Gets as resultsByExposure
     *
     * A description of the results for each exposure considered in the effect estimate.
     *
     * @return \TKusy\Hl7FhirR4\EffectEvidenceSynthesisResultsByExposureType[]
     */
    ...
    /**
     * Adds as effectEstimate
     *
     * The estimated effect of the exposure variant.
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EffectEvidenceSynthesisEffectEstimateType $effectEstimate
     */
    public function addToEffectEstimate(\TKusy\Hl7FhirR4\EffectEvidenceSynthesisEffectEstimateType $effectEstimate)
    {
     ...
     * @return bool
     */
    public function issetEffectEstimate($index)
    {
        return isset($this->effectEstimate[$index]);
    }

    /**
     * unset effectEstimate
     *
     * The estimated effect of the exposure variant.
     *
     * @param int|string $index
     * @return void
     */
    public function unsetEffectEstimate($index)
    {
        unset($this->effectEstimate[$index]);
    }

    /**
     * Gets as effectEstimate
     *
     * The estimated effect of the exposure variant.
     *
     * @return \TKusy\Hl7FhirR4\EffectEvidenceSynthesisEffectEstimateType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EffectEvidenceSynthesisCertaintyType $certainty
     */
    public function addToCertainty(\TKusy\Hl7FhirR4\EffectEvidenceSynthesisCertaintyType $certainty)
    {
     ...
     * A description of the certainty of the effect estimate.
     *
     * @return \TKusy\Hl7FhirR4\EffectEvidenceSynthesisCertaintyType[]
     */
