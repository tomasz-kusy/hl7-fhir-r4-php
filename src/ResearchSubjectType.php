...
class ResearchSubjectType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ResearchSubjectStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $consent
     */
     ...
     * The current state of the subject.
     *
     * @return \TKusy\Hl7FhirR4\ResearchSubjectStatusType
     */
     ...
     * The current state of the subject.
     *
     * @param \TKusy\Hl7FhirR4\ResearchSubjectStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7FhirR4\ResearchSubjectStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * @return self
     */
    public function setStudy(\TKusy\Hl7FhirR4\ReferenceType $study)
    {
        $this->study = $study;
        return $this;
    }
     ...
     * A record of the patient's informed agreement to participate in the study.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $consent
     * @return self
     */
    public function setConsent(\TKusy\Hl7FhirR4\ReferenceType $consent)
    {
