...
class ExampleScenarioProcessType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\MarkdownType $preConditions
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\MarkdownType $postConditions
     */
     ...
     * Description of initial status before the process starts.
     *
     * @param \TKusy\Hl7FhirR4\MarkdownType $preConditions
     * @return self
     */
    public function setPreConditions(\TKusy\Hl7FhirR4\MarkdownType $preConditions)
    {
     ...
     * Description of final status after the process ends.
     *
     * @param \TKusy\Hl7FhirR4\MarkdownType $postConditions
     * @return self
     */
    public function setPostConditions(\TKusy\Hl7FhirR4\MarkdownType $postConditions)
    {
