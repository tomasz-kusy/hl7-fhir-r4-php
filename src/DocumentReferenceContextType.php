...
class DocumentReferenceContextType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $facilityType
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $practiceSetting
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $sourcePatientInfo
     */
     ...
     */
    public function addToEvent(\TKusy\Hl7FhirR4\CodeableConceptType $event)
    {
        $this->event[] = $event;
        return $this;
    }
     ...
     * The kind of facility where the patient was seen.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $facilityType
     * @return self
     */
    public function setFacilityType(\TKusy\Hl7FhirR4\CodeableConceptType $facilityType)
    {
     ...
     * This property may convey specifics about the practice setting where the content was created, often reflecting the clinical specialty.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $practiceSetting
     * @return self
     */
    public function setPracticeSetting(\TKusy\Hl7FhirR4\CodeableConceptType $practiceSetting)
    {
     ...
     * The Patient Information as known when the document was published. May be a reference to a version specific, or contained.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $sourcePatientInfo
     * @return self
     */
    public function setSourcePatientInfo(\TKusy\Hl7FhirR4\ReferenceType $sourcePatientInfo)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $related
     */
    public function addToRelated(\TKusy\Hl7FhirR4\ReferenceType $related)
    {
