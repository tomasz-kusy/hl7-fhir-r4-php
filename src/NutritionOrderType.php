...
class NutritionOrderType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $orderer
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\NutritionOrderOralDietType $oralDiet
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\NutritionOrderEnteralFormulaType $enteralFormula
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\UriType $instantiates
     */
    public function addToInstantiates(\TKusy\Hl7FhirR4\UriType $instantiates)
    {
     ...
     * The practitioner that holds legal responsibility for ordering the diet, nutritional supplement, or formula feedings.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $orderer
     * @return self
     */
    public function setOrderer(\TKusy\Hl7FhirR4\ReferenceType $orderer)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $allergyIntolerance
     */
    public function addToAllergyIntolerance(\TKusy\Hl7FhirR4\ReferenceType $allergyIntolerance)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $foodPreferenceModifier
     */
    public function addToFoodPreferenceModifier(\TKusy\Hl7FhirR4\CodeableConceptType $foodPreferenceModifier)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $excludeFoodModifier
     */
    public function addToExcludeFoodModifier(\TKusy\Hl7FhirR4\CodeableConceptType $excludeFoodModifier)
    {
     ...
     * Diet given orally in contrast to enteral (tube) feeding.
     *
     * @return \TKusy\Hl7FhirR4\NutritionOrderOralDietType
     */
     ...
     * Diet given orally in contrast to enteral (tube) feeding.
     *
     * @param \TKusy\Hl7FhirR4\NutritionOrderOralDietType $oralDiet
     * @return self
     */
    public function setOralDiet(\TKusy\Hl7FhirR4\NutritionOrderOralDietType $oralDiet)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\NutritionOrderSupplementType $supplement
     */
    public function addToSupplement(\TKusy\Hl7FhirR4\NutritionOrderSupplementType $supplement)
    {
     ...
     * Oral nutritional products given in order to add further nutritional value to the patient's diet.
     *
     * @return \TKusy\Hl7FhirR4\NutritionOrderSupplementType[]
     */
     ...
     * Feeding provided through the gastrointestinal tract via a tube, catheter, or stoma that delivers nutrition distal to the oral cavity.
     *
     * @return \TKusy\Hl7FhirR4\NutritionOrderEnteralFormulaType
     */
     ...
     * Feeding provided through the gastrointestinal tract via a tube, catheter, or stoma that delivers nutrition distal to the oral cavity.
     *
     * @param \TKusy\Hl7FhirR4\NutritionOrderEnteralFormulaType $enteralFormula
     * @return self
     */
    public function setEnteralFormula(\TKusy\Hl7FhirR4\NutritionOrderEnteralFormulaType $enteralFormula)
    {
