...
class AccountType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\AccountStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\PeriodType $servicePeriod
     */
     ...
     * Indicates whether the account is presently used/usable or not.
     *
     * @return \TKusy\Hl7FhirR4\AccountStatusType
     */
     ...
     * Indicates whether the account is presently used/usable or not.
     *
     * @param \TKusy\Hl7FhirR4\AccountStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7FhirR4\AccountStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     * The date range of services associated with this account.
     *
     * @param \TKusy\Hl7FhirR4\PeriodType $servicePeriod
     * @return self
     */
    public function setServicePeriod(\TKusy\Hl7FhirR4\PeriodType $servicePeriod)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\AccountCoverageType $coverage
     */
    public function addToCoverage(\TKusy\Hl7FhirR4\AccountCoverageType $coverage)
    {
     ...
     * The party(s) that are responsible for covering the payment of this account, and what order should they be applied to the account.
     *
     * @return \TKusy\Hl7FhirR4\AccountCoverageType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\AccountGuarantorType $guarantor
     */
    public function addToGuarantor(\TKusy\Hl7FhirR4\AccountGuarantorType $guarantor)
    {
     ...
     * The parties responsible for balancing the account if other payment options fall short.
     *
     * @return \TKusy\Hl7FhirR4\AccountGuarantorType[]
     */
