...
class MedicationAdministrationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\MedicationAdministrationDosageType $dosage
     */
    private $dosage = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MedicationAdministrationPerformerType $performer
     */
    public function addToPerformer(\TKusy\Hl7FhirR4\MedicationAdministrationPerformerType $performer)
    {
     ...
     * Indicates who or what performed the medication administration and how they were involved.
     *
     * @return \TKusy\Hl7FhirR4\MedicationAdministrationPerformerType[]
     */
     ...
     * Describes the medication dosage information details e.g. dose, rate, site, route, etc.
     *
     * @return \TKusy\Hl7FhirR4\MedicationAdministrationDosageType
     */
     ...
     * Describes the medication dosage information details e.g. dose, rate, site, route, etc.
     *
     * @param \TKusy\Hl7FhirR4\MedicationAdministrationDosageType $dosage
     * @return self
     */
    public function setDosage(\TKusy\Hl7FhirR4\MedicationAdministrationDosageType $dosage)
    {
        $this->dosage = $dosage;
        return $this;
    }
