...
class ExplanationOfBenefitDetail1Type extends BackboneElementType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ExplanationOfBenefitSubDetail1Type $subDetail
     */
    public function addToSubDetail(\TKusy\Hl7FhirR4\ExplanationOfBenefitSubDetail1Type $subDetail)
    {
     ...
     * The third-tier service adjudications for payor added services.
     *
     * @return \TKusy\Hl7FhirR4\ExplanationOfBenefitSubDetail1Type[]
     */
