...
class EvidenceVariableCharacteristicType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $definitionReference
     */
     ...
     * Define members of the evidence element using Codes (such as condition, medication, or observation), Expressions ( using an expression language such as FHIRPath or CQL) or DataRequirements (such as Diabetes diagnosis onset in the last year). (choose any one of definition*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\TriggerDefinitionType $definitionTriggerDefinition
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\DurationType $timeFromStart
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\GroupMeasureType $groupMeasure
     */
     ...
     * Define members of the evidence element using Codes (such as condition, medication, or observation), Expressions ( using an expression language such as FHIRPath or CQL) or DataRequirements (such as Diabetes diagnosis onset in the last year). (choose any one of definition*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $definitionReference
     * @return self
     */
    public function setDefinitionReference(\TKusy\Hl7FhirR4\ReferenceType $definitionReference)
    {
     ...
     * Define members of the evidence element using Codes (such as condition, medication, or observation), Expressions ( using an expression language such as FHIRPath or CQL) or DataRequirements (such as Diabetes diagnosis onset in the last year). (choose any one of definition*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\TriggerDefinitionType $definitionTriggerDefinition
     * @return self
     */
    public function setDefinitionTriggerDefinition(\TKusy\Hl7FhirR4\TriggerDefinitionType $definitionTriggerDefinition)
    {
     ...
     * Indicates duration from the participant's study entry.
     *
     * @param \TKusy\Hl7FhirR4\DurationType $timeFromStart
     * @return self
     */
    public function setTimeFromStart(\TKusy\Hl7FhirR4\DurationType $timeFromStart)
    {
     ...
     * Indicates how elements are aggregated within the study effective period.
     *
     * @param \TKusy\Hl7FhirR4\GroupMeasureType $groupMeasure
     * @return self
     */
    public function setGroupMeasure(\TKusy\Hl7FhirR4\GroupMeasureType $groupMeasure)
    {
