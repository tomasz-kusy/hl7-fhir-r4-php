...
class TerminologyCapabilitiesType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\TerminologyCapabilitiesSoftwareType $software
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\TerminologyCapabilitiesImplementationType $implementation
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\BooleanType $lockedDate
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\TerminologyCapabilitiesExpansionType $expansion
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeSearchSupportType $codeSearch
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\TerminologyCapabilitiesValidateCodeType $validateCode
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\TerminologyCapabilitiesTranslationType $translation
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\TerminologyCapabilitiesClosureType $closure
     */
     ...
     * Software that is covered by this terminology capability statement. It is used when the statement describes the capabilities of a particular software version, independent of an installation.
     *
     * @return \TKusy\Hl7FhirR4\TerminologyCapabilitiesSoftwareType
     */
     ...
     * Software that is covered by this terminology capability statement. It is used when the statement describes the capabilities of a particular software version, independent of an installation.
     *
     * @param \TKusy\Hl7FhirR4\TerminologyCapabilitiesSoftwareType $software
     * @return self
     */
    public function setSoftware(\TKusy\Hl7FhirR4\TerminologyCapabilitiesSoftwareType $software)
    {
     ...
     * Identifies a specific implementation instance that is described by the terminology capability statement - i.e. a particular installation, rather than the capabilities of a software program.
     *
     * @return \TKusy\Hl7FhirR4\TerminologyCapabilitiesImplementationType
     */
     ...
     * Identifies a specific implementation instance that is described by the terminology capability statement - i.e. a particular installation, rather than the capabilities of a software program.
     *
     * @param \TKusy\Hl7FhirR4\TerminologyCapabilitiesImplementationType $implementation
     * @return self
     */
    public function setImplementation(\TKusy\Hl7FhirR4\TerminologyCapabilitiesImplementationType $implementation)
    {
     ...
     * Whether the server supports lockedDate.
     *
     * @param \TKusy\Hl7FhirR4\BooleanType $lockedDate
     * @return self
     */
    public function setLockedDate(\TKusy\Hl7FhirR4\BooleanType $lockedDate)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\TerminologyCapabilitiesCodeSystemType $codeSystem
     */
    public function addToCodeSystem(\TKusy\Hl7FhirR4\TerminologyCapabilitiesCodeSystemType $codeSystem)
    {
     ...
     * Identifies a code system that is supported by the server. If there is a no code system URL, then this declares the general assumptions a client can make about support for any CodeSystem resource.
     *
     * @return \TKusy\Hl7FhirR4\TerminologyCapabilitiesCodeSystemType[]
     */
     ...
     * Information about the [ValueSet/$expand](valueset-operation-expand.html) operation.
     *
     * @return \TKusy\Hl7FhirR4\TerminologyCapabilitiesExpansionType
     */
     ...
     * Information about the [ValueSet/$expand](valueset-operation-expand.html) operation.
     *
     * @param \TKusy\Hl7FhirR4\TerminologyCapabilitiesExpansionType $expansion
     * @return self
     */
    public function setExpansion(\TKusy\Hl7FhirR4\TerminologyCapabilitiesExpansionType $expansion)
    {
     ...
     * The degree to which the server supports the code search parameter on ValueSet, if it is supported.
     *
     * @return \TKusy\Hl7FhirR4\CodeSearchSupportType
     */
     ...
     * The degree to which the server supports the code search parameter on ValueSet, if it is supported.
     *
     * @param \TKusy\Hl7FhirR4\CodeSearchSupportType $codeSearch
     * @return self
     */
    public function setCodeSearch(\TKusy\Hl7FhirR4\CodeSearchSupportType $codeSearch)
    {
     ...
     * Information about the [ValueSet/$validate-code](valueset-operation-validate-code.html) operation.
     *
     * @return \TKusy\Hl7FhirR4\TerminologyCapabilitiesValidateCodeType
     */
     ...
     * Information about the [ValueSet/$validate-code](valueset-operation-validate-code.html) operation.
     *
     * @param \TKusy\Hl7FhirR4\TerminologyCapabilitiesValidateCodeType $validateCode
     * @return self
     */
    public function setValidateCode(\TKusy\Hl7FhirR4\TerminologyCapabilitiesValidateCodeType $validateCode)
    {
     ...
     * Information about the [ConceptMap/$translate](conceptmap-operation-translate.html) operation.
     *
     * @return \TKusy\Hl7FhirR4\TerminologyCapabilitiesTranslationType
     */
     ...
     * Information about the [ConceptMap/$translate](conceptmap-operation-translate.html) operation.
     *
     * @param \TKusy\Hl7FhirR4\TerminologyCapabilitiesTranslationType $translation
     * @return self
     */
    public function setTranslation(\TKusy\Hl7FhirR4\TerminologyCapabilitiesTranslationType $translation)
    {
     ...
     * Whether the $closure operation is supported.
     *
     * @return \TKusy\Hl7FhirR4\TerminologyCapabilitiesClosureType
     */
     ...
     * Whether the $closure operation is supported.
     *
     * @param \TKusy\Hl7FhirR4\TerminologyCapabilitiesClosureType $closure
     * @return self
     */
    public function setClosure(\TKusy\Hl7FhirR4\TerminologyCapabilitiesClosureType $closure)
    {
