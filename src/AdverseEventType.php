...
class AdverseEventType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\AdverseEventActualityType $actuality
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $detected
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $seriousness
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $severity
     */
     ...
     * Whether the event actually happened, or just had the potential to. Note that this is independent of whether anyone was affected or harmed or how severely.
     *
     * @return \TKusy\Hl7FhirR4\AdverseEventActualityType
     */
     ...
     * Whether the event actually happened, or just had the potential to. Note that this is independent of whether anyone was affected or harmed or how severely.
     *
     * @param \TKusy\Hl7FhirR4\AdverseEventActualityType $actuality
     * @return self
     */
    public function setActuality(\TKusy\Hl7FhirR4\AdverseEventActualityType $actuality)
    {
     ...
     * This element defines the specific type of event that occurred or that was prevented from occurring.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $event
     * @return self
     */
    public function setEvent(\TKusy\Hl7FhirR4\CodeableConceptType $event)
    {
        $this->event = $event;
        return $this;
    }
     ...
     * Estimated or actual date the AdverseEvent began, in the opinion of the reporter.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $detected
     * @return self
     */
    public function setDetected(\TKusy\Hl7FhirR4\DateTimeType $detected)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $resultingCondition
     */
    public function addToResultingCondition(\TKusy\Hl7FhirR4\ReferenceType $resultingCondition)
    {
     ...
     * Assessment whether this event was of real importance.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $seriousness
     * @return self
     */
    public function setSeriousness(\TKusy\Hl7FhirR4\CodeableConceptType $seriousness)
    {
     ...
     * Describes the severity of the adverse event, in relation to the subject. Contrast to AdverseEvent.seriousness - a severe rash might not be serious, but a mild heart problem is.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $severity
     * @return self
     */
    public function setSeverity(\TKusy\Hl7FhirR4\CodeableConceptType $severity)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $contributor
     */
    public function addToContributor(\TKusy\Hl7FhirR4\ReferenceType $contributor)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\AdverseEventSuspectEntityType $suspectEntity
     */
    public function addToSuspectEntity(\TKusy\Hl7FhirR4\AdverseEventSuspectEntityType $suspectEntity)
    {
     ...
     * Describes the entity that is suspected to have caused the adverse event.
     *
     * @return \TKusy\Hl7FhirR4\AdverseEventSuspectEntityType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $subjectMedicalHistory
     */
    public function addToSubjectMedicalHistory(\TKusy\Hl7FhirR4\ReferenceType $subjectMedicalHistory)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $referenceDocument
     */
    public function addToReferenceDocument(\TKusy\Hl7FhirR4\ReferenceType $referenceDocument)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $study
     */
    public function addToStudy(\TKusy\Hl7FhirR4\ReferenceType $study)
    {
        $this->study[] = $study;
        return $this;
    }
