...
class InsurancePlanPlanType extends BackboneElementType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\InsurancePlanGeneralCostType $generalCost
     */
    public function addToGeneralCost(\TKusy\Hl7FhirR4\InsurancePlanGeneralCostType $generalCost)
    {
     ...
     * Overall costs associated with the plan.
     *
     * @return \TKusy\Hl7FhirR4\InsurancePlanGeneralCostType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\InsurancePlanSpecificCostType $specificCost
     */
    public function addToSpecificCost(\TKusy\Hl7FhirR4\InsurancePlanSpecificCostType $specificCost)
    {
     ...
     * Costs associated with the coverage provided by the product.
     *
     * @return \TKusy\Hl7FhirR4\InsurancePlanSpecificCostType[]
     */
