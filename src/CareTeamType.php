...
class CareTeamType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CareTeamStatusType $status
     */
    private $status = null;
     ...
     * Indicates the current state of the care team.
     *
     * @return \TKusy\Hl7FhirR4\CareTeamStatusType
     */
     ...
     * Indicates the current state of the care team.
     *
     * @param \TKusy\Hl7FhirR4\CareTeamStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7FhirR4\CareTeamStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CareTeamParticipantType $participant
     */
    public function addToParticipant(\TKusy\Hl7FhirR4\CareTeamParticipantType $participant)
    {
     ...
     * Identifies all people and organizations who are expected to be involved in the care team.
     *
     * @return \TKusy\Hl7FhirR4\CareTeamParticipantType[]
     */
     ...
     */
    public function addToManagingOrganization(\TKusy\Hl7FhirR4\ReferenceType $managingOrganization)
    {
