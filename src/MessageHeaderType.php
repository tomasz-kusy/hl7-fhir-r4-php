...
class MessageHeaderType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\MessageHeaderSourceType $source
     */
    private $source = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\MessageHeaderResponseType $response
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MessageHeaderDestinationType $destination
     */
    public function addToDestination(\TKusy\Hl7FhirR4\MessageHeaderDestinationType $destination)
    {
     ...
     * The destination application which the message is intended for.
     *
     * @return \TKusy\Hl7FhirR4\MessageHeaderDestinationType[]
     */
     ...
     * The source application from which this message originated.
     *
     * @return \TKusy\Hl7FhirR4\MessageHeaderSourceType
     */
     ...
     * The source application from which this message originated.
     *
     * @param \TKusy\Hl7FhirR4\MessageHeaderSourceType $source
     * @return self
     */
    public function setSource(\TKusy\Hl7FhirR4\MessageHeaderSourceType $source)
    {
        $this->source = $source;
        return $this;
    }
     ...
     * Information about the message that this message is a response to. Only present if this message is a response.
     *
     * @return \TKusy\Hl7FhirR4\MessageHeaderResponseType
     */
     ...
     * Information about the message that this message is a response to. Only present if this message is a response.
     *
     * @param \TKusy\Hl7FhirR4\MessageHeaderResponseType $response
     * @return self
     */
    public function setResponse(\TKusy\Hl7FhirR4\MessageHeaderResponseType $response)
    {
