...
class ClaimResponseItemType extends BackboneElementType
{
     ...
     * @return self
     */
    public function setItemSequence(\TKusy\Hl7FhirR4\PositiveIntType $itemSequence)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimResponseDetailType $detail
     */
    public function addToDetail(\TKusy\Hl7FhirR4\ClaimResponseDetailType $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
     ...
     * A claim detail. Either a simple (a product or service) or a 'group' of sub-details which are simple items.
     *
     * @return \TKusy\Hl7FhirR4\ClaimResponseDetailType[]
     */
