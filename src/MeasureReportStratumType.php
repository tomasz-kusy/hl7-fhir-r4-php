...
class MeasureReportStratumType extends BackboneElementType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MeasureReportComponentType $component
     */
    public function addToComponent(\TKusy\Hl7FhirR4\MeasureReportComponentType $component)
    {
     ...
     * A stratifier component value.
     *
     * @return \TKusy\Hl7FhirR4\MeasureReportComponentType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MeasureReportPopulation1Type $population
     */
    public function addToPopulation(\TKusy\Hl7FhirR4\MeasureReportPopulation1Type $population)
    {
     ...
     * The populations that make up the stratum, one for each type of population appropriate to the measure.
     *
     * @return \TKusy\Hl7FhirR4\MeasureReportPopulation1Type[]
     */
