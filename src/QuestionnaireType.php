...
class QuestionnaireType extends DomainResourceType
{
     ...
     */
    public function addToDerivedFrom(\TKusy\Hl7FhirR4\CanonicalType $derivedFrom)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeType $subjectType
     */
    public function addToSubjectType(\TKusy\Hl7FhirR4\CodeType $subjectType)
    {
