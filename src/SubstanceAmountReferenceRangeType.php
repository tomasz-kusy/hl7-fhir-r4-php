...
class SubstanceAmountReferenceRangeType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\QuantityType $lowLimit
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\QuantityType $highLimit
     */
     ...
     * Lower limit possible or expected.
     *
     * @param \TKusy\Hl7FhirR4\QuantityType $lowLimit
     * @return self
     */
    public function setLowLimit(\TKusy\Hl7FhirR4\QuantityType $lowLimit)
    {
     ...
     * Upper limit possible or expected.
     *
     * @param \TKusy\Hl7FhirR4\QuantityType $highLimit
     * @return self
     */
    public function setHighLimit(\TKusy\Hl7FhirR4\QuantityType $highLimit)
    {
