...
class ClaimDetailType extends BackboneElementType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimSubDetailType $subDetail
     */
    public function addToSubDetail(\TKusy\Hl7FhirR4\ClaimSubDetailType $subDetail)
    {
     ...
     * A claim detail line. Either a simple (a product or service) or a 'group' of sub-details which are simple items.
     *
     * @return \TKusy\Hl7FhirR4\ClaimSubDetailType[]
     */
