...
class CapabilityStatementInteraction1Type extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\SystemRestfulInteractionType $code
     */
    private $code = null;
     ...
     * A coded identifier of the operation, supported by the system.
     *
     * @return \TKusy\Hl7FhirR4\SystemRestfulInteractionType
     */
     ...
     * A coded identifier of the operation, supported by the system.
     *
     * @param \TKusy\Hl7FhirR4\SystemRestfulInteractionType $code
     * @return self
     */
    public function setCode(\TKusy\Hl7FhirR4\SystemRestfulInteractionType $code)
    {
        $this->code = $code;
        return $this;
    }
