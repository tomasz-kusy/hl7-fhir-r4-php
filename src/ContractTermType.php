...
class ContractTermType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ContractOfferType $offer
     */
    private $offer = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ContractSecurityLabelType $securityLabel
     */
    public function addToSecurityLabel(\TKusy\Hl7FhirR4\ContractSecurityLabelType $securityLabel)
    {
     ...
     * Security labels that protect the handling of information about the term and its elements, which may be specifically identified..
     *
     * @return \TKusy\Hl7FhirR4\ContractSecurityLabelType[]
     */
     ...
     * The matter of concern in the context of this provision of the agrement.
     *
     * @return \TKusy\Hl7FhirR4\ContractOfferType
     */
     ...
     * The matter of concern in the context of this provision of the agrement.
     *
     * @param \TKusy\Hl7FhirR4\ContractOfferType $offer
     * @return self
     */
    public function setOffer(\TKusy\Hl7FhirR4\ContractOfferType $offer)
    {
        $this->offer = $offer;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ContractAssetType $asset
     */
    public function addToAsset(\TKusy\Hl7FhirR4\ContractAssetType $asset)
    {
        $this->asset[] = $asset;
        return $this;
    }
     ...
     * Contract Term Asset List.
     *
     * @return \TKusy\Hl7FhirR4\ContractAssetType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ContractActionType $action
     */
    public function addToAction(\TKusy\Hl7FhirR4\ContractActionType $action)
    {
        $this->action[] = $action;
        return $this;
    }
     ...
     * An actor taking a role in an activity for which it can be assigned some degree of responsibility for the activity taking place.
     *
     * @return \TKusy\Hl7FhirR4\ContractActionType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ContractTermType $group
     */
    public function addToGroup(\TKusy\Hl7FhirR4\ContractTermType $group)
    {
        $this->group[] = $group;
        return $this;
    }
