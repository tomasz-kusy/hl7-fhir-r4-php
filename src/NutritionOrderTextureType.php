...
class NutritionOrderTextureType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $foodType
     */
     ...
     * The food type(s) (e.g. meats, all foods) that the texture modification applies to. This could be all foods types.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $foodType
     * @return self
     */
    public function setFoodType(\TKusy\Hl7FhirR4\CodeableConceptType $foodType)
    {
