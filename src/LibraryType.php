...
class LibraryType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ParameterDefinitionType[] $parameter
     */
    private $parameter = [
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ParameterDefinitionType $parameter
     */
    public function addToParameter(\TKusy\Hl7FhirR4\ParameterDefinitionType $parameter)
    {
     ...
     */
    public function addToContent(\TKusy\Hl7FhirR4\AttachmentType $content)
    {
