...
class ContractSecurityLabelType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodingType $classification
     */
     ...
     */
    public function addToNumber(\TKusy\Hl7FhirR4\UnsignedIntType $number)
    {
        $this->number[] = $number;
        return $this;
    }
     ...
     * Security label privacy tag that species the level of confidentiality protection required for this term and/or term elements.
     *
     * @param \TKusy\Hl7FhirR4\CodingType $classification
     * @return self
     */
    public function setClassification(\TKusy\Hl7FhirR4\CodingType $classification)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodingType $category
     */
    public function addToCategory(\TKusy\Hl7FhirR4\CodingType $category)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodingType $control
     */
    public function addToControl(\TKusy\Hl7FhirR4\CodingType $control)
    {
