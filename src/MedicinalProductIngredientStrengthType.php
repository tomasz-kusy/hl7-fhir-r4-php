...
class MedicinalProductIngredientStrengthType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\RatioType $presentation
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\RatioType $presentationLowLimit
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\RatioType $concentration
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\RatioType $concentrationLowLimit
     */
     ...
     * The quantity of substance in the unit of presentation, or in the volume (or mass) of the single pharmaceutical product or manufactured item.
     *
     * @param \TKusy\Hl7FhirR4\RatioType $presentation
     * @return self
     */
    public function setPresentation(\TKusy\Hl7FhirR4\RatioType $presentation)
    {
     ...
     * A lower limit for the quantity of substance in the unit of presentation. For use when there is a range of strengths, this is the lower limit, with the presentation attribute becoming the upper limit.
     *
     * @param \TKusy\Hl7FhirR4\RatioType $presentationLowLimit
     * @return self
     */
    public function setPresentationLowLimit(\TKusy\Hl7FhirR4\RatioType $presentationLowLimit)
    {
     ...
     * The strength per unitary volume (or mass).
     *
     * @param \TKusy\Hl7FhirR4\RatioType $concentration
     * @return self
     */
    public function setConcentration(\TKusy\Hl7FhirR4\RatioType $concentration)
    {
     ...
     * A lower limit for the strength per unitary volume (or mass), for when there is a range. The concentration attribute then becomes the upper limit.
     *
     * @param \TKusy\Hl7FhirR4\RatioType $concentrationLowLimit
     * @return self
     */
    public function setConcentrationLowLimit(\TKusy\Hl7FhirR4\RatioType $concentrationLowLimit)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MedicinalProductIngredientReferenceStrengthType $referenceStrength
     */
    public function addToReferenceStrength(\TKusy\Hl7FhirR4\MedicinalProductIngredientReferenceStrengthType $referenceStrength)
    {
     ...
     * Strength expressed in terms of a reference substance.
     *
     * @return \TKusy\Hl7FhirR4\MedicinalProductIngredientReferenceStrengthType[]
     */
