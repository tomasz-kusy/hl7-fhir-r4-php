...
class ChargeItemType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ChargeItemStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $performingOrganization
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $requestingOrganization
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $costCenter
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\MoneyType $priceOverride
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $enteredDate
     */
     ...
     */
    public function addToDefinitionUri(\TKusy\Hl7FhirR4\UriType $definitionUri)
    {
     ...
     */
    public function addToDefinitionCanonical(\TKusy\Hl7FhirR4\CanonicalType $definitionCanonical)
    {
     ...
     * The current state of the ChargeItem.
     *
     * @return \TKusy\Hl7FhirR4\ChargeItemStatusType
     */
     ...
     * The current state of the ChargeItem.
     *
     * @param \TKusy\Hl7FhirR4\ChargeItemStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7FhirR4\ChargeItemStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ChargeItemPerformerType $performer
     */
    public function addToPerformer(\TKusy\Hl7FhirR4\ChargeItemPerformerType $performer)
    {
     ...
     * Indicates who or what performed or participated in the charged service.
     *
     * @return \TKusy\Hl7FhirR4\ChargeItemPerformerType[]
     */
     ...
     * The organization requesting the service.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $performingOrganization
     * @return self
     */
    public function setPerformingOrganization(\TKusy\Hl7FhirR4\ReferenceType $performingOrganization)
    {
     ...
     * The organization performing the service.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $requestingOrganization
     * @return self
     */
    public function setRequestingOrganization(\TKusy\Hl7FhirR4\ReferenceType $requestingOrganization)
    {
     ...
     * The financial cost center permits the tracking of charge attribution.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $costCenter
     * @return self
     */
    public function setCostCenter(\TKusy\Hl7FhirR4\ReferenceType $costCenter)
    {
     ...
     * Total price of the charge overriding the list price associated with the code.
     *
     * @param \TKusy\Hl7FhirR4\MoneyType $priceOverride
     * @return self
     */
    public function setPriceOverride(\TKusy\Hl7FhirR4\MoneyType $priceOverride)
    {
     ...
     * Date the charge item was entered.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $enteredDate
     * @return self
     */
    public function setEnteredDate(\TKusy\Hl7FhirR4\DateTimeType $enteredDate)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $service
     */
    public function addToService(\TKusy\Hl7FhirR4\ReferenceType $service)
    {
