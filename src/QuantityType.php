...
class QuantityType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\QuantityComparatorType $comparator
     */
     ...
     * How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is "<" , then the real value is < stated value.
     *
     * @return \TKusy\Hl7FhirR4\QuantityComparatorType
     */
     ...
     * How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is "<" , then the real value is < stated value.
     *
     * @param \TKusy\Hl7FhirR4\QuantityComparatorType $comparator
     * @return self
     */
    public function setComparator(\TKusy\Hl7FhirR4\QuantityComparatorType $comparator)
    {
