...
class ContractSecurityLabelType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodingType $classification
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodingType[] $category
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodingType[] $control
     */
     ...
     */
    public function addToNumber(\TKusy\Hl7Fhir\R5\UnsignedIntType $number)
    {
        $this->number[] = $number;
        return $this;
    }
     ...
     * Security label privacy tag that specifies the level of confidentiality protection required for this term and/or term elements.
     *
     * @param \TKusy\Hl7Fhir\R5\CodingType $classification
     * @return self
     */
    public function setClassification(\TKusy\Hl7Fhir\R5\CodingType $classification)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CodingType $category
     */
    public function addToCategory(\TKusy\Hl7Fhir\R5\CodingType $category)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CodingType $control
     */
    public function addToControl(\TKusy\Hl7Fhir\R5\CodingType $control)
    {
