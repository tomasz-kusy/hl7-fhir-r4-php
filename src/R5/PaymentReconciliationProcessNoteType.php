...
class PaymentReconciliationProcessNoteType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\NoteTypeType $type
     */
    private $type = null;
     ...
     * The business purpose of the note text.
     *
     * @return \TKusy\Hl7Fhir\R5\NoteTypeType
     */
     ...
     * The business purpose of the note text.
     *
     * @param \TKusy\Hl7Fhir\R5\NoteTypeType $type
     * @return self
     */
    public function setType(?\TKusy\Hl7Fhir\R5\NoteTypeType $type = null)
    {
        $this->type = $type;
        return $this;
    }
