...
class SubstanceSourceMaterialHybridType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StringType $maternalOrganismId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StringType $maternalOrganismName
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StringType $paternalOrganismId
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StringType $paternalOrganismName
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType $hybridType
     */
     ...
     * The identifier of the maternal species constituting the hybrid organism shall be specified based on a controlled vocabulary. For plants, the parents aren’t always known, and it is unlikely that it will be known which is maternal and which is paternal.
     *
     * @param \TKusy\Hl7Fhir\R5\StringType $maternalOrganismId
     * @return self
     */
    public function setMaternalOrganismId(?\TKusy\Hl7Fhir\R5\StringType $maternalOrganismId = null)
    {
     ...
     * The name of the maternal species constituting the hybrid organism shall be specified. For plants, the parents aren’t always known, and it is unlikely that it will be known which is maternal and which is paternal.
     *
     * @param \TKusy\Hl7Fhir\R5\StringType $maternalOrganismName
     * @return self
     */
    public function setMaternalOrganismName(?\TKusy\Hl7Fhir\R5\StringType $maternalOrganismName = null)
    {
     ...
     * The identifier of the paternal species constituting the hybrid organism shall be specified based on a controlled vocabulary.
     *
     * @param \TKusy\Hl7Fhir\R5\StringType $paternalOrganismId
     * @return self
     */
    public function setPaternalOrganismId(?\TKusy\Hl7Fhir\R5\StringType $paternalOrganismId = null)
    {
     ...
     * The name of the paternal species constituting the hybrid organism shall be specified.
     *
     * @param \TKusy\Hl7Fhir\R5\StringType $paternalOrganismName
     * @return self
     */
    public function setPaternalOrganismName(?\TKusy\Hl7Fhir\R5\StringType $paternalOrganismName = null)
    {
     ...
     * The hybrid type of an organism shall be specified.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $hybridType
     * @return self
     */
    public function setHybridType(?\TKusy\Hl7Fhir\R5\CodeableConceptType $hybridType = null)
    {
