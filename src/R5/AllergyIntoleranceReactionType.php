...
class AllergyIntoleranceReactionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\DateTimeType $onset
     */
    private $onset = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\AllergyIntoleranceSeverityType $severity
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType $exposureRoute
     */
     ...
     * @return self
     */
    public function setSubstance(?\TKusy\Hl7Fhir\R5\CodeableConceptType $substance = null)
    {
     ...
     */
    public function addToManifestation(\TKusy\Hl7Fhir\R5\CodeableReferenceType $manifestation)
    {
     ...
     * Record of the date and/or time of the onset of the Reaction.
     *
     * @param \TKusy\Hl7Fhir\R5\DateTimeType $onset
     * @return self
     */
    public function setOnset(?\TKusy\Hl7Fhir\R5\DateTimeType $onset = null)
    {
        $this->onset = $onset;
        return $this;
    }
     ...
     * Clinical assessment of the severity of the reaction event as a whole, potentially considering multiple different manifestations.
     *
     * @return \TKusy\Hl7Fhir\R5\AllergyIntoleranceSeverityType
     */
     ...
     * Clinical assessment of the severity of the reaction event as a whole, potentially considering multiple different manifestations.
     *
     * @param \TKusy\Hl7Fhir\R5\AllergyIntoleranceSeverityType $severity
     * @return self
     */
    public function setSeverity(?\TKusy\Hl7Fhir\R5\AllergyIntoleranceSeverityType $severity = null)
    {
     ...
     * Identification of the route by which the subject was exposed to the substance.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $exposureRoute
     * @return self
     */
    public function setExposureRoute(?\TKusy\Hl7Fhir\R5\CodeableConceptType $exposureRoute = null)
    {
