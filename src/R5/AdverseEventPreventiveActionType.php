...
/**
 * Class representing AdverseEventPreventiveActionType
 *
 ...
 * XSD Type: AdverseEvent.PreventiveAction
 */
class AdverseEventPreventiveActionType extends BackboneElementType
{
