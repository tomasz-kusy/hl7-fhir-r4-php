...
class CoverageEligibilityResponseItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\BooleanType $excluded
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CoverageEligibilityResponseBenefitType[] $benefit
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\BooleanType $authorizationRequired
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType[] $authorizationSupporting
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\UriType $authorizationUrl
     */
     ...
     * True if the indicated class of service is excluded from the plan, missing or False indicates the product or service is included in the coverage.
     *
     * @param \TKusy\Hl7Fhir\R5\BooleanType $excluded
     * @return self
     */
    public function setExcluded(?\TKusy\Hl7Fhir\R5\BooleanType $excluded = null)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CoverageEligibilityResponseBenefitType $benefit
     */
    public function addToBenefit(\TKusy\Hl7Fhir\R5\CoverageEligibilityResponseBenefitType $benefit)
    {
     ...
     * Benefits used to date.
     *
     * @return \TKusy\Hl7Fhir\R5\CoverageEligibilityResponseBenefitType[]
     */
     ...
     * A boolean flag indicating whether a preauthorization is required prior to actual service delivery.
     *
     * @param \TKusy\Hl7Fhir\R5\BooleanType $authorizationRequired
     * @return self
     */
    public function setAuthorizationRequired(?\TKusy\Hl7Fhir\R5\BooleanType $authorizationRequired = null)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $authorizationSupporting
     */
    public function addToAuthorizationSupporting(\TKusy\Hl7Fhir\R5\CodeableConceptType $authorizationSupporting)
    {
     ...
     * @return self
     */
    public function setAuthorizationSupporting(array $authorizationSupporting = null)
    {
        $this->authorizationSupporting = $authorizationSupporting;
        return $this;
    }
     ...
     * A web location for obtaining requirements or descriptive information regarding the preauthorization.
     *
     * @param \TKusy\Hl7Fhir\R5\UriType $authorizationUrl
     * @return self
     */
    public function setAuthorizationUrl(?\TKusy\Hl7Fhir\R5\UriType $authorizationUrl = null)
    {
