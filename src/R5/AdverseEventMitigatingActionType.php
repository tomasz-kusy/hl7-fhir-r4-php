...
/**
 * Class representing AdverseEventMitigatingActionType
 *
 ...
 * XSD Type: AdverseEvent.MitigatingAction
 */
class AdverseEventMitigatingActionType extends BackboneElementType
{
