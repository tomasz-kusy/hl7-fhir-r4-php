 ...
 * XSD Type: Quantity
 */
class QuantityType extends DataTypeType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\QuantityComparatorType $comparator
     */
     ...
     * How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is "<" , then the real value is < stated value.
     *
     * @return \TKusy\Hl7Fhir\R5\QuantityComparatorType
     */
     ...
     * How the value should be understood and represented - whether the actual value is greater or less than the stated value due to measurement issues; e.g. if the comparator is "<" , then the real value is < stated value.
     *
     * @param \TKusy\Hl7Fhir\R5\QuantityComparatorType $comparator
     * @return self
     */
    public function setComparator(?\TKusy\Hl7Fhir\R5\QuantityComparatorType $comparator = null)
    {
