...
class SubstanceNucleicAcidSubunitType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType $fivePrime
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType $threePrime
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\SubstanceNucleicAcidLinkageType[] $linkage
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\SubstanceNucleicAcidSugarType[] $sugar
     */
    private $sugar = null;
     ...
     * The nucleotide present at the 5’ terminal shall be specified based on a controlled vocabulary. Since the sequence is represented from the 5' to the 3' end, the 5’ prime nucleotide is the letter at the first position in the sequence. A separate representation would be redundant.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $fivePrime
     * @return self
     */
    public function setFivePrime(?\TKusy\Hl7Fhir\R5\CodeableConceptType $fivePrime = null)
    {
     ...
     * The nucleotide present at the 3’ terminal shall be specified based on a controlled vocabulary. Since the sequence is represented from the 5' to the 3' end, the 5’ prime nucleotide is the letter at the last position in the sequence. A separate representation would be redundant.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $threePrime
     * @return self
     */
    public function setThreePrime(?\TKusy\Hl7Fhir\R5\CodeableConceptType $threePrime = null)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\SubstanceNucleicAcidLinkageType $linkage
     */
    public function addToLinkage(\TKusy\Hl7Fhir\R5\SubstanceNucleicAcidLinkageType $linkage)
    {
     ...
     * The linkages between sugar residues will also be captured.
     *
     * @return \TKusy\Hl7Fhir\R5\SubstanceNucleicAcidLinkageType[]
     */
     ...
     * @return self
     */
    public function setLinkage(array $linkage = null)
    {
        $this->linkage = $linkage;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\SubstanceNucleicAcidSugarType $sugar
     */
    public function addToSugar(\TKusy\Hl7Fhir\R5\SubstanceNucleicAcidSugarType $sugar)
    {
        $this->sugar[] = $sugar;
        return $this;
    }
     ...
     * 5.3.6.8.1 Sugar ID (Mandatory).
     *
     * @return \TKusy\Hl7Fhir\R5\SubstanceNucleicAcidSugarType[]
     */
     ...
     * @return self
     */
    public function setSugar(array $sugar = null)
    {
        $this->sugar = $sugar;
        return $this;
    }
