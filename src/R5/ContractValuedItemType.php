...
class ContractValuedItemType extends BackboneElementType
{
    ...
    /**
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType $entityCodeableConcept
     */
    private $entityCodeableConcept = null;

    /**
     * @var \TKusy\Hl7Fhir\R5\ReferenceType $entityReference
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\DateTimeType $effectiveTime
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\DecimalType $points
     */
    private $points = null;
     ...
     * Terms of valuation.
     *
     * @var \TKusy\Hl7Fhir\R5\StringType $payment
     */
     ...
     * When payment is due.
     *
     * @var \TKusy\Hl7Fhir\R5\DateTimeType $paymentDate
     */
     ...
     *
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $entityCodeableConcept
     * @return self
     */
    public function setEntityCodeableConcept(?\TKusy\Hl7Fhir\R5\CodeableConceptType $entityCodeableConcept = null)
    {
     ...
     *
     * @param \TKusy\Hl7Fhir\R5\ReferenceType $entityReference
     * @return self
     */
    public function setEntityReference(?\TKusy\Hl7Fhir\R5\ReferenceType $entityReference = null)
    {
     ...
     * Indicates the time during which this Contract ValuedItem information is effective.
     *
     * @param \TKusy\Hl7Fhir\R5\DateTimeType $effectiveTime
     * @return self
     */
    public function setEffectiveTime(?\TKusy\Hl7Fhir\R5\DateTimeType $effectiveTime = null)
    {
     ...
     * An amount that expresses the weighting (based on difficulty, cost and/or resource intensiveness) associated with the Contract Valued Item delivered. The concept of Points allows for assignment of point values for a Contract Valued Item, such that a monetary amount can be assigned to each point.
     *
     * @param \TKusy\Hl7Fhir\R5\DecimalType $points
     * @return self
     */
    public function setPoints(?\TKusy\Hl7Fhir\R5\DecimalType $points = null)
    {
        $this->points = $points;
        return $this;
    }
     ...
     * Terms of valuation.
     *
     * @param \TKusy\Hl7Fhir\R5\StringType $payment
     * @return self
     */
    public function setPayment(?\TKusy\Hl7Fhir\R5\StringType $payment = null)
    {
     ...
     * When payment is due.
     *
     * @param \TKusy\Hl7Fhir\R5\DateTimeType $paymentDate
     * @return self
     */
    public function setPaymentDate(?\TKusy\Hl7Fhir\R5\DateTimeType $paymentDate = null)
    {
