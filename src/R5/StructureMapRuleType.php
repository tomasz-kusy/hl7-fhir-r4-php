...
class StructureMapRuleType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StructureMapSourceType[] $source
     */
    private $source = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StructureMapTargetType[] $target
     */
    private $target = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StructureMapRuleType[] $rule
     */
    private $rule = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StructureMapDependentType[] $dependent
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\StructureMapSourceType $source
     */
    public function addToSource(\TKusy\Hl7Fhir\R5\StructureMapSourceType $source)
    {
        $this->source[] = $source;
        return $this;
    }
     ...
     * Source inputs to the mapping.
     *
     * @return \TKusy\Hl7Fhir\R5\StructureMapSourceType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\StructureMapTargetType $target
     */
    public function addToTarget(\TKusy\Hl7Fhir\R5\StructureMapTargetType $target)
    {
        $this->target[] = $target;
        return $this;
    }
     ...
     * Content to create because of this mapping rule.
     *
     * @return \TKusy\Hl7Fhir\R5\StructureMapTargetType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\StructureMapRuleType $rule
     */
    public function addToRule(\TKusy\Hl7Fhir\R5\StructureMapRuleType $rule)
    {
        $this->rule[] = $rule;
        return $this;
    }
     ...
     * Rules contained in this rule.
     *
     * @return \TKusy\Hl7Fhir\R5\StructureMapRuleType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\StructureMapDependentType $dependent
     */
    public function addToDependent(\TKusy\Hl7Fhir\R5\StructureMapDependentType $dependent)
    {
     ...
     * Which other rules to apply in the context of this rule.
     *
     * @return \TKusy\Hl7Fhir\R5\StructureMapDependentType[]
     */
     ...
     * @return self
     */
    public function setDependent(array $dependent = null)
    {
        $this->dependent = $dependent;
        return $this;
    }
