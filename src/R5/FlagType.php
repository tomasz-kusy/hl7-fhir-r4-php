...
class FlagType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\FlagStatusType $status
     */
    private $status = null;
     ...
     * Supports basic workflow.
     *
     * @return \TKusy\Hl7Fhir\R5\FlagStatusType
     */
     ...
     * Supports basic workflow.
     *
     * @param \TKusy\Hl7Fhir\R5\FlagStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7Fhir\R5\FlagStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
