...
class RelatedPersonType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\RelatedPersonCommunicationType[] $communication
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\RelatedPersonCommunicationType $communication
     */
    public function addToCommunication(\TKusy\Hl7Fhir\R5\RelatedPersonCommunicationType $communication)
    {
     ...
     * A language which may be used to communicate with the related person about the patient's health.
     *
     * @return \TKusy\Hl7Fhir\R5\RelatedPersonCommunicationType[]
     */
