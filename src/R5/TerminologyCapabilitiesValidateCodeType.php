...
class TerminologyCapabilitiesValidateCodeType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\BooleanType $translations
     */
     ...
     * Whether translations are validated.
     *
     * @param \TKusy\Hl7Fhir\R5\BooleanType $translations
     * @return self
     */
    public function setTranslations(\TKusy\Hl7Fhir\R5\BooleanType $translations)
    {
