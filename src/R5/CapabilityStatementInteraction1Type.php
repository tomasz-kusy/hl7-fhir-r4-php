...
class CapabilityStatementInteraction1Type extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\SystemRestfulInteractionType $code
     */
    private $code = null;
     ...
     * A coded identifier of the operation, supported by the system.
     *
     * @return \TKusy\Hl7Fhir\R5\SystemRestfulInteractionType
     */
     ...
     * A coded identifier of the operation, supported by the system.
     *
     * @param \TKusy\Hl7Fhir\R5\SystemRestfulInteractionType $code
     * @return self
     */
    public function setCode(\TKusy\Hl7Fhir\R5\SystemRestfulInteractionType $code)
    {
        $this->code = $code;
        return $this;
    }
