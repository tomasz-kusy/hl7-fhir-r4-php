...
class ImmunizationRecommendationType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\ImmunizationRecommendationRecommendationType[] $recommendation
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\ImmunizationRecommendationRecommendationType $recommendation
     */
    public function addToRecommendation(\TKusy\Hl7Fhir\R5\ImmunizationRecommendationRecommendationType $recommendation)
    {
     ...
     * Vaccine administration recommendations.
     *
     * @return \TKusy\Hl7Fhir\R5\ImmunizationRecommendationRecommendationType[]
     */
