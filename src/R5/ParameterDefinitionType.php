 ...
 */
class ParameterDefinitionType extends DataTypeType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeType $use
     */
    private $use = null;
     ...
     * Whether the parameter is input or output for the module.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeType $use
     * @return self
     */
    public function setUse(\TKusy\Hl7Fhir\R5\CodeType $use)
    {
        $this->use = $use;
        return $this;
    }
