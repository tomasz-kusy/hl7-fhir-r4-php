...
/**
 * Class representing TestReportTestType
 *
 * A summary of information based on the results of executing a TestScript.
 * XSD Type: TestReport.Test
 */
class TestReportTestType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\TestReportAction1Type[] $action
     */
    private $action = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\TestReportAction1Type $action
     */
    public function addToAction(\TKusy\Hl7Fhir\R5\TestReportAction1Type $action)
    {
        $this->action[] = $action;
        return $this;
    }
     ...
     * Action would contain either an operation or an assertion.
     *
     * @return \TKusy\Hl7Fhir\R5\TestReportAction1Type[]
     */
