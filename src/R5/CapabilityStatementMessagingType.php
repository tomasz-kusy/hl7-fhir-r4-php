...
class CapabilityStatementMessagingType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CapabilityStatementEndpointType[] $endpoint
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\UnsignedIntType $reliableCache
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CapabilityStatementSupportedMessageType[] $supportedMessage
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CapabilityStatementEndpointType $endpoint
     */
    public function addToEndpoint(\TKusy\Hl7Fhir\R5\CapabilityStatementEndpointType $endpoint)
    {
     ...
     * An endpoint (network accessible address) to which messages and/or replies are to be sent.
     *
     * @return \TKusy\Hl7Fhir\R5\CapabilityStatementEndpointType[]
     */
     ...
     * Length if the receiver's reliable messaging cache in minutes (if a receiver) or how long the cache length on the receiver should be (if a sender).
     *
     * @param \TKusy\Hl7Fhir\R5\UnsignedIntType $reliableCache
     * @return self
     */
    public function setReliableCache(?\TKusy\Hl7Fhir\R5\UnsignedIntType $reliableCache = null)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CapabilityStatementSupportedMessageType $supportedMessage
     */
    public function addToSupportedMessage(\TKusy\Hl7Fhir\R5\CapabilityStatementSupportedMessageType $supportedMessage)
    {
     ...
     * References to message definitions for messages this system can send or receive.
     *
     * @return \TKusy\Hl7Fhir\R5\CapabilityStatementSupportedMessageType[]
     */
     ...
     * @return self
     */
    public function setSupportedMessage(array $supportedMessage = null)
    {
        $this->supportedMessage = $supportedMessage;
        return $this;
    }
