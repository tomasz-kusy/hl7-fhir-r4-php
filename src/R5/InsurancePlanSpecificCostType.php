...
class InsurancePlanSpecificCostType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\InsurancePlanBenefit1Type[] $benefit
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\InsurancePlanBenefit1Type $benefit
     */
    public function addToBenefit(\TKusy\Hl7Fhir\R5\InsurancePlanBenefit1Type $benefit)
    {
     ...
     * List of the specific benefits under this category of benefit.
     *
     * @return \TKusy\Hl7Fhir\R5\InsurancePlanBenefit1Type[]
     */
