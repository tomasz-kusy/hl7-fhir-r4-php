...
class TestScriptCapabilityType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\BooleanType $validated
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\UriType[] $link
     */
    private $link = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CanonicalType $capabilities
     */
     ...
     * @return self
     */
    public function setRequired(\TKusy\Hl7Fhir\R5\BooleanType $required)
    {
     ...
     * Whether or not the test execution will validate the given capabilities of the server in order for this test script to execute.
     *
     * @param \TKusy\Hl7Fhir\R5\BooleanType $validated
     * @return self
     */
    public function setValidated(\TKusy\Hl7Fhir\R5\BooleanType $validated)
    {
     ...
     */
    public function addToOrigin(\TKusy\Hl7Fhir\R5\IntegerType $origin)
    {
        $this->origin[] = $origin;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\UriType $link
     */
    public function addToLink(\TKusy\Hl7Fhir\R5\UriType $link)
    {
        $this->link[] = $link;
        return $this;
    }
     ...
     * Minimum capabilities required of server for test script to execute successfully. If server does not meet at a minimum the referenced capability statement, then all tests in this script are skipped.
     *
     * @param \TKusy\Hl7Fhir\R5\CanonicalType $capabilities
     * @return self
     */
    public function setCapabilities(\TKusy\Hl7Fhir\R5\CanonicalType $capabilities)
    {
