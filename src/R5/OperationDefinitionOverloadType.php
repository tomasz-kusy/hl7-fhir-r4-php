...
class OperationDefinitionOverloadType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StringType[] $parameterName
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\StringType $parameterName
     */
    public function addToParameterName(\TKusy\Hl7Fhir\R5\StringType $parameterName)
    {
     ...
     * @return self
     */
    public function setParameterName(array $parameterName = null)
    {
        $this->parameterName = $parameterName;
        return $this;
    }
