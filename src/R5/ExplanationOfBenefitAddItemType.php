...
class ExplanationOfBenefitAddItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\ExplanationOfBenefitBodySite1Type[] $bodySite
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\ExplanationOfBenefitReviewOutcomeType $reviewOutcome
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\ExplanationOfBenefitDetail1Type[] $detail
     */
    private $detail = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\ExplanationOfBenefitBodySite1Type $bodySite
     */
    public function addToBodySite(\TKusy\Hl7Fhir\R5\ExplanationOfBenefitBodySite1Type $bodySite)
    {
     ...
     * Physical location where the service is performed or applies.
     *
     * @return \TKusy\Hl7Fhir\R5\ExplanationOfBenefitBodySite1Type[]
     */
     ...
     * The high-level results of the adjudication if adjudication has been performed.
     *
     * @return \TKusy\Hl7Fhir\R5\ExplanationOfBenefitReviewOutcomeType
     */
     ...
     * The high-level results of the adjudication if adjudication has been performed.
     *
     * @param \TKusy\Hl7Fhir\R5\ExplanationOfBenefitReviewOutcomeType $reviewOutcome
     * @return self
     */
    public function setReviewOutcome(?\TKusy\Hl7Fhir\R5\ExplanationOfBenefitReviewOutcomeType $reviewOutcome = null)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\ExplanationOfBenefitDetail1Type $detail
     */
    public function addToDetail(\TKusy\Hl7Fhir\R5\ExplanationOfBenefitDetail1Type $detail)
    {
        $this->detail[] = $detail;
        return $this;
    }
     ...
     * The second-tier service adjudications for payor added services.
     *
     * @return \TKusy\Hl7Fhir\R5\ExplanationOfBenefitDetail1Type[]
     */
