...
class ContractOfferType extends BackboneElementType
{
     ...
     * Offer Recipient.
     *
     * @var \TKusy\Hl7Fhir\R5\ContractPartyType[] $party
     */
    private $party = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\ReferenceType $topic
     */
    private $topic = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType[] $decisionMode
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\ContractPartyType $party
     */
    public function addToParty(\TKusy\Hl7Fhir\R5\ContractPartyType $party)
    {
        $this->party[] = $party;
        return $this;
    }
     ...
     * Offer Recipient.
     *
     * @return \TKusy\Hl7Fhir\R5\ContractPartyType[]
     */
     ...
     * The owner of an asset has the residual control rights over the asset: the right to decide all usages of the asset in any way not inconsistent with a prior contract, custom, or law (Hart, 1995, p. 30).
     *
     * @param \TKusy\Hl7Fhir\R5\ReferenceType $topic
     * @return self
     */
    public function setTopic(?\TKusy\Hl7Fhir\R5\ReferenceType $topic = null)
    {
        $this->topic = $topic;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $decisionMode
     */
    public function addToDecisionMode(\TKusy\Hl7Fhir\R5\CodeableConceptType $decisionMode)
    {
     ...
     * @return self
     */
    public function setDecisionMode(array $decisionMode = null)
    {
        $this->decisionMode = $decisionMode;
        return $this;
    }
