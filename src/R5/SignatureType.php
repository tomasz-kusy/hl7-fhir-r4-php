 ...
 * XSD Type: Signature
 */
class SignatureType extends DataTypeType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\InstantType $when
     */
    private $when = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeType $targetFormat
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeType $sigFormat
     */
     ...
     */
    public function addToType(\TKusy\Hl7Fhir\R5\CodingType $type)
    {
        $this->type[] = $type;
        return $this;
    }
     ...
     * When the digital signature was signed.
     *
     * @param \TKusy\Hl7Fhir\R5\InstantType $when
     * @return self
     */
    public function setWhen(?\TKusy\Hl7Fhir\R5\InstantType $when = null)
    {
        $this->when = $when;
        return $this;
    }
     ...
     * A mime type that indicates the technical format of the target resources signed by the signature.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeType $targetFormat
     * @return self
     */
    public function setTargetFormat(?\TKusy\Hl7Fhir\R5\CodeType $targetFormat = null)
    {
     ...
     * A mime type that indicates the technical format of the signature. Important mime types are application/signature+xml for X ML DigSig, application/jose for JWS, and image/* for a graphical image of a signature, etc.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeType $sigFormat
     * @return self
     */
    public function setSigFormat(?\TKusy\Hl7Fhir\R5\CodeType $sigFormat = null)
    {
