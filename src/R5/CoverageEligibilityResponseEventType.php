...
/**
 * Class representing CoverageEligibilityResponseEventType
 *
 * This resource provides eligibility and plan details from the processing of an CoverageEligibilityRequest resource.
 * XSD Type: CoverageEligibilityResponse.Event
 */
class CoverageEligibilityResponseEventType extends BackboneElementType
{
