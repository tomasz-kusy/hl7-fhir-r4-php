...
class NutritionOrderTextureType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType $foodType
     */
     ...
     * The food type(s) (e.g. meats, all foods) that the texture modification applies to. This could be all foods types.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $foodType
     * @return self
     */
    public function setFoodType(?\TKusy\Hl7Fhir\R5\CodeableConceptType $foodType = null)
    {
