...
class VisionPrescriptionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\DateTimeType $dateWritten
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\ReferenceType $prescriber
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\VisionPrescriptionLensSpecificationType[] $lensSpecification
     */
     ...
     * The date (and perhaps time) when the prescription was written.
     *
     * @param \TKusy\Hl7Fhir\R5\DateTimeType $dateWritten
     * @return self
     */
    public function setDateWritten(\TKusy\Hl7Fhir\R5\DateTimeType $dateWritten)
    {
     ...
     * The healthcare professional responsible for authorizing the prescription.
     *
     * @param \TKusy\Hl7Fhir\R5\ReferenceType $prescriber
     * @return self
     */
    public function setPrescriber(\TKusy\Hl7Fhir\R5\ReferenceType $prescriber)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\VisionPrescriptionLensSpecificationType $lensSpecification
     */
    public function addToLensSpecification(\TKusy\Hl7Fhir\R5\VisionPrescriptionLensSpecificationType $lensSpecification)
    {
     ...
     * Contain the details of the individual lens specifications and serves as the authorization for the fullfillment by certified professionals.
     *
     * @return \TKusy\Hl7Fhir\R5\VisionPrescriptionLensSpecificationType[]
     */
