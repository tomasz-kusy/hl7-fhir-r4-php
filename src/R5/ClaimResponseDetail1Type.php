...
class ClaimResponseDetail1Type extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\ClaimResponseSubDetail1Type[] $subDetail
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\ClaimResponseSubDetail1Type $subDetail
     */
    public function addToSubDetail(\TKusy\Hl7Fhir\R5\ClaimResponseSubDetail1Type $subDetail)
    {
     ...
     * The third-tier service adjudications for payor added services.
     *
     * @return \TKusy\Hl7Fhir\R5\ClaimResponseSubDetail1Type[]
     */
