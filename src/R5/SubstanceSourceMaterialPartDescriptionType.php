...
class SubstanceSourceMaterialPartDescriptionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeableConceptType $partLocation
     */
     ...
     * The detailed anatomic location when the part can be extracted from different anatomical locations of the organism. Multiple alternative locations may apply.
     *
     * @param \TKusy\Hl7Fhir\R5\CodeableConceptType $partLocation
     * @return self
     */
    public function setPartLocation(?\TKusy\Hl7Fhir\R5\CodeableConceptType $partLocation = null)
    {
