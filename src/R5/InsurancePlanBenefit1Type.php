...
class InsurancePlanBenefit1Type extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\InsurancePlanCostType[] $cost
     */
    private $cost = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\InsurancePlanCostType $cost
     */
    public function addToCost(\TKusy\Hl7Fhir\R5\InsurancePlanCostType $cost)
    {
        $this->cost[] = $cost;
        return $this;
    }
     ...
     * List of the costs associated with a specific benefit.
     *
     * @return \TKusy\Hl7Fhir\R5\InsurancePlanCostType[]
     */
