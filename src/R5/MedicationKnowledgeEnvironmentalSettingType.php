...
/**
 * Class representing MedicationKnowledgeEnvironmentalSettingType
 *
 * Information about a medication that is used to support knowledge.
 * XSD Type: MedicationKnowledge.EnvironmentalSetting
 */
class MedicationKnowledgeEnvironmentalSettingType extends BackboneElementType
{
