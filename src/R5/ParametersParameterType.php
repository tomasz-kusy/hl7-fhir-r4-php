...
class ParametersParameterType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\ParametersParameterType[] $part
     */
    private $part = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\ParametersParameterType $part
     */
    public function addToPart(\TKusy\Hl7Fhir\R5\ParametersParameterType $part)
    {
        $this->part[] = $part;
        return $this;
    }
