...
class CodeSystemConceptType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\StringType $definition
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeSystemDesignationType[] $designation
     */
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\CodeSystemProperty1Type[] $property
     */
     ...
     * The formal definition of the concept. The code system resource does not make formal definitions required, because of the prevalence of legacy systems. However, they are highly recommended, as without them there is no formal meaning associated with the concept.
     *
     * @param \TKusy\Hl7Fhir\R5\StringType $definition
     * @return self
     */
    public function setDefinition(?\TKusy\Hl7Fhir\R5\StringType $definition = null)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CodeSystemDesignationType $designation
     */
    public function addToDesignation(\TKusy\Hl7Fhir\R5\CodeSystemDesignationType $designation)
    {
     ...
     * Additional representations for the concept - other languages, aliases, specialized purposes, used for particular purposes, etc.
     *
     * @return \TKusy\Hl7Fhir\R5\CodeSystemDesignationType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\CodeSystemProperty1Type $property
     */
    public function addToProperty(\TKusy\Hl7Fhir\R5\CodeSystemProperty1Type $property)
    {
     ...
     * A property value for this concept.
     *
     * @return \TKusy\Hl7Fhir\R5\CodeSystemProperty1Type[]
     */
