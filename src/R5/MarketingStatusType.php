 ...
 */
class MarketingStatusType extends BackboneTypeType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\PeriodType $dateRange
     */
     ...
     * The date when the Medicinal Product is placed on the market by the Marketing Authorization Holder (or where applicable, the manufacturer/distributor) in a country and/or jurisdiction shall be provided A complete date consisting of day, month and year shall be specified using the ISO 8601 date format NOTE “Placed on the market” refers to the release of the Medicinal Product into the distribution chain.
     *
     * @var \TKusy\Hl7Fhir\R5\DateTimeType $restoreDate
     */
     ...
     * @return self
     */
    public function setCountry(?\TKusy\Hl7Fhir\R5\CodeableConceptType $country = null)
    {
     ...
     * The date when the Medicinal Product is placed on the market by the Marketing Authorization Holder (or where applicable, the manufacturer/distributor) in a country and/or jurisdiction shall be provided A complete date consisting of day, month and year shall be specified using the ISO 8601 date format NOTE “Placed on the market” refers to the release of the Medicinal Product into the distribution chain.
     *
     * @param \TKusy\Hl7Fhir\R5\PeriodType $dateRange
     * @return self
     */
    public function setDateRange(?\TKusy\Hl7Fhir\R5\PeriodType $dateRange = null)
    {
     ...
     * The date when the Medicinal Product is placed on the market by the Marketing Authorization Holder (or where applicable, the manufacturer/distributor) in a country and/or jurisdiction shall be provided A complete date consisting of day, month and year shall be specified using the ISO 8601 date format NOTE “Placed on the market” refers to the release of the Medicinal Product into the distribution chain.
     *
     * @param \TKusy\Hl7Fhir\R5\DateTimeType $restoreDate
     * @return self
     */
    public function setRestoreDate(?\TKusy\Hl7Fhir\R5\DateTimeType $restoreDate = null)
    {
