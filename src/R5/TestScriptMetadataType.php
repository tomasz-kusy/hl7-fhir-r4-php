...
class TestScriptMetadataType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\TestScriptLinkType[] $link
     */
    private $link = null;
     ...
     *
     * @var \TKusy\Hl7Fhir\R5\TestScriptCapabilityType[] $capability
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\TestScriptLinkType $link
     */
    public function addToLink(\TKusy\Hl7Fhir\R5\TestScriptLinkType $link)
    {
        $this->link[] = $link;
        return $this;
    }
     ...
     * A link to the FHIR specification that this test is covering.
     *
     * @return \TKusy\Hl7Fhir\R5\TestScriptLinkType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7Fhir\R5\TestScriptCapabilityType $capability
     */
    public function addToCapability(\TKusy\Hl7Fhir\R5\TestScriptCapabilityType $capability)
    {
     ...
     * Capabilities that must exist and are assumed to function correctly on the FHIR server being tested.
     *
     * @return \TKusy\Hl7Fhir\R5\TestScriptCapabilityType[]
     */
