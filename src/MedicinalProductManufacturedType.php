...
class MedicinalProductManufacturedType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $manufacturedDoseForm
     */
     ...
     * Dose form as manufactured and before any transformation into the pharmaceutical product.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $manufacturedDoseForm
     * @return self
     */
    public function setManufacturedDoseForm(\TKusy\Hl7FhirR4\CodeableConceptType $manufacturedDoseForm)
    {
