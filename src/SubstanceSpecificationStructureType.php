...
class SubstanceSpecificationStructureType extends BackboneElementType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\SubstanceSpecificationIsotopeType $isotope
     */
    public function addToIsotope(\TKusy\Hl7FhirR4\SubstanceSpecificationIsotopeType $isotope)
    {
     ...
     * Applicable for single substances that contain a radionuclide or a non-natural isotopic ratio.
     *
     * @return \TKusy\Hl7FhirR4\SubstanceSpecificationIsotopeType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\SubstanceSpecificationRepresentationType $representation
     */
    public function addToRepresentation(\TKusy\Hl7FhirR4\SubstanceSpecificationRepresentationType $representation)
    {
     ...
     * Molecular structural representation.
     *
     * @return \TKusy\Hl7FhirR4\SubstanceSpecificationRepresentationType[]
     */
