...
class SignatureType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\InstantType $when
     */
    private $when = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeType $targetFormat
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeType $sigFormat
     */
     ...
     * When the digital signature was signed.
     *
     * @param \TKusy\Hl7FhirR4\InstantType $when
     * @return self
     */
    public function setWhen(\TKusy\Hl7FhirR4\InstantType $when)
    {
        $this->when = $when;
        return $this;
    }
     ...
     * A mime type that indicates the technical format of the target resources signed by the signature.
     *
     * @param \TKusy\Hl7FhirR4\CodeType $targetFormat
     * @return self
     */
    public function setTargetFormat(\TKusy\Hl7FhirR4\CodeType $targetFormat)
    {
     ...
     * A mime type that indicates the technical format of the signature. Important mime types are application/signature+xml for X ML DigSig, application/jose for JWS, and image/* for a graphical image of a signature, etc.
     *
     * @param \TKusy\Hl7FhirR4\CodeType $sigFormat
     * @return self
     */
    public function setSigFormat(\TKusy\Hl7FhirR4\CodeType $sigFormat)
    {
