...
class SupplyRequestType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\SupplyRequestStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $deliverFrom
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $deliverTo
     */
     ...
     * Status of the supply request.
     *
     * @return \TKusy\Hl7FhirR4\SupplyRequestStatusType
     */
     ...
     * Status of the supply request.
     *
     * @param \TKusy\Hl7FhirR4\SupplyRequestStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7FhirR4\SupplyRequestStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\SupplyRequestParameterType $parameter
     */
    public function addToParameter(\TKusy\Hl7FhirR4\SupplyRequestParameterType $parameter)
    {
     ...
     * Specific parameters for the ordered item. For example, the size of the indicated item.
     *
     * @return \TKusy\Hl7FhirR4\SupplyRequestParameterType[]
     */
     ...
     */
    public function addToSupplier(\TKusy\Hl7FhirR4\ReferenceType $supplier)
    {
     ...
     * Where the supply is expected to come from.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $deliverFrom
     * @return self
     */
    public function setDeliverFrom(\TKusy\Hl7FhirR4\ReferenceType $deliverFrom)
    {
     ...
     * Where the supply is destined to go.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $deliverTo
     * @return self
     */
    public function setDeliverTo(\TKusy\Hl7FhirR4\ReferenceType $deliverTo)
    {
