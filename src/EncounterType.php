...
class EncounterType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\EncounterStatusType $status
     */
    private $status = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\DurationType $length
     */
    private $length = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\EncounterHospitalizationType $hospitalization
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $serviceProvider
     */
     ...
     * planned | arrived | triaged | in-progress | onleave | finished | cancelled +.
     *
     * @return \TKusy\Hl7FhirR4\EncounterStatusType
     */
     ...
     * planned | arrived | triaged | in-progress | onleave | finished | cancelled +.
     *
     * @param \TKusy\Hl7FhirR4\EncounterStatusType $status
     * @return self
     */
    public function setStatus(\TKusy\Hl7FhirR4\EncounterStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EncounterStatusHistoryType $statusHistory
     */
    public function addToStatusHistory(\TKusy\Hl7FhirR4\EncounterStatusHistoryType $statusHistory)
    {
     ...
     * The status history permits the encounter resource to contain the status history without needing to read through the historical versions of the resource, or even have the server store them.
     *
     * @return \TKusy\Hl7FhirR4\EncounterStatusHistoryType[]
     */
     ...
     * Concepts representing classification of patient encounter such as ambulatory (outpatient), inpatient, emergency, home health or others due to local variations.
     *
     * @param \TKusy\Hl7FhirR4\CodingType $class
     * @return self
     */
    public function setClass(\TKusy\Hl7FhirR4\CodingType $class)
    {
        $this->class = $class;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EncounterClassHistoryType $classHistory
     */
    public function addToClassHistory(\TKusy\Hl7FhirR4\EncounterClassHistoryType $classHistory)
    {
     ...
     * The class history permits the tracking of the encounters transitions without needing to go through the resource history. This would be used for a case where an admission starts of as an emergency encounter, then transitions into an inpatient scenario. Doing this and not restarting a new encounter ensures that any lab/diagnostic results can more easily follow the patient and not require re-processing and not get lost or cancelled during a kind of discharge from emergency to inpatient.
     *
     * @return \TKusy\Hl7FhirR4\EncounterClassHistoryType[]
     */
     ...
     * @return self
     */
    public function setServiceType(\TKusy\Hl7FhirR4\CodeableConceptType $serviceType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $episodeOfCare
     */
    public function addToEpisodeOfCare(\TKusy\Hl7FhirR4\ReferenceType $episodeOfCare)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EncounterParticipantType $participant
     */
    public function addToParticipant(\TKusy\Hl7FhirR4\EncounterParticipantType $participant)
    {
     ...
     * The list of people responsible for providing the service.
     *
     * @return \TKusy\Hl7FhirR4\EncounterParticipantType[]
     */
     ...
     */
    public function addToAppointment(\TKusy\Hl7FhirR4\ReferenceType $appointment)
    {
     ...
     * Quantity of time the encounter lasted. This excludes the time during leaves of absence.
     *
     * @param \TKusy\Hl7FhirR4\DurationType $length
     * @return self
     */
    public function setLength(\TKusy\Hl7FhirR4\DurationType $length)
    {
        $this->length = $length;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EncounterDiagnosisType $diagnosis
     */
    public function addToDiagnosis(\TKusy\Hl7FhirR4\EncounterDiagnosisType $diagnosis)
    {
     ...
     * The list of diagnosis relevant to this encounter.
     *
     * @return \TKusy\Hl7FhirR4\EncounterDiagnosisType[]
     */
     ...
     */
    public function addToAccount(\TKusy\Hl7FhirR4\ReferenceType $account)
    {
     ...
     * Details about the admission to a healthcare service.
     *
     * @return \TKusy\Hl7FhirR4\EncounterHospitalizationType
     */
     ...
     * Details about the admission to a healthcare service.
     *
     * @param \TKusy\Hl7FhirR4\EncounterHospitalizationType $hospitalization
     * @return self
     */
    public function setHospitalization(\TKusy\Hl7FhirR4\EncounterHospitalizationType $hospitalization)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EncounterLocationType $location
     */
    public function addToLocation(\TKusy\Hl7FhirR4\EncounterLocationType $location)
    {
     ...
     * List of locations where the patient has been during this encounter.
     *
     * @return \TKusy\Hl7FhirR4\EncounterLocationType[]
     */
     ...
     * The organization that is primarily responsible for this Encounter's services. This MAY be the same as the organization on the Patient record, however it could be different, such as if the actor performing the services was from an external organization (which may be billed seperately) for an external consultation. Refer to the example bundle showing an abbreviated set of Encounters for a colonoscopy.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $serviceProvider
     * @return self
     */
    public function setServiceProvider(\TKusy\Hl7FhirR4\ReferenceType $serviceProvider)
    {
