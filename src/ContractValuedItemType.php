...
class ContractValuedItemType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $entityCodeableConcept
     */
     ...
     * Specific type of Contract Valued Item that may be priced. (choose any one of entity*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $entityReference
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $effectiveTime
     */
     ...
     * When payment is due.
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $paymentDate
     */
     ...
     * Specific type of Contract Valued Item that may be priced. (choose any one of entity*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $entityCodeableConcept
     * @return self
     */
    public function setEntityCodeableConcept(\TKusy\Hl7FhirR4\CodeableConceptType $entityCodeableConcept)
    {
     ...
     * Specific type of Contract Valued Item that may be priced. (choose any one of entity*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $entityReference
     * @return self
     */
    public function setEntityReference(\TKusy\Hl7FhirR4\ReferenceType $entityReference)
    {
     ...
     * Indicates the time during which this Contract ValuedItem information is effective.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $effectiveTime
     * @return self
     */
    public function setEffectiveTime(\TKusy\Hl7FhirR4\DateTimeType $effectiveTime)
    {
     ...
     * When payment is due.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $paymentDate
     * @return self
     */
    public function setPaymentDate(\TKusy\Hl7FhirR4\DateTimeType $paymentDate)
    {
