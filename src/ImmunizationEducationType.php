...
class ImmunizationEducationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $presentationDate
     */
     ...
     * Date the educational material was given to the patient.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $presentationDate
     * @return self
     */
    public function setPresentationDate(\TKusy\Hl7FhirR4\DateTimeType $presentationDate)
    {
