...
class MeasureReportPopulation1Type extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $subjectResults
     */
     ...
     * This element refers to a List of subject level MeasureReport resources, one for each subject in this population in this stratum.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $subjectResults
     * @return self
     */
    public function setSubjectResults(\TKusy\Hl7FhirR4\ReferenceType $subjectResults)
    {
