...
class TimingRepeatType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\DurationType $boundsDuration
     */
     ...
     * Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule. (choose any one of bounds*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\RangeType $boundsRange
     */
     ...
     * Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule. (choose any one of bounds*, but only one)
     *
     * @var \TKusy\Hl7FhirR4\PeriodType $boundsPeriod
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\PositiveIntType $count
     */
    private $count = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\PositiveIntType $countMax
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\UnitsOfTimeType $durationUnit
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\PositiveIntType $frequency
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\PositiveIntType $frequencyMax
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\UnitsOfTimeType $periodUnit
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\UnsignedIntType $offset
     */
    private $offset = null;
     ...
     * Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule. (choose any one of bounds*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\DurationType $boundsDuration
     * @return self
     */
    public function setBoundsDuration(\TKusy\Hl7FhirR4\DurationType $boundsDuration)
    {
     ...
     * Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule. (choose any one of bounds*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\RangeType $boundsRange
     * @return self
     */
    public function setBoundsRange(\TKusy\Hl7FhirR4\RangeType $boundsRange)
    {
     ...
     * Either a duration for the length of the timing schedule, a range of possible length, or outer bounds for start and/or end limits of the timing schedule. (choose any one of bounds*, but only one)
     *
     * @param \TKusy\Hl7FhirR4\PeriodType $boundsPeriod
     * @return self
     */
    public function setBoundsPeriod(\TKusy\Hl7FhirR4\PeriodType $boundsPeriod)
    {
     ...
     * A total count of the desired number of repetitions across the duration of the entire timing specification. If countMax is present, this element indicates the lower bound of the allowed range of count values.
     *
     * @param \TKusy\Hl7FhirR4\PositiveIntType $count
     * @return self
     */
    public function setCount(\TKusy\Hl7FhirR4\PositiveIntType $count)
    {
        $this->count = $count;
        return $this;
    }
     ...
     * If present, indicates that the count is a range - so to perform the action between [count] and [countMax] times.
     *
     * @param \TKusy\Hl7FhirR4\PositiveIntType $countMax
     * @return self
     */
    public function setCountMax(\TKusy\Hl7FhirR4\PositiveIntType $countMax)
    {
     ...
     * The units of time for the duration, in UCUM units.
     *
     * @return \TKusy\Hl7FhirR4\UnitsOfTimeType
     */
     ...
     * The units of time for the duration, in UCUM units.
     *
     * @param \TKusy\Hl7FhirR4\UnitsOfTimeType $durationUnit
     * @return self
     */
    public function setDurationUnit(\TKusy\Hl7FhirR4\UnitsOfTimeType $durationUnit)
    {
     ...
     * The number of times to repeat the action within the specified period. If frequencyMax is present, this element indicates the lower bound of the allowed range of the frequency.
     *
     * @param \TKusy\Hl7FhirR4\PositiveIntType $frequency
     * @return self
     */
    public function setFrequency(\TKusy\Hl7FhirR4\PositiveIntType $frequency)
    {
     ...
     * If present, indicates that the frequency is a range - so to repeat between [frequency] and [frequencyMax] times within the period or period range.
     *
     * @param \TKusy\Hl7FhirR4\PositiveIntType $frequencyMax
     * @return self
     */
    public function setFrequencyMax(\TKusy\Hl7FhirR4\PositiveIntType $frequencyMax)
    {
     ...
     * The units of time for the period in UCUM units.
     *
     * @param \TKusy\Hl7FhirR4\UnitsOfTimeType $periodUnit
     * @return self
     */
    public function setPeriodUnit(\TKusy\Hl7FhirR4\UnitsOfTimeType $periodUnit)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeType $dayOfWeek
     */
    public function addToDayOfWeek(\TKusy\Hl7FhirR4\CodeType $dayOfWeek)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\TimeType $timeOfDay
     */
    public function addToTimeOfDay(\TKusy\Hl7FhirR4\TimeType $timeOfDay)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\EventTimingType $when
     */
    public function addToWhen(\TKusy\Hl7FhirR4\EventTimingType $when)
    {
        $this->when[] = $when;
        return $this;
    }
     ...
     * An approximate time period during the day, potentially linked to an event of daily living that indicates when the action should occur.
     *
     * @return \TKusy\Hl7FhirR4\EventTimingType[]
     */
     ...
     * The number of minutes from the event. If the event code does not indicate whether the minutes is before or after the event, then the offset is assumed to be after the event.
     *
     * @param \TKusy\Hl7FhirR4\UnsignedIntType $offset
     * @return self
     */
    public function setOffset(\TKusy\Hl7FhirR4\UnsignedIntType $offset)
    {
        $this->offset = $offset;
        return $this;
    }
