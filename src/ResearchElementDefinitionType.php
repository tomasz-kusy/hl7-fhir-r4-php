...
class ResearchElementDefinitionType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ResearchElementDefinitionCharacteristicType[] $characteristic
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ResearchElementDefinitionCharacteristicType $characteristic
     */
    public function addToCharacteristic(\TKusy\Hl7FhirR4\ResearchElementDefinitionCharacteristicType $characteristic)
    {
     ...
     * A characteristic that defines the members of the research element. Multiple characteristics are applied with "and" semantics.
     *
     * @return \TKusy\Hl7FhirR4\ResearchElementDefinitionCharacteristicType[]
     */
