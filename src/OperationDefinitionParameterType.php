...
class OperationDefinitionParameterType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\OperationParameterUseType $use
     */
    private $use = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\OperationDefinitionBindingType $binding
     */
     ...
     * Whether this is an input or an output parameter.
     *
     * @return \TKusy\Hl7FhirR4\OperationParameterUseType
     */
     ...
     * Whether this is an input or an output parameter.
     *
     * @param \TKusy\Hl7FhirR4\OperationParameterUseType $use
     * @return self
     */
    public function setUse(\TKusy\Hl7FhirR4\OperationParameterUseType $use)
    {
        $this->use = $use;
        return $this;
    }
     ...
     * Binds to a value set if this parameter is coded (code, Coding, CodeableConcept).
     *
     * @return \TKusy\Hl7FhirR4\OperationDefinitionBindingType
     */
     ...
     * Binds to a value set if this parameter is coded (code, Coding, CodeableConcept).
     *
     * @param \TKusy\Hl7FhirR4\OperationDefinitionBindingType $binding
     * @return self
     */
    public function setBinding(\TKusy\Hl7FhirR4\OperationDefinitionBindingType $binding)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\OperationDefinitionReferencedFromType $referencedFrom
     */
    public function addToReferencedFrom(\TKusy\Hl7FhirR4\OperationDefinitionReferencedFromType $referencedFrom)
    {
     ...
     * Identifies other resource parameters within the operation invocation that are expected to resolve to this resource.
     *
     * @return \TKusy\Hl7FhirR4\OperationDefinitionReferencedFromType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\OperationDefinitionParameterType $part
     */
    public function addToPart(\TKusy\Hl7FhirR4\OperationDefinitionParameterType $part)
    {
        $this->part[] = $part;
        return $this;
    }
