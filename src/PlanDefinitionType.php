...
class PlanDefinitionType extends DomainResourceType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\PlanDefinitionGoalType $goal
     */
    public function addToGoal(\TKusy\Hl7FhirR4\PlanDefinitionGoalType $goal)
    {
        $this->goal[] = $goal;
        return $this;
    }
     ...
     * Goals that describe what the activities within the plan are intended to achieve. For example, weight loss, restoring an activity of daily living, obtaining herd immunity via immunization, meeting a process improvement objective, etc.
     *
     * @return \TKusy\Hl7FhirR4\PlanDefinitionGoalType[]
     */
