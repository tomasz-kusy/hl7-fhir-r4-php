...
class ConsentDataType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ConsentDataMeaningType $meaning
     */
     ...
     * How the resource reference is interpreted when testing consent restrictions.
     *
     * @return \TKusy\Hl7FhirR4\ConsentDataMeaningType
     */
     ...
     * How the resource reference is interpreted when testing consent restrictions.
     *
     * @param \TKusy\Hl7FhirR4\ConsentDataMeaningType $meaning
     * @return self
     */
    public function setMeaning(\TKusy\Hl7FhirR4\ConsentDataMeaningType $meaning)
    {
