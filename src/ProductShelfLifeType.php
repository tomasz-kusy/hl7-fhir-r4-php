...
class ProductShelfLifeType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\QuantityType $period
     */
    private $period = null;
     ...
     * The shelf life time period can be specified using a numerical value for the period of time and its unit of time measurement The unit of measurement shall be specified in accordance with ISO 11240 and the resulting terminology The symbol and the symbol identifier shall be used.
     *
     * @param \TKusy\Hl7FhirR4\QuantityType $period
     * @return self
     */
    public function setPeriod(\TKusy\Hl7FhirR4\QuantityType $period)
    {
        $this->period = $period;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $specialPrecautionsForStorage
     */
    public function addToSpecialPrecautionsForStorage(\TKusy\Hl7FhirR4\CodeableConceptType $specialPrecautionsForStorage)
    {
