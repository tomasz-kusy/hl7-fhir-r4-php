...
class AttachmentType extends ElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\UnsignedIntType $size
     */
    private $size = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\Base64BinaryType $hash
     */
    private $hash = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $creation
     */
     ...
     * The number of bytes of data that make up this attachment (before base64 encoding, if that is done).
     *
     * @param \TKusy\Hl7FhirR4\UnsignedIntType $size
     * @return self
     */
    public function setSize(\TKusy\Hl7FhirR4\UnsignedIntType $size)
    {
        $this->size = $size;
        return $this;
    }
     ...
     * The calculated hash of the data using SHA-1. Represented using base64.
     *
     * @param \TKusy\Hl7FhirR4\Base64BinaryType $hash
     * @return self
     */
    public function setHash(\TKusy\Hl7FhirR4\Base64BinaryType $hash)
    {
        $this->hash = $hash;
        return $this;
    }
     ...
     * The date that the attachment was first created.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $creation
     * @return self
     */
    public function setCreation(\TKusy\Hl7FhirR4\DateTimeType $creation)
    {
