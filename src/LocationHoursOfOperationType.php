...
class LocationHoursOfOperationType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\TimeType $openingTime
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\TimeType $closingTime
     */
     ...
     * Time that the Location opens.
     *
     * @param \TKusy\Hl7FhirR4\TimeType $openingTime
     * @return self
     */
    public function setOpeningTime(\TKusy\Hl7FhirR4\TimeType $openingTime)
    {
     ...
     * Time that the Location closes.
     *
     * @param \TKusy\Hl7FhirR4\TimeType $closingTime
     * @return self
     */
    public function setClosingTime(\TKusy\Hl7FhirR4\TimeType $closingTime)
    {
