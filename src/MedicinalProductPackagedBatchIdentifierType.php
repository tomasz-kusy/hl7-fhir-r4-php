...
class MedicinalProductPackagedBatchIdentifierType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\IdentifierType $outerPackaging
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\IdentifierType $immediatePackaging
     */
     ...
     * A number appearing on the outer packaging of a specific batch.
     *
     * @param \TKusy\Hl7FhirR4\IdentifierType $outerPackaging
     * @return self
     */
    public function setOuterPackaging(\TKusy\Hl7FhirR4\IdentifierType $outerPackaging)
    {
     ...
     * A number appearing on the immediate packaging (and not the outer packaging).
     *
     * @param \TKusy\Hl7FhirR4\IdentifierType $immediatePackaging
     * @return self
     */
    public function setImmediatePackaging(\TKusy\Hl7FhirR4\IdentifierType $immediatePackaging)
    {
