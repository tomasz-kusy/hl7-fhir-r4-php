...
class ClaimType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ClaimPayeeType $payee
     */
    private $payee = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\ClaimAccidentType $accident
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\MoneyType $total
     */
    private $total = null;
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimRelatedType $related
     */
    public function addToRelated(\TKusy\Hl7FhirR4\ClaimRelatedType $related)
    {
     ...
     * Other claims which are related to this claim such as prior submissions or claims for related services or for the same event.
     *
     * @return \TKusy\Hl7FhirR4\ClaimRelatedType[]
     */
     ...
     * The party to be reimbursed for cost of the products and services according to the terms of the policy.
     *
     * @return \TKusy\Hl7FhirR4\ClaimPayeeType
     */
     ...
     * The party to be reimbursed for cost of the products and services according to the terms of the policy.
     *
     * @param \TKusy\Hl7FhirR4\ClaimPayeeType $payee
     * @return self
     */
    public function setPayee(\TKusy\Hl7FhirR4\ClaimPayeeType $payee)
    {
        $this->payee = $payee;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimCareTeamType $careTeam
     */
    public function addToCareTeam(\TKusy\Hl7FhirR4\ClaimCareTeamType $careTeam)
    {
     ...
     * The members of the team who provided the products and services.
     *
     * @return \TKusy\Hl7FhirR4\ClaimCareTeamType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimSupportingInfoType $supportingInfo
     */
    public function addToSupportingInfo(\TKusy\Hl7FhirR4\ClaimSupportingInfoType $supportingInfo)
    {
     ...
     * Additional information codes regarding exceptions, special considerations, the condition, situation, prior or concurrent issues.
     *
     * @return \TKusy\Hl7FhirR4\ClaimSupportingInfoType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimDiagnosisType $diagnosis
     */
    public function addToDiagnosis(\TKusy\Hl7FhirR4\ClaimDiagnosisType $diagnosis)
    {
     ...
     * Information about diagnoses relevant to the claim items.
     *
     * @return \TKusy\Hl7FhirR4\ClaimDiagnosisType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimProcedureType $procedure
     */
    public function addToProcedure(\TKusy\Hl7FhirR4\ClaimProcedureType $procedure)
    {
     ...
     * Procedures performed on the patient relevant to the billing items with the claim.
     *
     * @return \TKusy\Hl7FhirR4\ClaimProcedureType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimInsuranceType $insurance
     */
    public function addToInsurance(\TKusy\Hl7FhirR4\ClaimInsuranceType $insurance)
    {
     ...
     * Financial instruments for reimbursement for the health care products and services specified on the claim.
     *
     * @return \TKusy\Hl7FhirR4\ClaimInsuranceType[]
     */
     ...
     * Details of an accident which resulted in injuries which required the products and services listed in the claim.
     *
     * @return \TKusy\Hl7FhirR4\ClaimAccidentType
     */
     ...
     * Details of an accident which resulted in injuries which required the products and services listed in the claim.
     *
     * @param \TKusy\Hl7FhirR4\ClaimAccidentType $accident
     * @return self
     */
    public function setAccident(\TKusy\Hl7FhirR4\ClaimAccidentType $accident)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimItemType $item
     */
    public function addToItem(\TKusy\Hl7FhirR4\ClaimItemType $item)
    {
        $this->item[] = $item;
        return $this;
    }
     ...
     * A claim line. Either a simple product or service or a 'group' of details which can each be a simple items or groups of sub-details.
     *
     * @return \TKusy\Hl7FhirR4\ClaimItemType[]
     */
     ...
     * The total value of the all the items in the claim.
     *
     * @param \TKusy\Hl7FhirR4\MoneyType $total
     * @return self
     */
    public function setTotal(\TKusy\Hl7FhirR4\MoneyType $total)
    {
        $this->total = $total;
        return $this;
    }
