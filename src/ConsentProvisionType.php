...
class ConsentProvisionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ConsentProvisionTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\PeriodType $dataPeriod
     */
     ...
     * Action to take - permit or deny - when the rule conditions are met. Not permitted in root rule, required in all nested rules.
     *
     * @return \TKusy\Hl7FhirR4\ConsentProvisionTypeType
     */
     ...
     * Action to take - permit or deny - when the rule conditions are met. Not permitted in root rule, required in all nested rules.
     *
     * @param \TKusy\Hl7FhirR4\ConsentProvisionTypeType $type
     * @return self
     */
    public function setType(\TKusy\Hl7FhirR4\ConsentProvisionTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ConsentActorType $actor
     */
    public function addToActor(\TKusy\Hl7FhirR4\ConsentActorType $actor)
    {
        $this->actor[] = $actor;
        return $this;
    }
     ...
     * Who or what is controlled by this rule. Use group to identify a set of actors by some property they share (e.g. 'admitting officers').
     *
     * @return \TKusy\Hl7FhirR4\ConsentActorType[]
     */
     ...
     */
    public function addToAction(\TKusy\Hl7FhirR4\CodeableConceptType $action)
    {
        $this->action[] = $action;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodingType $purpose
     */
    public function addToPurpose(\TKusy\Hl7FhirR4\CodingType $purpose)
    {
     ...
     */
    public function addToClass(\TKusy\Hl7FhirR4\CodingType $class)
    {
        $this->class[] = $class;
        return $this;
    }
     ...
     * Clinical or Operational Relevant period of time that bounds the data controlled by this rule.
     *
     * @param \TKusy\Hl7FhirR4\PeriodType $dataPeriod
     * @return self
     */
    public function setDataPeriod(\TKusy\Hl7FhirR4\PeriodType $dataPeriod)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ConsentDataType $data
     */
    public function addToData(\TKusy\Hl7FhirR4\ConsentDataType $data)
    {
        $this->data[] = $data;
        return $this;
    }
     ...
     * The resources controlled by this rule if specific resources are referenced.
     *
     * @return \TKusy\Hl7FhirR4\ConsentDataType[]
     */
     ...
     */
    public function addToProvision(\TKusy\Hl7FhirR4\ConsentProvisionType $provision)
    {
