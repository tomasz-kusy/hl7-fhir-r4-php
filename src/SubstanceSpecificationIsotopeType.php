...
class SubstanceSpecificationIsotopeType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $name
     */
    private $name = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $substitution
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\QuantityType $halfLife
     */
     ...
     * Substance name for each non-natural or radioisotope.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $name
     * @return self
     */
    public function setName(\TKusy\Hl7FhirR4\CodeableConceptType $name)
    {
        $this->name = $name;
        return $this;
    }
     ...
     * The type of isotopic substitution present in a single substance.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $substitution
     * @return self
     */
    public function setSubstitution(\TKusy\Hl7FhirR4\CodeableConceptType $substitution)
    {
     ...
     * Half life - for a non-natural nuclide.
     *
     * @param \TKusy\Hl7FhirR4\QuantityType $halfLife
     * @return self
     */
    public function setHalfLife(\TKusy\Hl7FhirR4\QuantityType $halfLife)
    {
     ...
     * @return self
     */
    public function setMolecularWeight(\TKusy\Hl7FhirR4\SubstanceSpecificationMolecularWeightType $molecularWeight)
    {
