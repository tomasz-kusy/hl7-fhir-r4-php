...
class VerificationResultPrimarySourceType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $validationStatus
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $validationDate
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $canPushUpdates
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $communicationMethod
     */
    public function addToCommunicationMethod(\TKusy\Hl7FhirR4\CodeableConceptType $communicationMethod)
    {
     ...
     * Status of the validation of the target against the primary source (successful; failed; unknown).
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $validationStatus
     * @return self
     */
    public function setValidationStatus(\TKusy\Hl7FhirR4\CodeableConceptType $validationStatus)
    {
     ...
     * When the target was validated against the primary source.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $validationDate
     * @return self
     */
    public function setValidationDate(\TKusy\Hl7FhirR4\DateTimeType $validationDate)
    {
     ...
     * Ability of the primary source to push updates/alerts (yes; no; undetermined).
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $canPushUpdates
     * @return self
     */
    public function setCanPushUpdates(\TKusy\Hl7FhirR4\CodeableConceptType $canPushUpdates)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $pushTypeAvailable
     */
    public function addToPushTypeAvailable(\TKusy\Hl7FhirR4\CodeableConceptType $pushTypeAvailable)
    {
