...
class CapabilityStatementDocumentType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\DocumentModeType $mode
     */
    private $mode = null;
     ...
     * Mode of this document declaration - whether an application is a producer or consumer.
     *
     * @return \TKusy\Hl7FhirR4\DocumentModeType
     */
     ...
     * Mode of this document declaration - whether an application is a producer or consumer.
     *
     * @param \TKusy\Hl7FhirR4\DocumentModeType $mode
     * @return self
     */
    public function setMode(\TKusy\Hl7FhirR4\DocumentModeType $mode)
    {
        $this->mode = $mode;
        return $this;
    }
