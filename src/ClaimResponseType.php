...
class ClaimResponseType extends DomainResourceType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\PeriodType $preAuthPeriod
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $payeeType
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\ClaimResponsePaymentType $payment
     */
     ...
     * The time frame during which this authorization is effective.
     *
     * @param \TKusy\Hl7FhirR4\PeriodType $preAuthPeriod
     * @return self
     */
    public function setPreAuthPeriod(\TKusy\Hl7FhirR4\PeriodType $preAuthPeriod)
    {
     ...
     * Type of Party to be reimbursed: subscriber, provider, other.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $payeeType
     * @return self
     */
    public function setPayeeType(\TKusy\Hl7FhirR4\CodeableConceptType $payeeType)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimResponseItemType $item
     */
    public function addToItem(\TKusy\Hl7FhirR4\ClaimResponseItemType $item)
    {
        $this->item[] = $item;
        return $this;
    }
     ...
     * A claim line. Either a simple (a product or service) or a 'group' of details which can also be a simple items or groups of sub-details.
     *
     * @return \TKusy\Hl7FhirR4\ClaimResponseItemType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimResponseAddItemType $addItem
     */
    public function addToAddItem(\TKusy\Hl7FhirR4\ClaimResponseAddItemType $addItem)
    {
     ...
     * The first-tier service adjudications for payor added product or service lines.
     *
     * @return \TKusy\Hl7FhirR4\ClaimResponseAddItemType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimResponseTotalType $total
     */
    public function addToTotal(\TKusy\Hl7FhirR4\ClaimResponseTotalType $total)
    {
        $this->total[] = $total;
        return $this;
    }
     ...
     * Categorized monetary totals for the adjudication.
     *
     * @return \TKusy\Hl7FhirR4\ClaimResponseTotalType[]
     */
     ...
     * Payment details for the adjudication of the claim.
     *
     * @return \TKusy\Hl7FhirR4\ClaimResponsePaymentType
     */
     ...
     * Payment details for the adjudication of the claim.
     *
     * @param \TKusy\Hl7FhirR4\ClaimResponsePaymentType $payment
     * @return self
     */
    public function setPayment(\TKusy\Hl7FhirR4\ClaimResponsePaymentType $payment)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimResponseProcessNoteType $processNote
     */
    public function addToProcessNote(\TKusy\Hl7FhirR4\ClaimResponseProcessNoteType $processNote)
    {
     ...
     * A note that describes or explains adjudication results in a human readable form.
     *
     * @return \TKusy\Hl7FhirR4\ClaimResponseProcessNoteType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ReferenceType $communicationRequest
     */
    public function addToCommunicationRequest(\TKusy\Hl7FhirR4\ReferenceType $communicationRequest)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimResponseInsuranceType $insurance
     */
    public function addToInsurance(\TKusy\Hl7FhirR4\ClaimResponseInsuranceType $insurance)
    {
     ...
     * Financial instruments for reimbursement for the health care products and services specified on the claim.
     *
     * @return \TKusy\Hl7FhirR4\ClaimResponseInsuranceType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ClaimResponseErrorType $error
     */
    public function addToError(\TKusy\Hl7FhirR4\ClaimResponseErrorType $error)
    {
        $this->error[] = $error;
        return $this;
    }
     ...
     * Errors encountered during the processing of the adjudication.
     *
     * @return \TKusy\Hl7FhirR4\ClaimResponseErrorType[]
     */
