...
class SubstancePolymerType extends DomainResourceType
{
     ...
     * Todo.
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $class
     */
    private $class = null;
     ...
     * Todo.
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $geometry
     */
     ...
     * Todo.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $class
     * @return self
     */
    public function setClass(\TKusy\Hl7FhirR4\CodeableConceptType $class)
    {
        $this->class = $class;
        return $this;
    }
     ...
     * Todo.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $geometry
     * @return self
     */
    public function setGeometry(\TKusy\Hl7FhirR4\CodeableConceptType $geometry)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $copolymerConnectivity
     */
    public function addToCopolymerConnectivity(\TKusy\Hl7FhirR4\CodeableConceptType $copolymerConnectivity)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\SubstancePolymerMonomerSetType $monomerSet
     */
    public function addToMonomerSet(\TKusy\Hl7FhirR4\SubstancePolymerMonomerSetType $monomerSet)
    {
     ...
     * Todo.
     *
     * @return \TKusy\Hl7FhirR4\SubstancePolymerMonomerSetType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\SubstancePolymerRepeatType $repeat
     */
    public function addToRepeat(\TKusy\Hl7FhirR4\SubstancePolymerRepeatType $repeat)
    {
        $this->repeat[] = $repeat;
        return $this;
    }
     ...
     * Todo.
     *
     * @return \TKusy\Hl7FhirR4\SubstancePolymerRepeatType[]
     */
