...
class CapabilityStatementSupportedMessageType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\EventCapabilityModeType $mode
     */
    private $mode = null;
     ...
     * The mode of this event declaration - whether application is sender or receiver.
     *
     * @return \TKusy\Hl7FhirR4\EventCapabilityModeType
     */
     ...
     * The mode of this event declaration - whether application is sender or receiver.
     *
     * @param \TKusy\Hl7FhirR4\EventCapabilityModeType $mode
     * @return self
     */
    public function setMode(\TKusy\Hl7FhirR4\EventCapabilityModeType $mode)
    {
        $this->mode = $mode;
        return $this;
    }
