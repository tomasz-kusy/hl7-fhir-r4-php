...
class ExplanationOfBenefitDiagnosisType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $onAdmission
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $packageCode
     */
     ...
     * Indication of whether the diagnosis was present on admission to a facility.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $onAdmission
     * @return self
     */
    public function setOnAdmission(\TKusy\Hl7FhirR4\CodeableConceptType $onAdmission)
    {
     ...
     * A package billing code or bundle code used to group products and services to a particular health condition (such as heart attack) which is based on a predetermined grouping code system.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $packageCode
     * @return self
     */
    public function setPackageCode(\TKusy\Hl7FhirR4\CodeableConceptType $packageCode)
    {
