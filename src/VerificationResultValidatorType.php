...
class VerificationResultValidatorType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\SignatureType $attestationSignature
     */
     ...
     * Signed assertion by the validator that they have validated the information.
     *
     * @param \TKusy\Hl7FhirR4\SignatureType $attestationSignature
     * @return self
     */
    public function setAttestationSignature(\TKusy\Hl7FhirR4\SignatureType $attestationSignature)
    {
