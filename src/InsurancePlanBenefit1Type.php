...
class InsurancePlanBenefit1Type extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\InsurancePlanCostType[] $cost
     */
    private $cost = [
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\InsurancePlanCostType $cost
     */
    public function addToCost(\TKusy\Hl7FhirR4\InsurancePlanCostType $cost)
    {
        $this->cost[] = $cost;
        return $this;
    }
     ...
     * List of the costs associated with a specific benefit.
     *
     * @return \TKusy\Hl7FhirR4\InsurancePlanCostType[]
     */
