...
class ContractContentDefinitionType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $publisher
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\DateTimeType $publicationDate
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\ContractResourcePublicationStatusCodesType $publicationStatus
     */
     ...
     * The individual or organization that published the Contract precursor content.
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $publisher
     * @return self
     */
    public function setPublisher(\TKusy\Hl7FhirR4\ReferenceType $publisher)
    {
     ...
     * The date (and optionally time) when the contract was published. The date must change when the business version changes and it must change if the status code changes. In addition, it should change when the substantive content of the contract changes.
     *
     * @param \TKusy\Hl7FhirR4\DateTimeType $publicationDate
     * @return self
     */
    public function setPublicationDate(\TKusy\Hl7FhirR4\DateTimeType $publicationDate)
    {
     ...
     * amended | appended | cancelled | disputed | entered-in-error | executable | executed | negotiable | offered | policy | rejected | renewed | revoked | resolved | terminated.
     *
     * @return \TKusy\Hl7FhirR4\ContractResourcePublicationStatusCodesType
     */
     ...
     * amended | appended | cancelled | disputed | entered-in-error | executable | executed | negotiable | offered | policy | rejected | renewed | revoked | resolved | terminated.
     *
     * @param \TKusy\Hl7FhirR4\ContractResourcePublicationStatusCodesType $publicationStatus
     * @return self
     */
    public function setPublicationStatus(\TKusy\Hl7FhirR4\ContractResourcePublicationStatusCodesType $publicationStatus)
    {
