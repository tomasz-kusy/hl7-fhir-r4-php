...
class ContractOfferType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\ReferenceType $topic
     */
    private $topic = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $decision
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ContractPartyType $party
     */
    public function addToParty(\TKusy\Hl7FhirR4\ContractPartyType $party)
    {
        $this->party[] = $party;
        return $this;
    }
     ...
     * Offer Recipient.
     *
     * @return \TKusy\Hl7FhirR4\ContractPartyType[]
     */
     ...
     * The owner of an asset has the residual control rights over the asset: the right to decide all usages of the asset in any way not inconsistent with a prior contract, custom, or law (Hart, 1995, p. 30).
     *
     * @param \TKusy\Hl7FhirR4\ReferenceType $topic
     * @return self
     */
    public function setTopic(\TKusy\Hl7FhirR4\ReferenceType $topic)
    {
        $this->topic = $topic;
        return $this;
    }
     ...
     * Type of choice made by accepting party with respect to an offer made by an offeror/ grantee.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $decision
     * @return self
     */
    public function setDecision(\TKusy\Hl7FhirR4\CodeableConceptType $decision)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $decisionMode
     */
    public function addToDecisionMode(\TKusy\Hl7FhirR4\CodeableConceptType $decisionMode)
    {
