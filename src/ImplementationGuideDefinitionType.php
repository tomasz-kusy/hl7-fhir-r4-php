...
class ImplementationGuideDefinitionType extends BackboneElementType
{
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ImplementationGuideGroupingType $grouping
     */
    public function addToGrouping(\TKusy\Hl7FhirR4\ImplementationGuideGroupingType $grouping)
    {
     ...
     * A logical group of resources. Logical groups can be used when building pages.
     *
     * @return \TKusy\Hl7FhirR4\ImplementationGuideGroupingType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ImplementationGuideResourceType $resource
     */
    public function addToResource(\TKusy\Hl7FhirR4\ImplementationGuideResourceType $resource)
    {
     ...
     * A resource that is part of the implementation guide. Conformance resources (value set, structure definition, capability statements etc.) are obvious candidates for inclusion, but any kind of resource can be included as an example resource.
     *
     * @return \TKusy\Hl7FhirR4\ImplementationGuideResourceType[]
     */
     ...
     * @return self
     */
    public function setPage(\TKusy\Hl7FhirR4\ImplementationGuidePageType $page)
    {
        $this->page = $page;
        return $this;
    }
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ImplementationGuideParameterType $parameter
     */
    public function addToParameter(\TKusy\Hl7FhirR4\ImplementationGuideParameterType $parameter)
    {
     ...
     * Defines how IG is built by tools.
     *
     * @return \TKusy\Hl7FhirR4\ImplementationGuideParameterType[]
     */
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\ImplementationGuideTemplateType $template
     */
    public function addToTemplate(\TKusy\Hl7FhirR4\ImplementationGuideTemplateType $template)
    {
     ...
     * A template for building resources.
     *
     * @return \TKusy\Hl7FhirR4\ImplementationGuideTemplateType[]
     */
