...
class OperationOutcomeIssueType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\IssueSeverityType $severity
     */
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $details
     */
     ...
     * Indicates whether the issue indicates a variation from successful processing.
     *
     * @return \TKusy\Hl7FhirR4\IssueSeverityType
     */
     ...
     * Indicates whether the issue indicates a variation from successful processing.
     *
     * @param \TKusy\Hl7FhirR4\IssueSeverityType $severity
     * @return self
     */
    public function setSeverity(\TKusy\Hl7FhirR4\IssueSeverityType $severity)
    {
     ...
     * Additional details about the error. This may be a text description of the error or a system code that identifies the error.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $details
     * @return self
     */
    public function setDetails(\TKusy\Hl7FhirR4\CodeableConceptType $details)
    {
