...
class MedicinalProductIngredientSpecifiedSubstanceType extends BackboneElementType
{
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $group
     */
    private $group = null;
     ...
     *
     * @var \TKusy\Hl7FhirR4\CodeableConceptType $confidentiality
     */
     ...
     * The group of specified substance, e.g. group 1 to 4.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $group
     * @return self
     */
    public function setGroup(\TKusy\Hl7FhirR4\CodeableConceptType $group)
    {
        $this->group = $group;
        return $this;
    }
     ...
     * Confidentiality level of the specified substance as the ingredient.
     *
     * @param \TKusy\Hl7FhirR4\CodeableConceptType $confidentiality
     * @return self
     */
    public function setConfidentiality(\TKusy\Hl7FhirR4\CodeableConceptType $confidentiality)
    {
     ...
     *
     * @return self
     * @param \TKusy\Hl7FhirR4\MedicinalProductIngredientStrengthType $strength
     */
    public function addToStrength(\TKusy\Hl7FhirR4\MedicinalProductIngredientStrengthType $strength)
    {
     ...
     * Quantity of the substance or specified substance present in the manufactured item or pharmaceutical product.
     *
     * @return \TKusy\Hl7FhirR4\MedicinalProductIngredientStrengthType[]
     */
